...
public class Linux_SambaGlobalBrowseOptionsHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaGlobalBrowseOptions.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaGlobalBrowseOptions.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaGlobalBrowseOptionsHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaGlobalBrowseOptions.");
                        resultArrayList.add(new Linux_SambaGlobalBrowseOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaGlobalBrowseOptions.");
                        resultArrayList.add(new Linux_SambaGlobalBrowseOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaGlobalBrowseOptions.");
                        resultArrayList.add(new Linux_SambaGlobalBrowseOptions(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaGlobalBrowseOptions getInstance(WBEMClient client,
    ...
    public final static Linux_SambaGlobalBrowseOptions getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(Linux_SambaGlobalBrowseOptions.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                Linux_SambaGlobalBrowseOptions.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(Linux_SambaGlobalBrowseOptions.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                Linux_SambaGlobalBrowseOptions.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_SambaGlobalBrowseOptions createInstance(WBEMClient client,
            Linux_SambaGlobalBrowseOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaGlobalBrowseOptions newDataInstance = Linux_SambaGlobalBrowseOptionsHelper
     ...
     */
    public final static Linux_SambaGlobalBrowseOptions modifyInstance(WBEMClient client,
            Linux_SambaGlobalBrowseOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaGlobalBrowseOptions dataInstance2 = Linux_SambaGlobalBrowseOptionsHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaGlobalBrowseOptions dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaGlobalBrowseOptions.getPackages());
    }
