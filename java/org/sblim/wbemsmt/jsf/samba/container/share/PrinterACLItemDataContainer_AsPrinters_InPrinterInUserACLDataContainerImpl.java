...
public class PrinterACLItemDataContainer_AsPrinters_InPrinterInUserACLDataContainerImpl extends
        org.sblim.wbemsmt.tools.jsf.MultiLineBasePanel2 implements
        org.sblim.wbemsmt.samba.bl.container.share.PrinterACLItemDataContainer {
    ...
    public PrinterACLItemDataContainer_AsPrinters_InPrinterInUserACLDataContainerImpl(
    ...
    public void reload() {
        ...
        if (ic_PrinterName != null) {
            ic_PrinterName
                    .setLabelText(bundle.getString("PrinterACLItemDataContainer.PrinterName"));
        }
        if (ic_usr_AccessTypeVI != null) {
            ic_usr_AccessTypeVI.setLabelText(bundle
                    .getString("PrinterACLItemDataContainer.accessTypeVI"));
        }
        if (ic_usr_AccessTypeRW != null) {
            ic_usr_AccessTypeRW.setLabelText(bundle
                    .getString("PrinterACLItemDataContainer.accessTypeRW"));
        }
        if (ic_usr_Admin != null) {
