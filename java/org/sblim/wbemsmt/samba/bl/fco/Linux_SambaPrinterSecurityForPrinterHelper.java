...
public class Linux_SambaPrinterSecurityForPrinterHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaPrinterSecurityForPrinter.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaPrinterSecurityForPrinter.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaPrinterSecurityForPrinterHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaPrinterSecurityForPrinter.");
                        resultArrayList.add(new Linux_SambaPrinterSecurityForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaPrinterSecurityForPrinter.");
                        resultArrayList.add(new Linux_SambaPrinterSecurityForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaPrinterSecurityForPrinter.");
                        resultArrayList.add(new Linux_SambaPrinterSecurityForPrinter(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaPrinterSecurityForPrinter getInstance(WBEMClient client,
     ...
     */
    public final static Linux_SambaPrinterSecurityForPrinter getInstance(WBEMClient client,
            String namespace, Linux_SambaPrinterSecurityOptions SettingData,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaPrinterSecurityForPrinter.PROPERTY_SETTINGDATA_LINUX_SAMBAPRINTERSECURITYOPTIONS.NAME,
                new CIMDataType(Linux_SambaPrinterSecurityOptions.CIM_CLASS_NAME), setThis, false,
                false, Linux_SambaPrinterSecurityForPrinter.CIM_CLASS_NAME);

        setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                Linux_SambaPrinterSecurityForPrinter.PROPERTY_MANAGEDELEMENT_LINUX_SAMBAPRINTEROPTIONS.NAME,
                new CIMDataType(Linux_SambaPrinterOptions.CIM_CLASS_NAME), setThis, false, false,
                Linux_SambaPrinterSecurityForPrinter.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_SambaPrinterSecurityForPrinter createInstance(WBEMClient client,
            Linux_SambaPrinterSecurityForPrinter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaPrinterSecurityForPrinter newDataInstance = Linux_SambaPrinterSecurityForPrinterHelper
     ...
     */
    public final static Linux_SambaPrinterSecurityForPrinter modifyInstance(WBEMClient client,
            Linux_SambaPrinterSecurityForPrinter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaPrinterSecurityForPrinter dataInstance2 = Linux_SambaPrinterSecurityForPrinterHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaPrinterSecurityForPrinter dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaPrinterSecurityForPrinter.getPackages());
    }
