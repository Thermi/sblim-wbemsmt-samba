...
public final class Linux_SambaPrinterOptionsHelper {
	...
	*/	
	public final static Linux_SambaPrinterOptions getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_SambaPrinterOptionsHelper.getInstance(cimClient, new Linux_SambaPrinterOptions(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaPrinterOptions getInstance(CIMClient cimClient, Linux_SambaPrinterOptions dataInstance) {
		...
		return Linux_SambaPrinterOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaPrinterOptions getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			...
			{
				dataInstance = new Linux_SambaPrinterOptions(cimObjectPath, cimInstance);
			}
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = Linux_SambaPrinterOptions.getPackages();
	...
	*/	
	public final static Linux_SambaPrinterOptions createInstance(CIMClient cimClient, Linux_SambaPrinterOptions dataInstance, boolean notifyDifferencies){ 
		...
		Linux_SambaPrinterOptions newDataInstance = null;
		try {
			newDataInstance = Linux_SambaPrinterOptionsHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaPrinterOptions modifyInstance(CIMClient cimClient, Linux_SambaPrinterOptions dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_SambaPrinterOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_SambaPrinterOptions dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_SambaPrinterOptions dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_SambaPrinterOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_SambaPrinterOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_SambaPrinterOptions.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_SambaPrinterOptions.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_SambaPrinterOptions.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_Available(Boolean Available) {
		return true;
	}

	public static boolean isValid_Comment(String Comment) {
		return true;
	}
	...
	public static boolean isValid_Path(String Path) {
		return true;
	}
	...
	public static boolean isValid_SystemPrinterName(String SystemPrinterName) {
		return true;
	}
