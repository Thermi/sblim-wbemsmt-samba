...
public class Linux_SambaCommonSecurityOptionsHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaCommonSecurityOptions.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaCommonSecurityOptions.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaCommonSecurityOptionsHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaCommonSecurityOptions.");
                        resultArrayList.add(new Linux_SambaCommonSecurityOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaCommonSecurityOptions.");
                        resultArrayList.add(new Linux_SambaCommonSecurityOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaCommonSecurityOptions.");
                        resultArrayList.add(new Linux_SambaCommonSecurityOptions(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaCommonSecurityOptions getInstance(WBEMClient client,
    ...
    public final static Linux_SambaCommonSecurityOptions getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaCommonSecurityOptions.PROPERTY_INSTANCEID.NAME, CIMDataType.STRING_T,
                setThis, true, false, Linux_SambaCommonSecurityOptions.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(Linux_SambaCommonSecurityOptions.PROPERTY_NAME.NAME,
     ...
     *
     */
    public final static Linux_SambaCommonSecurityOptions createInstance(WBEMClient client,
            Linux_SambaCommonSecurityOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaCommonSecurityOptions newDataInstance = Linux_SambaCommonSecurityOptionsHelper
     ...
     */
    public final static Linux_SambaCommonSecurityOptions modifyInstance(WBEMClient client,
            Linux_SambaCommonSecurityOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaCommonSecurityOptions dataInstance2 = Linux_SambaCommonSecurityOptionsHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaCommonSecurityOptions dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaCommonSecurityOptions.getPackages());
    }
