/**
 * EditServiceListenerEditBeanTabServiceOptions.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS
...
public class EditServiceListenerEditBeanTabServiceOptions extends EditBean {

    private org.sblim.wbemsmt.jsf.samba.container.service.ServiceOptionsDataContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.samba.bl.adapter.SambaCimAdapter adapter1 = null;

    private HtmlPanelGrid panel;

    public EditServiceListenerEditBeanTabServiceOptions() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container ServiceOptionsDataContainer
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        expressionPrefix = "objectActionController.editBeans['tabServiceOptions'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.jsf.samba.container.service.ServiceOptionsDataContainerImpl(
        ...
        addFooter(panel, "objectActionController.editBeans['tabServiceOptions'].");
