...
public class Linux_SambaInvalidUsersForShareHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaInvalidUsersForShare.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaInvalidUsersForShare.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaInvalidUsersForShareHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaInvalidUsersForShare.");
                        resultArrayList.add(new Linux_SambaInvalidUsersForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaInvalidUsersForShare.");
                        resultArrayList.add(new Linux_SambaInvalidUsersForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaInvalidUsersForShare.");
                        resultArrayList.add(new Linux_SambaInvalidUsersForShare(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaInvalidUsersForShare getInstance(WBEMClient client,
     ...
     */
    public final static Linux_SambaInvalidUsersForShare getInstance(WBEMClient client,
            String namespace, Linux_SambaUser PartComponent, Linux_SambaShareOptions GroupComponent
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaInvalidUsersForShare.PROPERTY_PARTCOMPONENT_LINUX_SAMBAUSER.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_SambaInvalidUsersForShare.PROPERTY_GROUPCOMPONENT_LINUX_SAMBASHAREOPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaInvalidUsersForShare createInstance(WBEMClient client,
            Linux_SambaInvalidUsersForShare dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaInvalidUsersForShare newDataInstance = Linux_SambaInvalidUsersForShareHelper
     ...
     */
    public final static Linux_SambaInvalidUsersForShare modifyInstance(WBEMClient client,
            Linux_SambaInvalidUsersForShare dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaInvalidUsersForShare dataInstance2 = Linux_SambaInvalidUsersForShareHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaInvalidUsersForShare dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaInvalidUsersForShare.getPackages());
    }
