...
public class AdminUsersInPrinterGlobals_AsUsers_InPrintingGlobalsDataContainerImpl extends
        org.sblim.wbemsmt.tools.jsf.MultiLineBasePanel2 implements
        org.sblim.wbemsmt.samba.bl.container.global.AdminUsersInPrinterGlobals {
    ...
    public AdminUsersInPrinterGlobals_AsUsers_InPrintingGlobalsDataContainerImpl(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_SambaUserName() {
        if (ic_usr_SambaUserName == null) {
            ...
            ;
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent) ic_usr_SambaUserName)
    ...
    public LabeledJSFInputComponent[] getComponents() {
        return new LabeledJSFInputComponent[] { (LabeledJSFInputComponent) get_usr_SambaUserName(),
