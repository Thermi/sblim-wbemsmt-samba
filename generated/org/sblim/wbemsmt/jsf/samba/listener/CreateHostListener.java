...
public class CreateHostListener extends TaskLauncherContextMenuEventListenerImpl {
    ...
    public String processEvent(TaskLauncherTreeNodeEvent event) throws WbemsmtException {
        ...
        helpManager.setCurrentTopic("SAMBA", "CreateHostListener");
        ...
        if (selector.execute()) {
            ...
            org.sblim.wbemsmt.jsf.samba.wizard.HostWizard wizard = new org.sblim.wbemsmt.jsf.samba.wizard.HostWizard(
                    adapter);
