/**
 * Linux_SambaWriteListForPrinter.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class Linux_SambaWriteListForPrinter extends CIM_Component {
    ...
    public Linux_SambaWriteListForPrinter(WBEMClient client, String namespace)
    ...
    public Linux_SambaWriteListForPrinter(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaWriteListForPrinter() {
    }
    ...
    public static CIMProperty create_PartComponent_Linux_SambaUser(WBEMClient client,
        ...
        Linux_SambaWriteListForPrinter fco = new Linux_SambaWriteListForPrinter(client, namespace);
    ...
    public String getObjectName() {
        return Linux_SambaWriteListForPrinter.CIM_CLASS_NAME;
    }
