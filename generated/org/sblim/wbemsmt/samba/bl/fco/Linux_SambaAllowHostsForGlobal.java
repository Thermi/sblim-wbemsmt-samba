/**
 * Linux_SambaAllowHostsForGlobal.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class Linux_SambaAllowHostsForGlobal extends CIM_Component {
    ...
    public Linux_SambaAllowHostsForGlobal(WBEMClient client, String namespace)
    ...
    public Linux_SambaAllowHostsForGlobal(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaAllowHostsForGlobal() {
    }
    ...
    public static CIMProperty create_PartComponent_Linux_SambaHost(WBEMClient client,
        ...
        Linux_SambaAllowHostsForGlobal fco = new Linux_SambaAllowHostsForGlobal(client, namespace);
    ...
    public String getObjectName() {
        return Linux_SambaAllowHostsForGlobal.CIM_CLASS_NAME;
    }
