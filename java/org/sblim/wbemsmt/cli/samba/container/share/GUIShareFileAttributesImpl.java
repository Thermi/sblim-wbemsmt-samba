...
public class GUIShareFileAttributesImpl extends BaseDataContainer implements
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle()
                    .getString("GUIShareFileAttributes.caption"));
        }
