/**
 * Linux_SambaGroupForUser.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class Linux_SambaGroupForUser extends CIM_Component {
     ...
     * 
     */
    public static class PROPERTY_GROUPCOMPONENT_LINUX_SAMBAGROUP {
        /**
    ...
    public Linux_SambaGroupForUser(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public Linux_SambaGroupForUser(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaGroupForUser() {
    }
    ...
    public Linux_SambaGroup get_GroupComponent_Linux_SambaGroup(javax.wbem.client.WBEMClient client)
            throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_GROUPCOMPONENT_LINUX_SAMBAGROUP.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_GROUPCOMPONENT_LINUX_SAMBAGROUP.NAME
    ...
    public boolean set_GroupComponent_Linux_SambaGroup(Linux_SambaGroup newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_GROUPCOMPONENT_LINUX_SAMBAGROUP.NAME);
        if (currentProperty != null) {
            setProperty(setPropertyValue_GroupComponent_Linux_SambaGroup(currentProperty, newValue));
            return true;
        }
        else {
            logger.warning("Property " + PROPERTY_GROUPCOMPONENT_LINUX_SAMBAGROUP.NAME
    ...
    public static CIMProperty create_GroupComponent_Linux_SambaGroup(WBEMClient client,
            String namespace, Linux_SambaGroup newValue) throws WbemsmtException {
        Linux_SambaGroupForUser fco = new Linux_SambaGroupForUser(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_GROUPCOMPONENT_LINUX_SAMBAGROUP.NAME);
        if (property != null) {
            property = setPropertyValue_GroupComponent_Linux_SambaGroup(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_GROUPCOMPONENT_LINUX_SAMBAGROUP.NAME
    ...
    private static CIMProperty setPropertyValue_GroupComponent_Linux_SambaGroup(
    ...
    public String getObjectName() {
        return Linux_SambaGroupForUser.CIM_CLASS_NAME;
    }
