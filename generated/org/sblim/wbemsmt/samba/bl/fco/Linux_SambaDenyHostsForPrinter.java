/**
 * Linux_SambaDenyHostsForPrinter.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class Linux_SambaDenyHostsForPrinter extends CIM_Component {
    ...
    public Linux_SambaDenyHostsForPrinter(WBEMClient client, String namespace)
    ...
    public Linux_SambaDenyHostsForPrinter(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaDenyHostsForPrinter() {
    }
    ...
    public static CIMProperty create_PartComponent_Linux_SambaHost(WBEMClient client,
        ...
        Linux_SambaDenyHostsForPrinter fco = new Linux_SambaDenyHostsForPrinter(client, namespace);
    ...
    public String getObjectName() {
        return Linux_SambaDenyHostsForPrinter.CIM_CLASS_NAME;
    }
