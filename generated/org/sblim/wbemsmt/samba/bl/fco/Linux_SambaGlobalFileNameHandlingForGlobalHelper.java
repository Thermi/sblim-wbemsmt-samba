/** 
  * Linux_SambaGlobalFileNameHandlingForGlobalHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_SambaGlobalFileNameHandlingForGlobal
  *    
  * 
  * generated Class
  * @see Linux_SambaGlobalFileNameHandlingForGlobal
  */
...
public class Linux_SambaGlobalFileNameHandlingForGlobalHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_SambaGlobalFileNameHandlingForGlobal or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaGlobalFileNameHandlingForGlobal.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaGlobalFileNameHandlingForGlobal.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_SambaGlobalFileNameHandlingForGlobal or the subclasses if deep == true
    */        
    public final static List<Linux_SambaGlobalFileNameHandlingForGlobal> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaGlobalFileNameHandlingForGlobal> resultArrayList = new ArrayList<Linux_SambaGlobalFileNameHandlingForGlobal>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaGlobalFileNameHandlingForGlobal.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaGlobalFileNameHandlingForGlobal(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_SambaGlobalFileNameHandlingForGlobalHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_SambaGlobalFileNameHandlingForGlobal.");
                        resultArrayList.add(new Linux_SambaGlobalFileNameHandlingForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_SambaGlobalFileNameHandlingForGlobal.");
                        resultArrayList.add(new Linux_SambaGlobalFileNameHandlingForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaGlobalFileNameHandlingForGlobal)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaGlobalFileNameHandlingForGlobal.");
                        resultArrayList.add(new Linux_SambaGlobalFileNameHandlingForGlobal(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaGlobalFileNameHandlingForGlobal getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaGlobalFileNameHandlingForGlobal getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_SambaGlobalFileNameHandlingForGlobal dataInstance = null;
        Class<?> clazz = Linux_SambaGlobalFileNameHandlingForGlobalHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_SambaGlobalFileNameHandlingForGlobal)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaGlobalFileNameHandlingForGlobal.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_SambaGlobalFileNameHandlingForGlobal(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_SambaGlobalFileNameHandlingForGlobal getInstance(WBEMClient client, String namespace
                                                       ,Linux_SambaGlobalOptions ManagedElement
                                                       ,Linux_SambaGlobalFileNameHandlingOptions SettingData
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaGlobalFileNameHandlingForGlobal.PROPERTY_MANAGEDELEMENT_LINUX_SAMBAGLOBALOPTIONS.NAME,new CIMDataType(Linux_SambaGlobalOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaGlobalFileNameHandlingForGlobal.CIM_CLASS_NAME); 
                   
                                 setThis = SettingData != null ? SettingData.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_SambaGlobalFileNameHandlingForGlobal.PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALFILENAMEHANDLINGOPTIONS.NAME,new CIMDataType(Linux_SambaGlobalFileNameHandlingOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaGlobalFileNameHandlingForGlobal.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaGlobalFileNameHandlingForGlobal.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_SambaGlobalFileNameHandlingForGlobal createInstance(WBEMClient client, Linux_SambaGlobalFileNameHandlingForGlobal dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_SambaGlobalFileNameHandlingForGlobal newDataInstance = Linux_SambaGlobalFileNameHandlingForGlobalHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_SambaGlobalFileNameHandlingForGlobal modifyInstance(WBEMClient client, Linux_SambaGlobalFileNameHandlingForGlobal dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_SambaGlobalFileNameHandlingForGlobal dataInstance2 = Linux_SambaGlobalFileNameHandlingForGlobalHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaGlobalFileNameHandlingForGlobal dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaGlobalFileNameHandlingForGlobal.getPackages());
    }
