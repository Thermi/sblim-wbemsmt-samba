/** 
 * UserInPrinterWizardACLItemDataContainerImpl.java
 *
 * 
...
public class UserInPrinterWizardACLItemDataContainerImpl extends
        org.sblim.wbemsmt.tools.wizard.jsf.WizardBasePanel implements
        org.sblim.wbemsmt.samba.bl.container.wizard.UserInPrinterWizardACLItemDataContainer {
    ...
    public UserInPrinterWizardACLItemDataContainerImpl(
        ...
        super(adapter, bindingPrefix, "UserInPrinterWizardACLItemDataContainer.caption",
                "UserInPrinterWizardACLItemDataContainer.subTitle", false);
        ...
        setFooter(getPanelForCustomLayout(), "UserInPrinterWizardACLItemDataContainer.footerText");
    ...
    public void reload() {
        ...
        if (ic_usr_AccessTypeVI != null) {
            ic_usr_AccessTypeVI.setLabelText(bundle
                    .getString("UserInPrinterWizardACLItemDataContainer.accessTypeVI"));
        }
        if (ic_usr_AccessTypeRW != null) {
            ic_usr_AccessTypeRW.setLabelText(bundle
                    .getString("UserInPrinterWizardACLItemDataContainer.accessTypeRW"));
        }
        if (ic_usr_Admin != null) {
            ic_usr_Admin.setLabelText(bundle
                    .getString("UserInPrinterWizardACLItemDataContainer.admin"));
        }
    }
    ...
    public void copyFrom(DataContainer sourceContainer) throws WbemsmtException {
        UserInPrinterWizardACLItemDataContainerImpl source = (UserInPrinterWizardACLItemDataContainerImpl) sourceContainer;
