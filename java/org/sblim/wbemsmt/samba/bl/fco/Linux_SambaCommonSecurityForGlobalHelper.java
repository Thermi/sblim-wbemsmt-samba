...
public class Linux_SambaCommonSecurityForGlobalHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaCommonSecurityForGlobal.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaCommonSecurityForGlobal.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaCommonSecurityForGlobalHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaCommonSecurityForGlobal.");
                        resultArrayList.add(new Linux_SambaCommonSecurityForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaCommonSecurityForGlobal.");
                        resultArrayList.add(new Linux_SambaCommonSecurityForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaCommonSecurityForGlobal.");
                        resultArrayList.add(new Linux_SambaCommonSecurityForGlobal(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaCommonSecurityForGlobal getInstance(WBEMClient client,
    ...
    public final static Linux_SambaCommonSecurityForGlobal getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaCommonSecurityForGlobal.PROPERTY_SETTINGDATA_LINUX_SAMBACOMMONSECURITYOPTIONS.NAME,
                new CIMDataType(Linux_SambaCommonSecurityOptions.CIM_CLASS_NAME), setThis, false,
                false, Linux_SambaCommonSecurityForGlobal.CIM_CLASS_NAME);

        setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                Linux_SambaCommonSecurityForGlobal.PROPERTY_MANAGEDELEMENT_LINUX_SAMBAGLOBALOPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaCommonSecurityForGlobal createInstance(WBEMClient client,
            Linux_SambaCommonSecurityForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaCommonSecurityForGlobal newDataInstance = Linux_SambaCommonSecurityForGlobalHelper
     ...
     */
    public final static Linux_SambaCommonSecurityForGlobal modifyInstance(WBEMClient client,
            Linux_SambaCommonSecurityForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaCommonSecurityForGlobal dataInstance2 = Linux_SambaCommonSecurityForGlobalHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaCommonSecurityForGlobal dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaCommonSecurityForGlobal.getPackages());
    }
