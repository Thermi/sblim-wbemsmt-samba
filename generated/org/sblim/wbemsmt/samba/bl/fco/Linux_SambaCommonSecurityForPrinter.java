/**
 * Linux_SambaCommonSecurityForPrinter.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED
...
public class Linux_SambaCommonSecurityForPrinter extends CIM_ElementSettingData {
     ...
     * 
     */
    public static class PROPERTY_SETTINGDATA_LINUX_SAMBACOMMONSECURITYOPTIONS {
        /**
    ...
    public Linux_SambaCommonSecurityForPrinter(WBEMClient client, String namespace)
    ...
    public Linux_SambaCommonSecurityForPrinter(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaCommonSecurityForPrinter() {
    }
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        propertiesToCheck.put("SettingData", new CIMProperty("SettingData", new CIMDataType(
                Linux_SambaCommonSecurityOptions.CIM_CLASS_NAME), null));
    ...
    public Linux_SambaCommonSecurityOptions get_SettingData_Linux_SambaCommonSecurityOptions(
            javax.wbem.client.WBEMClient client) throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBACOMMONSECURITYOPTIONS.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_SETTINGDATA_LINUX_SAMBACOMMONSECURITYOPTIONS.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }

        return Linux_SambaCommonSecurityOptionsHelper.getInstance(client,
    ...
    public boolean set_SettingData_Linux_SambaCommonSecurityOptions(
    ...
    public static CIMProperty create_SettingData_Linux_SambaCommonSecurityOptions(
            WBEMClient client, String namespace, Linux_SambaCommonSecurityOptions newValue)
            throws WbemsmtException {
        Linux_SambaCommonSecurityForPrinter fco = new Linux_SambaCommonSecurityForPrinter(client,
                namespace);
        CIMProperty property = fco
                .getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBACOMMONSECURITYOPTIONS.NAME);
        if (property != null) {
            property = setPropertyValue_SettingData_Linux_SambaCommonSecurityOptions(property,
                    newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_SETTINGDATA_LINUX_SAMBACOMMONSECURITYOPTIONS.NAME
    ...
    private static CIMProperty setPropertyValue_SettingData_Linux_SambaCommonSecurityOptions(
            CIMProperty currentProperty, Linux_SambaCommonSecurityOptions newValue) {
        Object setThis = null;
    ...
    public String getObjectName() {
        return Linux_SambaCommonSecurityForPrinter.CIM_CLASS_NAME;
    }
