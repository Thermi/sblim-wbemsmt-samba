...
public class PrinterInUserWizardACLItemDataContainerImpl extends
    ...
    public PrinterInUserWizardACLItemDataContainerImpl(
            org.sblim.wbemsmt.samba.bl.adapter.SambaCimAdapter adapter, String bindingPrefix)
            throws WbemsmtException {

        super(adapter, bindingPrefix, "PrinterInUserWizardACLItemDataContainer.caption",
                "PrinterInUserWizardACLItemDataContainer.subTitle", false);
        ...
        setFooter(getPanelForCustomLayout(), "PrinterInUserWizardACLItemDataContainer.footerText");
