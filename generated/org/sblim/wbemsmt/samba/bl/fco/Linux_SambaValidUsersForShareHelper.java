/** 
  * Linux_SambaValidUsersForShareHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_SambaValidUsersForShare
  *    
  * 
  * generated Class
  * @see Linux_SambaValidUsersForShare
  */
...
public class Linux_SambaValidUsersForShareHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_SambaValidUsersForShare or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaValidUsersForShare.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaValidUsersForShare.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_SambaValidUsersForShare or the subclasses if deep == true
    */        
    public final static List<Linux_SambaValidUsersForShare> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaValidUsersForShare> resultArrayList = new ArrayList<Linux_SambaValidUsersForShare>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaValidUsersForShare.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaValidUsersForShare(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_SambaValidUsersForShareHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_SambaValidUsersForShare.");
                        resultArrayList.add(new Linux_SambaValidUsersForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_SambaValidUsersForShare.");
                        resultArrayList.add(new Linux_SambaValidUsersForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaValidUsersForShare)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaValidUsersForShare.");
                        resultArrayList.add(new Linux_SambaValidUsersForShare(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaValidUsersForShare getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaValidUsersForShare getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_SambaValidUsersForShare dataInstance = null;
        Class<?> clazz = Linux_SambaValidUsersForShareHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_SambaValidUsersForShare)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaValidUsersForShare.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_SambaValidUsersForShare(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_SambaValidUsersForShare getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaValidUsersForShare.PROPERTY_PARTCOMPONENT_LINUX_SAMBAUSER.NAME,new CIMDataType(Linux_SambaUser.CIM_CLASS_NAME),setThis,false,false,Linux_SambaValidUsersForShare.CIM_CLASS_NAME); 
                   
                                 setThis = GroupComponent != null ? GroupComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_SambaValidUsersForShare.PROPERTY_GROUPCOMPONENT_LINUX_SAMBASHAREOPTIONS.NAME,new CIMDataType(Linux_SambaShareOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaValidUsersForShare.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaValidUsersForShare.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_SambaValidUsersForShare createInstance(WBEMClient client, Linux_SambaValidUsersForShare dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_SambaValidUsersForShare newDataInstance = Linux_SambaValidUsersForShareHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_SambaValidUsersForShare modifyInstance(WBEMClient client, Linux_SambaValidUsersForShare dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_SambaValidUsersForShare dataInstance2 = Linux_SambaValidUsersForShareHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaValidUsersForShare dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaValidUsersForShare.getPackages());
    }
