...
public class Linux_SambaWriteListForShareHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaWriteListForShare.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaWriteListForShare.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_SambaWriteListForShare.");
                        resultArrayList.add(new Linux_SambaWriteListForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaWriteListForShare.");
                        resultArrayList.add(new Linux_SambaWriteListForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaWriteListForShare.");
                        resultArrayList.add(new Linux_SambaWriteListForShare(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaWriteListForShare getInstance(WBEMClient client,
    ...
    public final static Linux_SambaWriteListForShare getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaWriteListForShare.PROPERTY_PARTCOMPONENT_LINUX_SAMBAUSER.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_SambaWriteListForShare.PROPERTY_GROUPCOMPONENT_LINUX_SAMBASHAREOPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaWriteListForShare createInstance(WBEMClient client,
            Linux_SambaWriteListForShare dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaWriteListForShare newDataInstance = Linux_SambaWriteListForShareHelper
     ...
     */
    public final static Linux_SambaWriteListForShare modifyInstance(WBEMClient client,
            Linux_SambaWriteListForShare dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaWriteListForShare dataInstance2 = Linux_SambaWriteListForShareHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaWriteListForShare dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaWriteListForShare.getPackages());
    }
