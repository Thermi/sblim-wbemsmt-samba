...
public class Linux_SambaWriteListForShare extends CIM_Component {
    ...
    public Linux_SambaWriteListForShare(WBEMClient client, String namespace)
    ...
    public Linux_SambaWriteListForShare(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaWriteListForShare() {
    }
    ...
    public static CIMProperty create_PartComponent_Linux_SambaUser(WBEMClient client,
        ...
        Linux_SambaWriteListForShare fco = new Linux_SambaWriteListForShare(client, namespace);
    ...
    public String getObjectName() {
        return Linux_SambaWriteListForShare.CIM_CLASS_NAME;
    }
