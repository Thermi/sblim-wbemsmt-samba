...
public class ShareListItemDataContainer_AsShares_InShareListDataContainerImpl extends
    ...
    public ShareListItemDataContainer_AsShares_InShareListDataContainerImpl(
    ...
    public LabeledJSFInputComponent[] getComponents() {
        return new LabeledJSFInputComponent[] { (LabeledJSFInputComponent) get_Name(),
                ...
                (LabeledJSFInputComponent) get_Comment(), (LabeledJSFInputComponent) get_Path(),
