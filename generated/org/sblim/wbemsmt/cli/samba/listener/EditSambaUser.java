/**
 * EditSambaUser.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS OF THE
...
public class EditSambaUser extends CimCommand {
    ...
    public static final OptionDefinition KEY_sambaUserName = new OptionDefinition(null,
            "sambaUserName", null, "UserDataContainer.SambaUserName.argValue", false, true,
            "UserDataContainer.SambaUserName.argDescription");
    /**
     *  --isGuest
     */
    public static final OptionDefinition KEY_isGuest = new OptionDefinition(null, "isGuest", null,
            "UserDataContainer.isGuest.argValue", false, false,
            "UserDataContainer.isGuest.argDescription");
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("UserDataContainer.caption") }));
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.samba.bl.container.user.UserDataContainer dc) throws WbemsmtException {
