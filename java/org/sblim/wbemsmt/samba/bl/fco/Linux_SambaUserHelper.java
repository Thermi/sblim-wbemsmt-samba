...
public class Linux_SambaUserHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaUser.CIM_CLASS_NAME,
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_SambaUser.");
                        resultArrayList.add(new Linux_SambaUser(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaUser.");
                        resultArrayList.add(new Linux_SambaUser(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaUser.");
                        resultArrayList.add(new Linux_SambaUser(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaUser getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static Linux_SambaUser getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static Linux_SambaUser getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(Linux_SambaUser.PROPERTY_SAMBAUSERNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_SambaUser.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_SambaUser createInstance(WBEMClient client,
            Linux_SambaUser dataInstance, boolean notifyDifferencies) throws WbemsmtException {
     ...
     */
    public final static Linux_SambaUser modifyInstance(WBEMClient client,
            Linux_SambaUser dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaUser dataInstance2 = Linux_SambaUserHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, Linux_SambaUser dataInstance)
            throws WbemsmtException {
