...
public class UserACLItemDataContainerForShareImpl extends BaseDataContainer implements org.sblim.wbemsmt.samba.bl.container.share.UserACLItemDataContainerForShare {
	...
	public UserACLItemDataContainerForShareImpl(AbstractBaseCimAdapter adapter) throws InitContainerException {
		super();
		setAdapter(adapter);
	...
	public void trace(java.io.PrintWriter 	printStream, String listOptions, boolean title)
	{
		if (title)
		{
			printStream.println(getAdapter().getBundle().getString("UserACLItemDataContainerForShare.caption"));
		}
