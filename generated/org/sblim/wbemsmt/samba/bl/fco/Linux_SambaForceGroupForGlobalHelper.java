/** 
  * Linux_SambaForceGroupForGlobalHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_SambaForceGroupForGlobal
  *    
  * 
  * generated Class
  * @see Linux_SambaForceGroupForGlobal
  */
...
public class Linux_SambaForceGroupForGlobalHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_SambaForceGroupForGlobal or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaForceGroupForGlobal.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaForceGroupForGlobal.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_SambaForceGroupForGlobal or the subclasses if deep == true
    */        
    public final static List<Linux_SambaForceGroupForGlobal> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaForceGroupForGlobal> resultArrayList = new ArrayList<Linux_SambaForceGroupForGlobal>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaForceGroupForGlobal.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaForceGroupForGlobal(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_SambaForceGroupForGlobalHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_SambaForceGroupForGlobal.");
                        resultArrayList.add(new Linux_SambaForceGroupForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_SambaForceGroupForGlobal.");
                        resultArrayList.add(new Linux_SambaForceGroupForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaForceGroupForGlobal)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaForceGroupForGlobal.");
                        resultArrayList.add(new Linux_SambaForceGroupForGlobal(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaForceGroupForGlobal getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaForceGroupForGlobal getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_SambaForceGroupForGlobal dataInstance = null;
        Class<?> clazz = Linux_SambaForceGroupForGlobalHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_SambaForceGroupForGlobal)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaForceGroupForGlobal.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_SambaForceGroupForGlobal(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_SambaForceGroupForGlobal getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaForceGroupForGlobal.PROPERTY_GROUPCOMPONENT_LINUX_SAMBAGLOBALOPTIONS.NAME,new CIMDataType(Linux_SambaGlobalOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaForceGroupForGlobal.CIM_CLASS_NAME); 
                   
                                 setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_SambaForceGroupForGlobal.PROPERTY_PARTCOMPONENT_LINUX_SAMBAGROUP.NAME,new CIMDataType(Linux_SambaGroup.CIM_CLASS_NAME),setThis,false,false,Linux_SambaForceGroupForGlobal.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaForceGroupForGlobal.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_SambaForceGroupForGlobal createInstance(WBEMClient client, Linux_SambaForceGroupForGlobal dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_SambaForceGroupForGlobal newDataInstance = Linux_SambaForceGroupForGlobalHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_SambaForceGroupForGlobal modifyInstance(WBEMClient client, Linux_SambaForceGroupForGlobal dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_SambaForceGroupForGlobal dataInstance2 = Linux_SambaForceGroupForGlobalHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaForceGroupForGlobal dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaForceGroupForGlobal.getPackages());
    }
