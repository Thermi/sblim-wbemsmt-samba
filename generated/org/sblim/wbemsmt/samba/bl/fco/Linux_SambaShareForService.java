/**
 * Linux_SambaShareForService.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class Linux_SambaShareForService extends CIM_ElementSettingData {
     ...
     * 
     */
    public static class PROPERTY_SETTINGDATA_LINUX_SAMBASHAREOPTIONS {
        /**
    ...
    public Linux_SambaShareForService(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public Linux_SambaShareForService(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaShareForService() {
    }
    ...
    public Linux_SambaShareOptions get_SettingData_Linux_SambaShareOptions(
            javax.wbem.client.WBEMClient client) throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBASHAREOPTIONS.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_SETTINGDATA_LINUX_SAMBASHAREOPTIONS.NAME
    ...
    public boolean set_SettingData_Linux_SambaShareOptions(Linux_SambaShareOptions newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBASHAREOPTIONS.NAME);
        if (currentProperty != null) {
            setProperty(setPropertyValue_SettingData_Linux_SambaShareOptions(currentProperty,
                    newValue));
            return true;
        }
        else {
    ...
    public static CIMProperty create_SettingData_Linux_SambaShareOptions(WBEMClient client,
            String namespace, Linux_SambaShareOptions newValue) throws WbemsmtException {
        Linux_SambaShareForService fco = new Linux_SambaShareForService(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBASHAREOPTIONS.NAME);
        if (property != null) {
            property = setPropertyValue_SettingData_Linux_SambaShareOptions(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_SETTINGDATA_LINUX_SAMBASHAREOPTIONS.NAME
    ...
    private static CIMProperty setPropertyValue_SettingData_Linux_SambaShareOptions(
    ...
    public String getObjectName() {
        return Linux_SambaShareForService.CIM_CLASS_NAME;
    }
