...
public class Linux_SambaPrinterBrowseOptionsHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaPrinterBrowseOptions.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaPrinterBrowseOptions.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaPrinterBrowseOptionsHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaPrinterBrowseOptions.");
                        resultArrayList.add(new Linux_SambaPrinterBrowseOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaPrinterBrowseOptions.");
                        resultArrayList.add(new Linux_SambaPrinterBrowseOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaPrinterBrowseOptions.");
                        resultArrayList.add(new Linux_SambaPrinterBrowseOptions(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaPrinterBrowseOptions getInstance(WBEMClient client,
    ...
    public final static Linux_SambaPrinterBrowseOptions getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaPrinterBrowseOptions.PROPERTY_INSTANCEID.NAME, CIMDataType.STRING_T,
                setThis, true, false, Linux_SambaPrinterBrowseOptions.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(Linux_SambaPrinterBrowseOptions.PROPERTY_NAME.NAME,
     ...
     *
     */
    public final static Linux_SambaPrinterBrowseOptions createInstance(WBEMClient client,
            Linux_SambaPrinterBrowseOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaPrinterBrowseOptions newDataInstance = Linux_SambaPrinterBrowseOptionsHelper
     ...
     */
    public final static Linux_SambaPrinterBrowseOptions modifyInstance(WBEMClient client,
            Linux_SambaPrinterBrowseOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaPrinterBrowseOptions dataInstance2 = Linux_SambaPrinterBrowseOptionsHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaPrinterBrowseOptions dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaPrinterBrowseOptions.getPackages());
    }
