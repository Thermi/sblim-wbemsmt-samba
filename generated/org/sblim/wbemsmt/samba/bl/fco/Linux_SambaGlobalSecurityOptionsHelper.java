/** 
  * Linux_SambaGlobalSecurityOptionsHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_SambaGlobalSecurityOptions
  *    
  * 
  * generated Class
  * @see Linux_SambaGlobalSecurityOptions
  */
...
public class Linux_SambaGlobalSecurityOptionsHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_SambaGlobalSecurityOptions or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaGlobalSecurityOptions.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaGlobalSecurityOptions.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_SambaGlobalSecurityOptions or the subclasses if deep == true
    */        
    public final static List<Linux_SambaGlobalSecurityOptions> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaGlobalSecurityOptions> resultArrayList = new ArrayList<Linux_SambaGlobalSecurityOptions>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaGlobalSecurityOptions.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaGlobalSecurityOptions(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_SambaGlobalSecurityOptionsHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_SambaGlobalSecurityOptions.");
                        resultArrayList.add(new Linux_SambaGlobalSecurityOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_SambaGlobalSecurityOptions.");
                        resultArrayList.add(new Linux_SambaGlobalSecurityOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaGlobalSecurityOptions)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaGlobalSecurityOptions.");
                        resultArrayList.add(new Linux_SambaGlobalSecurityOptions(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaGlobalSecurityOptions getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaGlobalSecurityOptions getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_SambaGlobalSecurityOptions dataInstance = null;
        Class<?> clazz = Linux_SambaGlobalSecurityOptionsHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_SambaGlobalSecurityOptions)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaGlobalSecurityOptions.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_SambaGlobalSecurityOptions(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_SambaGlobalSecurityOptions getInstance(WBEMClient client, String namespace
                                                       ,String InstanceID
                                                       ,String Name
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaGlobalSecurityOptions.PROPERTY_INSTANCEID.NAME,CIMDataType.STRING_T,setThis,true,false,Linux_SambaGlobalSecurityOptions.CIM_CLASS_NAME); 
                   
                   setThis = Name;
                
           keyProperties[1]  = new CIMProperty(Linux_SambaGlobalSecurityOptions.PROPERTY_NAME.NAME,CIMDataType.STRING_T,setThis,true,false,Linux_SambaGlobalSecurityOptions.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaGlobalSecurityOptions.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_SambaGlobalSecurityOptions createInstance(WBEMClient client, Linux_SambaGlobalSecurityOptions dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_SambaGlobalSecurityOptions newDataInstance = Linux_SambaGlobalSecurityOptionsHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_SambaGlobalSecurityOptions modifyInstance(WBEMClient client, Linux_SambaGlobalSecurityOptions dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_SambaGlobalSecurityOptions dataInstance2 = Linux_SambaGlobalSecurityOptionsHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaGlobalSecurityOptions dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaGlobalSecurityOptions.getPackages());
    }
