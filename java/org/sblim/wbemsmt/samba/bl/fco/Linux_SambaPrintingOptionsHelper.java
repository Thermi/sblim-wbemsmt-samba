...
public class Linux_SambaPrintingOptionsHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaPrintingOptions.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaPrintingOptions.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    Linux_SambaPrintingOptions.CIM_CLASS_NAME)) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_SambaPrintingOptions.");
                        resultArrayList.add(new Linux_SambaPrintingOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaPrintingOptions.");
                        resultArrayList.add(new Linux_SambaPrintingOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaPrintingOptions.");
                        resultArrayList.add(new Linux_SambaPrintingOptions(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaPrintingOptions getInstance(WBEMClient client,
    ...
    public final static Linux_SambaPrintingOptions getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(Linux_SambaPrintingOptions.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                Linux_SambaPrintingOptions.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(Linux_SambaPrintingOptions.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                Linux_SambaPrintingOptions.CIM_CLASS_NAME);
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaPrintingOptions dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaPrintingOptions.getPackages());
    }
