...
public class AdminUsersInShareGlobals_AsUsers_InGUIShareGlobalsDataContainerImpl extends
    ...
    public AdminUsersInShareGlobals_AsUsers_InGUIShareGlobalsDataContainerImpl(
    ...
    public void reload() {
        ...
        if (ic_usr_SambaUserName != null) {
            ic_usr_SambaUserName.setLabelText(bundle
                    .getString("AdminUsersInShareGlobals.SambaUserName"));
        }
        if (ic_usr_Admin != null) {
