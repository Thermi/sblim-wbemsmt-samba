/**
 * CreateHostListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS
...
public class CreateHostListener extends TaskLauncherContextMenuEventListenerImpl implements
        org.sblim.wbemsmt.tasklauncher.event.CreateListener {

    String jsfListener = "org.sblim.wbemsmt.jsf.samba.listener.CreateHostListener";
    String swingListener = "org.sblim.wbemsmt.jswing.samba.listener.CreateHostListener";

    //String cmdListener = "org.sblim.wbemsmt.cli.samba.listener.CreateHostListener";
