...
public final class Linux_SambaLoggingOptionsHelper {
	...
	*/	
	public final static Linux_SambaLoggingOptions getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_SambaLoggingOptionsHelper.getInstance(cimClient, new Linux_SambaLoggingOptions(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaLoggingOptions getInstance(CIMClient cimClient, Linux_SambaLoggingOptions dataInstance) {
		...
		return Linux_SambaLoggingOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaLoggingOptions getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			...
			{
				dataInstance = new Linux_SambaLoggingOptions(cimObjectPath, cimInstance);
			}
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = Linux_SambaLoggingOptions.getPackages();
	...
	*/	
	public final static Linux_SambaLoggingOptions createInstance(CIMClient cimClient, Linux_SambaLoggingOptions dataInstance, boolean notifyDifferencies){ 
		...
		Linux_SambaLoggingOptions newDataInstance = null;
		try {
			newDataInstance = Linux_SambaLoggingOptionsHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaLoggingOptions modifyInstance(CIMClient cimClient, Linux_SambaLoggingOptions dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_SambaLoggingOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_SambaLoggingOptions dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_SambaLoggingOptions dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_SambaLoggingOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_SambaLoggingOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_SambaLoggingOptions.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_SambaLoggingOptions.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_SambaLoggingOptions.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_DebugHiresTimestamp(Boolean DebugHiresTimestamp) {
		return true;
	}

	public static boolean isValid_DebugPID(Boolean DebugPID) {
		return true;
	}

	public static boolean isValid_DebugTimestamp(Boolean DebugTimestamp) {
		return true;
	}

	public static boolean isValid_DebugUID(Boolean DebugUID) {
		return true;
	}

	public static boolean isValid_LogFile(String LogFile) {
		return true;
	}

	public static boolean isValid_LogLevel(String LogLevel) {
		return true;
	}

	public static boolean isValid_MaxLogSize(UnsignedInt32 MaxLogSize) {
		return true;
	}
	...
	public static boolean isValid_SysLog(UnsignedInt16 SysLog) {
		return true;
	}

	public static boolean isValid_SysLogOnly(Boolean SysLogOnly) {
		return true;
	}
