...
public class ShareACLItemDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.samba.bl.container.share.ShareACLItemDataContainer {
    ...
    public ShareACLItemDataContainerImpl(
    ...
    public void reload() {
        ...
        if (ic_usr_AccessTypeVI != null) {
            ic_usr_AccessTypeVI.setLabelText(bundle
                    .getString("ShareACLItemDataContainer.accessTypeVI"));
        }
        if (ic_usr_AccessTypeRW != null) {
            ic_usr_AccessTypeRW.setLabelText(bundle
                    .getString("ShareACLItemDataContainer.accessTypeRW"));
        }
        if (ic_usr_Admin != null) {
