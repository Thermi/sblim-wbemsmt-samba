/**
 * DeletePrinterListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class DeletePrinterListener extends TaskLauncherContextMenuEventListenerImpl implements
        org.sblim.wbemsmt.tasklauncher.event.DeleteListener {

    String jsfListener = "org.sblim.wbemsmt.jsf.samba.listener.DeletePrinterListener";
    String swingListener = "org.sblim.wbemsmt.jswing.samba.listener.DeletePrinterListener";

    //String cmdListener = "org.sblim.wbemsmt.cli.samba.listener.DeletePrinterListener";
