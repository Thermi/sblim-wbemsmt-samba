/** 
  * Linux_SambaShareSecurityForShareHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_SambaShareSecurityForShare
  *    
  * 
  * generated Class
  * @see Linux_SambaShareSecurityForShare
  */
...
public class Linux_SambaShareSecurityForShareHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_SambaShareSecurityForShare or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaShareSecurityForShare.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaShareSecurityForShare.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_SambaShareSecurityForShare or the subclasses if deep == true
    */        
    public final static List<Linux_SambaShareSecurityForShare> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaShareSecurityForShare> resultArrayList = new ArrayList<Linux_SambaShareSecurityForShare>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaShareSecurityForShare.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaShareSecurityForShare(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_SambaShareSecurityForShareHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_SambaShareSecurityForShare.");
                        resultArrayList.add(new Linux_SambaShareSecurityForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_SambaShareSecurityForShare.");
                        resultArrayList.add(new Linux_SambaShareSecurityForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaShareSecurityForShare)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaShareSecurityForShare.");
                        resultArrayList.add(new Linux_SambaShareSecurityForShare(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaShareSecurityForShare getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaShareSecurityForShare getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_SambaShareSecurityForShare dataInstance = null;
        Class<?> clazz = Linux_SambaShareSecurityForShareHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_SambaShareSecurityForShare)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaShareSecurityForShare.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_SambaShareSecurityForShare(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_SambaShareSecurityForShare getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaShareSecurityForShare.PROPERTY_SETTINGDATA_LINUX_SAMBASHARESECURITYOPTIONS.NAME,new CIMDataType(Linux_SambaShareSecurityOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaShareSecurityForShare.CIM_CLASS_NAME); 
                   
                                 setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_SambaShareSecurityForShare.PROPERTY_MANAGEDELEMENT_LINUX_SAMBASHAREOPTIONS.NAME,new CIMDataType(Linux_SambaShareOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaShareSecurityForShare.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaShareSecurityForShare.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_SambaShareSecurityForShare createInstance(WBEMClient client, Linux_SambaShareSecurityForShare dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_SambaShareSecurityForShare newDataInstance = Linux_SambaShareSecurityForShareHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_SambaShareSecurityForShare modifyInstance(WBEMClient client, Linux_SambaShareSecurityForShare dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_SambaShareSecurityForShare dataInstance2 = Linux_SambaShareSecurityForShareHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaShareSecurityForShare dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaShareSecurityForShare.getPackages());
    }
