...
public final class Linux_SambaCommonSecurityOptionsHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<Linux_SambaCommonSecurityOptions.Java_Package_List.size(); i++) {
						if (!((String)(Linux_SambaCommonSecurityOptions.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(Linux_SambaCommonSecurityOptions.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							Linux_SambaCommonSecurityOptions.Java_Package_List.setElementAt((String)(Linux_SambaCommonSecurityOptions.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (Linux_SambaCommonSecurityOptions.Java_Package_List.get(i)) + cimClassName;
	...
	*/	
	public final static Linux_SambaCommonSecurityOptions getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_SambaCommonSecurityOptionsHelper.getInstance(cimClient, new Linux_SambaCommonSecurityOptions(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaCommonSecurityOptions getInstance(CIMClient cimClient, Linux_SambaCommonSecurityOptions dataInstance) {
		...
		return Linux_SambaCommonSecurityOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaCommonSecurityOptions getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			dataInstance = new Linux_SambaCommonSecurityOptions(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaCommonSecurityOptions createInstance(CIMClient cimClient, Linux_SambaCommonSecurityOptions dataInstance, boolean notifyDifferencies){ 
		...
		Linux_SambaCommonSecurityOptions newDataInstance = null;
		try {
			newDataInstance = Linux_SambaCommonSecurityOptionsHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaCommonSecurityOptions modifyInstance(CIMClient cimClient, Linux_SambaCommonSecurityOptions dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_SambaCommonSecurityOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_SambaCommonSecurityOptions dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_SambaCommonSecurityOptions dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_SambaCommonSecurityOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_SambaCommonSecurityOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_SambaCommonSecurityOptions.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_SambaCommonSecurityOptions.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_SambaCommonSecurityOptions.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_GuestOK(Boolean GuestOK) {
		return true;
	}

	public static boolean isValid_GuestOnly(Boolean GuestOnly) {
		return true;
	}

	public static boolean isValid_HostsAllow(String HostsAllow) {
		return true;
	}

	public static boolean isValid_HostsDeny(String HostsDeny) {
		return true;
	}
	...
	public static boolean isValid_ReadOnly(Boolean ReadOnly) {
		return true;
	}
