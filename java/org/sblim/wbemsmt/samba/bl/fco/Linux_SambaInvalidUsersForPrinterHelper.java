...
public class Linux_SambaInvalidUsersForPrinterHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaInvalidUsersForPrinter.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaInvalidUsersForPrinter.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaInvalidUsersForPrinterHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaInvalidUsersForPrinter.");
                        resultArrayList.add(new Linux_SambaInvalidUsersForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaInvalidUsersForPrinter.");
                        resultArrayList.add(new Linux_SambaInvalidUsersForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaInvalidUsersForPrinter.");
                        resultArrayList.add(new Linux_SambaInvalidUsersForPrinter(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaInvalidUsersForPrinter getInstance(WBEMClient client,
     ...
     */
    public final static Linux_SambaInvalidUsersForPrinter getInstance(WBEMClient client,
            String namespace, Linux_SambaUser PartComponent,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaInvalidUsersForPrinter.PROPERTY_PARTCOMPONENT_LINUX_SAMBAUSER.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_SambaInvalidUsersForPrinter.PROPERTY_GROUPCOMPONENT_LINUX_SAMBAPRINTEROPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaInvalidUsersForPrinter createInstance(WBEMClient client,
            Linux_SambaInvalidUsersForPrinter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaInvalidUsersForPrinter newDataInstance = Linux_SambaInvalidUsersForPrinterHelper
     ...
     */
    public final static Linux_SambaInvalidUsersForPrinter modifyInstance(WBEMClient client,
            Linux_SambaInvalidUsersForPrinter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaInvalidUsersForPrinter dataInstance2 = Linux_SambaInvalidUsersForPrinterHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaInvalidUsersForPrinter dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaInvalidUsersForPrinter.getPackages());
    }
