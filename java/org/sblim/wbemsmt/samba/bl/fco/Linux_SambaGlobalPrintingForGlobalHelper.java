...
public class Linux_SambaGlobalPrintingForGlobalHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaGlobalPrintingForGlobal.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaGlobalPrintingForGlobal.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaGlobalPrintingForGlobalHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaGlobalPrintingForGlobal.");
                        resultArrayList.add(new Linux_SambaGlobalPrintingForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaGlobalPrintingForGlobal.");
                        resultArrayList.add(new Linux_SambaGlobalPrintingForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaGlobalPrintingForGlobal.");
                        resultArrayList.add(new Linux_SambaGlobalPrintingForGlobal(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaGlobalPrintingForGlobal getInstance(WBEMClient client,
     ...
     */
    public final static Linux_SambaGlobalPrintingForGlobal getInstance(WBEMClient client,
            String namespace, Linux_SambaGlobalPrintingOptions SettingData,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaGlobalPrintingForGlobal.PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALPRINTINGOPTIONS.NAME,
                new CIMDataType(Linux_SambaGlobalPrintingOptions.CIM_CLASS_NAME), setThis, false,
                false, Linux_SambaGlobalPrintingForGlobal.CIM_CLASS_NAME);

        setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                Linux_SambaGlobalPrintingForGlobal.PROPERTY_MANAGEDELEMENT_LINUX_SAMBAGLOBALOPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaGlobalPrintingForGlobal createInstance(WBEMClient client,
            Linux_SambaGlobalPrintingForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaGlobalPrintingForGlobal newDataInstance = Linux_SambaGlobalPrintingForGlobalHelper
     ...
     */
    public final static Linux_SambaGlobalPrintingForGlobal modifyInstance(WBEMClient client,
            Linux_SambaGlobalPrintingForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaGlobalPrintingForGlobal dataInstance2 = Linux_SambaGlobalPrintingForGlobalHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaGlobalPrintingForGlobal dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaGlobalPrintingForGlobal.getPackages());
    }
