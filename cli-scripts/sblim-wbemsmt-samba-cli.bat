@REM ##############################################################################
@REM sblim-wbemsmt-samba-cli.bat
@REM
...
@REM Description:
@REM
@REM This file is a startup script for the SBLIM WBEM-SMT Samba
...
SET CLASSPATH=%CLASSPATH%;lib\sblim-wbemsmt-samba-bl2-0.2.1.jar
SET CLASSPATH=%CLASSPATH%;lib\sblim-wbemsmt-samba-eui-cli-0.2.1.jar
SET CLASSPATH=%CLASSPATH%;lib\sblim-wbemsmt-samba-eui-common-0.2.1.jar
...
SET VM_OPTIONS=-Djava.util.logging.config.file=cmdlogging.properties -Dcommands=org.sblim.wbemsmt.cli.samba.listener.Commands
