...
public class Linux_SambaDenyHostsForPrinterHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaDenyHostsForPrinter.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaDenyHostsForPrinter.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaDenyHostsForPrinterHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaDenyHostsForPrinter.");
                        resultArrayList.add(new Linux_SambaDenyHostsForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaDenyHostsForPrinter.");
                        resultArrayList.add(new Linux_SambaDenyHostsForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaDenyHostsForPrinter.");
                        resultArrayList.add(new Linux_SambaDenyHostsForPrinter(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaDenyHostsForPrinter getInstance(WBEMClient client,
    ...
    public final static Linux_SambaDenyHostsForPrinter getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaDenyHostsForPrinter.PROPERTY_PARTCOMPONENT_LINUX_SAMBAHOST.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_SambaDenyHostsForPrinter.PROPERTY_GROUPCOMPONENT_LINUX_SAMBAPRINTEROPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaDenyHostsForPrinter createInstance(WBEMClient client,
            Linux_SambaDenyHostsForPrinter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaDenyHostsForPrinter newDataInstance = Linux_SambaDenyHostsForPrinterHelper
     ...
     */
    public final static Linux_SambaDenyHostsForPrinter modifyInstance(WBEMClient client,
            Linux_SambaDenyHostsForPrinter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaDenyHostsForPrinter dataInstance2 = Linux_SambaDenyHostsForPrinterHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaDenyHostsForPrinter dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaDenyHostsForPrinter.getPackages());
    }
