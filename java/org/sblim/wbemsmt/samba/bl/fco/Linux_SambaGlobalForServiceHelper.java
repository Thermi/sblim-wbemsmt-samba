...
public class Linux_SambaGlobalForServiceHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaGlobalForService.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaGlobalForService.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_SambaGlobalForService.");
                        resultArrayList.add(new Linux_SambaGlobalForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaGlobalForService.");
                        resultArrayList.add(new Linux_SambaGlobalForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaGlobalForService.");
                        resultArrayList.add(new Linux_SambaGlobalForService(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaGlobalForService getInstance(WBEMClient client,
     ...
     */
    public final static Linux_SambaGlobalForService getInstance(WBEMClient client,
            String namespace, Linux_SambaGlobalOptions SettingData,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaGlobalForService.PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALOPTIONS.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_SambaGlobalForService.PROPERTY_MANAGEDELEMENT_LINUX_SAMBASERVICE.NAME,
     ...
     *
     */
    public final static Linux_SambaGlobalForService createInstance(WBEMClient client,
            Linux_SambaGlobalForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaGlobalForService newDataInstance = Linux_SambaGlobalForServiceHelper
     ...
     */
    public final static Linux_SambaGlobalForService modifyInstance(WBEMClient client,
            Linux_SambaGlobalForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaGlobalForService dataInstance2 = Linux_SambaGlobalForServiceHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaGlobalForService dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaGlobalForService.getPackages());
    }
