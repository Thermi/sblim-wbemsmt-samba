...
public class Linux_SambaDenyHostsForGlobalHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaDenyHostsForGlobal.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaDenyHostsForGlobal.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaDenyHostsForGlobalHelper
                            .findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaDenyHostsForGlobal.");
                        resultArrayList.add(new Linux_SambaDenyHostsForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaDenyHostsForGlobal.");
                        resultArrayList.add(new Linux_SambaDenyHostsForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaDenyHostsForGlobal.");
                        resultArrayList.add(new Linux_SambaDenyHostsForGlobal(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaDenyHostsForGlobal getInstance(WBEMClient client,
    ...
    public final static Linux_SambaDenyHostsForGlobal getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaDenyHostsForGlobal.PROPERTY_PARTCOMPONENT_LINUX_SAMBAHOST.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_SambaDenyHostsForGlobal.PROPERTY_GROUPCOMPONENT_LINUX_SAMBAGLOBALOPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaDenyHostsForGlobal createInstance(WBEMClient client,
            Linux_SambaDenyHostsForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaDenyHostsForGlobal newDataInstance = Linux_SambaDenyHostsForGlobalHelper
     ...
     */
    public final static Linux_SambaDenyHostsForGlobal modifyInstance(WBEMClient client,
            Linux_SambaDenyHostsForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaDenyHostsForGlobal dataInstance2 = Linux_SambaDenyHostsForGlobalHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaDenyHostsForGlobal dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaDenyHostsForGlobal.getPackages());
    }
