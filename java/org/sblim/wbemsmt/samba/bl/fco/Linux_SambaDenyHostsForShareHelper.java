...
public class Linux_SambaDenyHostsForShareHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaDenyHostsForShare.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaDenyHostsForShare.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_SambaDenyHostsForShare.");
                        resultArrayList.add(new Linux_SambaDenyHostsForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaDenyHostsForShare.");
                        resultArrayList.add(new Linux_SambaDenyHostsForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaDenyHostsForShare.");
                        resultArrayList.add(new Linux_SambaDenyHostsForShare(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaDenyHostsForShare getInstance(WBEMClient client,
    ...
    public final static Linux_SambaDenyHostsForShare getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaDenyHostsForShare.PROPERTY_PARTCOMPONENT_LINUX_SAMBAHOST.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_SambaDenyHostsForShare.PROPERTY_GROUPCOMPONENT_LINUX_SAMBASHAREOPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaDenyHostsForShare createInstance(WBEMClient client,
            Linux_SambaDenyHostsForShare dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaDenyHostsForShare newDataInstance = Linux_SambaDenyHostsForShareHelper
     ...
     */
    public final static Linux_SambaDenyHostsForShare modifyInstance(WBEMClient client,
            Linux_SambaDenyHostsForShare dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaDenyHostsForShare dataInstance2 = Linux_SambaDenyHostsForShareHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaDenyHostsForShare dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaDenyHostsForShare.getPackages());
    }
