/**
 * Linux_SambaGlobalSecurityForGlobal.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED
...
public class Linux_SambaGlobalSecurityForGlobal extends CIM_ElementSettingData {
     ...
     * 
     */
    public static class PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALSECURITYOPTIONS {
        /**
    ...
    public Linux_SambaGlobalSecurityForGlobal(WBEMClient client, String namespace)
    ...
    public Linux_SambaGlobalSecurityForGlobal(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaGlobalSecurityForGlobal() {
    }
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        propertiesToCheck.put("SettingData", new CIMProperty("SettingData", new CIMDataType(
                Linux_SambaGlobalSecurityOptions.CIM_CLASS_NAME), null));
    ...
    public Linux_SambaGlobalSecurityOptions get_SettingData_Linux_SambaGlobalSecurityOptions(
            javax.wbem.client.WBEMClient client) throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALSECURITYOPTIONS.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALSECURITYOPTIONS.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }

        return Linux_SambaGlobalSecurityOptionsHelper.getInstance(client,
    ...
    public boolean set_SettingData_Linux_SambaGlobalSecurityOptions(
            Linux_SambaGlobalSecurityOptions newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALSECURITYOPTIONS.NAME);
        if (currentProperty != null) {
            setProperty(setPropertyValue_SettingData_Linux_SambaGlobalSecurityOptions(
    ...
    public static CIMProperty create_SettingData_Linux_SambaGlobalSecurityOptions(
            WBEMClient client, String namespace, Linux_SambaGlobalSecurityOptions newValue)
            throws WbemsmtException {
        Linux_SambaGlobalSecurityForGlobal fco = new Linux_SambaGlobalSecurityForGlobal(client,
                namespace);
        CIMProperty property = fco
                .getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALSECURITYOPTIONS.NAME);
        if (property != null) {
            property = setPropertyValue_SettingData_Linux_SambaGlobalSecurityOptions(property,
                    newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALSECURITYOPTIONS.NAME
    ...
    private static CIMProperty setPropertyValue_SettingData_Linux_SambaGlobalSecurityOptions(
            CIMProperty currentProperty, Linux_SambaGlobalSecurityOptions newValue) {
        Object setThis = null;
    ...
    public String getObjectName() {
        return Linux_SambaGlobalSecurityForGlobal.CIM_CLASS_NAME;
    }
