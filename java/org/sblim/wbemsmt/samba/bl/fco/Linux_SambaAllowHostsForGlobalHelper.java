...
public class Linux_SambaAllowHostsForGlobalHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaAllowHostsForGlobal.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaAllowHostsForGlobal.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaAllowHostsForGlobalHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaAllowHostsForGlobal.");
                        resultArrayList.add(new Linux_SambaAllowHostsForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaAllowHostsForGlobal.");
                        resultArrayList.add(new Linux_SambaAllowHostsForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaAllowHostsForGlobal.");
                        resultArrayList.add(new Linux_SambaAllowHostsForGlobal(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaAllowHostsForGlobal getInstance(WBEMClient client,
     ...
     */
    public final static Linux_SambaAllowHostsForGlobal getInstance(WBEMClient client,
            String namespace, Linux_SambaHost PartComponent, Linux_SambaGlobalOptions GroupComponent
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaAllowHostsForGlobal.PROPERTY_PARTCOMPONENT_LINUX_SAMBAHOST.NAME,
                new CIMDataType(Linux_SambaHost.CIM_CLASS_NAME), setThis, false, false,
                Linux_SambaAllowHostsForGlobal.CIM_CLASS_NAME);

        setThis = GroupComponent != null ? GroupComponent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                Linux_SambaAllowHostsForGlobal.PROPERTY_GROUPCOMPONENT_LINUX_SAMBAGLOBALOPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaAllowHostsForGlobal createInstance(WBEMClient client,
            Linux_SambaAllowHostsForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaAllowHostsForGlobal newDataInstance = Linux_SambaAllowHostsForGlobalHelper
     ...
     */
    public final static Linux_SambaAllowHostsForGlobal modifyInstance(WBEMClient client,
            Linux_SambaAllowHostsForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaAllowHostsForGlobal dataInstance2 = Linux_SambaAllowHostsForGlobalHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaAllowHostsForGlobal dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaAllowHostsForGlobal.getPackages());
    }
