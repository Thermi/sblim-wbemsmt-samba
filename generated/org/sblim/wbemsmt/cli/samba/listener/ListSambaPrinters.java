/**
 * ListSambaPrinters.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS OF
...
public class ListSambaPrinters extends CimCommand {
    ...
    public static final OptionDefinition KEY_list = new OptionDefinition(null, "list",
            "INSTANCE_WITH_CHILDS", "ListSambaPrinters.list.argValue", false, false,
            "ListSambaPrinters.list.argDescription");
    ...
    public void execute(CimCommandValues values) throws WbemsmtException {
        ...
        try {
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("listing", new Object[] { bundle
                                    .getString("PrinterListDataContainer.caption") }));

            CliDataLoader loader = new ListSambaPrintersLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.cli.samba.container.printer.PrinterListDataContainerImpl dc = new org.sblim.wbemsmt.cli.samba.container.printer.PrinterListDataContainerImpl(
                    adapter);
            ...
            for (int i = 0; i < count; i++) {
                org.sblim.wbemsmt.cli.samba.container.share.PrinterListItemDataContainerImpl child = new org.sblim.wbemsmt.cli.samba.container.share.PrinterListItemDataContainerImpl(
                        adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.samba.bl.container.printer.PrinterListDataContainer dc)
