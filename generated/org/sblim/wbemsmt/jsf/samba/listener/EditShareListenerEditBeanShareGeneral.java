/**
 * EditShareListenerEditBeanShareGeneral.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED
...
public class EditShareListenerEditBeanShareGeneral extends EditBean {
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        expressionPrefix = "objectActionController.editBeans['shareGeneral'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.jsf.samba.container.share.ShareOptionsDataContainerImpl(
        ...
        expressionPrefix = "objectActionController.editBeans['shareGeneral'].containers[1].";

        //create cotainner
        currentEditContainer2 = new org.sblim.wbemsmt.jsf.samba.container.share.GUIShareFileAttributesImpl(
