...
public class PrinterOptionsDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.samba.bl.container.printer.PrinterOptionsDataContainer {
    ...
    public PrinterOptionsDataContainerImpl(
    ...
    public void reload() {
        ...
        if (ic_usr_SystemPrinterName != null) {
            ic_usr_SystemPrinterName.setLabelText(bundle
                    .getString("PrinterOptionsDataContainer.SystemPrinterName"));
        }
        if (ic_Path != null) {
