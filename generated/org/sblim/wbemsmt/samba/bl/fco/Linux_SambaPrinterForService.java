/**
 * Linux_SambaPrinterForService.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class Linux_SambaPrinterForService extends CIM_ElementSettingData {
    ...
    public boolean set_SettingData_Linux_SambaPrinterOptions(Linux_SambaPrinterOptions newValue) {
        ...
        if (currentProperty != null) {
            setProperty(setPropertyValue_SettingData_Linux_SambaPrinterOptions(currentProperty,
                    newValue));
            return true;
        }
        else {
