...
public class HostWizardPage2Impl extends BaseDataContainer implements
        org.sblim.wbemsmt.samba.bl.container.wizard.HostWizardPage2 {
    private org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf ic_Name;

    public HostWizardPage2Impl(AbstractBaseCimAdapter adapter) throws WbemsmtException {
        super();
        setAdapter(adapter);
