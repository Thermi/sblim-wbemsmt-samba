...
//**********************************************************************
   ...
   public Linux_SambaPrinterSecurityOptions(WBEMClient client, String namespace) throws WbemsmtException
   {
...
//**********************************************************************
   ...
   public boolean set_key_Name(String newValue)
   {
    ...
    public static CIMProperty create_key_Name(WBEMClient client, String namespace, String newValue) throws WbemsmtException {
        Linux_SambaPrinterSecurityOptions fco = new Linux_SambaPrinterSecurityOptions(client,namespace);
...
//**********************************************************************
     ...
     **/
     ...
     public java.util.List<Linux_SambaPrinterOptions> getAssociated_Linux_SambaPrinterOptions_Linux_SambaPrinterSecurityForPrinters(WBEMClient cimClient) throws WbemsmtException {
     ...
     **/
     ...
     public java.util.List<Linux_SambaPrinterOptions> getAssociated_Linux_SambaPrinterOptions_Linux_SambaPrinterSecurityForPrinters(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
     ...
     public java.util.List<Linux_SambaPrinterOptions> getAssociated_Linux_SambaPrinterOptions_Linux_SambaPrinterSecurityForPrinters(WBEMClient cimClient, String associationClass, String resultClass, String role, String resultRole, boolean includeQualifiers, boolean includeClassOrigin, java.lang.String[] propertyList) throws WbemsmtException {
         ...
         try {
                 ...
                 if (obj instanceof CIMInstance) {
                     ...
                     Class<?> clazz = Linux_SambaPrinterSecurityOptionsHelper.findClass(cimClient, cimInstance);
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_Linux_SambaPrinterOptions_Linux_SambaPrinterSecurityForPrinterNames(WBEMClient cimClient) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_Linux_SambaPrinterOptions_Linux_SambaPrinterSecurityForPrinterNames(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_Linux_SambaPrinterOptions_Linux_SambaPrinterSecurityForPrinterNames(WBEMClient cimClient,boolean deep,String associationClass, String resultClass, String role, String resultRole) throws WbemsmtException {
   ...
   public java.util.List<Linux_SambaPrinterSecurityForPrinter> getAssociations_Linux_SambaPrinterSecurityForPrinter(WBEMClient cimClient, boolean includeQualifiers, boolean includeClassOrigin, String role,java.lang.String[] propertyList) throws WbemsmtException {

       if (cimClient == null) {
            throw new WbemsmtException(WbemsmtException.ERR_INVALID_PARAMETER ,"The cimClient parameter does not contain a valid reference.");
       }

       java.util.List<Linux_SambaPrinterSecurityForPrinter> result = new java.util.ArrayList<Linux_SambaPrinterSecurityForPrinter>();
       CloseableIterator enumeration = null;
       ...
       try {
        ...
        try {
          while (enumeration.hasNext()) {
             ...
             if (obj instanceof CIMInstance) {
                CIMInstance cimInstance = (CIMInstance)obj;
                Class<?> clazz = Linux_SambaPrinterSecurityForPrinterHelper.findClass(cimClient, cimInstance);
                ...
                try {
                   Object[] actargs = new Object[] {cimInstance};
                   Object dataObj = cons.newInstance(actargs);
                   result.add((Linux_SambaPrinterSecurityForPrinter)dataObj);
                } catch (Exception e) {
                   System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of the base class.");
                   result.add(new Linux_SambaPrinterSecurityForPrinter(cimInstance));
                   continue;
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociationNames_Linux_SambaPrinterSecurityForPrinter(WBEMClient cimClient,String role, boolean deep) throws WbemsmtException {
        ...
        try {
                while (enumeration.hasNext()) {
                   ...
                   if (obj instanceof CIMObjectPath) {
                      if (deep || ((CIMObjectPath)obj).getObjectName().equals(Linux_SambaPrinterSecurityForPrinter.CIM_CLASS_NAME)) {
                         result.add((CIMObjectPath)obj);
                      }
                   }
                }
     ...
     **/
     ...
     public java.util.List<Linux_SambaGlobalOptions> getAssociated_Linux_SambaGlobalOptions_Linux_SambaPrinterSecurityForGlobals(WBEMClient cimClient) throws WbemsmtException {
     ...
     **/
     ...
     public java.util.List<Linux_SambaGlobalOptions> getAssociated_Linux_SambaGlobalOptions_Linux_SambaPrinterSecurityForGlobals(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
     ...
     **/
     ...
     public java.util.List<Linux_SambaGlobalOptions> getAssociated_Linux_SambaGlobalOptions_Linux_SambaPrinterSecurityForGlobals(WBEMClient cimClient, String associationClass, String resultClass, String role, String resultRole, boolean includeQualifiers, boolean includeClassOrigin, java.lang.String[] propertyList) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_Linux_SambaGlobalOptions_Linux_SambaPrinterSecurityForGlobalNames(WBEMClient cimClient) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_Linux_SambaGlobalOptions_Linux_SambaPrinterSecurityForGlobalNames(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_Linux_SambaGlobalOptions_Linux_SambaPrinterSecurityForGlobalNames(WBEMClient cimClient,boolean deep,String associationClass, String resultClass, String role, String resultRole) throws WbemsmtException {
