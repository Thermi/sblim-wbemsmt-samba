...
public class Linux_SambaPrinterBrowseForPrinterHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaPrinterBrowseForPrinter.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaPrinterBrowseForPrinter.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaPrinterBrowseForPrinterHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaPrinterBrowseForPrinter.");
                        resultArrayList.add(new Linux_SambaPrinterBrowseForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaPrinterBrowseForPrinter.");
                        resultArrayList.add(new Linux_SambaPrinterBrowseForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaPrinterBrowseForPrinter.");
                        resultArrayList.add(new Linux_SambaPrinterBrowseForPrinter(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaPrinterBrowseForPrinter getInstance(WBEMClient client,
     ...
     */
    public final static Linux_SambaPrinterBrowseForPrinter getInstance(WBEMClient client,
            String namespace, Linux_SambaPrinterOptions ManagedElement,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaPrinterBrowseForPrinter.PROPERTY_MANAGEDELEMENT_LINUX_SAMBAPRINTEROPTIONS.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_SambaPrinterBrowseForPrinter.PROPERTY_SETTINGDATA_LINUX_SAMBAPRINTERBROWSEOPTIONS.NAME,
                new CIMDataType(Linux_SambaPrinterBrowseOptions.CIM_CLASS_NAME), setThis, false,
                false, Linux_SambaPrinterBrowseForPrinter.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_SambaPrinterBrowseForPrinter createInstance(WBEMClient client,
            Linux_SambaPrinterBrowseForPrinter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaPrinterBrowseForPrinter newDataInstance = Linux_SambaPrinterBrowseForPrinterHelper
     ...
     */
    public final static Linux_SambaPrinterBrowseForPrinter modifyInstance(WBEMClient client,
            Linux_SambaPrinterBrowseForPrinter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaPrinterBrowseForPrinter dataInstance2 = Linux_SambaPrinterBrowseForPrinterHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaPrinterBrowseForPrinter dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaPrinterBrowseForPrinter.getPackages());
    }
