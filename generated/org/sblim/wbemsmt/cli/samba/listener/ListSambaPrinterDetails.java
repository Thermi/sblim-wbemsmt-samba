/**
 * ListSambaPrinterDetails.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class ListSambaPrinterDetails extends CimCommand {
    ...
    public static final OptionDefinition KEY_list = new OptionDefinition(null, "list",
            "INSTANCE_WITH_CHILDS", "ListSambaPrinterDetails.list.argValue", false, false,
            "ListSambaPrinterDetails.list.argDescription");
    /**
