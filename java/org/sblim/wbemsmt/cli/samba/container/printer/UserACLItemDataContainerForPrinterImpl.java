...
public class UserACLItemDataContainerForPrinterImpl extends BaseDataContainer implements
    ...
    public UserACLItemDataContainerForPrinterImpl(AbstractBaseCimAdapter adapter)
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "UserACLItemDataContainerForPrinter.caption"));
        }
