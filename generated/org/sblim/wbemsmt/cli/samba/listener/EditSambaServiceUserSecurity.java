/**
 * EditSambaServiceUserSecurity.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class EditSambaServiceUserSecurity extends CimCommand {
     ...
     *  --newForceUser
     */
    public static final OptionDefinition KEY_newForceUser = new OptionDefinition(null,
            "newForceUser", null, "ServiceUserSecurityOptionsDataContainer.newForceUser.argValue",
            false, false, "ServiceUserSecurityOptionsDataContainer.newForceUser.argDescription");
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] { KEY_newForceUser, };
