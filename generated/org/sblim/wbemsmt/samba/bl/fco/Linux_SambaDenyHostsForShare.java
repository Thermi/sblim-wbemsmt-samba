/**
 * Linux_SambaDenyHostsForShare.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class Linux_SambaDenyHostsForShare extends CIM_Component {
    ...
    public Linux_SambaDenyHostsForShare(WBEMClient client, String namespace)
    ...
    public Linux_SambaDenyHostsForShare(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaDenyHostsForShare() {
    }
    ...
    public static CIMProperty create_PartComponent_Linux_SambaHost(WBEMClient client,
        ...
        Linux_SambaDenyHostsForShare fco = new Linux_SambaDenyHostsForShare(client, namespace);
    ...
    public String getObjectName() {
        return Linux_SambaDenyHostsForShare.CIM_CLASS_NAME;
    }
