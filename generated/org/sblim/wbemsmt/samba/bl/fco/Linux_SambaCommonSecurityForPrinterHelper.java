/** 
  * Linux_SambaCommonSecurityForPrinterHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_SambaCommonSecurityForPrinter
  *    
  * 
  * generated Class
  * @see Linux_SambaCommonSecurityForPrinter
  */
...
public class Linux_SambaCommonSecurityForPrinterHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_SambaCommonSecurityForPrinter or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaCommonSecurityForPrinter.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaCommonSecurityForPrinter.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_SambaCommonSecurityForPrinter or the subclasses if deep == true
    */        
    public final static List<Linux_SambaCommonSecurityForPrinter> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaCommonSecurityForPrinter> resultArrayList = new ArrayList<Linux_SambaCommonSecurityForPrinter>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaCommonSecurityForPrinter.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaCommonSecurityForPrinter(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_SambaCommonSecurityForPrinterHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_SambaCommonSecurityForPrinter.");
                        resultArrayList.add(new Linux_SambaCommonSecurityForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_SambaCommonSecurityForPrinter.");
                        resultArrayList.add(new Linux_SambaCommonSecurityForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaCommonSecurityForPrinter)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaCommonSecurityForPrinter.");
                        resultArrayList.add(new Linux_SambaCommonSecurityForPrinter(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaCommonSecurityForPrinter getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaCommonSecurityForPrinter getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_SambaCommonSecurityForPrinter dataInstance = null;
        Class<?> clazz = Linux_SambaCommonSecurityForPrinterHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_SambaCommonSecurityForPrinter)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaCommonSecurityForPrinter.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_SambaCommonSecurityForPrinter(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_SambaCommonSecurityForPrinter getInstance(WBEMClient client, String namespace
                                                       ,Linux_SambaCommonSecurityOptions SettingData
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaCommonSecurityForPrinter.PROPERTY_SETTINGDATA_LINUX_SAMBACOMMONSECURITYOPTIONS.NAME,new CIMDataType(Linux_SambaCommonSecurityOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaCommonSecurityForPrinter.CIM_CLASS_NAME); 
                   
                                 setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_SambaCommonSecurityForPrinter.PROPERTY_MANAGEDELEMENT_LINUX_SAMBAPRINTEROPTIONS.NAME,new CIMDataType(Linux_SambaPrinterOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaCommonSecurityForPrinter.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaCommonSecurityForPrinter.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_SambaCommonSecurityForPrinter createInstance(WBEMClient client, Linux_SambaCommonSecurityForPrinter dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_SambaCommonSecurityForPrinter newDataInstance = Linux_SambaCommonSecurityForPrinterHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_SambaCommonSecurityForPrinter modifyInstance(WBEMClient client, Linux_SambaCommonSecurityForPrinter dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_SambaCommonSecurityForPrinter dataInstance2 = Linux_SambaCommonSecurityForPrinterHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaCommonSecurityForPrinter dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaCommonSecurityForPrinter.getPackages());
    }
