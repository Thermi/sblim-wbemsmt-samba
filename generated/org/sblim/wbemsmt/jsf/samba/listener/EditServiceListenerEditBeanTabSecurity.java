/**
 * EditServiceListenerEditBeanTabSecurity.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS
...
public class EditServiceListenerEditBeanTabSecurity extends EditBean {
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        expressionPrefix = "objectActionController.editBeans['tabSecurity'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.jsf.samba.container.service.ServiceGlobalSecurityOptionsDataContainerImpl(
        ...
        expressionPrefix = "objectActionController.editBeans['tabSecurity'].containers[1].";

        //create cotainner
        currentEditContainer2 = new org.sblim.wbemsmt.jsf.samba.container.service.ServiceUserSecurityOptionsDataContainerImpl(
        ...
        //add the childs with occurence list
        {
            ...
            childPanel.setId(org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputComponent
                    .asJsfId("editUserSecurityPanelChild_userRights"));
