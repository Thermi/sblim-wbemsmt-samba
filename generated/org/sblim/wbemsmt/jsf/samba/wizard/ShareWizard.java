/**
 * ShareWizard.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS OF THE
...
public class ShareWizard extends JSFWizardBase implements IPageWizardAdapter {
    ...
    public ShareWizard(final org.sblim.wbemsmt.samba.bl.adapter.SambaCimAdapter adapter) {
        super(adapter, ResourceBundleManager.getResourceBundle(new String[] { "messages",
                ...
                .getCurrentLocale()), "ShareWizard.title");
        this.adapter = adapter;
        this.container = new org.sblim.wbemsmt.samba.wizard.ShareWizardContainer(adapter,
                new org.sblim.wbemsmt.samba.wizard.ShareWizardContainerPanels() {
                    ...
                    public DataContainer getPage1() throws WbemsmtException {
                        ...
                        try {
                            panel1 = new org.sblim.wbemsmt.jsf.samba.container.wizard.ShareWizardPage1Impl(
                                    adapter, binding);
                            ...
                            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
                                    "Cannot process Wizard shareWizard", e);
                        }
                    }
                    ...
                    public DataContainer getPage2() throws WbemsmtException {
                        ...
                        try {
                            panel2 = new org.sblim.wbemsmt.jsf.samba.container.wizard.ShareWizardPage2Impl(
                                    adapter, binding);
                    ...
                    public DataContainer getPage4() throws WbemsmtException {
                        ...
                        try {
                            panel3 = new org.sblim.wbemsmt.jsf.samba.container.wizard.ShareWizardPage4Impl(
                                    adapter, binding);
    ...
    public String getJavaScriptWaitStatement() {
        String text = bundle.getString("ShareWizard.createWaitText", bundle
