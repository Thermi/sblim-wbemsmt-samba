/**
 * Linux_SambaUsersForService.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class Linux_SambaUsersForService extends CIM_Component {
    ...
    public Linux_SambaUsersForService(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public Linux_SambaUsersForService(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaUsersForService() {
    }
    ...
    public static CIMProperty create_PartComponent_Linux_SambaUser(WBEMClient client,
        ...
        Linux_SambaUsersForService fco = new Linux_SambaUsersForService(client, namespace);
    ...
    public String getObjectName() {
        return Linux_SambaUsersForService.CIM_CLASS_NAME;
    }
