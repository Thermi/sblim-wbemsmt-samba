/**
 * CreateShareListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS
...
public class CreateShareListener extends TaskLauncherContextMenuEventListenerImpl implements
        org.sblim.wbemsmt.tasklauncher.event.CreateListener {

    String jsfListener = "org.sblim.wbemsmt.jsf.samba.listener.CreateShareListener";
    String swingListener = "org.sblim.wbemsmt.jswing.samba.listener.CreateShareListener";

    //String cmdListener = "org.sblim.wbemsmt.cli.samba.listener.CreateShareListener";
