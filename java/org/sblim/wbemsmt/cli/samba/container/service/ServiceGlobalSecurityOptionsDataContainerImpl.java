...
public class ServiceGlobalSecurityOptionsDataContainerImpl extends BaseDataContainer implements
    ...
    public ServiceGlobalSecurityOptionsDataContainerImpl(AbstractBaseCimAdapter adapter)
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "ServiceGlobalSecurityOptionsDataContainer.caption"));
        }
        ...
        if (showInstance(listOptions)) {
            if (get_AuthMethods().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_AuthMethods())
                        .getValue();
                printStream.println(get_AuthMethods().getLabelText() + ": " + value);
            }
            if (get_EncryptPasswords().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_EncryptPasswords())
                        .getValue();
                printStream.println(get_EncryptPasswords().getLabelText() + ": " + value);
            }
            if (get_MinPasswordLength().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_MinPasswordLength())
                        .getValue();
                printStream.println(get_MinPasswordLength().getLabelText() + ": " + value);
            }
            if (get_NullPasswords().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_NullPasswords())
                        .getValue();
                printStream.println(get_NullPasswords().getLabelText() + ": " + value);
            }
            if (get_usr_PassdbBackend().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_PassdbBackend())
                        .getValue();
                printStream.println(get_usr_PassdbBackend().getLabelText() + ": " + value);
            }
            if (get_SMBPasswdFile().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_SMBPasswdFile())
                        .getValue();
                printStream.println(get_SMBPasswdFile().getLabelText() + ": " + value);
            }
            if (get_Security().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_Security())
                        .getValue();
            ...
            if (get_DomainMaster().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_DomainMaster())
                        .getValue();
