...
public class UserInPrinterACLDataContainerImpl extends BaseDataContainer implements
        org.sblim.wbemsmt.samba.bl.container.printer.UserInPrinterACLDataContainer,
    ...
    public UserInPrinterACLDataContainerImpl(AbstractBaseCimAdapter adapter)
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "UserInPrinterACLDataContainer.caption"));
        }
    ...
    public void traceChilds(java.io.PrintWriter printStream, String listOptions, boolean title) {
        ...
        printStream.println();
        printStream.println(getAdapter().getBundle().getString(
                "UserInPrinterACLDataContainer.role.users")
                + " "
