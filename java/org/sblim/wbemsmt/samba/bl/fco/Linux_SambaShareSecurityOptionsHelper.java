...
public final class Linux_SambaShareSecurityOptionsHelper {
	...
	*/	
	public final static Linux_SambaShareSecurityOptions getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_SambaShareSecurityOptionsHelper.getInstance(cimClient, new Linux_SambaShareSecurityOptions(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaShareSecurityOptions getInstance(CIMClient cimClient, Linux_SambaShareSecurityOptions dataInstance) {
		...
		return Linux_SambaShareSecurityOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaShareSecurityOptions getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			dataInstance = new Linux_SambaShareSecurityOptions(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaShareSecurityOptions createInstance(CIMClient cimClient, Linux_SambaShareSecurityOptions dataInstance, boolean notifyDifferencies){ 
		...
		Linux_SambaShareSecurityOptions newDataInstance = null;
		try {
			newDataInstance = Linux_SambaShareSecurityOptionsHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaShareSecurityOptions modifyInstance(CIMClient cimClient, Linux_SambaShareSecurityOptions dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_SambaShareSecurityOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_SambaShareSecurityOptions dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_SambaShareSecurityOptions dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_SambaShareSecurityOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_SambaShareSecurityOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_SambaShareSecurityOptions.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_SambaShareSecurityOptions.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_SambaShareSecurityOptions.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_CreateMask(UnsignedInt16 CreateMask) {
		return true;
	}

	public static boolean isValid_DirectoryMask(UnsignedInt16 DirectoryMask) {
		return true;
	}

	public static boolean isValid_DirectorySecurityMask(UnsignedInt16 DirectorySecurityMask) {
		return true;
	}
