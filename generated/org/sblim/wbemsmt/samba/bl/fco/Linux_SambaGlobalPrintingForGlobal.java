/**
 * Linux_SambaGlobalPrintingForGlobal.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED
...
public class Linux_SambaGlobalPrintingForGlobal extends CIM_ElementSettingData {
     ...
     * 
     */
    public static class PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALPRINTINGOPTIONS {
        /**
    ...
    public Linux_SambaGlobalPrintingForGlobal(WBEMClient client, String namespace)
    ...
    public Linux_SambaGlobalPrintingForGlobal(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaGlobalPrintingForGlobal() {
    }
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        propertiesToCheck.put("SettingData", new CIMProperty("SettingData", new CIMDataType(
                Linux_SambaGlobalPrintingOptions.CIM_CLASS_NAME), null));
    ...
    public Linux_SambaGlobalPrintingOptions get_SettingData_Linux_SambaGlobalPrintingOptions(
            javax.wbem.client.WBEMClient client) throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALPRINTINGOPTIONS.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALPRINTINGOPTIONS.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }

        return Linux_SambaGlobalPrintingOptionsHelper.getInstance(client,
    ...
    public boolean set_SettingData_Linux_SambaGlobalPrintingOptions(
            Linux_SambaGlobalPrintingOptions newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALPRINTINGOPTIONS.NAME);
        if (currentProperty != null) {
            setProperty(setPropertyValue_SettingData_Linux_SambaGlobalPrintingOptions(
    ...
    public static CIMProperty create_SettingData_Linux_SambaGlobalPrintingOptions(
            WBEMClient client, String namespace, Linux_SambaGlobalPrintingOptions newValue)
            throws WbemsmtException {
        Linux_SambaGlobalPrintingForGlobal fco = new Linux_SambaGlobalPrintingForGlobal(client,
                namespace);
        CIMProperty property = fco
                .getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALPRINTINGOPTIONS.NAME);
        if (property != null) {
            property = setPropertyValue_SettingData_Linux_SambaGlobalPrintingOptions(property,
                    newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALPRINTINGOPTIONS.NAME
    ...
    private static CIMProperty setPropertyValue_SettingData_Linux_SambaGlobalPrintingOptions(
            CIMProperty currentProperty, Linux_SambaGlobalPrintingOptions newValue) {
        Object setThis = null;
    ...
    public String getObjectName() {
        return Linux_SambaGlobalPrintingForGlobal.CIM_CLASS_NAME;
    }
