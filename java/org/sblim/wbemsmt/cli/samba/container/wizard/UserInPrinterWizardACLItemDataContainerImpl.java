...
public class UserInPrinterWizardACLItemDataContainerImpl extends BaseDataContainer implements
    ...
    public UserInPrinterWizardACLItemDataContainerImpl(AbstractBaseCimAdapter adapter)
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "UserInPrinterWizardACLItemDataContainer.caption"));
        }
