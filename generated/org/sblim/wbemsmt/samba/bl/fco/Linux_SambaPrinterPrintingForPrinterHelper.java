/** 
  * Linux_SambaPrinterPrintingForPrinterHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_SambaPrinterPrintingForPrinter
  *    
  * 
  * generated Class
  * @see Linux_SambaPrinterPrintingForPrinter
  */
...
public class Linux_SambaPrinterPrintingForPrinterHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_SambaPrinterPrintingForPrinter or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaPrinterPrintingForPrinter.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaPrinterPrintingForPrinter.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_SambaPrinterPrintingForPrinter or the subclasses if deep == true
    */        
    public final static List<Linux_SambaPrinterPrintingForPrinter> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaPrinterPrintingForPrinter> resultArrayList = new ArrayList<Linux_SambaPrinterPrintingForPrinter>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaPrinterPrintingForPrinter.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaPrinterPrintingForPrinter(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_SambaPrinterPrintingForPrinterHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_SambaPrinterPrintingForPrinter.");
                        resultArrayList.add(new Linux_SambaPrinterPrintingForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_SambaPrinterPrintingForPrinter.");
                        resultArrayList.add(new Linux_SambaPrinterPrintingForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaPrinterPrintingForPrinter)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaPrinterPrintingForPrinter.");
                        resultArrayList.add(new Linux_SambaPrinterPrintingForPrinter(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaPrinterPrintingForPrinter getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaPrinterPrintingForPrinter getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_SambaPrinterPrintingForPrinter dataInstance = null;
        Class<?> clazz = Linux_SambaPrinterPrintingForPrinterHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_SambaPrinterPrintingForPrinter)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaPrinterPrintingForPrinter.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_SambaPrinterPrintingForPrinter(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_SambaPrinterPrintingForPrinter getInstance(WBEMClient client, String namespace
                                                       ,Linux_SambaPrinterPrintingOptions SettingData
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaPrinterPrintingForPrinter.PROPERTY_SETTINGDATA_LINUX_SAMBAPRINTERPRINTINGOPTIONS.NAME,new CIMDataType(Linux_SambaPrinterPrintingOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaPrinterPrintingForPrinter.CIM_CLASS_NAME); 
                   
                                 setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_SambaPrinterPrintingForPrinter.PROPERTY_MANAGEDELEMENT_LINUX_SAMBAPRINTEROPTIONS.NAME,new CIMDataType(Linux_SambaPrinterOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaPrinterPrintingForPrinter.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaPrinterPrintingForPrinter.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_SambaPrinterPrintingForPrinter createInstance(WBEMClient client, Linux_SambaPrinterPrintingForPrinter dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_SambaPrinterPrintingForPrinter newDataInstance = Linux_SambaPrinterPrintingForPrinterHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_SambaPrinterPrintingForPrinter modifyInstance(WBEMClient client, Linux_SambaPrinterPrintingForPrinter dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_SambaPrinterPrintingForPrinter dataInstance2 = Linux_SambaPrinterPrintingForPrinterHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaPrinterPrintingForPrinter dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaPrinterPrintingForPrinter.getPackages());
    }
