...
public class Linux_SambaLoggingOptions extends CIM_SettingData {
    ...
    public static class PROPERTY_SYSLOG {
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_0_FOR_VALUE_ENTRY_LOG_ERR = new javax.cim.UnsignedInteger16(
                "0");

        /**
         * constant for value entry LOG_ERR (corresponds to mapEntry 0 )
         */
        public final static String VALUE_ENTRY_LOG_ERR = "LOG_ERR";

        /**
         * constant for value map entry 1
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_1_FOR_VALUE_ENTRY_LOG_WARNING = new javax.cim.UnsignedInteger16(
                "1");

        /**
         * constant for value entry LOG_WARNING (corresponds to mapEntry 1 )
         */
        public final static String VALUE_ENTRY_LOG_WARNING = "LOG_WARNING";

        /**
         * constant for value map entry 2
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_2_FOR_VALUE_ENTRY_LOG_NOTICE = new javax.cim.UnsignedInteger16(
                "2");

        /**
         * constant for value entry LOG_NOTICE (corresponds to mapEntry 2 )
         */
        public final static String VALUE_ENTRY_LOG_NOTICE = "LOG_NOTICE";

        /**
         * constant for value map entry 3
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_3_FOR_VALUE_ENTRY_LOG_INFO = new javax.cim.UnsignedInteger16(
                "3");

        /**
         * constant for value entry LOG_INFO (corresponds to mapEntry 3 )
         */
        public final static String VALUE_ENTRY_LOG_INFO = "LOG_INFO";

        /**
         * constant for value map entry 4
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_4_FOR_VALUE_ENTRY_LOG_DEBUG = new javax.cim.UnsignedInteger16(
                "4");

        /**
         * constant for value entry LOG_DEBUG (corresponds to mapEntry 4 )
         */
        public final static String VALUE_ENTRY_LOG_DEBUG = "LOG_DEBUG";
         ...
         * Value Map for the property SysLog   
         */
        public final static String[] VALUE_ENTRIES = { VALUE_ENTRY_LOG_ERR,
                VALUE_ENTRY_LOG_WARNING, VALUE_ENTRY_LOG_NOTICE, VALUE_ENTRY_LOG_INFO,
         ...
         * Value Map for the property SysLog   
         */
        public final static String[] VALUE_ENTRIES_FOR_DISPLAY = { VALUE_ENTRY_LOG_ERR,
                VALUE_ENTRY_LOG_WARNING, VALUE_ENTRY_LOG_NOTICE, VALUE_ENTRY_LOG_INFO,
                VALUE_ENTRY_LOG_DEBUG };
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        propertiesToCheck.put("DebugHiresTimestamp", new CIMProperty("DebugHiresTimestamp",
                CIMDataType.BOOLEAN_T, null));
        propertiesToCheck.put("DebugPID", new CIMProperty("DebugPID", CIMDataType.BOOLEAN_T, null));
        propertiesToCheck.put("DebugTimestamp", new CIMProperty("DebugTimestamp",
                CIMDataType.BOOLEAN_T, null));
        ...
        propertiesToCheck.put("MaxLogSize", new CIMProperty("MaxLogSize", CIMDataType.UINT32_T,
                null));
        propertiesToCheck.put("Name", new CIMProperty("Name", CIMDataType.STRING_T, null));
        propertiesToCheck.put("SysLog", new CIMProperty("SysLog", CIMDataType.UINT16_T, null));
        propertiesToCheck.put("SysLogOnly", new CIMProperty("SysLogOnly", CIMDataType.BOOLEAN_T,
                null));
    ...
    public Boolean get_DebugHiresTimestamp() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_DEBUGHIRESTIMESTAMP.NAME
    ...
    public static CIMProperty create_DebugHiresTimestamp(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_DebugHiresTimestamp(CIMProperty currentProperty,
            Boolean newValue) {
        Object setThis = null;
    ...
    public Boolean get_DebugPID() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_DEBUGPID.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_DebugPID(WBEMClient client, String namespace, Boolean newValue)
            throws WbemsmtException {
        Linux_SambaLoggingOptions fco = new Linux_SambaLoggingOptions(client, namespace);
    ...
    private static CIMProperty setPropertyValue_DebugPID(CIMProperty currentProperty,
            Boolean newValue) {
        Object setThis = null;
    ...
    public Boolean get_DebugTimestamp() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_DEBUGTIMESTAMP.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_DebugTimestamp(WBEMClient client, String namespace,
            Boolean newValue) throws WbemsmtException {
        Linux_SambaLoggingOptions fco = new Linux_SambaLoggingOptions(client, namespace);
    ...
    private static CIMProperty setPropertyValue_DebugTimestamp(CIMProperty currentProperty,
            Boolean newValue) {
        Object setThis = null;
    ...
    public Boolean get_DebugUID() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_DEBUGUID.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_DebugUID(WBEMClient client, String namespace, Boolean newValue)
            throws WbemsmtException {
        Linux_SambaLoggingOptions fco = new Linux_SambaLoggingOptions(client, namespace);
    ...
    private static CIMProperty setPropertyValue_DebugUID(CIMProperty currentProperty,
            Boolean newValue) {
        Object setThis = null;
    ...
    public String get_LogFile() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_LOGFILE.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_LogFile(WBEMClient client, String namespace, String newValue)
            throws WbemsmtException {
        Linux_SambaLoggingOptions fco = new Linux_SambaLoggingOptions(client, namespace);
    ...
    public String get_LogLevel() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_LOGLEVEL.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_LogLevel(WBEMClient client, String namespace, String newValue)
            throws WbemsmtException {
        Linux_SambaLoggingOptions fco = new Linux_SambaLoggingOptions(client, namespace);
    ...
    private static CIMProperty setPropertyValue_LogLevel(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    public javax.cim.UnsignedInteger32 get_MaxLogSize() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_MAXLOGSIZE.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_MaxLogSize(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_MaxLogSize(CIMProperty currentProperty,
    ...
    public javax.cim.UnsignedInteger16 get_SysLog() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_SYSLOG.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_SysLog(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_SysLog(CIMProperty currentProperty,
    ...
    public Boolean get_SysLogOnly() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_SYSLOGONLY.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_SysLogOnly(WBEMClient client, String namespace,
            Boolean newValue) throws WbemsmtException {
        Linux_SambaLoggingOptions fco = new Linux_SambaLoggingOptions(client, namespace);
    ...
    private static CIMProperty setPropertyValue_SysLogOnly(CIMProperty currentProperty,
            Boolean newValue) {
        Object setThis = null;
    ...
    public java.util.List getAssociated_Linux_SambaGlobalOptions_Linux_SambaLoggingForGlobals(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_Linux_SambaGlobalOptions_Linux_SambaLoggingForGlobals(cimClient,
    ...
    public java.util.List getAssociated_Linux_SambaGlobalOptions_Linux_SambaLoggingForGlobalNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_Linux_SambaGlobalOptions_Linux_SambaLoggingForGlobalNames(cimClient,
