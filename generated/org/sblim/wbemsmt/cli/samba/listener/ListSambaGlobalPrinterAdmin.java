/**
 * ListSambaGlobalPrinterAdmin.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class ListSambaGlobalPrinterAdmin extends CimCommand {
    ...
    public static final OptionDefinition KEY_list = new OptionDefinition(null, "list",
            "INSTANCE_WITH_CHILDS", "ListSambaGlobalPrinterAdmin.list.argValue", false, false,
            "ListSambaGlobalPrinterAdmin.list.argDescription");
    /**
    ...
    public static final OptionDefinition KEY_sambaUsername = new OptionDefinition(null,
            "sambaUsername", null, "UserIsAdminItem.SambaUserName.argValue", true, true,
            "UserIsAdminItem.SambaUserName.argDescription");
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("listing", new Object[] { bundle
                                    .getString("AdminUsersInPrinterGlobals.caption") }));

            CliDataLoader loader = new ListSambaGlobalPrinterAdminLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.cli.samba.container.global.AdminUsersInPrinterGlobalsImpl dc = new org.sblim.wbemsmt.cli.samba.container.global.AdminUsersInPrinterGlobalsImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.samba.bl.container.global.AdminUsersInPrinterGlobals dc)
