...
public final class Linux_SambaShareBrowseOptionsHelper {
	...
	*/	
	public final static Linux_SambaShareBrowseOptions getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_SambaShareBrowseOptionsHelper.getInstance(cimClient, new Linux_SambaShareBrowseOptions(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaShareBrowseOptions getInstance(CIMClient cimClient, Linux_SambaShareBrowseOptions dataInstance) {
		...
		return Linux_SambaShareBrowseOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaShareBrowseOptions getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			dataInstance = new Linux_SambaShareBrowseOptions(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaShareBrowseOptions createInstance(CIMClient cimClient, Linux_SambaShareBrowseOptions dataInstance, boolean notifyDifferencies){ 
		...
		Linux_SambaShareBrowseOptions newDataInstance = null;
		try {
			newDataInstance = Linux_SambaShareBrowseOptionsHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaShareBrowseOptions modifyInstance(CIMClient cimClient, Linux_SambaShareBrowseOptions dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_SambaShareBrowseOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_SambaShareBrowseOptions dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_SambaShareBrowseOptions dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_SambaShareBrowseOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_SambaShareBrowseOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_SambaShareBrowseOptions.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_SambaShareBrowseOptions.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_SambaShareBrowseOptions.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
