/**
 * Linux_SambaInvalidUsersForPrinter.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED
...
public class Linux_SambaInvalidUsersForPrinter extends CIM_Component {
    ...
    public Linux_SambaInvalidUsersForPrinter(WBEMClient client, String namespace)
    ...
    public Linux_SambaInvalidUsersForPrinter(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaInvalidUsersForPrinter() {
    }
    ...
    public static CIMProperty create_PartComponent_Linux_SambaUser(WBEMClient client,
        ...
        Linux_SambaInvalidUsersForPrinter fco = new Linux_SambaInvalidUsersForPrinter(client,
                namespace);
    ...
    public String getObjectName() {
        return Linux_SambaInvalidUsersForPrinter.CIM_CLASS_NAME;
    }
