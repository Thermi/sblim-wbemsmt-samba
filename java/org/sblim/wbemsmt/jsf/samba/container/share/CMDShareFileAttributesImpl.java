...
public class CMDShareFileAttributesImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel implements
    ...
    public CMDShareFileAttributesImpl(org.sblim.wbemsmt.samba.bl.adapter.SambaCimAdapter adapter,
    ...
    public void reload() {
        ...
        if (ic_AclCompatibility != null) {
            ic_AclCompatibility.setLabelText(bundle
                    .getString("CMDShareFileAttributes.AclCompatibility"));
        }
        if (ic_NTACLSupport != null) {
        ...
        if (ic_DirectorySecurityMask != null) {
            ic_DirectorySecurityMask.setLabelText(bundle
                    .getString("CMDShareFileAttributes.DirectorySecurityMask"));
        }
    }
