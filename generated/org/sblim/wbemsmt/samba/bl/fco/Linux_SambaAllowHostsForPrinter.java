/**
 * Linux_SambaAllowHostsForPrinter.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class Linux_SambaAllowHostsForPrinter extends CIM_Component {
    ...
    public Linux_SambaAllowHostsForPrinter(WBEMClient client, String namespace)
    ...
    public Linux_SambaAllowHostsForPrinter(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaAllowHostsForPrinter() {
    }
    ...
    public boolean set_PartComponent_Linux_SambaHost(Linux_SambaHost newValue) {
        ...
        if (currentProperty != null) {
            setProperty(setPropertyValue_PartComponent_Linux_SambaHost(currentProperty, newValue));
            return true;
        }
        else {
            logger.warning("Property " + PROPERTY_PARTCOMPONENT_LINUX_SAMBAHOST.NAME
    ...
    public static CIMProperty create_PartComponent_Linux_SambaHost(WBEMClient client,
        ...
        Linux_SambaAllowHostsForPrinter fco = new Linux_SambaAllowHostsForPrinter(client, namespace);
    ...
    public String getObjectName() {
        return Linux_SambaAllowHostsForPrinter.CIM_CLASS_NAME;
    }
