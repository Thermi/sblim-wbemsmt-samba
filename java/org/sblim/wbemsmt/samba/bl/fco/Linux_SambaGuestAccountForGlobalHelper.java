...
public class Linux_SambaGuestAccountForGlobalHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaGuestAccountForGlobal.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaGuestAccountForGlobal.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaGuestAccountForGlobalHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaGuestAccountForGlobal.");
                        resultArrayList.add(new Linux_SambaGuestAccountForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaGuestAccountForGlobal.");
                        resultArrayList.add(new Linux_SambaGuestAccountForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaGuestAccountForGlobal.");
                        resultArrayList.add(new Linux_SambaGuestAccountForGlobal(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaGuestAccountForGlobal getInstance(WBEMClient client,
    ...
    public final static Linux_SambaGuestAccountForGlobal getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaGuestAccountForGlobal.PROPERTY_PARTCOMPONENT_LINUX_SAMBAUSER.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_SambaGuestAccountForGlobal.PROPERTY_GROUPCOMPONENT_LINUX_SAMBAGLOBALOPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaGuestAccountForGlobal createInstance(WBEMClient client,
            Linux_SambaGuestAccountForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaGuestAccountForGlobal newDataInstance = Linux_SambaGuestAccountForGlobalHelper
     ...
     */
    public final static Linux_SambaGuestAccountForGlobal modifyInstance(WBEMClient client,
            Linux_SambaGuestAccountForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaGuestAccountForGlobal dataInstance2 = Linux_SambaGuestAccountForGlobalHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaGuestAccountForGlobal dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaGuestAccountForGlobal.getPackages());
    }
