...
public class Linux_SambaPrinterSecurityOptionsHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaPrinterSecurityOptions.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaPrinterSecurityOptions.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaPrinterSecurityOptionsHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaPrinterSecurityOptions.");
                        resultArrayList.add(new Linux_SambaPrinterSecurityOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaPrinterSecurityOptions.");
                        resultArrayList.add(new Linux_SambaPrinterSecurityOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaPrinterSecurityOptions.");
                        resultArrayList.add(new Linux_SambaPrinterSecurityOptions(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaPrinterSecurityOptions getInstance(WBEMClient client,
    ...
    public final static Linux_SambaPrinterSecurityOptions getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaPrinterSecurityOptions.PROPERTY_INSTANCEID.NAME, CIMDataType.STRING_T,
                setThis, true, false, Linux_SambaPrinterSecurityOptions.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(Linux_SambaPrinterSecurityOptions.PROPERTY_NAME.NAME,
     ...
     *
     */
    public final static Linux_SambaPrinterSecurityOptions createInstance(WBEMClient client,
            Linux_SambaPrinterSecurityOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaPrinterSecurityOptions newDataInstance = Linux_SambaPrinterSecurityOptionsHelper
     ...
     */
    public final static Linux_SambaPrinterSecurityOptions modifyInstance(WBEMClient client,
            Linux_SambaPrinterSecurityOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaPrinterSecurityOptions dataInstance2 = Linux_SambaPrinterSecurityOptionsHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaPrinterSecurityOptions dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaPrinterSecurityOptions.getPackages());
    }
