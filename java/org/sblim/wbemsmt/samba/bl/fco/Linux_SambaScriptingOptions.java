...
public class Linux_SambaScriptingOptions extends CIM_SettingData {
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        ...
        propertiesToCheck.put("addGroupScript", new CIMProperty("addGroupScript",
                CIMDataType.STRING_T, null));
        propertiesToCheck.put("addPrinterCommand", new CIMProperty("addPrinterCommand",
                CIMDataType.STRING_T, null));
        propertiesToCheck.put("addShareCommand", new CIMProperty("addShareCommand",
                CIMDataType.STRING_T, null));
        propertiesToCheck.put("addUserScript", new CIMProperty("addUserScript",
                CIMDataType.STRING_T, null));
        propertiesToCheck.put("addUsertoGroupScript", new CIMProperty("addUsertoGroupScript",
                CIMDataType.STRING_T, null));
        propertiesToCheck.put("deleteGrouprScript", new CIMProperty("deleteGrouprScript",
                CIMDataType.STRING_T, null));
        propertiesToCheck.put("deleteUserScript", new CIMProperty("deleteUserScript",
                CIMDataType.STRING_T, null));
        propertiesToCheck.put("deleteUserfromGroupScript", new CIMProperty(
                "deleteUserfromGroupScript", CIMDataType.STRING_T, null));
        propertiesToCheck.put("setPrimaryGroupScript", new CIMProperty("setPrimaryGroupScript",
                CIMDataType.STRING_T, null));
    ...
    public String get_addGroupScript() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_ADDGROUPSCRIPT.NAME
    ...
    public static CIMProperty create_addGroupScript(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_addGroupScript(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    public String get_addPrinterCommand() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_ADDPRINTERCOMMAND.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_addPrinterCommand(WBEMClient client, String namespace,
            String newValue) throws WbemsmtException {
        Linux_SambaScriptingOptions fco = new Linux_SambaScriptingOptions(client, namespace);
    ...
    private static CIMProperty setPropertyValue_addPrinterCommand(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    public String get_addShareCommand() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_ADDSHARECOMMAND.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_addShareCommand(WBEMClient client, String namespace,
            String newValue) throws WbemsmtException {
        Linux_SambaScriptingOptions fco = new Linux_SambaScriptingOptions(client, namespace);
    ...
    private static CIMProperty setPropertyValue_addShareCommand(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    public String get_addUserScript() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_ADDUSERSCRIPT.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_addUserScript(WBEMClient client, String namespace,
            String newValue) throws WbemsmtException {
        Linux_SambaScriptingOptions fco = new Linux_SambaScriptingOptions(client, namespace);
    ...
    private static CIMProperty setPropertyValue_addUserScript(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    public String get_addUsertoGroupScript() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_ADDUSERTOGROUPSCRIPT.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_addUsertoGroupScript(WBEMClient client, String namespace,
            String newValue) throws WbemsmtException {
        Linux_SambaScriptingOptions fco = new Linux_SambaScriptingOptions(client, namespace);
    ...
    private static CIMProperty setPropertyValue_addUsertoGroupScript(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    public String get_deleteGrouprScript() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_DELETEGROUPRSCRIPT.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_deleteGrouprScript(WBEMClient client, String namespace,
            String newValue) throws WbemsmtException {
        Linux_SambaScriptingOptions fco = new Linux_SambaScriptingOptions(client, namespace);
    ...
    private static CIMProperty setPropertyValue_deleteGrouprScript(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    public String get_deleteUserScript() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_DELETEUSERSCRIPT.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_deleteUserScript(WBEMClient client, String namespace,
            String newValue) throws WbemsmtException {
        Linux_SambaScriptingOptions fco = new Linux_SambaScriptingOptions(client, namespace);
    ...
    private static CIMProperty setPropertyValue_deleteUserScript(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    public String get_deleteUserfromGroupScript() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_DELETEUSERFROMGROUPSCRIPT.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_deleteUserfromGroupScript(WBEMClient client, String namespace,
            String newValue) throws WbemsmtException {
        Linux_SambaScriptingOptions fco = new Linux_SambaScriptingOptions(client, namespace);
    ...
    private static CIMProperty setPropertyValue_deleteUserfromGroupScript(
    ...
    public String get_setPrimaryGroupScript() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_SETPRIMARYGROUPSCRIPT.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_setPrimaryGroupScript(WBEMClient client, String namespace,
            String newValue) throws WbemsmtException {
        Linux_SambaScriptingOptions fco = new Linux_SambaScriptingOptions(client, namespace);
    ...
    private static CIMProperty setPropertyValue_setPrimaryGroupScript(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    public java.util.List getAssociated_Linux_SambaGlobalOptions_Linux_SambaScriptingForGlobals(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_Linux_SambaGlobalOptions_Linux_SambaScriptingForGlobals(cimClient,
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaScriptingOptionsHelper.findClass(cimClient,
                            cimInstance);
    ...
    public java.util.List getAssociated_Linux_SambaGlobalOptions_Linux_SambaScriptingForGlobalNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_Linux_SambaGlobalOptions_Linux_SambaScriptingForGlobalNames(cimClient,
                true, CIM_ASSOCIATOR_CLASS_NAME_LINUX_SAMBASCRIPTINGFORGLOBAL,
    ...
    public java.util.List getAssociated_Linux_SambaGlobalOptions_Linux_SambaScriptingForGlobalNames(
        ...
        return getAssociated_Linux_SambaGlobalOptions_Linux_SambaScriptingForGlobalNames(cimClient,
                true, CIM_ASSOCIATOR_CLASS_NAME_LINUX_SAMBASCRIPTINGFORGLOBAL, resultClass, role,
                resultRole);
    }
