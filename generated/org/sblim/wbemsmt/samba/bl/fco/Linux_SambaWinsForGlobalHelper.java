/** 
  * Linux_SambaWinsForGlobalHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_SambaWinsForGlobal
  *    
  * 
  * generated Class
  * @see Linux_SambaWinsForGlobal
  */
...
public class Linux_SambaWinsForGlobalHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_SambaWinsForGlobal or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaWinsForGlobal.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaWinsForGlobal.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_SambaWinsForGlobal or the subclasses if deep == true
    */        
    public final static List<Linux_SambaWinsForGlobal> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaWinsForGlobal> resultArrayList = new ArrayList<Linux_SambaWinsForGlobal>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaWinsForGlobal.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaWinsForGlobal(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_SambaWinsForGlobalHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_SambaWinsForGlobal.");
                        resultArrayList.add(new Linux_SambaWinsForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_SambaWinsForGlobal.");
                        resultArrayList.add(new Linux_SambaWinsForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaWinsForGlobal)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaWinsForGlobal.");
                        resultArrayList.add(new Linux_SambaWinsForGlobal(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaWinsForGlobal getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaWinsForGlobal getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_SambaWinsForGlobal dataInstance = null;
        Class<?> clazz = Linux_SambaWinsForGlobalHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_SambaWinsForGlobal)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaWinsForGlobal.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_SambaWinsForGlobal(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_SambaWinsForGlobal getInstance(WBEMClient client, String namespace
                                                       ,Linux_SambaWinsOptions SettingData
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaWinsForGlobal.PROPERTY_SETTINGDATA_LINUX_SAMBAWINSOPTIONS.NAME,new CIMDataType(Linux_SambaWinsOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaWinsForGlobal.CIM_CLASS_NAME); 
                   
                                 setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_SambaWinsForGlobal.PROPERTY_MANAGEDELEMENT_LINUX_SAMBAGLOBALOPTIONS.NAME,new CIMDataType(Linux_SambaGlobalOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaWinsForGlobal.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaWinsForGlobal.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_SambaWinsForGlobal createInstance(WBEMClient client, Linux_SambaWinsForGlobal dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_SambaWinsForGlobal newDataInstance = Linux_SambaWinsForGlobalHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_SambaWinsForGlobal modifyInstance(WBEMClient client, Linux_SambaWinsForGlobal dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_SambaWinsForGlobal dataInstance2 = Linux_SambaWinsForGlobalHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaWinsForGlobal dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaWinsForGlobal.getPackages());
    }
