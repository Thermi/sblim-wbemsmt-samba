...
public final class Linux_SambaShareFileNameHandlingOptionsHelper {
	...
	*/	
	public final static Linux_SambaShareFileNameHandlingOptions getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_SambaShareFileNameHandlingOptionsHelper.getInstance(cimClient, new Linux_SambaShareFileNameHandlingOptions(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaShareFileNameHandlingOptions getInstance(CIMClient cimClient, Linux_SambaShareFileNameHandlingOptions dataInstance) {
		...
		return Linux_SambaShareFileNameHandlingOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaShareFileNameHandlingOptions getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			dataInstance = new Linux_SambaShareFileNameHandlingOptions(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaShareFileNameHandlingOptions createInstance(CIMClient cimClient, Linux_SambaShareFileNameHandlingOptions dataInstance, boolean notifyDifferencies){ 
		...
		Linux_SambaShareFileNameHandlingOptions newDataInstance = null;
		try {
			newDataInstance = Linux_SambaShareFileNameHandlingOptionsHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaShareFileNameHandlingOptions modifyInstance(CIMClient cimClient, Linux_SambaShareFileNameHandlingOptions dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_SambaShareFileNameHandlingOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_SambaShareFileNameHandlingOptions dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_SambaShareFileNameHandlingOptions dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_SambaShareFileNameHandlingOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_SambaShareFileNameHandlingOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_SambaShareFileNameHandlingOptions.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_SambaShareFileNameHandlingOptions.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_SambaShareFileNameHandlingOptions.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
