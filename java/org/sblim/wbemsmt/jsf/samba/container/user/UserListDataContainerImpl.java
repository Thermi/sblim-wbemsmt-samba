...
public class UserListDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel implements
    ...
    public UserListDataContainerImpl(org.sblim.wbemsmt.samba.bl.adapter.SambaCimAdapter adapter,
    ...
    private void addUsers(
            org.sblim.wbemsmt.jsf.samba.container.user.UserListItemDataContainer_AsUsers_InUserListDataContainerImpl child) {
    ...
    public java.util.List getUsersForUI() {
        ...
        while (result.size() < MIN_TABLE_LENGTH) {
            try {
                org.sblim.wbemsmt.jsf.samba.container.user.UserListItemDataContainer_AsUsers_InUserListDataContainerImpl item = new org.sblim.wbemsmt.jsf.samba.container.user.UserListItemDataContainer_AsUsers_InUserListDataContainerImpl(
    ...
    private String[] getUsersFieldNames() {
        return new String[] { "_SambaUserName", "_SystemUserName", "_usr_IsGuest", };
    }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getUsersHeader_SystemUserName() {
        if (icUsersHeader_SystemUserName == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = true;
            icUsersHeader_SystemUserName = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(
                    parent, label, binding, converter, readOnly);
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent) icUsersHeader_SystemUserName)
                    .setOrientation(org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT);
        }
        ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent) icUsersHeader_SystemUserName)
                .setHeader(true);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getUsersHeader_usr_IsGuest() {
        if (icUsersHeader_usr_IsGuest == null) {
            ...
            icUsersHeader_usr_IsGuest = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFCheckboxComponent(
                    parent, label, binding, converter, readOnly);
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFCheckboxComponent) icUsersHeader_usr_IsGuest)
                    .setOrientation(org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT);
        }
        ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFCheckboxComponent) icUsersHeader_usr_IsGuest)
                .setHeader(true);
    ...
    public void countAndCreateChildren() throws WbemsmtException {
        ...
        try {
            int count = adapter
                    .count(
                            "users",
                            org.sblim.wbemsmt.samba.bl.container.user.UserListItemDataContainer.class,
                            this);
            if (count != usersCount) {
                usersCount = count;
                clearUsers();
                for (int i = 0; i < count; i++) {
                    addUsers(new org.sblim.wbemsmt.jsf.samba.container.user.UserListItemDataContainer_AsUsers_InUserListDataContainerImpl(
                            (org.sblim.wbemsmt.samba.bl.adapter.SambaCimAdapter) adapter,
                            bindingPrefix, i));
                }
            }
