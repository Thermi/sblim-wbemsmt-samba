...
public class Linux_SambaShareBrowseOptionsHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaShareBrowseOptions.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaShareBrowseOptions.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaShareBrowseOptionsHelper
                            .findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaShareBrowseOptions.");
                        resultArrayList.add(new Linux_SambaShareBrowseOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaShareBrowseOptions.");
                        resultArrayList.add(new Linux_SambaShareBrowseOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaShareBrowseOptions.");
                        resultArrayList.add(new Linux_SambaShareBrowseOptions(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaShareBrowseOptions getInstance(WBEMClient client,
    ...
    public final static Linux_SambaShareBrowseOptions getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(Linux_SambaShareBrowseOptions.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                Linux_SambaShareBrowseOptions.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(Linux_SambaShareBrowseOptions.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                Linux_SambaShareBrowseOptions.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_SambaShareBrowseOptions createInstance(WBEMClient client,
            Linux_SambaShareBrowseOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaShareBrowseOptions newDataInstance = Linux_SambaShareBrowseOptionsHelper
     ...
     */
    public final static Linux_SambaShareBrowseOptions modifyInstance(WBEMClient client,
            Linux_SambaShareBrowseOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaShareBrowseOptions dataInstance2 = Linux_SambaShareBrowseOptionsHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaShareBrowseOptions dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaShareBrowseOptions.getPackages());
    }
