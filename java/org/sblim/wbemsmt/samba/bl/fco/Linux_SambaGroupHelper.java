...
public final class Linux_SambaGroupHelper {
	...
	*/	
	public final static Linux_SambaGroup getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_SambaGroupHelper.getInstance(cimClient, new Linux_SambaGroup(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaGroup getInstance(CIMClient cimClient, Linux_SambaGroup dataInstance) {
		...
		return Linux_SambaGroupHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaGroup getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			dataInstance = new Linux_SambaGroup(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaGroup createInstance(CIMClient cimClient, Linux_SambaGroup dataInstance, boolean notifyDifferencies){ 
		...
		Linux_SambaGroup newDataInstance = null;
		try {
			newDataInstance = Linux_SambaGroupHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaGroup modifyInstance(CIMClient cimClient, Linux_SambaGroup dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_SambaGroupHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_SambaGroup dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_SambaGroup dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_SambaGroup.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_SambaGroup.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_SambaGroup.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_SambaGroup.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_SambaGroup.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_SambaGroupName(String SambaGroupName) {
		return true;
	}

	public static boolean isValid_SystemGroupName(String SystemGroupName) {
		return true;
	}
