...
public class Linux_SambaInvalidUsersForShare extends CIM_Component {
    ...
    public Linux_SambaInvalidUsersForShare(WBEMClient client, String namespace)
    ...
    public Linux_SambaInvalidUsersForShare(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaInvalidUsersForShare() {
    }
    ...
    public static CIMProperty create_PartComponent_Linux_SambaUser(WBEMClient client,
        ...
        Linux_SambaInvalidUsersForShare fco = new Linux_SambaInvalidUsersForShare(client, namespace);
    ...
    public boolean set_GroupComponent_Linux_SambaShareOptions(Linux_SambaShareOptions newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_GROUPCOMPONENT_LINUX_SAMBASHAREOPTIONS.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_GroupComponent_Linux_SambaShareOptions(
    ...
    public String getObjectName() {
        return Linux_SambaInvalidUsersForShare.CIM_CLASS_NAME;
    }
