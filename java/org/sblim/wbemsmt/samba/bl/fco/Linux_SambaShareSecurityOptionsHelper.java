...
public class Linux_SambaShareSecurityOptionsHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaShareSecurityOptions.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaShareSecurityOptions.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaShareSecurityOptionsHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaShareSecurityOptions.");
                        resultArrayList.add(new Linux_SambaShareSecurityOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaShareSecurityOptions.");
                        resultArrayList.add(new Linux_SambaShareSecurityOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaShareSecurityOptions.");
                        resultArrayList.add(new Linux_SambaShareSecurityOptions(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaShareSecurityOptions getInstance(WBEMClient client,
    ...
    public final static Linux_SambaShareSecurityOptions getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaShareSecurityOptions.PROPERTY_INSTANCEID.NAME, CIMDataType.STRING_T,
                setThis, true, false, Linux_SambaShareSecurityOptions.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(Linux_SambaShareSecurityOptions.PROPERTY_NAME.NAME,
     ...
     *
     */
    public final static Linux_SambaShareSecurityOptions createInstance(WBEMClient client,
            Linux_SambaShareSecurityOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaShareSecurityOptions newDataInstance = Linux_SambaShareSecurityOptionsHelper
     ...
     */
    public final static Linux_SambaShareSecurityOptions modifyInstance(WBEMClient client,
            Linux_SambaShareSecurityOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaShareSecurityOptions dataInstance2 = Linux_SambaShareSecurityOptionsHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaShareSecurityOptions dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaShareSecurityOptions.getPackages());
    }
