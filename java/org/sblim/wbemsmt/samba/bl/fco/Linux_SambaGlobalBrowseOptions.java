...
public class Linux_SambaGlobalBrowseOptions extends Linux_SambaBrowseOptions {
    ...
    public static class PROPERTY_DOMAINMASTER {
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_0_FOR_VALUE_ENTRY_No = new javax.cim.UnsignedInteger16(
                "0");

        /**
         * constant for value entry No (corresponds to mapEntry 0 )
         */
        public final static String VALUE_ENTRY_No = "No";

        /**
         * constant for value map entry 1
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_1_FOR_VALUE_ENTRY_Yes = new javax.cim.UnsignedInteger16(
                "1");

        /**
         * constant for value entry Yes (corresponds to mapEntry 1 )
         */
        public final static String VALUE_ENTRY_Yes = "Yes";

        /**
         * constant for value map entry 2
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_2_FOR_VALUE_ENTRY_Auto = new javax.cim.UnsignedInteger16(
                "2");

        /**
         * constant for value entry Auto (corresponds to mapEntry 2 )
         */
         ...
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@1d87b85
        public static javax.cim.UnsignedInteger16 getValueMapEntry(String value) {

            if (VALUE_ENTRY_No.equals(value)) {
                return VALUE_MAP_ENTRY_0_FOR_VALUE_ENTRY_No;
            }

            if (VALUE_ENTRY_Yes.equals(value)) {
                return VALUE_MAP_ENTRY_1_FOR_VALUE_ENTRY_Yes;
            }

            if (VALUE_ENTRY_Auto.equals(value)) {
                return VALUE_MAP_ENTRY_2_FOR_VALUE_ENTRY_Auto;
            }
            return null;
        ...
        public static String getValueEntry(javax.cim.UnsignedInteger16 value) {
            ...
            if (iValue == VALUE_MAP_ENTRY_0_FOR_VALUE_ENTRY_No.intValue()) {
                return VALUE_ENTRY_No;
            }

            if (iValue == VALUE_MAP_ENTRY_1_FOR_VALUE_ENTRY_Yes.intValue()) {
                return VALUE_ENTRY_Yes;
            }

            if (iValue == VALUE_MAP_ENTRY_2_FOR_VALUE_ENTRY_Auto.intValue()) {
        ...
        public final static javax.cim.UnsignedInteger16[] VALUE_MAP_ENTRIES = {
                VALUE_MAP_ENTRY_0_FOR_VALUE_ENTRY_No, VALUE_MAP_ENTRY_1_FOR_VALUE_ENTRY_Yes,
                VALUE_MAP_ENTRY_2_FOR_VALUE_ENTRY_Auto };
         ...
         * Value Map for the property DomainMaster   
         */
        public final static String[] VALUE_ENTRIES = { VALUE_ENTRY_No, VALUE_ENTRY_Yes,
                VALUE_ENTRY_Auto };
         ...
         * Value Map for the property DomainMaster   
         */
        public final static String[] VALUE_ENTRIES_FOR_DISPLAY = { VALUE_ENTRY_No, VALUE_ENTRY_Yes,
                VALUE_ENTRY_Auto };
    ...
    public Linux_SambaGlobalBrowseOptions(WBEMClient client, String namespace)
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        propertiesToCheck.put("DomainMaster", new CIMProperty("DomainMaster", CIMDataType.UINT16_T,
                null));
    ...
    public javax.cim.UnsignedInteger16 get_DomainMaster() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_DOMAINMASTER.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_DomainMaster(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_DomainMaster(CIMProperty currentProperty,
    ...
    public java.util.List getAssociated_Linux_SambaGlobalOptions_Linux_SambaGlobalBrowseForGlobals(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_Linux_SambaGlobalOptions_Linux_SambaGlobalBrowseForGlobals(cimClient,
    ...
    public java.util.List getAssociated_Linux_SambaGlobalOptions_Linux_SambaGlobalBrowseForGlobals(
        ...
        return getAssociated_Linux_SambaGlobalOptions_Linux_SambaGlobalBrowseForGlobals(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_LINUX_SAMBAGLOBALBROWSEFORGLOBAL, resultClass, role,
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaGlobalBrowseOptionsHelper.findClass(cimClient,
                            cimInstance);
    ...
    public java.util.List getAssociated_Linux_SambaGlobalOptions_Linux_SambaGlobalBrowseForGlobalNames(
            WBEMClient cimClient) throws WbemsmtException {
