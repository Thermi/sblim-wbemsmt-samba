/** 
  * Linux_SambaPrinterBrowseForPrinterHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_SambaPrinterBrowseForPrinter
  *    
  * 
  * generated Class
  * @see Linux_SambaPrinterBrowseForPrinter
  */
...
public class Linux_SambaPrinterBrowseForPrinterHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_SambaPrinterBrowseForPrinter or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaPrinterBrowseForPrinter.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaPrinterBrowseForPrinter.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_SambaPrinterBrowseForPrinter or the subclasses if deep == true
    */        
    public final static List<Linux_SambaPrinterBrowseForPrinter> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaPrinterBrowseForPrinter> resultArrayList = new ArrayList<Linux_SambaPrinterBrowseForPrinter>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaPrinterBrowseForPrinter.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaPrinterBrowseForPrinter(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_SambaPrinterBrowseForPrinterHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_SambaPrinterBrowseForPrinter.");
                        resultArrayList.add(new Linux_SambaPrinterBrowseForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_SambaPrinterBrowseForPrinter.");
                        resultArrayList.add(new Linux_SambaPrinterBrowseForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaPrinterBrowseForPrinter)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaPrinterBrowseForPrinter.");
                        resultArrayList.add(new Linux_SambaPrinterBrowseForPrinter(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaPrinterBrowseForPrinter getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaPrinterBrowseForPrinter getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_SambaPrinterBrowseForPrinter dataInstance = null;
        Class<?> clazz = Linux_SambaPrinterBrowseForPrinterHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_SambaPrinterBrowseForPrinter)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaPrinterBrowseForPrinter.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_SambaPrinterBrowseForPrinter(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_SambaPrinterBrowseForPrinter getInstance(WBEMClient client, String namespace
                                                       ,Linux_SambaPrinterOptions ManagedElement
                                                       ,Linux_SambaPrinterBrowseOptions SettingData
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaPrinterBrowseForPrinter.PROPERTY_MANAGEDELEMENT_LINUX_SAMBAPRINTEROPTIONS.NAME,new CIMDataType(Linux_SambaPrinterOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaPrinterBrowseForPrinter.CIM_CLASS_NAME); 
                   
                                 setThis = SettingData != null ? SettingData.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_SambaPrinterBrowseForPrinter.PROPERTY_SETTINGDATA_LINUX_SAMBAPRINTERBROWSEOPTIONS.NAME,new CIMDataType(Linux_SambaPrinterBrowseOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaPrinterBrowseForPrinter.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaPrinterBrowseForPrinter.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_SambaPrinterBrowseForPrinter createInstance(WBEMClient client, Linux_SambaPrinterBrowseForPrinter dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_SambaPrinterBrowseForPrinter newDataInstance = Linux_SambaPrinterBrowseForPrinterHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_SambaPrinterBrowseForPrinter modifyInstance(WBEMClient client, Linux_SambaPrinterBrowseForPrinter dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_SambaPrinterBrowseForPrinter dataInstance2 = Linux_SambaPrinterBrowseForPrinterHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaPrinterBrowseForPrinter dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaPrinterBrowseForPrinter.getPackages());
    }
