...
public class ServiceDenyHostDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.samba.bl.container.service.ServiceDenyHostDataContainer {
    ...
    public ServiceDenyHostDataContainerImpl(
    ...
    public void reload() {
        ...
        if (ic_usr_DeniedHosts != null) {
            ic_usr_DeniedHosts.setLabelText(bundle
                    .getString("ServiceDenyHostDataContainer.deniedHosts"));
        }
        if (ic_usr_HostsToDeny != null) {
            ic_usr_HostsToDeny.setLabelText(bundle
                    .getString("ServiceDenyHostDataContainer.hostsToDeny"));
        }
        if (ic_usr_AddHost != null) {
        ...
        if (ic_usr_RemoveHost != null) {
            ic_usr_RemoveHost.setLabelText(bundle
                    .getString("ServiceDenyHostDataContainer.removeHost"));
        }
    }
