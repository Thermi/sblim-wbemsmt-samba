...
public class UserInShareWizardACLItemDataContainer_AsUsers_InShareWizardPage2Impl extends
    ...
    public UserInShareWizardACLItemDataContainer_AsUsers_InShareWizardPage2Impl(
    ...
    public void reload() {
        ...
        if (ic_SambaUserName != null) {
            ic_SambaUserName.setLabelText(bundle
                    .getString("UserInShareWizardACLItemDataContainer.SambaUserName"));
        }
        if (ic_usr_AccessTypeVI != null) {
            ic_usr_AccessTypeVI.setLabelText(bundle
                    .getString("UserInShareWizardACLItemDataContainer.accessTypeVI"));
        }
        if (ic_usr_AccessTypeRW != null) {
            ic_usr_AccessTypeRW.setLabelText(bundle
                    .getString("UserInShareWizardACLItemDataContainer.accessTypeRW"));
        }
        if (ic_usr_Admin != null) {
            ic_usr_Admin.setLabelText(bundle
                    .getString("UserInShareWizardACLItemDataContainer.admin"));
        }
    }
