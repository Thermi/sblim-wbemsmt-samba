 /** 
  * EditSambaShareAclInUserLoader.java
  *
  ...
  * Contributors: 
  * 
  * Description: class for loading the objects if user lists the share-related acl of a user
  * 
  */
...
public class ListSambaShareAclOfUserLoader extends SambaLoader implements CliDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
		...
		String serviceName = CliUtil.getOption(commandValues,ListSambaShareAclOfUser.KEY_GLOBAL_serviceName);
		String username = CliUtil.getOption(commandValues,ListSambaShareAclOfUser.KEY_sambaUsername);
