...
public class PrinterACLItemDataContainerImpl extends BaseDataContainer implements
    ...
    public PrinterACLItemDataContainerImpl(AbstractBaseCimAdapter adapter) throws WbemsmtException {
        super();
        setAdapter(adapter);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_PrinterName() {
        if (ic_PrinterName == null) {
            String label = getAdapter().getBundle().getString(
                    "PrinterACLItemDataContainer.PrinterName");
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            ic_PrinterName = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(this,
                    label, "", converter);
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_AccessTypeVI() {
        if (ic_usr_AccessTypeVI == null) {
            String label = getAdapter().getBundle().getString(
                    "PrinterACLItemDataContainer.accessTypeVI");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_AccessTypeRW() {
        if (ic_usr_AccessTypeRW == null) {
            String label = getAdapter().getBundle().getString(
                    "PrinterACLItemDataContainer.accessTypeRW");
            org.sblim.wbemsmt.tools.converter.StringArrayConverter converter = new org.sblim.wbemsmt.tools.converter.UnsignedInt16StringArrayConverter();
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "PrinterACLItemDataContainer.caption"));
        }
        ...
        if (showInstance(listOptions)) {
            if (get_PrinterName().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_PrinterName())
                        .getValue();
