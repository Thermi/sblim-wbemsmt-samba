...
public final class Linux_SambaAllowHostsForPrinterHelper {

	public final static String CIM_CLASS_NAME = "Linux_SambaAllowHostsForPrinter";
	...
	*/	
	public final static Linux_SambaAllowHostsForPrinter getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_SambaAllowHostsForPrinterHelper.getInstance(cimClient, new Linux_SambaAllowHostsForPrinter(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaAllowHostsForPrinter getInstance(CIMClient cimClient, Linux_SambaAllowHostsForPrinter dataInstance) {
		...
		return Linux_SambaAllowHostsForPrinterHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaAllowHostsForPrinter getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			...
			{
				dataInstance = new Linux_SambaAllowHostsForPrinter(cimObjectPath, cimInstance);
			}
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaAllowHostsForPrinter createInstance(CIMClient cimClient, Linux_SambaAllowHostsForPrinter dataInstance, boolean notifyDifferencies){ 
		...
		Linux_SambaAllowHostsForPrinter newDataInstance = null;
		try {
			newDataInstance = Linux_SambaAllowHostsForPrinterHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaAllowHostsForPrinter modifyInstance(CIMClient cimClient, Linux_SambaAllowHostsForPrinter dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_SambaAllowHostsForPrinterHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_SambaAllowHostsForPrinter dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_SambaAllowHostsForPrinter dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_SambaAllowHostsForPrinter.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_SambaAllowHostsForPrinter.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_SambaAllowHostsForPrinter.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_SambaAllowHostsForPrinter.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_SambaAllowHostsForPrinter.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
