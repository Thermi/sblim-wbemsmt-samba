...
public class Linux_SambaShareProtocolOptionsHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaShareProtocolOptions.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaShareProtocolOptions.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaShareProtocolOptionsHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaShareProtocolOptions.");
                        resultArrayList.add(new Linux_SambaShareProtocolOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaShareProtocolOptions.");
                        resultArrayList.add(new Linux_SambaShareProtocolOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaShareProtocolOptions.");
                        resultArrayList.add(new Linux_SambaShareProtocolOptions(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaShareProtocolOptions getInstance(WBEMClient client,
    ...
    public final static Linux_SambaShareProtocolOptions getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaShareProtocolOptions.PROPERTY_INSTANCEID.NAME, CIMDataType.STRING_T,
                setThis, true, false, Linux_SambaShareProtocolOptions.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(Linux_SambaShareProtocolOptions.PROPERTY_NAME.NAME,
     ...
     *
     */
    public final static Linux_SambaShareProtocolOptions createInstance(WBEMClient client,
            Linux_SambaShareProtocolOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaShareProtocolOptions newDataInstance = Linux_SambaShareProtocolOptionsHelper
     ...
     */
    public final static Linux_SambaShareProtocolOptions modifyInstance(WBEMClient client,
            Linux_SambaShareProtocolOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaShareProtocolOptions dataInstance2 = Linux_SambaShareProtocolOptionsHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaShareProtocolOptions dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaShareProtocolOptions.getPackages());
    }
