...
public class Linux_SambaCommonSecurityForShareHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaCommonSecurityForShare.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaCommonSecurityForShare.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaCommonSecurityForShareHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaCommonSecurityForShare.");
                        resultArrayList.add(new Linux_SambaCommonSecurityForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaCommonSecurityForShare.");
                        resultArrayList.add(new Linux_SambaCommonSecurityForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaCommonSecurityForShare.");
                        resultArrayList.add(new Linux_SambaCommonSecurityForShare(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaCommonSecurityForShare getInstance(WBEMClient client,
    ...
    public final static Linux_SambaCommonSecurityForShare getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaCommonSecurityForShare.PROPERTY_SETTINGDATA_LINUX_SAMBACOMMONSECURITYOPTIONS.NAME,
                new CIMDataType(Linux_SambaCommonSecurityOptions.CIM_CLASS_NAME), setThis, false,
                false, Linux_SambaCommonSecurityForShare.CIM_CLASS_NAME);

        setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                Linux_SambaCommonSecurityForShare.PROPERTY_MANAGEDELEMENT_LINUX_SAMBASHAREOPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaCommonSecurityForShare createInstance(WBEMClient client,
            Linux_SambaCommonSecurityForShare dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaCommonSecurityForShare newDataInstance = Linux_SambaCommonSecurityForShareHelper
     ...
     */
    public final static Linux_SambaCommonSecurityForShare modifyInstance(WBEMClient client,
            Linux_SambaCommonSecurityForShare dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaCommonSecurityForShare dataInstance2 = Linux_SambaCommonSecurityForShareHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaCommonSecurityForShare dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaCommonSecurityForShare.getPackages());
    }
