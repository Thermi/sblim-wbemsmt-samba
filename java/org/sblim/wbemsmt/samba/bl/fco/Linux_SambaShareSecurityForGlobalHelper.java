...
public class Linux_SambaShareSecurityForGlobalHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaShareSecurityForGlobal.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaShareSecurityForGlobal.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaShareSecurityForGlobalHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaShareSecurityForGlobal.");
                        resultArrayList.add(new Linux_SambaShareSecurityForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaShareSecurityForGlobal.");
                        resultArrayList.add(new Linux_SambaShareSecurityForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaShareSecurityForGlobal.");
                        resultArrayList.add(new Linux_SambaShareSecurityForGlobal(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaShareSecurityForGlobal getInstance(WBEMClient client,
    ...
    public final static Linux_SambaShareSecurityForGlobal getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaShareSecurityForGlobal.PROPERTY_SETTINGDATA_LINUX_SAMBASHARESECURITYOPTIONS.NAME,
                new CIMDataType(Linux_SambaShareSecurityOptions.CIM_CLASS_NAME), setThis, false,
                false, Linux_SambaShareSecurityForGlobal.CIM_CLASS_NAME);

        setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                Linux_SambaShareSecurityForGlobal.PROPERTY_MANAGEDELEMENT_LINUX_SAMBAGLOBALOPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaShareSecurityForGlobal createInstance(WBEMClient client,
            Linux_SambaShareSecurityForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaShareSecurityForGlobal newDataInstance = Linux_SambaShareSecurityForGlobalHelper
     ...
     */
    public final static Linux_SambaShareSecurityForGlobal modifyInstance(WBEMClient client,
            Linux_SambaShareSecurityForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaShareSecurityForGlobal dataInstance2 = Linux_SambaShareSecurityForGlobalHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaShareSecurityForGlobal dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaShareSecurityForGlobal.getPackages());
    }
