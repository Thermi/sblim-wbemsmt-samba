...
public class PrinterInUserACLDataContainerImpl extends BaseDataContainer implements
        org.sblim.wbemsmt.samba.bl.container.user.PrinterInUserACLDataContainer,
    ...
    public PrinterInUserACLDataContainerImpl(AbstractBaseCimAdapter adapter)
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "PrinterInUserACLDataContainer.caption"));
        }
    ...
    public void traceChilds(java.io.PrintWriter printStream, String listOptions, boolean title) {
        ...
        printStream.println();
        printStream.println(getAdapter().getBundle().getString(
                "PrinterInUserACLDataContainer.role.printers")
                + " "
