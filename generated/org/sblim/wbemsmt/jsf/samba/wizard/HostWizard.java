...
public class HostWizard extends JSFWizardBase implements IPageWizardAdapter {
    ...
    org.sblim.wbemsmt.jsf.samba.container.wizard.HostWizardPage1Impl panel1 = null;
    org.sblim.wbemsmt.jsf.samba.container.wizard.HostWizardPage2Impl panel2 = null;
    ...
    public HostWizard(final org.sblim.wbemsmt.samba.bl.adapter.SambaCimAdapter adapter) {
        super(adapter, ResourceBundleManager.getResourceBundle(new String[] { "messages",
                ...
                .getCurrentLocale()), "HostWizard.title");
        ...
        this.container = new org.sblim.wbemsmt.samba.wizard.HostWizardContainer(adapter,
                new org.sblim.wbemsmt.samba.wizard.HostWizardContainerPanels() {
                    ...
                    public DataContainer getPage1() throws WbemsmtException {
                        ...
                        try {
                            panel1 = new org.sblim.wbemsmt.jsf.samba.container.wizard.HostWizardPage1Impl(
                                    adapter, binding);
                            ...
                            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
                                    "Cannot process Wizard hostWizard", e);
                        }
                    }
                    ...
                    public DataContainer getPage2() throws WbemsmtException {
                        ...
                        try {
                            panel2 = new org.sblim.wbemsmt.jsf.samba.container.wizard.HostWizardPage2Impl(
                                    adapter, binding);
    ...
    public void countAndCreateChilds(DataContainer dataContainer) throws WbemsmtException {
        ...
        if (dataContainer instanceof org.sblim.wbemsmt.jsf.samba.container.wizard.HostWizardPage2Impl) {
            //update the child objects
            try {
    ...
    public String getJavaScriptWaitStatement() {
        String text = bundle.getString("HostWizard.createWaitText", bundle
