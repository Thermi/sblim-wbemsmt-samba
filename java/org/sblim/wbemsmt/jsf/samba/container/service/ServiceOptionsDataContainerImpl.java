...
public class ServiceOptionsDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.samba.bl.container.service.ServiceOptionsDataContainer {
    ...
    public ServiceOptionsDataContainerImpl(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_BindInterfacesOnly() {
        if (ic_BindInterfacesOnly == null) {
            ...
            ic_BindInterfacesOnly = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFCheckboxComponent(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_Interfaces() {
        if (ic_Interfaces == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_Interfaces = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_NetbiosAlias() {
        if (ic_NetbiosAlias == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_NetbiosAlias = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_NetbiosName() {
        if (ic_NetbiosName == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_NetbiosName = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_ServerString() {
        if (ic_ServerString == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_ServerString = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_Workgroup() {
        if (ic_Workgroup == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_Workgroup = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_ConfigurationFile() {
        if (ic_ConfigurationFile == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_ConfigurationFile = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public void reload() {
        super.reload();
        if (ic_BindInterfacesOnly != null) {
            ic_BindInterfacesOnly.setLabelText(bundle
                    .getString("ServiceOptionsDataContainer.BindInterfacesOnly"));
        }
        if (ic_Interfaces != null) {
            ic_Interfaces.setLabelText(bundle.getString("ServiceOptionsDataContainer.Interfaces"));
        }
        if (ic_NetbiosAlias != null) {
            ic_NetbiosAlias.setLabelText(bundle
                    .getString("ServiceOptionsDataContainer.NetbiosAlias"));
        }
        if (ic_NetbiosName != null) {
            ic_NetbiosName
                    .setLabelText(bundle.getString("ServiceOptionsDataContainer.NetbiosName"));
        }
        if (ic_ServerString != null) {
            ic_ServerString.setLabelText(bundle
                    .getString("ServiceOptionsDataContainer.ServerString"));
        }
        if (ic_Workgroup != null) {
            ic_Workgroup.setLabelText(bundle.getString("ServiceOptionsDataContainer.Workgroup"));
        }
        if (ic_ConfigurationFile != null) {
            ic_ConfigurationFile.setLabelText(bundle
                    .getString("ServiceOptionsDataContainer.ConfigurationFile"));
        }
    }
