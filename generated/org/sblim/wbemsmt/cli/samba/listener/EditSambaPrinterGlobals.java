/**
 * EditSambaPrinterGlobals.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class EditSambaPrinterGlobals extends CimCommand {
     ...
     *  --printcapCacheTime
     */
    public static final OptionDefinition KEY_printcapCacheTime = new OptionDefinition(null,
            "printcapCacheTime", null, "PrintingGlobalsDataContainer.PrintcapCacheTime.argValue",
            false, false, "PrintingGlobalsDataContainer.PrintcapCacheTime.argDescription");
    /**
     *  --systemPrinterName
     */
    public static final OptionDefinition KEY_systemPrinterName = new OptionDefinition(null,
            "systemPrinterName", null, "PrintingGlobalsDataContainer.SystemPrinterName.argValue",
            false, false, "PrintingGlobalsDataContainer.SystemPrinterName.argDescription");
    /**
     *  --cupsOptions
     */
    public static final OptionDefinition KEY_cupsOptions = new OptionDefinition(null,
            "cupsOptions", null, "PrintingGlobalsDataContainer.CupsOptions.argValue", false, false,
            "PrintingGlobalsDataContainer.CupsOptions.argDescription");
    /**
     *  --defaultDevMode
     */
    public static final OptionDefinition KEY_defaultDevMode = new OptionDefinition(null,
            "defaultDevMode", null, "PrintingGlobalsDataContainer.DefaultDevMode.argValue", false,
            false, "PrintingGlobalsDataContainer.DefaultDevMode.argDescription");
    /**
     *  --maxPrintjobs
     */
    public static final OptionDefinition KEY_maxPrintjobs = new OptionDefinition(null,
            "maxPrintjobs", null, "PrintingGlobalsDataContainer.MaxPrintjobs.argValue", false,
            false, "PrintingGlobalsDataContainer.MaxPrintjobs.argDescription");
    /**
    ...
    public static final OptionDefinition KEY_maxReportedPrintjobs = new OptionDefinition(null,
            ...
            "PrintingGlobalsDataContainer.MaxReportedPrintjobs.argValue", false, false,
            "PrintingGlobalsDataContainer.MaxReportedPrintjobs.argDescription");
    /**
     *  --printCommand
     */
    public static final OptionDefinition KEY_printCommand = new OptionDefinition(null,
            "printCommand", null, "PrintingGlobalsDataContainer.PrintCommand.argValue", false,
            false, "PrintingGlobalsDataContainer.PrintCommand.argDescription");
    /**
     *  --useClientDriver
     */
    public static final OptionDefinition KEY_useClientDriver = new OptionDefinition(null,
            "useClientDriver", null, "PrintingGlobalsDataContainer.UseClientDriver.argValue",
            false, false, "PrintingGlobalsDataContainer.UseClientDriver.argDescription");
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] {
            KEY_printcapCacheTime, KEY_systemPrinterName, KEY_cupsOptions, KEY_defaultDevMode,
            KEY_maxPrintjobs, KEY_maxReportedPrintjobs, KEY_printCommand, KEY_useClientDriver, };
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("PrintingGlobalsDataContainer.caption") }));

            CliDataLoader loader = new EditSambaPrinterGlobalsLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.cli.samba.container.global.PrintingGlobalsDataContainerImpl dc = new org.sblim.wbemsmt.cli.samba.container.global.PrintingGlobalsDataContainerImpl(
                    adapter);
            int count = 0;
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.samba.bl.container.global.PrintingGlobalsDataContainer dc)
