...
public final class Linux_SambaPrinterBrowseOptionsHelper {
	...
	*/	
	public final static Linux_SambaPrinterBrowseOptions getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_SambaPrinterBrowseOptionsHelper.getInstance(cimClient, new Linux_SambaPrinterBrowseOptions(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaPrinterBrowseOptions getInstance(CIMClient cimClient, Linux_SambaPrinterBrowseOptions dataInstance) {
		...
		return Linux_SambaPrinterBrowseOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaPrinterBrowseOptions getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			dataInstance = new Linux_SambaPrinterBrowseOptions(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaPrinterBrowseOptions createInstance(CIMClient cimClient, Linux_SambaPrinterBrowseOptions dataInstance, boolean notifyDifferencies){ 
		...
		Linux_SambaPrinterBrowseOptions newDataInstance = null;
		try {
			newDataInstance = Linux_SambaPrinterBrowseOptionsHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaPrinterBrowseOptions modifyInstance(CIMClient cimClient, Linux_SambaPrinterBrowseOptions dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_SambaPrinterBrowseOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_SambaPrinterBrowseOptions dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_SambaPrinterBrowseOptions dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_SambaPrinterBrowseOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_SambaPrinterBrowseOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_SambaPrinterBrowseOptions.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_SambaPrinterBrowseOptions.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_SambaPrinterBrowseOptions.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
