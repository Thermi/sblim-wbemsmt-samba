/**
 * Linux_SambaReadListForPrinter.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class Linux_SambaReadListForPrinter extends CIM_Component {
    ...
    public Linux_SambaReadListForPrinter(WBEMClient client, String namespace)
    ...
    public Linux_SambaReadListForPrinter(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaReadListForPrinter() {
    }
    ...
    public static CIMProperty create_PartComponent_Linux_SambaUser(WBEMClient client,
        ...
        Linux_SambaReadListForPrinter fco = new Linux_SambaReadListForPrinter(client, namespace);
    ...
    public String getObjectName() {
        return Linux_SambaReadListForPrinter.CIM_CLASS_NAME;
    }
