/**
 * Linux_SambaDenyHostsForGlobal.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class Linux_SambaDenyHostsForGlobal extends CIM_Component {
    ...
    public Linux_SambaDenyHostsForGlobal(WBEMClient client, String namespace)
    ...
    public Linux_SambaDenyHostsForGlobal(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaDenyHostsForGlobal() {
    }
    ...
    public static CIMProperty create_PartComponent_Linux_SambaHost(WBEMClient client,
        ...
        Linux_SambaDenyHostsForGlobal fco = new Linux_SambaDenyHostsForGlobal(client, namespace);
    ...
    public String getObjectName() {
        return Linux_SambaDenyHostsForGlobal.CIM_CLASS_NAME;
    }
