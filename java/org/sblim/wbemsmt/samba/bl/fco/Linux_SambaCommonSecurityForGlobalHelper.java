...
public final class Linux_SambaCommonSecurityForGlobalHelper {

	public final static String CIM_CLASS_NAME = "Linux_SambaCommonSecurityForGlobal";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new Linux_SambaCommonSecurityForGlobal(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<Linux_SambaCommonSecurityForGlobal.Java_Package_List.size(); i++) {
						if (!((String)(Linux_SambaCommonSecurityForGlobal.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(Linux_SambaCommonSecurityForGlobal.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							Linux_SambaCommonSecurityForGlobal.Java_Package_List.setElementAt((String)(Linux_SambaCommonSecurityForGlobal.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (Linux_SambaCommonSecurityForGlobal.Java_Package_List.get(i)) + cimClassName;
	...
	*/	
	public final static Linux_SambaCommonSecurityForGlobal getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_SambaCommonSecurityForGlobalHelper.getInstance(cimClient, new Linux_SambaCommonSecurityForGlobal(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaCommonSecurityForGlobal getInstance(CIMClient cimClient, Linux_SambaCommonSecurityForGlobal dataInstance) {
		...
		return Linux_SambaCommonSecurityForGlobalHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaCommonSecurityForGlobal getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			dataInstance = new Linux_SambaCommonSecurityForGlobal(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaCommonSecurityForGlobal createInstance(CIMClient cimClient, Linux_SambaCommonSecurityForGlobal dataInstance, boolean notifyDifferencies){ 
		...
		Linux_SambaCommonSecurityForGlobal newDataInstance = null;
		try {
			newDataInstance = Linux_SambaCommonSecurityForGlobalHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaCommonSecurityForGlobal modifyInstance(CIMClient cimClient, Linux_SambaCommonSecurityForGlobal dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_SambaCommonSecurityForGlobalHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_SambaCommonSecurityForGlobal dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_SambaCommonSecurityForGlobal dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_SambaCommonSecurityForGlobal.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_SambaCommonSecurityForGlobal.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_SambaCommonSecurityForGlobal.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_SambaCommonSecurityForGlobal.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_SambaCommonSecurityForGlobal.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
