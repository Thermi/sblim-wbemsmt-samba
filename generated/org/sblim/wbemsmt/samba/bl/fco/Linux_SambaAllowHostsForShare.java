/**
 * Linux_SambaAllowHostsForShare.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class Linux_SambaAllowHostsForShare extends CIM_Component {
    ...
    public Linux_SambaAllowHostsForShare(WBEMClient client, String namespace)
    ...
    public Linux_SambaAllowHostsForShare(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaAllowHostsForShare() {
    }
    ...
    public static CIMProperty create_PartComponent_Linux_SambaHost(WBEMClient client,
        ...
        Linux_SambaAllowHostsForShare fco = new Linux_SambaAllowHostsForShare(client, namespace);
    ...
    public String getObjectName() {
        return Linux_SambaAllowHostsForShare.CIM_CLASS_NAME;
    }
