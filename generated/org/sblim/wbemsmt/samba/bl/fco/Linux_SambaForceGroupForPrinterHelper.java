/** 
  * Linux_SambaForceGroupForPrinterHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_SambaForceGroupForPrinter
  *    
  * 
  * generated Class
  * @see Linux_SambaForceGroupForPrinter
  */
...
public class Linux_SambaForceGroupForPrinterHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_SambaForceGroupForPrinter or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaForceGroupForPrinter.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaForceGroupForPrinter.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_SambaForceGroupForPrinter or the subclasses if deep == true
    */        
    public final static List<Linux_SambaForceGroupForPrinter> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaForceGroupForPrinter> resultArrayList = new ArrayList<Linux_SambaForceGroupForPrinter>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaForceGroupForPrinter.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaForceGroupForPrinter(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_SambaForceGroupForPrinterHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_SambaForceGroupForPrinter.");
                        resultArrayList.add(new Linux_SambaForceGroupForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_SambaForceGroupForPrinter.");
                        resultArrayList.add(new Linux_SambaForceGroupForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaForceGroupForPrinter)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaForceGroupForPrinter.");
                        resultArrayList.add(new Linux_SambaForceGroupForPrinter(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaForceGroupForPrinter getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaForceGroupForPrinter getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_SambaForceGroupForPrinter dataInstance = null;
        Class<?> clazz = Linux_SambaForceGroupForPrinterHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_SambaForceGroupForPrinter)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaForceGroupForPrinter.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_SambaForceGroupForPrinter(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_SambaForceGroupForPrinter getInstance(WBEMClient client, String namespace
                                                       ,Linux_SambaPrinterOptions GroupComponent
                                                       ,Linux_SambaGroup PartComponent
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaForceGroupForPrinter.PROPERTY_GROUPCOMPONENT_LINUX_SAMBAPRINTEROPTIONS.NAME,new CIMDataType(Linux_SambaPrinterOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaForceGroupForPrinter.CIM_CLASS_NAME); 
                   
                                 setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_SambaForceGroupForPrinter.PROPERTY_PARTCOMPONENT_LINUX_SAMBAGROUP.NAME,new CIMDataType(Linux_SambaGroup.CIM_CLASS_NAME),setThis,false,false,Linux_SambaForceGroupForPrinter.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaForceGroupForPrinter.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_SambaForceGroupForPrinter createInstance(WBEMClient client, Linux_SambaForceGroupForPrinter dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_SambaForceGroupForPrinter newDataInstance = Linux_SambaForceGroupForPrinterHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_SambaForceGroupForPrinter modifyInstance(WBEMClient client, Linux_SambaForceGroupForPrinter dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_SambaForceGroupForPrinter dataInstance2 = Linux_SambaForceGroupForPrinterHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaForceGroupForPrinter dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaForceGroupForPrinter.getPackages());
    }
