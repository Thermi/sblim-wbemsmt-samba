...
public class PrinterInUserWizardACLItemDataContainer_AsPrinters_InUserWizardPage2Impl extends
        org.sblim.wbemsmt.tools.jsf.MultiLineBasePanel2 implements
        org.sblim.wbemsmt.samba.bl.container.wizard.PrinterInUserWizardACLItemDataContainer {
    ...
    public PrinterInUserWizardACLItemDataContainer_AsPrinters_InUserWizardPage2Impl(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_PrinterName() {
        if (ic_PrinterName == null) {
            ...
            ic_PrinterName = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(parent,
                    label, binding, converter, readOnly);
            ;
            ((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent) ic_PrinterName)
    ...
    public LabeledJSFInputComponent[] getComponents() {
        return new LabeledJSFInputComponent[] { (LabeledJSFInputComponent) get_PrinterName(),
    ...
    public void reload() {
        super.reload();
        if (ic_PrinterName != null) {
            ic_PrinterName.setLabelText(bundle
                    .getString("PrinterInUserWizardACLItemDataContainer.PrinterName"));
        }
        if (ic_usr_AccessTypeVI != null) {
            ic_usr_AccessTypeVI.setLabelText(bundle
                    .getString("PrinterInUserWizardACLItemDataContainer.accessTypeVI"));
        }
        if (ic_usr_AccessTypeRW != null) {
            ic_usr_AccessTypeRW.setLabelText(bundle
                    .getString("PrinterInUserWizardACLItemDataContainer.accessTypeRW"));
        }
        if (ic_usr_Admin != null) {
            ic_usr_Admin.setLabelText(bundle
                    .getString("PrinterInUserWizardACLItemDataContainer.admin"));
        }
    }
