/**
 * EditPrinterListenerEditBeanPrinterGeneral.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS
...
public class EditPrinterListenerEditBeanPrinterGeneral extends EditBean {
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        expressionPrefix = "objectActionController.editBeans['printerGeneral'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.jsf.samba.container.printer.PrinterOptionsDataContainerImpl(
        ...
        expressionPrefix = "objectActionController.editBeans['printerGeneral'].containers[1].";

        //create cotainner
        currentEditContainer2 = new org.sblim.wbemsmt.jsf.samba.container.printer.PrintingOptionsDataContainerImpl(
