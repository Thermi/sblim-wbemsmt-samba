...
public final class Linux_SambaShareOptionsHelper {
	...
	*/	
	public final static Linux_SambaShareOptions getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_SambaShareOptionsHelper.getInstance(cimClient, new Linux_SambaShareOptions(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaShareOptions getInstance(CIMClient cimClient, Linux_SambaShareOptions dataInstance) {
		...
		return Linux_SambaShareOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaShareOptions getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			...
			{
				dataInstance = new Linux_SambaShareOptions(cimObjectPath, cimInstance);
			}
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = Linux_SambaShareOptions.getPackages();
	...
	*/	
	public final static Linux_SambaShareOptions createInstance(CIMClient cimClient, Linux_SambaShareOptions dataInstance, boolean notifyDifferencies){ 
		...
		Linux_SambaShareOptions newDataInstance = null;
		try {
			newDataInstance = Linux_SambaShareOptionsHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaShareOptions modifyInstance(CIMClient cimClient, Linux_SambaShareOptions dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_SambaShareOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_SambaShareOptions dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_SambaShareOptions dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_SambaShareOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_SambaShareOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_SambaShareOptions.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_SambaShareOptions.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_SambaShareOptions.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
