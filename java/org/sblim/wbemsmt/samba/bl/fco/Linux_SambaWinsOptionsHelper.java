...
public class Linux_SambaWinsOptionsHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaWinsOptions.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaWinsOptions.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_SambaWinsOptions.");
                        resultArrayList.add(new Linux_SambaWinsOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaWinsOptions.");
                        resultArrayList.add(new Linux_SambaWinsOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaWinsOptions.");
                        resultArrayList.add(new Linux_SambaWinsOptions(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaWinsOptions getInstance(WBEMClient client,
    ...
    public final static Linux_SambaWinsOptions getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(Linux_SambaWinsOptions.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_SambaWinsOptions.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(Linux_SambaWinsOptions.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_SambaWinsOptions.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_SambaWinsOptions createInstance(WBEMClient client,
            Linux_SambaWinsOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaWinsOptions newDataInstance = Linux_SambaWinsOptionsHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static Linux_SambaWinsOptions modifyInstance(WBEMClient client,
            Linux_SambaWinsOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaWinsOptions dataInstance2 = Linux_SambaWinsOptionsHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, Linux_SambaWinsOptions dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaWinsOptions.getPackages());
    }
