...
public class Linux_SambaUsersForServiceHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaUsersForService.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaUsersForService.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_SambaUsersForService.");
                        resultArrayList.add(new Linux_SambaUsersForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaUsersForService.");
                        resultArrayList.add(new Linux_SambaUsersForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaUsersForService.");
                        resultArrayList.add(new Linux_SambaUsersForService(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaUsersForService getInstance(WBEMClient client,
    ...
    public final static Linux_SambaUsersForService getInstance(WBEMClient client, String namespace,
            Linux_SambaUser PartComponent, Linux_SambaService GroupComponent
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaUsersForService.PROPERTY_PARTCOMPONENT_LINUX_SAMBAUSER.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_SambaUsersForService.PROPERTY_GROUPCOMPONENT_LINUX_SAMBASERVICE.NAME,
     ...
     *
     */
    public final static Linux_SambaUsersForService createInstance(WBEMClient client,
            Linux_SambaUsersForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaUsersForService newDataInstance = Linux_SambaUsersForServiceHelper.getInstance(
     ...
     */
    public final static Linux_SambaUsersForService modifyInstance(WBEMClient client,
            Linux_SambaUsersForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaUsersForService dataInstance2 = Linux_SambaUsersForServiceHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaUsersForService dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaUsersForService.getPackages());
    }
