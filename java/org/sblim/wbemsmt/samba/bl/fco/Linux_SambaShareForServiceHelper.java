...
public class Linux_SambaShareForServiceHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaShareForService.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaShareForService.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_SambaShareForService.");
                        resultArrayList.add(new Linux_SambaShareForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaShareForService.");
                        resultArrayList.add(new Linux_SambaShareForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaShareForService.");
                        resultArrayList.add(new Linux_SambaShareForService(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaShareForService getInstance(WBEMClient client,
    ...
    public final static Linux_SambaShareForService getInstance(WBEMClient client, String namespace,
            Linux_SambaShareOptions SettingData, Linux_SambaService ManagedElement
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaShareForService.PROPERTY_SETTINGDATA_LINUX_SAMBASHAREOPTIONS.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_SambaShareForService.PROPERTY_MANAGEDELEMENT_LINUX_SAMBASERVICE.NAME,
     ...
     *
     */
    public final static Linux_SambaShareForService createInstance(WBEMClient client,
            Linux_SambaShareForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaShareForService newDataInstance = Linux_SambaShareForServiceHelper.getInstance(
     ...
     */
    public final static Linux_SambaShareForService modifyInstance(WBEMClient client,
            Linux_SambaShareForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaShareForService dataInstance2 = Linux_SambaShareForServiceHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaShareForService dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaShareForService.getPackages());
    }
