...
public class Linux_SambaWinbindForGlobalHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaWinbindForGlobal.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaWinbindForGlobal.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_SambaWinbindForGlobal.");
                        resultArrayList.add(new Linux_SambaWinbindForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaWinbindForGlobal.");
                        resultArrayList.add(new Linux_SambaWinbindForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaWinbindForGlobal.");
                        resultArrayList.add(new Linux_SambaWinbindForGlobal(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaWinbindForGlobal getInstance(WBEMClient client,
     ...
     */
    public final static Linux_SambaWinbindForGlobal getInstance(WBEMClient client,
            String namespace, Linux_SambaWinbindOptions SettingData,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaWinbindForGlobal.PROPERTY_SETTINGDATA_LINUX_SAMBAWINBINDOPTIONS.NAME,
                new CIMDataType(Linux_SambaWinbindOptions.CIM_CLASS_NAME), setThis, false, false,
                Linux_SambaWinbindForGlobal.CIM_CLASS_NAME);

        setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                Linux_SambaWinbindForGlobal.PROPERTY_MANAGEDELEMENT_LINUX_SAMBAGLOBALOPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaWinbindForGlobal createInstance(WBEMClient client,
            Linux_SambaWinbindForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaWinbindForGlobal newDataInstance = Linux_SambaWinbindForGlobalHelper
     ...
     */
    public final static Linux_SambaWinbindForGlobal modifyInstance(WBEMClient client,
            Linux_SambaWinbindForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaWinbindForGlobal dataInstance2 = Linux_SambaWinbindForGlobalHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaWinbindForGlobal dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaWinbindForGlobal.getPackages());
    }
