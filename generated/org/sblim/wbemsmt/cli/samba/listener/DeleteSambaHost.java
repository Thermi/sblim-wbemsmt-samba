/**
 * DeleteSambaHost.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS OF
...
public class DeleteSambaHost extends CimCommand {
     ...
     */
    public static final OptionDefinition KEY_sambaHostname = new OptionDefinition(null,
            "sambaHostname", null, "DeleteSambaHost.sambaHostname.argValue", true, false,
            "DeleteSambaHost.sambaHostname.argDescription");
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] { KEY_sambaHostname, };
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("deleting", new Object[] { bundle
                                    .getString("HostDataContainer.caption") }));
