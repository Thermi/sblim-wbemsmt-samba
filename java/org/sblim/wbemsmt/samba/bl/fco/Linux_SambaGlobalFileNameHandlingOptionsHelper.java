...
public class Linux_SambaGlobalFileNameHandlingOptionsHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(
                Linux_SambaGlobalFileNameHandlingOptions.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    Linux_SambaGlobalFileNameHandlingOptions.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaGlobalFileNameHandlingOptions(
                                cimInstance));
                        continue;
                    }
                    Class clazz = Linux_SambaGlobalFileNameHandlingOptionsHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaGlobalFileNameHandlingOptions.");
                        resultArrayList.add(new Linux_SambaGlobalFileNameHandlingOptions(
                                cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaGlobalFileNameHandlingOptions.");
                        resultArrayList.add(new Linux_SambaGlobalFileNameHandlingOptions(
                                cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaGlobalFileNameHandlingOptions.");
                        resultArrayList.add(new Linux_SambaGlobalFileNameHandlingOptions(
                                cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaGlobalFileNameHandlingOptions getInstance(WBEMClient client,
    ...
    public final static Linux_SambaGlobalFileNameHandlingOptions getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaGlobalFileNameHandlingOptions.PROPERTY_INSTANCEID.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_SambaGlobalFileNameHandlingOptions.PROPERTY_NAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, Linux_SambaGlobalFileNameHandlingOptions.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_SambaGlobalFileNameHandlingOptions createInstance(WBEMClient client,
            Linux_SambaGlobalFileNameHandlingOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaGlobalFileNameHandlingOptions newDataInstance = Linux_SambaGlobalFileNameHandlingOptionsHelper
     ...
     */
    public final static Linux_SambaGlobalFileNameHandlingOptions modifyInstance(WBEMClient client,
            Linux_SambaGlobalFileNameHandlingOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaGlobalFileNameHandlingOptions dataInstance2 = Linux_SambaGlobalFileNameHandlingOptionsHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaGlobalFileNameHandlingOptions dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaGlobalFileNameHandlingOptions.getPackages());
    }
