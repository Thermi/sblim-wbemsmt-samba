/** 
  * Linux_SambaShareProtocolForShareHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_SambaShareProtocolForShare
  *    
  * 
  * generated Class
  * @see Linux_SambaShareProtocolForShare
  */
...
public class Linux_SambaShareProtocolForShareHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_SambaShareProtocolForShare or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaShareProtocolForShare.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaShareProtocolForShare.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_SambaShareProtocolForShare or the subclasses if deep == true
    */        
    public final static List<Linux_SambaShareProtocolForShare> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaShareProtocolForShare> resultArrayList = new ArrayList<Linux_SambaShareProtocolForShare>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaShareProtocolForShare.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaShareProtocolForShare(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_SambaShareProtocolForShareHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_SambaShareProtocolForShare.");
                        resultArrayList.add(new Linux_SambaShareProtocolForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_SambaShareProtocolForShare.");
                        resultArrayList.add(new Linux_SambaShareProtocolForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaShareProtocolForShare)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaShareProtocolForShare.");
                        resultArrayList.add(new Linux_SambaShareProtocolForShare(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaShareProtocolForShare getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaShareProtocolForShare getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_SambaShareProtocolForShare dataInstance = null;
        Class<?> clazz = Linux_SambaShareProtocolForShareHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_SambaShareProtocolForShare)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaShareProtocolForShare.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_SambaShareProtocolForShare(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_SambaShareProtocolForShare getInstance(WBEMClient client, String namespace
                                                       ,Linux_SambaShareOptions ManagedElement
                                                       ,Linux_SambaShareProtocolOptions SettingData
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaShareProtocolForShare.PROPERTY_MANAGEDELEMENT_LINUX_SAMBASHAREOPTIONS.NAME,new CIMDataType(Linux_SambaShareOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaShareProtocolForShare.CIM_CLASS_NAME); 
                   
                                 setThis = SettingData != null ? SettingData.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_SambaShareProtocolForShare.PROPERTY_SETTINGDATA_LINUX_SAMBASHAREPROTOCOLOPTIONS.NAME,new CIMDataType(Linux_SambaShareProtocolOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaShareProtocolForShare.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaShareProtocolForShare.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_SambaShareProtocolForShare createInstance(WBEMClient client, Linux_SambaShareProtocolForShare dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_SambaShareProtocolForShare newDataInstance = Linux_SambaShareProtocolForShareHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_SambaShareProtocolForShare modifyInstance(WBEMClient client, Linux_SambaShareProtocolForShare dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_SambaShareProtocolForShare dataInstance2 = Linux_SambaShareProtocolForShareHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaShareProtocolForShare dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaShareProtocolForShare.getPackages());
    }
