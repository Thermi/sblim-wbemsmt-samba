...
public class Linux_SambaGlobalSecurityForGlobalHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaGlobalSecurityForGlobal.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaGlobalSecurityForGlobal.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaGlobalSecurityForGlobalHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaGlobalSecurityForGlobal.");
                        resultArrayList.add(new Linux_SambaGlobalSecurityForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaGlobalSecurityForGlobal.");
                        resultArrayList.add(new Linux_SambaGlobalSecurityForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaGlobalSecurityForGlobal.");
                        resultArrayList.add(new Linux_SambaGlobalSecurityForGlobal(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaGlobalSecurityForGlobal getInstance(WBEMClient client,
     ...
     */
    public final static Linux_SambaGlobalSecurityForGlobal getInstance(WBEMClient client,
            String namespace, Linux_SambaGlobalSecurityOptions SettingData,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaGlobalSecurityForGlobal.PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALSECURITYOPTIONS.NAME,
                new CIMDataType(Linux_SambaGlobalSecurityOptions.CIM_CLASS_NAME), setThis, false,
                false, Linux_SambaGlobalSecurityForGlobal.CIM_CLASS_NAME);

        setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                Linux_SambaGlobalSecurityForGlobal.PROPERTY_MANAGEDELEMENT_LINUX_SAMBAGLOBALOPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaGlobalSecurityForGlobal createInstance(WBEMClient client,
            Linux_SambaGlobalSecurityForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaGlobalSecurityForGlobal newDataInstance = Linux_SambaGlobalSecurityForGlobalHelper
     ...
     */
    public final static Linux_SambaGlobalSecurityForGlobal modifyInstance(WBEMClient client,
            Linux_SambaGlobalSecurityForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaGlobalSecurityForGlobal dataInstance2 = Linux_SambaGlobalSecurityForGlobalHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaGlobalSecurityForGlobal dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaGlobalSecurityForGlobal.getPackages());
    }
