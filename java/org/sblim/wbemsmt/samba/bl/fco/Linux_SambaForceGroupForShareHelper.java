...
public class Linux_SambaForceGroupForShareHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaForceGroupForShare.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaForceGroupForShare.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaForceGroupForShareHelper
                            .findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaForceGroupForShare.");
                        resultArrayList.add(new Linux_SambaForceGroupForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaForceGroupForShare.");
                        resultArrayList.add(new Linux_SambaForceGroupForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaForceGroupForShare.");
                        resultArrayList.add(new Linux_SambaForceGroupForShare(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaForceGroupForShare getInstance(WBEMClient client,
     ...
     */
    public final static Linux_SambaForceGroupForShare getInstance(WBEMClient client,
            String namespace, Linux_SambaShareOptions GroupComponent, Linux_SambaGroup PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaForceGroupForShare.PROPERTY_GROUPCOMPONENT_LINUX_SAMBASHAREOPTIONS.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_SambaForceGroupForShare.PROPERTY_PARTCOMPONENT_LINUX_SAMBAGROUP.NAME,
     ...
     *
     */
    public final static Linux_SambaForceGroupForShare createInstance(WBEMClient client,
            Linux_SambaForceGroupForShare dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaForceGroupForShare newDataInstance = Linux_SambaForceGroupForShareHelper
     ...
     */
    public final static Linux_SambaForceGroupForShare modifyInstance(WBEMClient client,
            Linux_SambaForceGroupForShare dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaForceGroupForShare dataInstance2 = Linux_SambaForceGroupForShareHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaForceGroupForShare dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaForceGroupForShare.getPackages());
    }
