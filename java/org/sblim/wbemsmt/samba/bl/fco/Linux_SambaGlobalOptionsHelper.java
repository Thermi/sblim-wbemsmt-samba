...
public class Linux_SambaGlobalOptionsHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaGlobalOptions.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaGlobalOptions.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_SambaGlobalOptions.");
                        resultArrayList.add(new Linux_SambaGlobalOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaGlobalOptions.");
                        resultArrayList.add(new Linux_SambaGlobalOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaGlobalOptions.");
                        resultArrayList.add(new Linux_SambaGlobalOptions(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaGlobalOptions getInstance(WBEMClient client,
    ...
    public final static Linux_SambaGlobalOptions getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(Linux_SambaGlobalOptions.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_SambaGlobalOptions.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(Linux_SambaGlobalOptions.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_SambaGlobalOptions.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_SambaGlobalOptions createInstance(WBEMClient client,
            Linux_SambaGlobalOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaGlobalOptions newDataInstance = Linux_SambaGlobalOptionsHelper.getInstance(
     ...
     */
    public final static Linux_SambaGlobalOptions modifyInstance(WBEMClient client,
            Linux_SambaGlobalOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaGlobalOptions dataInstance2 = Linux_SambaGlobalOptionsHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, Linux_SambaGlobalOptions dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaGlobalOptions.getPackages());
    }
