/** 
  * Linux_SambaServiceConfigurationHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_SambaServiceConfiguration
  *    
  * 
  * generated Class
  * @see Linux_SambaServiceConfiguration
  */
...
public class Linux_SambaServiceConfigurationHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_SambaServiceConfiguration or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaServiceConfiguration.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaServiceConfiguration.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_SambaServiceConfiguration or the subclasses if deep == true
    */        
    public final static List<Linux_SambaServiceConfiguration> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaServiceConfiguration> resultArrayList = new ArrayList<Linux_SambaServiceConfiguration>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaServiceConfiguration.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaServiceConfiguration(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_SambaServiceConfigurationHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_SambaServiceConfiguration.");
                        resultArrayList.add(new Linux_SambaServiceConfiguration(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_SambaServiceConfiguration.");
                        resultArrayList.add(new Linux_SambaServiceConfiguration(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaServiceConfiguration)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaServiceConfiguration.");
                        resultArrayList.add(new Linux_SambaServiceConfiguration(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaServiceConfiguration getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaServiceConfiguration getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_SambaServiceConfiguration dataInstance = null;
        Class<?> clazz = Linux_SambaServiceConfigurationHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_SambaServiceConfiguration)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaServiceConfiguration.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_SambaServiceConfiguration(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_SambaServiceConfiguration getInstance(WBEMClient client, String namespace
                                                       ,String Name
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaServiceConfiguration.PROPERTY_NAME.NAME,CIMDataType.STRING_T,setThis,true,false,Linux_SambaServiceConfiguration.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaServiceConfiguration.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_SambaServiceConfiguration createInstance(WBEMClient client, Linux_SambaServiceConfiguration dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_SambaServiceConfiguration newDataInstance = Linux_SambaServiceConfigurationHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_SambaServiceConfiguration modifyInstance(WBEMClient client, Linux_SambaServiceConfiguration dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_SambaServiceConfiguration dataInstance2 = Linux_SambaServiceConfigurationHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaServiceConfiguration dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaServiceConfiguration.getPackages());
    }
