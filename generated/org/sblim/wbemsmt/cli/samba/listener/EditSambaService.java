/**
 * EditSambaService.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS OF
...
public class EditSambaService extends CimCommand {
    ...
    public static final OptionDefinition KEY_start = new OptionDefinition(null, "start", null,
            null, false, false, "ServiceOperationsDataContainer.startService.argDescription");
    /**
     *  --stop
     */
    public static final OptionDefinition KEY_stop = new OptionDefinition(null, "stop", null, null,
            false, false, "ServiceOperationsDataContainer.stopService.argDescription");
    /**
     *  --restart
     */
    public static final OptionDefinition KEY_restart = new OptionDefinition(null, "restart", null,
            null, false, false, "ServiceOperationsDataContainer.restartService.argDescription");
