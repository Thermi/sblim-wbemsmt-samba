  ...
  * Contributors: 
  * 
  * Description: Loader to select the the Service for deleting a printer
  * 
  */
...
public class DeleteSambaPrinterLoader extends SambaLoader  implements CliDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle, AbstractBaseCimAdapter adapter, CimCommandValues commandValues) throws ObjectNotFoundException {
		...
		String printerName = CliUtil.getOption(commandValues,DeleteSambaPrinter.KEY_sambaPrintername);
