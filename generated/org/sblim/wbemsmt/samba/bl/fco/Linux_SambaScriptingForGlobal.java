/**
 * Linux_SambaScriptingForGlobal.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class Linux_SambaScriptingForGlobal extends CIM_ElementSettingData {
     ...
     * 
     */
    public static class PROPERTY_SETTINGDATA_LINUX_SAMBASCRIPTINGOPTIONS {
        /**
    ...
    public Linux_SambaScriptingForGlobal(WBEMClient client, String namespace)
    ...
    public Linux_SambaScriptingForGlobal(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaScriptingForGlobal() {
    }
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        ...
        propertiesToCheck.put("SettingData", new CIMProperty("SettingData", new CIMDataType(
                Linux_SambaScriptingOptions.CIM_CLASS_NAME), null));
    ...
    public static CIMProperty create_ManagedElement_Linux_SambaGlobalOptions(WBEMClient client,
        ...
        Linux_SambaScriptingForGlobal fco = new Linux_SambaScriptingForGlobal(client, namespace);
    ...
    public Linux_SambaScriptingOptions get_SettingData_Linux_SambaScriptingOptions(
            javax.wbem.client.WBEMClient client) throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBASCRIPTINGOPTIONS.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_SETTINGDATA_LINUX_SAMBASCRIPTINGOPTIONS.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }

        return Linux_SambaScriptingOptionsHelper.getInstance(client,
    ...
    public static CIMProperty create_SettingData_Linux_SambaScriptingOptions(WBEMClient client,
            String namespace, Linux_SambaScriptingOptions newValue) throws WbemsmtException {
        Linux_SambaScriptingForGlobal fco = new Linux_SambaScriptingForGlobal(client, namespace);
        CIMProperty property = fco
                .getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBASCRIPTINGOPTIONS.NAME);
        if (property != null) {
            property = setPropertyValue_SettingData_Linux_SambaScriptingOptions(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_SETTINGDATA_LINUX_SAMBASCRIPTINGOPTIONS.NAME
                    + " was not found in instance " + fco.getCimObjectPath());
    ...
    private static CIMProperty setPropertyValue_SettingData_Linux_SambaScriptingOptions(
            CIMProperty currentProperty, Linux_SambaScriptingOptions newValue) {
        Object setThis = null;
    ...
    public String getObjectName() {
        return Linux_SambaScriptingForGlobal.CIM_CLASS_NAME;
    }
