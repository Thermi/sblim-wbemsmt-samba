	...
	*/	
	...
	public static void addPackage(String packagename) {
        if (packagename != null) {
            ...
            Linux_SambaGlobalPrintingOptions.Java_Package_List.add(packagename);
    ...
    public static String[] getPackages() {
        return (String[]) Linux_SambaGlobalPrintingOptions.Java_Package_List.toArray(new String[Linux_SambaGlobalPrintingOptions.Java_Package_List.size()]);
    }
