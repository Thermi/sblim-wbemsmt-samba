...
public class Linux_SambaForceUserForShareHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaForceUserForShare.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaForceUserForShare.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_SambaForceUserForShare.");
                        resultArrayList.add(new Linux_SambaForceUserForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaForceUserForShare.");
                        resultArrayList.add(new Linux_SambaForceUserForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaForceUserForShare.");
                        resultArrayList.add(new Linux_SambaForceUserForShare(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaForceUserForShare getInstance(WBEMClient client,
    ...
    public final static Linux_SambaForceUserForShare getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaForceUserForShare.PROPERTY_PARTCOMPONENT_LINUX_SAMBAUSER.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_SambaForceUserForShare.PROPERTY_GROUPCOMPONENT_LINUX_SAMBASHAREOPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaForceUserForShare createInstance(WBEMClient client,
            Linux_SambaForceUserForShare dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaForceUserForShare newDataInstance = Linux_SambaForceUserForShareHelper
     ...
     */
    public final static Linux_SambaForceUserForShare modifyInstance(WBEMClient client,
            Linux_SambaForceUserForShare dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaForceUserForShare dataInstance2 = Linux_SambaForceUserForShareHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaForceUserForShare dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaForceUserForShare.getPackages());
    }
