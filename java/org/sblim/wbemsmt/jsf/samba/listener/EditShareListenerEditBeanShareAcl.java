        				...
        				if (!result.hasErrors())
        				{
    						...
    						try {
                    			...
                    			for (int i=0; i < count; i++) {
	                    			currentEditContainer1.addUsers(new org.sblim.wbemsmt.jsf.samba.container.share.UserACLItemDataContainerForShare_AsUsers_InUserInShareACLDataContainerImpl(adapter1,bindingPrefix, i));
                    			}
