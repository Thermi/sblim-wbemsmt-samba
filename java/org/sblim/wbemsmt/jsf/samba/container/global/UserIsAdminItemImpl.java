...
public class UserIsAdminItemImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel implements
        org.sblim.wbemsmt.samba.bl.container.global.UserIsAdminItem {
    ...
    public UserIsAdminItemImpl(org.sblim.wbemsmt.samba.bl.adapter.SambaCimAdapter adapter,
        ...
        setFooter(getPanelForCustomLayout(), "UserIsAdminItem.footerText");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_SambaUserName() {
        if (ic_usr_SambaUserName == null) {
            String label = bundle.getString("UserIsAdminItem.SambaUserName");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Admin() {
        if (ic_usr_Admin == null) {
            String label = bundle.getString("UserIsAdminItem.admin");
    ...
    public void reload() {
        super.reload();
        if (ic_usr_SambaUserName != null) {
            ic_usr_SambaUserName.setLabelText(bundle.getString("UserIsAdminItem.SambaUserName"));
        }
        if (ic_usr_Admin != null) {
            ic_usr_Admin.setLabelText(bundle.getString("UserIsAdminItem.admin"));
        }
    }
