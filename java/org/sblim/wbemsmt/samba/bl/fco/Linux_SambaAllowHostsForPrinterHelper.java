...
public class Linux_SambaAllowHostsForPrinterHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaAllowHostsForPrinter.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaAllowHostsForPrinter.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaAllowHostsForPrinterHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaAllowHostsForPrinter.");
                        resultArrayList.add(new Linux_SambaAllowHostsForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaAllowHostsForPrinter.");
                        resultArrayList.add(new Linux_SambaAllowHostsForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaAllowHostsForPrinter.");
                        resultArrayList.add(new Linux_SambaAllowHostsForPrinter(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaAllowHostsForPrinter getInstance(WBEMClient client,
     ...
     */
    public final static Linux_SambaAllowHostsForPrinter getInstance(WBEMClient client,
            String namespace, Linux_SambaHost PartComponent,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaAllowHostsForPrinter.PROPERTY_PARTCOMPONENT_LINUX_SAMBAHOST.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_SambaAllowHostsForPrinter.PROPERTY_GROUPCOMPONENT_LINUX_SAMBAPRINTEROPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaAllowHostsForPrinter createInstance(WBEMClient client,
            Linux_SambaAllowHostsForPrinter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaAllowHostsForPrinter newDataInstance = Linux_SambaAllowHostsForPrinterHelper
     ...
     */
    public final static Linux_SambaAllowHostsForPrinter modifyInstance(WBEMClient client,
            Linux_SambaAllowHostsForPrinter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaAllowHostsForPrinter dataInstance2 = Linux_SambaAllowHostsForPrinterHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaAllowHostsForPrinter dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaAllowHostsForPrinter.getPackages());
    }
