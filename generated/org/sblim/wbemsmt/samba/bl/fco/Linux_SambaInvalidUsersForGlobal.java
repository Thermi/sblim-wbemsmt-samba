/**
 * Linux_SambaInvalidUsersForGlobal.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED
...
public class Linux_SambaInvalidUsersForGlobal extends CIM_Component {
    ...
    public Linux_SambaInvalidUsersForGlobal(WBEMClient client, String namespace)
    ...
    public Linux_SambaInvalidUsersForGlobal(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaInvalidUsersForGlobal() {
    }
    ...
    public static CIMProperty create_PartComponent_Linux_SambaUser(WBEMClient client,
        ...
        Linux_SambaInvalidUsersForGlobal fco = new Linux_SambaInvalidUsersForGlobal(client,
                namespace);
    ...
    public String getObjectName() {
        return Linux_SambaInvalidUsersForGlobal.CIM_CLASS_NAME;
    }
