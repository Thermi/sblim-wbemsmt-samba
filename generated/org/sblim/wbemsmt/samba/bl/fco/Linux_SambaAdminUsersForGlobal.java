/**
 * Linux_SambaAdminUsersForGlobal.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class Linux_SambaAdminUsersForGlobal extends CIM_Component {
    ...
    public Linux_SambaAdminUsersForGlobal(WBEMClient client, String namespace)
    ...
    public Linux_SambaAdminUsersForGlobal(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaAdminUsersForGlobal() {
    }
    ...
    public static CIMProperty create_PartComponent_Linux_SambaUser(WBEMClient client,
        ...
        Linux_SambaAdminUsersForGlobal fco = new Linux_SambaAdminUsersForGlobal(client, namespace);
    ...
    public String getObjectName() {
        return Linux_SambaAdminUsersForGlobal.CIM_CLASS_NAME;
    }
