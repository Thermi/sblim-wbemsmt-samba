  ...
  * Contributors: 
  * 
  * Description: Loader to select the the Service for deleting a user
  * 
  */
...
public class DeleteSambaUserLoader extends SambaLoader  implements CliDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle, AbstractBaseCimAdapter adapter, CimCommandValues commandValues) throws WbemsmtException {
		...
		String username = CliUtil.getOption(commandValues,DeleteSambaUser.KEY_sambaUserName);
