/**
 * EditSambaServiceOptions.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class EditSambaServiceOptions extends CimCommand {
     ...
     *  --bindInterfaces
     */
    public static final OptionDefinition KEY_bindInterfaces = new OptionDefinition(null,
            "bindInterfaces", null, "ServiceOptionsDataContainer.BindInterfacesOnly.argValue",
            false, false, "ServiceOptionsDataContainer.BindInterfacesOnly.argDescription");
    /**
     *  --interfaces
     */
    public static final OptionDefinition KEY_interfaces = new OptionDefinition(null, "interfaces",
            null, "ServiceOptionsDataContainer.Interfaces.argValue", false, false,
            "ServiceOptionsDataContainer.Interfaces.argDescription");
    /**
     *  --netbiosAlias
     */
    public static final OptionDefinition KEY_netbiosAlias = new OptionDefinition(null,
            "netbiosAlias", null, "ServiceOptionsDataContainer.NetbiosAlias.argValue", false,
            false, "ServiceOptionsDataContainer.NetbiosAlias.argDescription");
    /**
     *  --netbiosName
     */
    public static final OptionDefinition KEY_netbiosName = new OptionDefinition(null,
            "netbiosName", null, "ServiceOptionsDataContainer.NetbiosName.argValue", false, false,
            "ServiceOptionsDataContainer.NetbiosName.argDescription");
    /**
     *  --serverString
     */
    public static final OptionDefinition KEY_serverString = new OptionDefinition(null,
            "serverString", null, "ServiceOptionsDataContainer.ServerString.argValue", false,
            false, "ServiceOptionsDataContainer.ServerString.argDescription");
    /**
     *  --workgroup
     */
    public static final OptionDefinition KEY_workgroup = new OptionDefinition(null, "workgroup",
            null, "ServiceOptionsDataContainer.Workgroup.argValue", false, false,
            "ServiceOptionsDataContainer.Workgroup.argDescription");
    /**
     *  --configurationFile
     */
    public static final OptionDefinition KEY_configurationFile = new OptionDefinition(null,
            "configurationFile", null, "ServiceOptionsDataContainer.ConfigurationFile.argValue",
            false, false, "ServiceOptionsDataContainer.ConfigurationFile.argDescription");
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] {
            KEY_bindInterfaces, KEY_interfaces, KEY_netbiosAlias, KEY_netbiosName,
            KEY_serverString, KEY_workgroup, KEY_configurationFile, };
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("ServiceOptionsDataContainer.caption") }));

            CliDataLoader loader = new EditSambaServiceOptionsLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.cli.samba.container.service.ServiceOptionsDataContainerImpl dc = new org.sblim.wbemsmt.cli.samba.container.service.ServiceOptionsDataContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.samba.bl.container.service.ServiceOptionsDataContainer dc)
