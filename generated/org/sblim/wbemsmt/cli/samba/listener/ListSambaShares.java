/**
 * ListSambaShares.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS OF
...
public class ListSambaShares extends CimCommand {
    ...
    public static final OptionDefinition KEY_list = new OptionDefinition(null, "list",
            "INSTANCE_WITH_CHILDS", "ListSambaShares.list.argValue", false, false,
            "ListSambaShares.list.argDescription");
    ...
    public void execute(CimCommandValues values) throws WbemsmtException {
        ...
        try {
            ...
            org.sblim.wbemsmt.cli.samba.container.share.ShareListDataContainerImpl dc = new org.sblim.wbemsmt.cli.samba.container.share.ShareListDataContainerImpl(
                    adapter);
            ...
            for (int i = 0; i < count; i++) {
                org.sblim.wbemsmt.cli.samba.container.share.ShareListItemDataContainerImpl child = new org.sblim.wbemsmt.cli.samba.container.share.ShareListItemDataContainerImpl(
                        adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.samba.bl.container.share.ShareListDataContainer dc)
