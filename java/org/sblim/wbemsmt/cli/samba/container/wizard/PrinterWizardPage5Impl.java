...
public class PrinterWizardPage5Impl extends BaseDataContainer implements
        org.sblim.wbemsmt.samba.bl.container.wizard.PrinterWizardPage5,
    ...
    public PrinterWizardPage5Impl(AbstractBaseCimAdapter adapter) throws WbemsmtException {
        super();
        setAdapter(adapter);
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        ...
        if (showInstance(listOptions)) {
            if (get_usr_AllOrOne().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_AllOrOne())
                        .getValue();
                printStream.println(get_usr_AllOrOne().getLabelText() + ": " + value);
            }
            if (get_SambaPrinterName().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_SambaPrinterName())
                        .getValue();
