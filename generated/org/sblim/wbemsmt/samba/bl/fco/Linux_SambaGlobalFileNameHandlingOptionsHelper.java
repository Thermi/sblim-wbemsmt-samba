/** 
  * Linux_SambaGlobalFileNameHandlingOptionsHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_SambaGlobalFileNameHandlingOptions
  *    
  * 
  * generated Class
  * @see Linux_SambaGlobalFileNameHandlingOptions
  */
...
public class Linux_SambaGlobalFileNameHandlingOptionsHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_SambaGlobalFileNameHandlingOptions or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaGlobalFileNameHandlingOptions.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaGlobalFileNameHandlingOptions.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_SambaGlobalFileNameHandlingOptions or the subclasses if deep == true
    */        
    public final static List<Linux_SambaGlobalFileNameHandlingOptions> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaGlobalFileNameHandlingOptions> resultArrayList = new ArrayList<Linux_SambaGlobalFileNameHandlingOptions>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaGlobalFileNameHandlingOptions.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaGlobalFileNameHandlingOptions(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_SambaGlobalFileNameHandlingOptionsHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_SambaGlobalFileNameHandlingOptions.");
                        resultArrayList.add(new Linux_SambaGlobalFileNameHandlingOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_SambaGlobalFileNameHandlingOptions.");
                        resultArrayList.add(new Linux_SambaGlobalFileNameHandlingOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaGlobalFileNameHandlingOptions)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaGlobalFileNameHandlingOptions.");
                        resultArrayList.add(new Linux_SambaGlobalFileNameHandlingOptions(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaGlobalFileNameHandlingOptions getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaGlobalFileNameHandlingOptions getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_SambaGlobalFileNameHandlingOptions dataInstance = null;
        Class<?> clazz = Linux_SambaGlobalFileNameHandlingOptionsHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_SambaGlobalFileNameHandlingOptions)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaGlobalFileNameHandlingOptions.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_SambaGlobalFileNameHandlingOptions(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_SambaGlobalFileNameHandlingOptions getInstance(WBEMClient client, String namespace
                                                       ,String InstanceID
                                                       ,String Name
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaGlobalFileNameHandlingOptions.PROPERTY_INSTANCEID.NAME,CIMDataType.STRING_T,setThis,true,false,Linux_SambaGlobalFileNameHandlingOptions.CIM_CLASS_NAME); 
                   
                   setThis = Name;
                
           keyProperties[1]  = new CIMProperty(Linux_SambaGlobalFileNameHandlingOptions.PROPERTY_NAME.NAME,CIMDataType.STRING_T,setThis,true,false,Linux_SambaGlobalFileNameHandlingOptions.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaGlobalFileNameHandlingOptions.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_SambaGlobalFileNameHandlingOptions createInstance(WBEMClient client, Linux_SambaGlobalFileNameHandlingOptions dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_SambaGlobalFileNameHandlingOptions newDataInstance = Linux_SambaGlobalFileNameHandlingOptionsHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_SambaGlobalFileNameHandlingOptions modifyInstance(WBEMClient client, Linux_SambaGlobalFileNameHandlingOptions dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_SambaGlobalFileNameHandlingOptions dataInstance2 = Linux_SambaGlobalFileNameHandlingOptionsHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaGlobalFileNameHandlingOptions dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaGlobalFileNameHandlingOptions.getPackages());
    }
