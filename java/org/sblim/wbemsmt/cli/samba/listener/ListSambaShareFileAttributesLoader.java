...
public class ListSambaShareFileAttributesLoader extends SambaLoader implements
	...
	public void load(WbemSmtResourceBundle bundle,
		...
		String serviceName = CliUtil.getOption(cmd,ListSambaShareFileAttributes.KEY_GLOBAL_serviceName);
		String shareName = CliUtil.getOption(cmd,ListSambaShareFileAttributes.KEY_sharename);
