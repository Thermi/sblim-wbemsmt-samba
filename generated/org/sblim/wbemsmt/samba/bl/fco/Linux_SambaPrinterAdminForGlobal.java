/**
 * Linux_SambaPrinterAdminForGlobal.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED
...
public class Linux_SambaPrinterAdminForGlobal extends CIM_Component {
    ...
    public Linux_SambaPrinterAdminForGlobal(WBEMClient client, String namespace)
    ...
    public Linux_SambaPrinterAdminForGlobal(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaPrinterAdminForGlobal() {
    }
    ...
    public static CIMProperty create_PartComponent_Linux_SambaUser(WBEMClient client,
        ...
        Linux_SambaPrinterAdminForGlobal fco = new Linux_SambaPrinterAdminForGlobal(client,
                namespace);
    ...
    public String getObjectName() {
        return Linux_SambaPrinterAdminForGlobal.CIM_CLASS_NAME;
    }
