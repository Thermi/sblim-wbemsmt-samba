...
public final class Linux_SambaGlobalFileNameHandlingOptionsHelper {
	...
	*/	
	public final static Linux_SambaGlobalFileNameHandlingOptions getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_SambaGlobalFileNameHandlingOptionsHelper.getInstance(cimClient, new Linux_SambaGlobalFileNameHandlingOptions(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaGlobalFileNameHandlingOptions getInstance(CIMClient cimClient, Linux_SambaGlobalFileNameHandlingOptions dataInstance) {
		...
		return Linux_SambaGlobalFileNameHandlingOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaGlobalFileNameHandlingOptions getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			dataInstance = new Linux_SambaGlobalFileNameHandlingOptions(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaGlobalFileNameHandlingOptions createInstance(CIMClient cimClient, Linux_SambaGlobalFileNameHandlingOptions dataInstance, boolean notifyDifferencies){ 
		...
		Linux_SambaGlobalFileNameHandlingOptions newDataInstance = null;
		try {
			newDataInstance = Linux_SambaGlobalFileNameHandlingOptionsHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaGlobalFileNameHandlingOptions modifyInstance(CIMClient cimClient, Linux_SambaGlobalFileNameHandlingOptions dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_SambaGlobalFileNameHandlingOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_SambaGlobalFileNameHandlingOptions dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_SambaGlobalFileNameHandlingOptions dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_SambaGlobalFileNameHandlingOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_SambaGlobalFileNameHandlingOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_SambaGlobalFileNameHandlingOptions.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_SambaGlobalFileNameHandlingOptions.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_SambaGlobalFileNameHandlingOptions.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
