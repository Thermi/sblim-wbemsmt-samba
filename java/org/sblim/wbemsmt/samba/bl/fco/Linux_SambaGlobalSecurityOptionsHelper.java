...
public final class Linux_SambaGlobalSecurityOptionsHelper {
	...
	*/	
	public final static Linux_SambaGlobalSecurityOptions getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_SambaGlobalSecurityOptionsHelper.getInstance(cimClient, new Linux_SambaGlobalSecurityOptions(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaGlobalSecurityOptions getInstance(CIMClient cimClient, Linux_SambaGlobalSecurityOptions dataInstance) {
		...
		return Linux_SambaGlobalSecurityOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaGlobalSecurityOptions getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			...
			{
				dataInstance = new Linux_SambaGlobalSecurityOptions(cimObjectPath, cimInstance);
			}
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = Linux_SambaGlobalSecurityOptions.getPackages();
	...
	*/	
	public final static Linux_SambaGlobalSecurityOptions createInstance(CIMClient cimClient, Linux_SambaGlobalSecurityOptions dataInstance, boolean notifyDifferencies){ 
		...
		Linux_SambaGlobalSecurityOptions newDataInstance = null;
		try {
			newDataInstance = Linux_SambaGlobalSecurityOptionsHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaGlobalSecurityOptions modifyInstance(CIMClient cimClient, Linux_SambaGlobalSecurityOptions dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_SambaGlobalSecurityOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_SambaGlobalSecurityOptions dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_SambaGlobalSecurityOptions dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_SambaGlobalSecurityOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_SambaGlobalSecurityOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_SambaGlobalSecurityOptions.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_SambaGlobalSecurityOptions.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_SambaGlobalSecurityOptions.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_AuthMethods(String AuthMethods) {
		return true;
	}

	public static boolean isValid_EncryptPasswords(Boolean EncryptPasswords) {
		return true;
	}

	public static boolean isValid_MinPasswordLength(UnsignedInt8 MinPasswordLength) {
		return true;
	}
	...
	public static boolean isValid_NullPasswords(Boolean NullPasswords) {
		return true;
	}

	public static boolean isValid_PassdbBackend(String PassdbBackend) {
		return true;
	}

	public static boolean isValid_SMBPasswdFile(String SMBPasswdFile) {
		return true;
	}

	public static boolean isValid_Security(UnsignedInt8 Security) {
		return true;
	}
