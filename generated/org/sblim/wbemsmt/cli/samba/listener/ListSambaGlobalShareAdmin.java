/**
 * ListSambaGlobalShareAdmin.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class ListSambaGlobalShareAdmin extends CimCommand {
    ...
    public static final OptionDefinition KEY_list = new OptionDefinition(null, "list",
            "INSTANCE_WITH_CHILDS", "ListSambaGlobalShareAdmin.list.argValue", false, false,
            "ListSambaGlobalShareAdmin.list.argDescription");
    /**
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("listing", new Object[] { bundle
                                    .getString("AdminUsersInShareGlobals.caption") }));

            CliDataLoader loader = new ListSambaGlobalShareAdminLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.cli.samba.container.global.AdminUsersInShareGlobalsImpl dc = new org.sblim.wbemsmt.cli.samba.container.global.AdminUsersInShareGlobalsImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.samba.bl.container.global.AdminUsersInShareGlobals dc)
