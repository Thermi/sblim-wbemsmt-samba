...
public class Linux_SambaPrinterForService extends CIM_ElementSettingData {
     ...
     * 
     */
    public static class PROPERTY_SETTINGDATA_LINUX_SAMBAPRINTEROPTIONS {
        /**
    ...
    public Linux_SambaPrinterForService(WBEMClient client, String namespace)
    ...
    public Linux_SambaPrinterForService(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaPrinterForService() {
    }
    ...
    public Linux_SambaPrinterOptions get_SettingData_Linux_SambaPrinterOptions(
            javax.wbem.client.WBEMClient client) throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBAPRINTEROPTIONS.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_SETTINGDATA_LINUX_SAMBAPRINTEROPTIONS.NAME
    ...
    public boolean set_SettingData_Linux_SambaPrinterOptions(Linux_SambaPrinterOptions newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBAPRINTEROPTIONS.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_SettingData_Linux_SambaPrinterOptions(
    ...
    public static CIMProperty create_SettingData_Linux_SambaPrinterOptions(WBEMClient client,
            String namespace, Linux_SambaPrinterOptions newValue) throws WbemsmtException {
        Linux_SambaPrinterForService fco = new Linux_SambaPrinterForService(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBAPRINTEROPTIONS.NAME);
        if (property != null) {
            property = setPropertyValue_SettingData_Linux_SambaPrinterOptions(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_SETTINGDATA_LINUX_SAMBAPRINTEROPTIONS.NAME
    ...
    private static CIMProperty setPropertyValue_SettingData_Linux_SambaPrinterOptions(
    ...
    public boolean set_ManagedElement_Linux_SambaService(Linux_SambaService newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_MANAGEDELEMENT_LINUX_SAMBASERVICE.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_ManagedElement_Linux_SambaService(currentProperty,
                    newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
    ...
    public String getObjectName() {
        return Linux_SambaPrinterForService.CIM_CLASS_NAME;
    }
