...
public final class Linux_SambaWinsOptionsHelper {
	...
	*/	
	public final static Linux_SambaWinsOptions getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_SambaWinsOptionsHelper.getInstance(cimClient, new Linux_SambaWinsOptions(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaWinsOptions getInstance(CIMClient cimClient, Linux_SambaWinsOptions dataInstance) {
		...
		return Linux_SambaWinsOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaWinsOptions getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			dataInstance = new Linux_SambaWinsOptions(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaWinsOptions createInstance(CIMClient cimClient, Linux_SambaWinsOptions dataInstance, boolean notifyDifferencies){ 
		...
		Linux_SambaWinsOptions newDataInstance = null;
		try {
			newDataInstance = Linux_SambaWinsOptionsHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaWinsOptions modifyInstance(CIMClient cimClient, Linux_SambaWinsOptions dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_SambaWinsOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_SambaWinsOptions dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_SambaWinsOptions dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_SambaWinsOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_SambaWinsOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_SambaWinsOptions.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_SambaWinsOptions.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_SambaWinsOptions.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_DNS_Proxy(String DNS_Proxy) {
		return true;
	}
	...
	public static boolean isValid_WINSHook(String WINSHook) {
		return true;
	}

	public static boolean isValid_WINSProxy(Boolean WINSProxy) {
		return true;
	}

	public static boolean isValid_WINSServer(String WINSServer) {
		return true;
	}

	public static boolean isValid_WINSSupport(Boolean WINSSupport) {
		return true;
	}
