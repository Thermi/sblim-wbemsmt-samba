/** 
  * Linux_SambaForceUserForPrinterHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_SambaForceUserForPrinter
  *    
  * 
  * generated Class
  * @see Linux_SambaForceUserForPrinter
  */
...
public class Linux_SambaForceUserForPrinterHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_SambaForceUserForPrinter or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaForceUserForPrinter.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaForceUserForPrinter.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_SambaForceUserForPrinter or the subclasses if deep == true
    */        
    public final static List<Linux_SambaForceUserForPrinter> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaForceUserForPrinter> resultArrayList = new ArrayList<Linux_SambaForceUserForPrinter>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaForceUserForPrinter.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaForceUserForPrinter(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_SambaForceUserForPrinterHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_SambaForceUserForPrinter.");
                        resultArrayList.add(new Linux_SambaForceUserForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_SambaForceUserForPrinter.");
                        resultArrayList.add(new Linux_SambaForceUserForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaForceUserForPrinter)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaForceUserForPrinter.");
                        resultArrayList.add(new Linux_SambaForceUserForPrinter(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaForceUserForPrinter getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaForceUserForPrinter getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_SambaForceUserForPrinter dataInstance = null;
        Class<?> clazz = Linux_SambaForceUserForPrinterHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_SambaForceUserForPrinter)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaForceUserForPrinter.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_SambaForceUserForPrinter(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_SambaForceUserForPrinter getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaForceUserForPrinter.PROPERTY_PARTCOMPONENT_LINUX_SAMBAUSER.NAME,new CIMDataType(Linux_SambaUser.CIM_CLASS_NAME),setThis,false,false,Linux_SambaForceUserForPrinter.CIM_CLASS_NAME); 
                   
                                 setThis = GroupComponent != null ? GroupComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_SambaForceUserForPrinter.PROPERTY_GROUPCOMPONENT_LINUX_SAMBAPRINTEROPTIONS.NAME,new CIMDataType(Linux_SambaPrinterOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaForceUserForPrinter.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaForceUserForPrinter.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_SambaForceUserForPrinter createInstance(WBEMClient client, Linux_SambaForceUserForPrinter dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_SambaForceUserForPrinter newDataInstance = Linux_SambaForceUserForPrinterHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_SambaForceUserForPrinter modifyInstance(WBEMClient client, Linux_SambaForceUserForPrinter dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_SambaForceUserForPrinter dataInstance2 = Linux_SambaForceUserForPrinterHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaForceUserForPrinter dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaForceUserForPrinter.getPackages());
    }
