...
public class CreatePrinterListener extends TaskLauncherContextMenuEventListenerImpl {
    ...
    public String processEvent(TaskLauncherTreeNodeEvent event) throws WbemsmtException {
        ...
        helpManager.setCurrentTopic("SAMBA", "CreatePrinterListener");
        ...
        if (selector.execute()) {
            ...
            org.sblim.wbemsmt.jsf.samba.wizard.PrinterWizard wizard = new org.sblim.wbemsmt.jsf.samba.wizard.PrinterWizard(
                    adapter);
