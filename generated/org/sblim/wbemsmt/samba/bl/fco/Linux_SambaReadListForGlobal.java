/**
 * Linux_SambaReadListForGlobal.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class Linux_SambaReadListForGlobal extends CIM_Component {
    ...
    public Linux_SambaReadListForGlobal(WBEMClient client, String namespace)
    ...
    public Linux_SambaReadListForGlobal(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaReadListForGlobal() {
    }
    ...
    public static CIMProperty create_PartComponent_Linux_SambaUser(WBEMClient client,
        ...
        Linux_SambaReadListForGlobal fco = new Linux_SambaReadListForGlobal(client, namespace);
    ...
    public String getObjectName() {
        return Linux_SambaReadListForGlobal.CIM_CLASS_NAME;
    }
