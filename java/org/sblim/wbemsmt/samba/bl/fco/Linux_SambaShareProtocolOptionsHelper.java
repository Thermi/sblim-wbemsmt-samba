...
public final class Linux_SambaShareProtocolOptionsHelper {
	...
	*/	
	public final static Linux_SambaShareProtocolOptions getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_SambaShareProtocolOptionsHelper.getInstance(cimClient, new Linux_SambaShareProtocolOptions(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaShareProtocolOptions getInstance(CIMClient cimClient, Linux_SambaShareProtocolOptions dataInstance) {
		...
		return Linux_SambaShareProtocolOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaShareProtocolOptions getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			dataInstance = new Linux_SambaShareProtocolOptions(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaShareProtocolOptions createInstance(CIMClient cimClient, Linux_SambaShareProtocolOptions dataInstance, boolean notifyDifferencies){ 
		...
		Linux_SambaShareProtocolOptions newDataInstance = null;
		try {
			newDataInstance = Linux_SambaShareProtocolOptionsHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaShareProtocolOptions modifyInstance(CIMClient cimClient, Linux_SambaShareProtocolOptions dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_SambaShareProtocolOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_SambaShareProtocolOptions dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_SambaShareProtocolOptions dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_SambaShareProtocolOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_SambaShareProtocolOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_SambaShareProtocolOptions.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_SambaShareProtocolOptions.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_SambaShareProtocolOptions.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
