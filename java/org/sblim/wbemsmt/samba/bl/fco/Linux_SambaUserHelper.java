...
public final class Linux_SambaUserHelper {
	...
	*/	
	public final static Linux_SambaUser getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_SambaUserHelper.getInstance(cimClient, new Linux_SambaUser(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaUser getInstance(CIMClient cimClient, Linux_SambaUser dataInstance) {
		...
		return Linux_SambaUserHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaUser getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			...
			{
				dataInstance = new Linux_SambaUser(cimObjectPath, cimInstance);
			}
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = Linux_SambaUser.getPackages();
	...
	*/	
	public final static Linux_SambaUser createInstance(CIMClient cimClient, Linux_SambaUser dataInstance, boolean notifyDifferencies){ 
		...
		Linux_SambaUser newDataInstance = null;
		try {
			newDataInstance = Linux_SambaUserHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaUser modifyInstance(CIMClient cimClient, Linux_SambaUser dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_SambaUserHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_SambaUser dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_SambaUser dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_SambaUser.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_SambaUser.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_SambaUser.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_SambaUser.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_SambaUser.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_SambaUserName(String SambaUserName) {
		return true;
	}

	public static boolean isValid_SambaUserPassword(String SambaUserPassword) {
		return true;
	}

	public static boolean isValid_SystemUserName(String SystemUserName) {
		return true;
	}
