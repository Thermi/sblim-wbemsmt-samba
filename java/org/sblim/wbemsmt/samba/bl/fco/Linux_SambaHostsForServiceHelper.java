...
public class Linux_SambaHostsForServiceHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaHostsForService.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaHostsForService.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_SambaHostsForService.");
                        resultArrayList.add(new Linux_SambaHostsForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaHostsForService.");
                        resultArrayList.add(new Linux_SambaHostsForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaHostsForService.");
                        resultArrayList.add(new Linux_SambaHostsForService(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaHostsForService getInstance(WBEMClient client,
    ...
    public final static Linux_SambaHostsForService getInstance(WBEMClient client, String namespace,
            Linux_SambaHost PartComponent, Linux_SambaService GroupComponent
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaHostsForService.PROPERTY_PARTCOMPONENT_LINUX_SAMBAHOST.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_SambaHostsForService.PROPERTY_GROUPCOMPONENT_LINUX_SAMBASERVICE.NAME,
     ...
     *
     */
    public final static Linux_SambaHostsForService createInstance(WBEMClient client,
            Linux_SambaHostsForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaHostsForService newDataInstance = Linux_SambaHostsForServiceHelper.getInstance(
     ...
     */
    public final static Linux_SambaHostsForService modifyInstance(WBEMClient client,
            Linux_SambaHostsForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaHostsForService dataInstance2 = Linux_SambaHostsForServiceHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaHostsForService dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaHostsForService.getPackages());
    }
