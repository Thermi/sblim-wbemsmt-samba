/**
 * ListSambaUserAclInService.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class ListSambaUserAclInService extends CimCommand {
    ...
    public static final OptionDefinition KEY_list = new OptionDefinition(null, "list",
            "INSTANCE_WITH_CHILDS", "ListSambaUserAclInService.list.argValue", false, false,
            "ListSambaUserAclInService.list.argDescription");
    /**
    ...
    public static final OptionDefinition KEY_sambaUsername = new OptionDefinition(null,
            "sambaUsername", null, "UserACLItemDataContainerForService.SambaUserName.argValue",
            true, true, "UserACLItemDataContainerForService.SambaUserName.argDescription");
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("listing", new Object[] { bundle
                                    .getString("UserACLItemDataContainerForService.caption") }));

            CliDataLoader loader = new ListSambaUserAclInServiceLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.cli.samba.container.service.UserACLItemDataContainerForServiceImpl dc = new org.sblim.wbemsmt.cli.samba.container.service.UserACLItemDataContainerForServiceImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.samba.bl.container.service.UserACLItemDataContainerForService dc)
