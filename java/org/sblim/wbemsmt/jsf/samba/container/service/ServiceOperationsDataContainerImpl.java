...
public class ServiceOperationsDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.samba.bl.container.service.ServiceOperationsDataContainer {
    ...
    public ServiceOperationsDataContainerImpl(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_Started() {
        if (ic_Started == null) {
            ...
            ic_Started = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFCheckboxComponent(parent,
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_invoke_StartService() {
        if (ic_invoke_StartService == null) {
            ...
            ic_invoke_StartService = new org.sblim.wbemsmt.tools.input.jsf.JSFButtonComponent(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_invoke_StopService() {
        if (ic_invoke_StopService == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_invoke_StopService = new org.sblim.wbemsmt.tools.input.jsf.JSFButtonComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_RestartService() {
        if (ic_usr_RestartService == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_RestartService = new org.sblim.wbemsmt.tools.input.jsf.JSFButtonComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public void reload() {
        ...
        if (ic_invoke_StartService != null) {
            ic_invoke_StartService.setLabelText(bundle
                    .getString("ServiceOperationsDataContainer.startService"));
        }
        if (ic_invoke_StopService != null) {
            ic_invoke_StopService.setLabelText(bundle
                    .getString("ServiceOperationsDataContainer.stopService"));
        }
        if (ic_usr_RestartService != null) {
            ic_usr_RestartService.setLabelText(bundle
                    .getString("ServiceOperationsDataContainer.restartService"));
        }
    }
