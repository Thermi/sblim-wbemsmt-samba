/**
 * CreateUserListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS
...
public class CreateUserListener extends TaskLauncherContextMenuEventListenerImpl {
    ...
    public String processEvent(TaskLauncherTreeNodeEvent event) throws WbemsmtException {
        ...
        TaskLauncherTreeNodeSelectorForCreate selector = new org.sblim.wbemsmt.samba.listener.CreateUserListenerSelector();
        ...
        if (selector.execute()) {
            ...
            org.sblim.wbemsmt.jsf.samba.wizard.UserWizard wizard = new org.sblim.wbemsmt.jsf.samba.wizard.UserWizard(
                    adapter);
