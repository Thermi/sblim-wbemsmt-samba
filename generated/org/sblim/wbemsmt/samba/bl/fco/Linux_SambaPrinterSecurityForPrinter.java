/**
 * Linux_SambaPrinterSecurityForPrinter.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED
...
public class Linux_SambaPrinterSecurityForPrinter extends CIM_ElementSettingData {
     ...
     * 
     */
    public static class PROPERTY_SETTINGDATA_LINUX_SAMBAPRINTERSECURITYOPTIONS {
        /**
    ...
    public Linux_SambaPrinterSecurityForPrinter(WBEMClient client, String namespace)
    ...
    public Linux_SambaPrinterSecurityForPrinter(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaPrinterSecurityForPrinter() {
    }
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        propertiesToCheck.put("SettingData", new CIMProperty("SettingData", new CIMDataType(
                Linux_SambaPrinterSecurityOptions.CIM_CLASS_NAME), null));
    ...
    public Linux_SambaPrinterSecurityOptions get_SettingData_Linux_SambaPrinterSecurityOptions(
            javax.wbem.client.WBEMClient client) throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBAPRINTERSECURITYOPTIONS.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property "
                    + PROPERTY_SETTINGDATA_LINUX_SAMBAPRINTERSECURITYOPTIONS.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }

        return Linux_SambaPrinterSecurityOptionsHelper.getInstance(client,
    ...
    public boolean set_SettingData_Linux_SambaPrinterSecurityOptions(
            Linux_SambaPrinterSecurityOptions newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBAPRINTERSECURITYOPTIONS.NAME);
        if (currentProperty != null) {
            setProperty(setPropertyValue_SettingData_Linux_SambaPrinterSecurityOptions(
    ...
    public static CIMProperty create_SettingData_Linux_SambaPrinterSecurityOptions(
            WBEMClient client, String namespace, Linux_SambaPrinterSecurityOptions newValue)
            throws WbemsmtException {
        Linux_SambaPrinterSecurityForPrinter fco = new Linux_SambaPrinterSecurityForPrinter(client,
                namespace);
        CIMProperty property = fco
                .getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBAPRINTERSECURITYOPTIONS.NAME);
        if (property != null) {
            property = setPropertyValue_SettingData_Linux_SambaPrinterSecurityOptions(property,
                    newValue);
        }
        else {
            logger.warning("Property "
    ...
    private static CIMProperty setPropertyValue_SettingData_Linux_SambaPrinterSecurityOptions(
            CIMProperty currentProperty, Linux_SambaPrinterSecurityOptions newValue) {
        Object setThis = null;
    ...
    public String getObjectName() {
        return Linux_SambaPrinterSecurityForPrinter.CIM_CLASS_NAME;
    }
