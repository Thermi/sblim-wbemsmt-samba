...
public class ShareFileAttributesImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel implements
    ...
    public ShareFileAttributesImpl(org.sblim.wbemsmt.samba.bl.adapter.SambaCimAdapter adapter,
    ...
    public void reload() {
        ...
        if (ic_AclCompatibility != null) {
            ic_AclCompatibility.setLabelText(bundle
                    .getString("ShareFileAttributes.AclCompatibility"));
        }
        if (ic_NTACLSupport != null) {
