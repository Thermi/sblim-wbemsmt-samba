...
public class Linux_SambaLoggingForGlobalHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaLoggingForGlobal.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaLoggingForGlobal.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_SambaLoggingForGlobal.");
                        resultArrayList.add(new Linux_SambaLoggingForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaLoggingForGlobal.");
                        resultArrayList.add(new Linux_SambaLoggingForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaLoggingForGlobal.");
                        resultArrayList.add(new Linux_SambaLoggingForGlobal(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaLoggingForGlobal getInstance(WBEMClient client,
     ...
     */
    public final static Linux_SambaLoggingForGlobal getInstance(WBEMClient client,
            String namespace, Linux_SambaLoggingOptions SettingData,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaLoggingForGlobal.PROPERTY_SETTINGDATA_LINUX_SAMBALOGGINGOPTIONS.NAME,
                new CIMDataType(Linux_SambaLoggingOptions.CIM_CLASS_NAME), setThis, false, false,
                Linux_SambaLoggingForGlobal.CIM_CLASS_NAME);

        setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                Linux_SambaLoggingForGlobal.PROPERTY_MANAGEDELEMENT_LINUX_SAMBAGLOBALOPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaLoggingForGlobal createInstance(WBEMClient client,
            Linux_SambaLoggingForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaLoggingForGlobal newDataInstance = Linux_SambaLoggingForGlobalHelper
     ...
     */
    public final static Linux_SambaLoggingForGlobal modifyInstance(WBEMClient client,
            Linux_SambaLoggingForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaLoggingForGlobal dataInstance2 = Linux_SambaLoggingForGlobalHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaLoggingForGlobal dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaLoggingForGlobal.getPackages());
    }
