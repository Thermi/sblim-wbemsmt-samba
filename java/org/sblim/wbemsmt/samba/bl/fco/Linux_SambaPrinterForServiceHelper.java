...
public class Linux_SambaPrinterForServiceHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaPrinterForService.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaPrinterForService.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_SambaPrinterForService.");
                        resultArrayList.add(new Linux_SambaPrinterForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaPrinterForService.");
                        resultArrayList.add(new Linux_SambaPrinterForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaPrinterForService.");
                        resultArrayList.add(new Linux_SambaPrinterForService(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaPrinterForService getInstance(WBEMClient client,
     ...
     */
    public final static Linux_SambaPrinterForService getInstance(WBEMClient client,
            String namespace, Linux_SambaPrinterOptions SettingData,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaPrinterForService.PROPERTY_SETTINGDATA_LINUX_SAMBAPRINTEROPTIONS.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_SambaPrinterForService.PROPERTY_MANAGEDELEMENT_LINUX_SAMBASERVICE.NAME,
     ...
     *
     */
    public final static Linux_SambaPrinterForService createInstance(WBEMClient client,
            Linux_SambaPrinterForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaPrinterForService newDataInstance = Linux_SambaPrinterForServiceHelper
     ...
     */
    public final static Linux_SambaPrinterForService modifyInstance(WBEMClient client,
            Linux_SambaPrinterForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaPrinterForService dataInstance2 = Linux_SambaPrinterForServiceHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaPrinterForService dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaPrinterForService.getPackages());
    }
