...
public class UserInShareACLDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel implements org.sblim.wbemsmt.samba.bl.container.share.UserInShareACLDataContainer
			, org.sblim.wbemsmt.samba.bl.container.share.UserACLItemDataContainerForShareHeader		
	{
    		...
    		private org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf ic_usr_CurrentForceUser;
				...
				private java.util.List<UserACLItemDataContainerForShare> icUsers = new java.util.ArrayList<UserACLItemDataContainerForShare>();
	...
	public UserInShareACLDataContainerImpl(org.sblim.wbemsmt.samba.bl.adapter.SambaCimAdapter adapter,String expressionPrefix) throws WbemsmtException  {

			
				super(adapter,expressionPrefix, "UserInShareACLDataContainer.caption",false);
	...
	*/
	public java.util.List<UserACLItemDataContainerForShare> getUsersForUI()
	{
				
		List<UserACLItemDataContainerForShare> result = new ArrayList<UserACLItemDataContainerForShare>();
	...
	public void countAndCreateChildren() throws WbemsmtException {
    			...
    			try
		{
			int count = adapter.count("users",org.sblim.wbemsmt.samba.bl.container.share.UserACLItemDataContainerForShare.class, this);
	        if (count != usersCount)
	        {
	           usersCount = count;
	           clearUsers();
			   for (int i=0; i < count ; i++) {
	    			addUsers(new org.sblim.wbemsmt.jsf.samba.container.share.UserACLItemDataContainerForShare_AsUsers_InUserInShareACLDataContainerImpl((org.sblim.wbemsmt.samba.bl.adapter.SambaCimAdapter)adapter,expressionPrefix, i));
			   }
	        }
	...
	public void copyFrom(DataContainer sourceContainer) throws WbemsmtException
	{
    	    		   ...
    	    		   List<UserACLItemDataContainerForShare> targetListForUsers = getUsers();
    		   List<UserACLItemDataContainerForShare> sourceListForUsers = source.getUsers();
