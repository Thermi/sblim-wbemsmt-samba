  ...
  * Contributors: 
  * 
  * Description: class for loading the objects if user lists the file attributes of a share
  * 
  */
...
public class ListSambaShareFileAttributesLoader extends SambaLoader implements
		CliDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
		...
		String serviceName = CliUtil.getOption(commandValues,ListSambaShareFileAttributes.KEY_GLOBAL_serviceName);
		String shareName = CliUtil.getOption(commandValues,ListSambaShareFileAttributes.KEY_sharename);
