...
public class ShareInUserWizardACLItemDataContainerImpl extends BaseDataContainer implements
    ...
    public ShareInUserWizardACLItemDataContainerImpl(AbstractBaseCimAdapter adapter)
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "ShareInUserWizardACLItemDataContainer.caption"));
        }
