...
public class Linux_SambaGlobalFileNameHandlingForGlobalHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(
                Linux_SambaGlobalFileNameHandlingForGlobal.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    Linux_SambaGlobalFileNameHandlingForGlobal.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaGlobalFileNameHandlingForGlobal(
                                cimInstance));
                        continue;
                    }
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_SambaGlobalFileNameHandlingForGlobal.");
                        resultArrayList.add(new Linux_SambaGlobalFileNameHandlingForGlobal(
                                cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaGlobalFileNameHandlingForGlobal.");
                        resultArrayList.add(new Linux_SambaGlobalFileNameHandlingForGlobal(
                                cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaGlobalFileNameHandlingForGlobal.");
                        resultArrayList.add(new Linux_SambaGlobalFileNameHandlingForGlobal(
                                cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaGlobalFileNameHandlingForGlobal getInstance(WBEMClient client,
    ...
    public final static Linux_SambaGlobalFileNameHandlingForGlobal getInstance(WBEMClient client,
        ...
        Class clazz = Linux_SambaGlobalFileNameHandlingForGlobalHelper.findClass(client,
                cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (Linux_SambaGlobalFileNameHandlingForGlobal) cons
                        .newInstance(actargs);
            }
            catch (Exception e) {
                System.err
     ...
     */
    public final static Linux_SambaGlobalFileNameHandlingForGlobal getInstance(WBEMClient client,
            String namespace, Linux_SambaGlobalOptions ManagedElement,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaGlobalFileNameHandlingForGlobal.PROPERTY_MANAGEDELEMENT_LINUX_SAMBAGLOBALOPTIONS.NAME,
                new CIMDataType(Linux_SambaGlobalOptions.CIM_CLASS_NAME), setThis, false, false,
                Linux_SambaGlobalFileNameHandlingForGlobal.CIM_CLASS_NAME);

        setThis = SettingData != null ? SettingData.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                Linux_SambaGlobalFileNameHandlingForGlobal.PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALFILENAMEHANDLINGOPTIONS.NAME,
                new CIMDataType(Linux_SambaGlobalFileNameHandlingOptions.CIM_CLASS_NAME), setThis,
                false, false, Linux_SambaGlobalFileNameHandlingForGlobal.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_SambaGlobalFileNameHandlingForGlobal createInstance(
            WBEMClient client, Linux_SambaGlobalFileNameHandlingForGlobal dataInstance,
        ...
        Linux_SambaGlobalFileNameHandlingForGlobal newDataInstance = Linux_SambaGlobalFileNameHandlingForGlobalHelper
     ...
     */
    public final static Linux_SambaGlobalFileNameHandlingForGlobal modifyInstance(
            WBEMClient client, Linux_SambaGlobalFileNameHandlingForGlobal dataInstance,
            boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaGlobalFileNameHandlingForGlobal dataInstance2 = Linux_SambaGlobalFileNameHandlingForGlobalHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaGlobalFileNameHandlingForGlobal dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaGlobalFileNameHandlingForGlobal.getPackages());
    }
