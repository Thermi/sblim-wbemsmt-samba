...
public final class Linux_SambaGlobalPrintingOptionsHelper {
	...
	*/	
	public final static Linux_SambaGlobalPrintingOptions getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_SambaGlobalPrintingOptionsHelper.getInstance(cimClient, new Linux_SambaGlobalPrintingOptions(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaGlobalPrintingOptions getInstance(CIMClient cimClient, Linux_SambaGlobalPrintingOptions dataInstance) {
		...
		return Linux_SambaGlobalPrintingOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaGlobalPrintingOptions getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = Linux_SambaGlobalPrintingOptions.getPackages();
	...
	*/	
	public final static Linux_SambaGlobalPrintingOptions createInstance(CIMClient cimClient, Linux_SambaGlobalPrintingOptions dataInstance, boolean notifyDifferencies){ 
		...
		Linux_SambaGlobalPrintingOptions newDataInstance = null;
		try {
			newDataInstance = Linux_SambaGlobalPrintingOptionsHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaGlobalPrintingOptions modifyInstance(CIMClient cimClient, Linux_SambaGlobalPrintingOptions dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_SambaGlobalPrintingOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_SambaGlobalPrintingOptions dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_SambaGlobalPrintingOptions dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_SambaGlobalPrintingOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_SambaGlobalPrintingOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_SambaGlobalPrintingOptions.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_SambaGlobalPrintingOptions.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_SambaGlobalPrintingOptions.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_PrintcapCacheTime(UnsignedInt64 PrintcapCacheTime) {
		return true;
	}
