        ...
        this.container = new org.sblim.wbemsmt.samba.wizard.ShareWizardContainer(adapter,
                new org.sblim.wbemsmt.samba.wizard.ShareWizardContainerPanels() {
                    public DataContainer getPage1() throws WbemsmtException {
                        DataContainer dc = new org.sblim.wbemsmt.cli.samba.container.wizard.ShareWizardPage1Impl(
                                adapter);
                        return dc;
                    }

                    public DataContainer getPage2() throws WbemsmtException {
                        DataContainer dc = new org.sblim.wbemsmt.cli.samba.container.wizard.ShareWizardPage2Impl(
                                adapter);
                        return dc;
                    }

                    public DataContainer getPage4() throws WbemsmtException {
                        DataContainer dc = new org.sblim.wbemsmt.cli.samba.container.wizard.ShareWizardPage4Impl(
                                adapter);
                        return dc;
                    }
                });
