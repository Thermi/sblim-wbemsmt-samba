...
//**********************************************************************
   ...
   public Linux_SambaPrinterPrintingOptions(WBEMClient client, String namespace) throws WbemsmtException
   {
...
//**********************************************************************
   ...
   public boolean set_key_Name(String newValue)
   {
    ...
    public static CIMProperty create_key_Name(WBEMClient client, String namespace, String newValue) throws WbemsmtException {
        Linux_SambaPrinterPrintingOptions fco = new Linux_SambaPrinterPrintingOptions(client,namespace);
...
//**********************************************************************
     ...
     **/
     ...
     public java.util.List<Linux_SambaPrinterOptions> getAssociated_Linux_SambaPrinterOptions_Linux_SambaPrinterPrintingForPrinters(WBEMClient cimClient) throws WbemsmtException {
     ...
     **/
     ...
     public java.util.List<Linux_SambaPrinterOptions> getAssociated_Linux_SambaPrinterOptions_Linux_SambaPrinterPrintingForPrinters(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_Linux_SambaPrinterOptions_Linux_SambaPrinterPrintingForPrinterNames(WBEMClient cimClient) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_Linux_SambaPrinterOptions_Linux_SambaPrinterPrintingForPrinterNames(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_Linux_SambaPrinterOptions_Linux_SambaPrinterPrintingForPrinterNames(WBEMClient cimClient,boolean deep,String associationClass, String resultClass, String role, String resultRole) throws WbemsmtException {
   ...
   public java.util.List<Linux_SambaPrinterPrintingForPrinter> getAssociations_Linux_SambaPrinterPrintingForPrinter(WBEMClient cimClient, boolean includeQualifiers, boolean includeClassOrigin, String role,java.lang.String[] propertyList) throws WbemsmtException {

       if (cimClient == null) {
            throw new WbemsmtException(WbemsmtException.ERR_INVALID_PARAMETER ,"The cimClient parameter does not contain a valid reference.");
       }

       java.util.List<Linux_SambaPrinterPrintingForPrinter> result = new java.util.ArrayList<Linux_SambaPrinterPrintingForPrinter>();
       CloseableIterator enumeration = null;
          ...
          while (enumeration.hasNext()) {
             ...
             if (obj instanceof CIMInstance) {
                ...
                try {
                   Object[] actargs = new Object[] {cimInstance};
                   Object dataObj = cons.newInstance(actargs);
                   result.add((Linux_SambaPrinterPrintingForPrinter)dataObj);
                } catch (Exception e) {
                   System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of the base class.");
                   result.add(new Linux_SambaPrinterPrintingForPrinter(cimInstance));
                   continue;
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociationNames_Linux_SambaPrinterPrintingForPrinter(WBEMClient cimClient,String role, boolean deep) throws WbemsmtException {
        ...
        try {
                while (enumeration.hasNext()) {
                   ...
                   if (obj instanceof CIMObjectPath) {
                      if (deep || ((CIMObjectPath)obj).getObjectName().equals(Linux_SambaPrinterPrintingForPrinter.CIM_CLASS_NAME)) {
                         result.add((CIMObjectPath)obj);
                      }
                   }
                }
