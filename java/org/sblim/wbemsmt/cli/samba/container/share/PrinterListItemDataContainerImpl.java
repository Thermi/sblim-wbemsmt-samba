...
public class PrinterListItemDataContainerImpl extends BaseDataContainer implements
    ...
    public PrinterListItemDataContainerImpl(AbstractBaseCimAdapter adapter) throws WbemsmtException {
        super();
        setAdapter(adapter);
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "PrinterListItemDataContainer.caption"));
        }
