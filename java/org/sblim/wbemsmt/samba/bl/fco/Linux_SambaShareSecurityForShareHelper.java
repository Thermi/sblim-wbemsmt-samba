...
public class Linux_SambaShareSecurityForShareHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaShareSecurityForShare.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaShareSecurityForShare.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaShareSecurityForShareHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaShareSecurityForShare.");
                        resultArrayList.add(new Linux_SambaShareSecurityForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaShareSecurityForShare.");
                        resultArrayList.add(new Linux_SambaShareSecurityForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaShareSecurityForShare.");
                        resultArrayList.add(new Linux_SambaShareSecurityForShare(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaShareSecurityForShare getInstance(WBEMClient client,
     ...
     */
    public final static Linux_SambaShareSecurityForShare getInstance(WBEMClient client,
            String namespace, Linux_SambaShareSecurityOptions SettingData,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaShareSecurityForShare.PROPERTY_SETTINGDATA_LINUX_SAMBASHARESECURITYOPTIONS.NAME,
                new CIMDataType(Linux_SambaShareSecurityOptions.CIM_CLASS_NAME), setThis, false,
                false, Linux_SambaShareSecurityForShare.CIM_CLASS_NAME);

        setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                Linux_SambaShareSecurityForShare.PROPERTY_MANAGEDELEMENT_LINUX_SAMBASHAREOPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaShareSecurityForShare createInstance(WBEMClient client,
            Linux_SambaShareSecurityForShare dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaShareSecurityForShare newDataInstance = Linux_SambaShareSecurityForShareHelper
     ...
     */
    public final static Linux_SambaShareSecurityForShare modifyInstance(WBEMClient client,
            Linux_SambaShareSecurityForShare dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaShareSecurityForShare dataInstance2 = Linux_SambaShareSecurityForShareHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaShareSecurityForShare dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaShareSecurityForShare.getPackages());
    }
