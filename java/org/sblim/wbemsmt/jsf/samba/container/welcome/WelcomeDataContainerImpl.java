...
public class WelcomeDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel implements
    ...
    public WelcomeDataContainerImpl(org.sblim.wbemsmt.samba.bl.adapter.SambaCimAdapter adapter,
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_WelcomeText() {
        if (ic_usr_WelcomeText == null) {
            ...
            ic_usr_WelcomeText = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_SharePicture() {
        if (ic_usr_SharePicture == null) {
            ...
            ic_usr_SharePicture = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFPictureComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_LinkCreateShare() {
        if (ic_usr_LinkCreateShare == null) {
            ...
            boolean readOnly = false;
            ic_usr_LinkCreateShare = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLinkComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Memo() {
        if (ic_usr_Memo == null) {
            ...
            boolean readOnly = false;
            ic_usr_Memo = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFMemoComponent(parent,
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_LinkCreatePrinter() {
        if (ic_usr_LinkCreatePrinter == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.jsf.LinkDataConverter();
            boolean readOnly = false;
            ic_usr_LinkCreatePrinter = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLinkComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_LinkCreateUser() {
        if (ic_usr_LinkCreateUser == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.jsf.LinkDataConverter();
            boolean readOnly = false;
            ic_usr_LinkCreateUser = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLinkComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Actions() {
        if (ic_usr_Actions == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Actions = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(parent,
                    label, binding, converter, readOnly);
            ;
        }
    ...
    public void reload() {
        ...
        if (ic_usr_LinkCreateShare != null) {
            ic_usr_LinkCreateShare.setLabelText(bundle
                    .getString("WelcomeDataContainer.linkCreateShare"));
        }
        if (ic_usr_Memo != null) {
            ic_usr_Memo.setLabelText(bundle.getString("WelcomeDataContainer.memo"));
        }
        if (ic_usr_LinkCreatePrinter != null) {
            ic_usr_LinkCreatePrinter.setLabelText(bundle
                    .getString("WelcomeDataContainer.linkCreatePrinter"));
        }
        if (ic_usr_LinkCreateUser != null) {
            ic_usr_LinkCreateUser.setLabelText(bundle
