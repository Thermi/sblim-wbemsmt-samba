...
public class Linux_SambaForceGroupForShare extends CIM_Component {
    ...
    public Linux_SambaForceGroupForShare(WBEMClient client, String namespace)
    ...
    public Linux_SambaForceGroupForShare(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaForceGroupForShare() {
    }
    ...
    public static CIMProperty create_GroupComponent_Linux_SambaShareOptions(WBEMClient client,
        ...
        Linux_SambaForceGroupForShare fco = new Linux_SambaForceGroupForShare(client, namespace);
    ...
    public String getObjectName() {
        return Linux_SambaForceGroupForShare.CIM_CLASS_NAME;
    }
