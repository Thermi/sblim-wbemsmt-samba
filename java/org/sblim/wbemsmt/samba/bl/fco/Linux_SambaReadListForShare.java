...
public class Linux_SambaReadListForShare extends CIM_Component {
    ...
    public Linux_SambaReadListForShare(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public Linux_SambaReadListForShare(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaReadListForShare() {
    }
    ...
    public static CIMProperty create_PartComponent_Linux_SambaUser(WBEMClient client,
        ...
        Linux_SambaReadListForShare fco = new Linux_SambaReadListForShare(client, namespace);
    ...
    public String getObjectName() {
        return Linux_SambaReadListForShare.CIM_CLASS_NAME;
    }
