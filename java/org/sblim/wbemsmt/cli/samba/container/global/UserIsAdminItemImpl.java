...
public class UserIsAdminItemImpl extends BaseDataContainer implements
    ...
    public UserIsAdminItemImpl(AbstractBaseCimAdapter adapter) throws WbemsmtException {
        super();
        setAdapter(adapter);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_SambaUserName() {
        if (ic_usr_SambaUserName == null) {
            String label = getAdapter().getBundle().getString("UserIsAdminItem.SambaUserName");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Admin() {
        if (ic_usr_Admin == null) {
            String label = getAdapter().getBundle().getString("UserIsAdminItem.admin");
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString("UserIsAdminItem.caption"));
        }
