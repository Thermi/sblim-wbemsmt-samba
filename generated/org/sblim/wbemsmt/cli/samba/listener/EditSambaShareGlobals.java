/**
 * EditSambaShareGlobals.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class EditSambaShareGlobals extends CimCommand {
    ...
    public static final OptionDefinition KEY_createMask = new OptionDefinition(null, "createMask",
            null, "CMDShareGlobalsDataContainer.CreateMask.argValue", false, false,
            "CMDShareGlobalsDataContainer.CreateMask.argDescription");
    /**
     * The directory Mask  --directoryMask
     */
    public static final OptionDefinition KEY_directoryMask = new OptionDefinition(null,
            "directoryMask", null, "CMDShareGlobalsDataContainer.DirectoryMask.argValue", false,
            false, "CMDShareGlobalsDataContainer.DirectoryMask.argDescription");
    /**
     *  --directorySecurityMask
     */
    public static final OptionDefinition KEY_directorySecurityMask = new OptionDefinition(null,
            "directorySecurityMask", null,
            "CMDShareGlobalsDataContainer.DirectorySecurityMask.argValue", false, false,
            "CMDShareGlobalsDataContainer.DirectorySecurityMask.argDescription");
    /**
     *  --caseSensitive
     */
    public static final OptionDefinition KEY_caseSensitive = new OptionDefinition(null,
            "caseSensitive", null, "ShareGlobalsDataContainer.CaseSensitive.argValue", false,
            false, "ShareGlobalsDataContainer.CaseSensitive.argDescription");
    /**
     *  --dosFiletimes
     */
    public static final OptionDefinition KEY_dosFiletimes = new OptionDefinition(null,
            "dosFiletimes", null, "ShareGlobalsDataContainer.DosFiletimes.argValue", false, false,
            "ShareGlobalsDataContainer.DosFiletimes.argDescription");
    /**
     *  --hideDotFiles
     */
    public static final OptionDefinition KEY_hideDotFiles = new OptionDefinition(null,
            "hideDotFiles", null, "ShareGlobalsDataContainer.HideDotFiles.argValue", false, false,
            "ShareGlobalsDataContainer.HideDotFiles.argDescription");
    /**
     *  --aclCompatibility
     */
    public static final OptionDefinition KEY_aclCompatibility = new OptionDefinition(null,
            "aclCompatibility", null, "ShareGlobalsDataContainer.AclCompatibility.argValue", false,
            false, "ShareGlobalsDataContainer.AclCompatibility.argDescription");
    /**
     *  --eaSupport
     */
    public static final OptionDefinition KEY_eaSupport = new OptionDefinition(null, "eaSupport",
            null, "ShareGlobalsDataContainer.EASupport.argValue", false, false,
            "ShareGlobalsDataContainer.EASupport.argDescription");
    /**
     *  --ntaclSupport
     */
    public static final OptionDefinition KEY_ntaclSupport = new OptionDefinition(null,
            "ntaclSupport", null, "ShareGlobalsDataContainer.NTACLSupport.argValue", false, false,
            "ShareGlobalsDataContainer.NTACLSupport.argDescription");
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] {
            KEY_createMask, KEY_directoryMask, KEY_directorySecurityMask, KEY_caseSensitive,
            KEY_dosFiletimes, KEY_hideDotFiles, KEY_aclCompatibility, KEY_eaSupport,
            KEY_ntaclSupport, };
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("CMDShareGlobalsDataContainer.caption") }));

            CliDataLoader loader = new EditSambaShareGlobalsLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.cli.samba.container.global.CMDShareGlobalsDataContainerImpl dc = new org.sblim.wbemsmt.cli.samba.container.global.CMDShareGlobalsDataContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.samba.bl.container.global.CMDShareGlobalsDataContainer dc)
