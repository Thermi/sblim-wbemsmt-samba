...
public class Linux_SambaCommonSecurityForPrinterHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaCommonSecurityForPrinter.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaCommonSecurityForPrinter.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaCommonSecurityForPrinterHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaCommonSecurityForPrinter.");
                        resultArrayList.add(new Linux_SambaCommonSecurityForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaCommonSecurityForPrinter.");
                        resultArrayList.add(new Linux_SambaCommonSecurityForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaCommonSecurityForPrinter.");
                        resultArrayList.add(new Linux_SambaCommonSecurityForPrinter(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaCommonSecurityForPrinter getInstance(WBEMClient client,
     ...
     */
    public final static Linux_SambaCommonSecurityForPrinter getInstance(WBEMClient client,
            String namespace, Linux_SambaCommonSecurityOptions SettingData,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaCommonSecurityForPrinter.PROPERTY_SETTINGDATA_LINUX_SAMBACOMMONSECURITYOPTIONS.NAME,
                new CIMDataType(Linux_SambaCommonSecurityOptions.CIM_CLASS_NAME), setThis, false,
                false, Linux_SambaCommonSecurityForPrinter.CIM_CLASS_NAME);

        setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                Linux_SambaCommonSecurityForPrinter.PROPERTY_MANAGEDELEMENT_LINUX_SAMBAPRINTEROPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaCommonSecurityForPrinter createInstance(WBEMClient client,
            Linux_SambaCommonSecurityForPrinter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaCommonSecurityForPrinter newDataInstance = Linux_SambaCommonSecurityForPrinterHelper
     ...
     */
    public final static Linux_SambaCommonSecurityForPrinter modifyInstance(WBEMClient client,
            Linux_SambaCommonSecurityForPrinter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaCommonSecurityForPrinter dataInstance2 = Linux_SambaCommonSecurityForPrinterHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaCommonSecurityForPrinter dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaCommonSecurityForPrinter.getPackages());
    }
