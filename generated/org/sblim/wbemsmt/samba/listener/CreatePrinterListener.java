/**
 * CreatePrinterListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class CreatePrinterListener extends TaskLauncherContextMenuEventListenerImpl implements
        org.sblim.wbemsmt.tasklauncher.event.CreateListener {

    String jsfListener = "org.sblim.wbemsmt.jsf.samba.listener.CreatePrinterListener";
    String swingListener = "org.sblim.wbemsmt.jswing.samba.listener.CreatePrinterListener";

    //String cmdListener = "org.sblim.wbemsmt.cli.samba.listener.CreatePrinterListener";
