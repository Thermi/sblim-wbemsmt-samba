...
public class ListSambaService extends CimCommand {
	...
	//All Options that are local and defined for this command
		 ...
		 */
		public static final OptionDefinition KEY_list = new OptionDefinition(null,"list","INSTANCE_WITH_CHILDS","ListSambaService.list.argValue",false,false,"ListSambaService.list.argDescription");
