...
public final class Linux_SambaPrinterBrowseForPrinterHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new Linux_SambaPrinterBrowseForPrinter(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<Linux_SambaPrinterBrowseForPrinter.Java_Package_List.size(); i++) {
						if (!((String)(Linux_SambaPrinterBrowseForPrinter.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(Linux_SambaPrinterBrowseForPrinter.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							Linux_SambaPrinterBrowseForPrinter.Java_Package_List.setElementAt((String)(Linux_SambaPrinterBrowseForPrinter.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (Linux_SambaPrinterBrowseForPrinter.Java_Package_List.get(i)) + cimClassName;
	...
	*/	
	public final static Linux_SambaPrinterBrowseForPrinter getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_SambaPrinterBrowseForPrinterHelper.getInstance(cimClient, new Linux_SambaPrinterBrowseForPrinter(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaPrinterBrowseForPrinter getInstance(CIMClient cimClient, Linux_SambaPrinterBrowseForPrinter dataInstance) {
		...
		return Linux_SambaPrinterBrowseForPrinterHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaPrinterBrowseForPrinter getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			dataInstance = new Linux_SambaPrinterBrowseForPrinter(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaPrinterBrowseForPrinter createInstance(CIMClient cimClient, Linux_SambaPrinterBrowseForPrinter dataInstance, boolean notifyDifferencies){ 
		...
		Linux_SambaPrinterBrowseForPrinter newDataInstance = null;
		try {
			newDataInstance = Linux_SambaPrinterBrowseForPrinterHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaPrinterBrowseForPrinter modifyInstance(CIMClient cimClient, Linux_SambaPrinterBrowseForPrinter dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_SambaPrinterBrowseForPrinterHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_SambaPrinterBrowseForPrinter dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_SambaPrinterBrowseForPrinter dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_SambaPrinterBrowseForPrinter.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_SambaPrinterBrowseForPrinter.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_SambaPrinterBrowseForPrinter.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_SambaPrinterBrowseForPrinter.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_SambaPrinterBrowseForPrinter.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_Linux_SambaPrinterBrowseOptions(Linux_SambaPrinterBrowseOptions Linux_SambaPrinterBrowseOptions) {
		return true;
	}
