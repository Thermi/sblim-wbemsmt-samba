...
public class Linux_SambaHostHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaHost.CIM_CLASS_NAME,
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_SambaHost.");
                        resultArrayList.add(new Linux_SambaHost(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaHost.");
                        resultArrayList.add(new Linux_SambaHost(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaHost.");
                        resultArrayList.add(new Linux_SambaHost(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaHost getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static Linux_SambaHost getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
     ...
     */
    public final static Linux_SambaHost getInstance(WBEMClient client, String namespace, String Name
        ...
        keyProperties[0] = new CIMProperty(Linux_SambaHost.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_SambaHost.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_SambaHost createInstance(WBEMClient client,
            Linux_SambaHost dataInstance, boolean notifyDifferencies) throws WbemsmtException {
     ...
     */
    public final static Linux_SambaHost modifyInstance(WBEMClient client,
            Linux_SambaHost dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaHost dataInstance2 = Linux_SambaHostHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, Linux_SambaHost dataInstance)
            throws WbemsmtException {
