...
public class UserListItemDataContainerImpl extends BaseDataContainer implements
    ...
    public UserListItemDataContainerImpl(AbstractBaseCimAdapter adapter) throws WbemsmtException {
        super();
        setAdapter(adapter);
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "UserListItemDataContainer.caption"));
        }
