...
public class UserACLItemDataContainerForShareImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.samba.bl.container.share.UserACLItemDataContainerForShare {
    ...
    public UserACLItemDataContainerForShareImpl(
    ...
    public void reload() {
        ...
        if (ic_SambaUserName != null) {
            ic_SambaUserName.setLabelText(bundle
                    .getString("UserACLItemDataContainerForShare.SambaUserName"));
        }
        if (ic_usr_AccessTypeVI != null) {
            ic_usr_AccessTypeVI.setLabelText(bundle
                    .getString("UserACLItemDataContainerForShare.accessTypeVI"));
        }
        if (ic_usr_AccessTypeRW != null) {
            ic_usr_AccessTypeRW.setLabelText(bundle
                    .getString("UserACLItemDataContainerForShare.accessTypeRW"));
        }
        if (ic_usr_Admin != null) {
