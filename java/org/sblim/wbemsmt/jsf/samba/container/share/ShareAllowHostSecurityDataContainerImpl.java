...
public class ShareAllowHostSecurityDataContainerImpl extends
    ...
    public ShareAllowHostSecurityDataContainerImpl(
    ...
    public void reload() {
        ...
        if (ic_usr_AllowedHosts != null) {
            ic_usr_AllowedHosts.setLabelText(bundle
                    .getString("ShareAllowHostSecurityDataContainer.allowedHosts"));
        }
        if (ic_usr_HostsToAllow != null) {
            ic_usr_HostsToAllow.setLabelText(bundle
                    .getString("ShareAllowHostSecurityDataContainer.hostsToAllow"));
        }
        if (ic_usr_AddHost != null) {
            ic_usr_AddHost.setLabelText(bundle
                    .getString("ShareAllowHostSecurityDataContainer.addHost"));
        }
        if (ic_usr_RemoveHost != null) {
            ic_usr_RemoveHost.setLabelText(bundle
                    .getString("ShareAllowHostSecurityDataContainer.removeHost"));
        }
    }
