...
public class Linux_SambaAdminUsersForShareHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaAdminUsersForShare.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaAdminUsersForShare.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaAdminUsersForShareHelper
                            .findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaAdminUsersForShare.");
                        resultArrayList.add(new Linux_SambaAdminUsersForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaAdminUsersForShare.");
                        resultArrayList.add(new Linux_SambaAdminUsersForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaAdminUsersForShare.");
                        resultArrayList.add(new Linux_SambaAdminUsersForShare(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaAdminUsersForShare getInstance(WBEMClient client,
    ...
    public final static Linux_SambaAdminUsersForShare getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaAdminUsersForShare.PROPERTY_PARTCOMPONENT_LINUX_SAMBAUSER.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_SambaAdminUsersForShare.PROPERTY_GROUPCOMPONENT_LINUX_SAMBASHAREOPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaAdminUsersForShare createInstance(WBEMClient client,
            Linux_SambaAdminUsersForShare dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaAdminUsersForShare newDataInstance = Linux_SambaAdminUsersForShareHelper
     ...
     */
    public final static Linux_SambaAdminUsersForShare modifyInstance(WBEMClient client,
            Linux_SambaAdminUsersForShare dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaAdminUsersForShare dataInstance2 = Linux_SambaAdminUsersForShareHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaAdminUsersForShare dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaAdminUsersForShare.getPackages());
    }
