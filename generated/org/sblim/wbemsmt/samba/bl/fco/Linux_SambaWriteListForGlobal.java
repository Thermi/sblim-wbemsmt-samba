/**
 * Linux_SambaWriteListForGlobal.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class Linux_SambaWriteListForGlobal extends CIM_Component {
    ...
    public Linux_SambaWriteListForGlobal(WBEMClient client, String namespace)
    ...
    public Linux_SambaWriteListForGlobal(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaWriteListForGlobal() {
    }
    ...
    public static CIMProperty create_PartComponent_Linux_SambaUser(WBEMClient client,
        ...
        Linux_SambaWriteListForGlobal fco = new Linux_SambaWriteListForGlobal(client, namespace);
    ...
    public String getObjectName() {
        return Linux_SambaWriteListForGlobal.CIM_CLASS_NAME;
    }
