...
public class Linux_SambaWinsForGlobalHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaWinsForGlobal.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaWinsForGlobal.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_SambaWinsForGlobal.");
                        resultArrayList.add(new Linux_SambaWinsForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaWinsForGlobal.");
                        resultArrayList.add(new Linux_SambaWinsForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaWinsForGlobal.");
                        resultArrayList.add(new Linux_SambaWinsForGlobal(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaWinsForGlobal getInstance(WBEMClient client,
    ...
    public final static Linux_SambaWinsForGlobal getInstance(WBEMClient client, String namespace,
            Linux_SambaWinsOptions SettingData, Linux_SambaGlobalOptions ManagedElement
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaWinsForGlobal.PROPERTY_SETTINGDATA_LINUX_SAMBAWINSOPTIONS.NAME,
                new CIMDataType(Linux_SambaWinsOptions.CIM_CLASS_NAME), setThis, false, false,
                Linux_SambaWinsForGlobal.CIM_CLASS_NAME);

        setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                Linux_SambaWinsForGlobal.PROPERTY_MANAGEDELEMENT_LINUX_SAMBAGLOBALOPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaWinsForGlobal createInstance(WBEMClient client,
            Linux_SambaWinsForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaWinsForGlobal newDataInstance = Linux_SambaWinsForGlobalHelper.getInstance(
                client, cimObjectPath);
     ...
     */
    public final static Linux_SambaWinsForGlobal modifyInstance(WBEMClient client,
            Linux_SambaWinsForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaWinsForGlobal dataInstance2 = Linux_SambaWinsForGlobalHelper.getInstance(
                    client, dataInstance.getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, Linux_SambaWinsForGlobal dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaWinsForGlobal.getPackages());
    }
