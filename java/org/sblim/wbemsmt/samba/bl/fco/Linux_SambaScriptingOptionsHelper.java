...
public class Linux_SambaScriptingOptionsHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaScriptingOptions.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaScriptingOptions.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_SambaScriptingOptions.");
                        resultArrayList.add(new Linux_SambaScriptingOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaScriptingOptions.");
                        resultArrayList.add(new Linux_SambaScriptingOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaScriptingOptions.");
                        resultArrayList.add(new Linux_SambaScriptingOptions(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaScriptingOptions getInstance(WBEMClient client,
    ...
    public final static Linux_SambaScriptingOptions getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(Linux_SambaScriptingOptions.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                Linux_SambaScriptingOptions.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(Linux_SambaScriptingOptions.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                Linux_SambaScriptingOptions.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_SambaScriptingOptions createInstance(WBEMClient client,
            Linux_SambaScriptingOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaScriptingOptions newDataInstance = Linux_SambaScriptingOptionsHelper
     ...
     */
    public final static Linux_SambaScriptingOptions modifyInstance(WBEMClient client,
            Linux_SambaScriptingOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaScriptingOptions dataInstance2 = Linux_SambaScriptingOptionsHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaScriptingOptions dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaScriptingOptions.getPackages());
    }
