...
public class ServiceGlobalSecurityOptionsDataContainerImpl extends
        org.sblim.wbemsmt.tools.jsf.EditBasePanel implements
        org.sblim.wbemsmt.samba.bl.container.service.ServiceGlobalSecurityOptionsDataContainer {
    ...
    public ServiceGlobalSecurityOptionsDataContainerImpl(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_AuthMethods() {
        if (ic_AuthMethods == null) {
            String label = bundle
                    .getString("ServiceGlobalSecurityOptionsDataContainer.AuthMethods");
            String binding = bindingPrefix + "_AuthMethods.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_AuthMethods = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_EncryptPasswords() {
        if (ic_EncryptPasswords == null) {
            String label = bundle
                    .getString("ServiceGlobalSecurityOptionsDataContainer.EncryptPasswords");
            String binding = bindingPrefix + "_EncryptPasswords.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_EncryptPasswords = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFCheckboxComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_MinPasswordLength() {
        if (ic_MinPasswordLength == null) {
            String label = bundle
                    .getString("ServiceGlobalSecurityOptionsDataContainer.MinPasswordLength");
            ...
            boolean readOnly = false;
            ic_MinPasswordLength = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_NullPasswords() {
        if (ic_NullPasswords == null) {
            String label = bundle
                    .getString("ServiceGlobalSecurityOptionsDataContainer.NullPasswords");
            String binding = bindingPrefix + "_NullPasswords.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_NullPasswords = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFCheckboxComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_PassdbBackend() {
        if (ic_usr_PassdbBackend == null) {
            String label = bundle
                    .getString("ServiceGlobalSecurityOptionsDataContainer.PassdbBackend");
            String binding = bindingPrefix + "_usr_PassdbBackend.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.UnsignedInt16StringConverter();
            boolean readOnly = false;
            ic_usr_PassdbBackend = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFComboBoxComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_SMBPasswdFile() {
        if (ic_SMBPasswdFile == null) {
            String label = bundle
                    .getString("ServiceGlobalSecurityOptionsDataContainer.SMBPasswdFile");
            String binding = bindingPrefix + "_SMBPasswdFile.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_SMBPasswdFile = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_Security() {
        if (ic_Security == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.UnsignedInt8StringConverter();
            boolean readOnly = false;
            ic_Security = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFComboBoxComponent(parent,
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_DomainMaster() {
        if (ic_DomainMaster == null) {
            String label = bundle
                    .getString("ServiceGlobalSecurityOptionsDataContainer.DomainMaster");
            String binding = bindingPrefix + "_DomainMaster.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.UnsignedInt16StringConverter();
            boolean readOnly = false;
            ic_DomainMaster = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFComboBoxComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public void reload() {
        super.reload();
        if (ic_AuthMethods != null) {
            ic_AuthMethods.setLabelText(bundle
                    .getString("ServiceGlobalSecurityOptionsDataContainer.AuthMethods"));
        }
        if (ic_EncryptPasswords != null) {
            ic_EncryptPasswords.setLabelText(bundle
                    .getString("ServiceGlobalSecurityOptionsDataContainer.EncryptPasswords"));
        }
        if (ic_MinPasswordLength != null) {
            ic_MinPasswordLength.setLabelText(bundle
                    .getString("ServiceGlobalSecurityOptionsDataContainer.MinPasswordLength"));
        }
        if (ic_NullPasswords != null) {
            ic_NullPasswords.setLabelText(bundle
                    .getString("ServiceGlobalSecurityOptionsDataContainer.NullPasswords"));
        }
        if (ic_usr_PassdbBackend != null) {
            ic_usr_PassdbBackend.setLabelText(bundle
                    .getString("ServiceGlobalSecurityOptionsDataContainer.PassdbBackend"));
        }
        if (ic_SMBPasswdFile != null) {
            ic_SMBPasswdFile.setLabelText(bundle
                    .getString("ServiceGlobalSecurityOptionsDataContainer.SMBPasswdFile"));
        }
        if (ic_Security != null) {
            ic_Security.setLabelText(bundle
                    .getString("ServiceGlobalSecurityOptionsDataContainer.Security"));
        }
        if (ic_GuestOK != null) {
            ic_GuestOK.setLabelText(bundle
                    .getString("ServiceGlobalSecurityOptionsDataContainer.GuestOK"));
        }
        if (ic_GuestOnly != null) {
            ic_GuestOnly.setLabelText(bundle
                    .getString("ServiceGlobalSecurityOptionsDataContainer.GuestOnly"));
        }
        if (ic_HostsAllow != null) {
            ic_HostsAllow.setLabelText(bundle
                    .getString("ServiceGlobalSecurityOptionsDataContainer.HostsAllow"));
        }
        if (ic_HostsDeny != null) {
            ic_HostsDeny.setLabelText(bundle
                    .getString("ServiceGlobalSecurityOptionsDataContainer.HostsDeny"));
        }
        if (ic_ReadOnly != null) {
            ic_ReadOnly.setLabelText(bundle
                    .getString("ServiceGlobalSecurityOptionsDataContainer.ReadOnly"));
        }
        if (ic_DomainMaster != null) {
            ic_DomainMaster.setLabelText(bundle
                    .getString("ServiceGlobalSecurityOptionsDataContainer.DomainMaster"));
        }
        if (ic_Browsable != null) {
            ic_Browsable.setLabelText(bundle
                    .getString("ServiceGlobalSecurityOptionsDataContainer.Browsable"));
        }
    }
