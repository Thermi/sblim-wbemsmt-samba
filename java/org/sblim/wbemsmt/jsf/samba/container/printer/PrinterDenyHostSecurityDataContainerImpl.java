...
public class PrinterDenyHostSecurityDataContainerImpl extends
    ...
    public PrinterDenyHostSecurityDataContainerImpl(
    ...
    public void reload() {
        ...
        if (ic_usr_DeniedHosts != null) {
            ic_usr_DeniedHosts.setLabelText(bundle
                    .getString("PrinterDenyHostSecurityDataContainer.deniedHosts"));
        }
        if (ic_usr_HostsToDeny != null) {
            ic_usr_HostsToDeny.setLabelText(bundle
                    .getString("PrinterDenyHostSecurityDataContainer.hostsToDeny"));
        }
        if (ic_usr_AddHost != null) {
            ic_usr_AddHost.setLabelText(bundle
                    .getString("PrinterDenyHostSecurityDataContainer.addHost"));
        }
        if (ic_usr_RemoveHost != null) {
            ic_usr_RemoveHost.setLabelText(bundle
                    .getString("PrinterDenyHostSecurityDataContainer.removeHost"));
        }
    }
