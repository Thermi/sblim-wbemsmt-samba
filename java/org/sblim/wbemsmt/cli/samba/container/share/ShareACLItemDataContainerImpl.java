/** 
 * ShareACLItemDataContainerImpl.java
 * 
...
public class ShareACLItemDataContainerImpl extends BaseDataContainer implements
        org.sblim.wbemsmt.samba.bl.container.share.ShareACLItemDataContainer {
    ...
    public ShareACLItemDataContainerImpl(AbstractBaseCimAdapter adapter) throws WbemsmtException {
        super();
        setAdapter(adapter);
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "ShareACLItemDataContainer.caption"));
        }
        ...
        if (showInstance(listOptions)) {
            if (get_ShareName().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_ShareName())
                        .getValue();
