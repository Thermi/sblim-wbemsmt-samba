/**
 * Linux_SambaShareSecurityForGlobal.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED
...
public class Linux_SambaShareSecurityForGlobal extends CIM_ElementSettingData {
    ...
    public Linux_SambaShareSecurityForGlobal(WBEMClient client, String namespace)
    ...
    public Linux_SambaShareSecurityForGlobal(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaShareSecurityForGlobal() {
    }
    ...
    public static CIMProperty create_SettingData_Linux_SambaShareSecurityOptions(WBEMClient client,
        ...
        Linux_SambaShareSecurityForGlobal fco = new Linux_SambaShareSecurityForGlobal(client,
                namespace);
    ...
    public String getObjectName() {
        return Linux_SambaShareSecurityForGlobal.CIM_CLASS_NAME;
    }
