...
public class ShareGlobalsDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.samba.bl.container.global.ShareGlobalsDataContainer {
    ...
    public ShareGlobalsDataContainerImpl(
    ...
    public void reload() {
        ...
        if (ic_CaseSensitive != null) {
            ic_CaseSensitive.setLabelText(bundle
                    .getString("ShareGlobalsDataContainer.CaseSensitive"));
        }
        if (ic_DosFiletimes != null) {
            ic_DosFiletimes
                    .setLabelText(bundle.getString("ShareGlobalsDataContainer.DosFiletimes"));
        }
        if (ic_HideDotFiles != null) {
            ic_HideDotFiles
                    .setLabelText(bundle.getString("ShareGlobalsDataContainer.HideDotFiles"));
        }
        if (ic_AclCompatibility != null) {
            ic_AclCompatibility.setLabelText(bundle
                    .getString("ShareGlobalsDataContainer.AclCompatibility"));
        }
        if (ic_EASupport != null) {
        ...
        if (ic_NTACLSupport != null) {
            ic_NTACLSupport
                    .setLabelText(bundle.getString("ShareGlobalsDataContainer.NTACLSupport"));
        }
    }
