/**
 * ListSambaServiceUserSecurity.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
 ...
 * @template: org/sblim/wbemsmt/dcg/templates/cmd/listCommand.vm Contributors: Prashanth
 *            Karnam<prkarnam@in.ibm.com> Description: Class for listing objects generated Class
 */
...
public class ListSambaServiceUserSecurity extends CimCommand {
    ...
    public static final OptionDefinition KEY_list = new OptionDefinition(null, "list",
            "INSTANCE_WITH_CHILDS", "ListSambaServiceUserSecurity.list.argValue", false, false,
            "ListSambaServiceUserSecurity.list.argDescription");
    ...
    public void execute(CimCommandValues values) throws WbemsmtException {
        ...
        try {
                            ...
                            "\n"
                                    + bundle
                                            .getString(
                                                    "listing",
                                                    new Object[] { bundle
                                                            .getString("ServiceUserSecurityOptionsDataContainer.caption") }));

            CliDataLoader loader = new ListSambaServiceUserSecurityLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.cli.samba.container.service.ServiceUserSecurityOptionsDataContainerImpl dc = new org.sblim.wbemsmt.cli.samba.container.service.ServiceUserSecurityOptionsDataContainerImpl(
                    adapter);
            ...
            for (int i = 0; i < count; i++) {
                org.sblim.wbemsmt.cli.samba.container.service.UserACLItemDataContainerForServiceImpl child = new org.sblim.wbemsmt.cli.samba.container.service.UserACLItemDataContainerForServiceImpl(
                        adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.samba.bl.container.service.ServiceUserSecurityOptionsDataContainer dc)
