...
public class Linux_SambaPrinterPrintingForPrinterHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaPrinterPrintingForPrinter.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaPrinterPrintingForPrinter.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaPrinterPrintingForPrinterHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaPrinterPrintingForPrinter.");
                        resultArrayList.add(new Linux_SambaPrinterPrintingForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaPrinterPrintingForPrinter.");
                        resultArrayList.add(new Linux_SambaPrinterPrintingForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaPrinterPrintingForPrinter.");
                        resultArrayList.add(new Linux_SambaPrinterPrintingForPrinter(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaPrinterPrintingForPrinter getInstance(WBEMClient client,
     ...
     */
    public final static Linux_SambaPrinterPrintingForPrinter getInstance(WBEMClient client,
            String namespace, Linux_SambaPrinterPrintingOptions SettingData,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaPrinterPrintingForPrinter.PROPERTY_SETTINGDATA_LINUX_SAMBAPRINTERPRINTINGOPTIONS.NAME,
                new CIMDataType(Linux_SambaPrinterPrintingOptions.CIM_CLASS_NAME), setThis, false,
                false, Linux_SambaPrinterPrintingForPrinter.CIM_CLASS_NAME);

        setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                Linux_SambaPrinterPrintingForPrinter.PROPERTY_MANAGEDELEMENT_LINUX_SAMBAPRINTEROPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaPrinterPrintingForPrinter createInstance(WBEMClient client,
            Linux_SambaPrinterPrintingForPrinter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaPrinterPrintingForPrinter newDataInstance = Linux_SambaPrinterPrintingForPrinterHelper
     ...
     */
    public final static Linux_SambaPrinterPrintingForPrinter modifyInstance(WBEMClient client,
            Linux_SambaPrinterPrintingForPrinter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaPrinterPrintingForPrinter dataInstance2 = Linux_SambaPrinterPrintingForPrinterHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaPrinterPrintingForPrinter dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaPrinterPrintingForPrinter.getPackages());
    }
