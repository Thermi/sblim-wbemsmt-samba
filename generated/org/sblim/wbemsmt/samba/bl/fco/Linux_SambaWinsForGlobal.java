/**
 * Linux_SambaWinsForGlobal.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class Linux_SambaWinsForGlobal extends CIM_ElementSettingData {
     ...
     * 
     */
    public static class PROPERTY_SETTINGDATA_LINUX_SAMBAWINSOPTIONS {
        /**
    ...
    public Linux_SambaWinsForGlobal(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public Linux_SambaWinsForGlobal(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaWinsForGlobal() {
    }
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        propertiesToCheck.put("SettingData", new CIMProperty("SettingData", new CIMDataType(
                Linux_SambaWinsOptions.CIM_CLASS_NAME), null));
    ...
    public Linux_SambaWinsOptions get_SettingData_Linux_SambaWinsOptions(
            javax.wbem.client.WBEMClient client) throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBAWINSOPTIONS.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_SETTINGDATA_LINUX_SAMBAWINSOPTIONS.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }

        return Linux_SambaWinsOptionsHelper.getInstance(client, (CIMObjectPath) currentProperty
                .getValue());
    ...
    public boolean set_SettingData_Linux_SambaWinsOptions(Linux_SambaWinsOptions newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBAWINSOPTIONS.NAME);
        if (currentProperty != null) {
            setProperty(setPropertyValue_SettingData_Linux_SambaWinsOptions(currentProperty,
                    newValue));
            return true;
        }
        else {
    ...
    public static CIMProperty create_SettingData_Linux_SambaWinsOptions(WBEMClient client,
            String namespace, Linux_SambaWinsOptions newValue) throws WbemsmtException {
        Linux_SambaWinsForGlobal fco = new Linux_SambaWinsForGlobal(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBAWINSOPTIONS.NAME);
        if (property != null) {
            property = setPropertyValue_SettingData_Linux_SambaWinsOptions(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_SETTINGDATA_LINUX_SAMBAWINSOPTIONS.NAME
    ...
    private static CIMProperty setPropertyValue_SettingData_Linux_SambaWinsOptions(
            CIMProperty currentProperty, Linux_SambaWinsOptions newValue) {
        Object setThis = null;
    ...
    public String getObjectName() {
        return Linux_SambaWinsForGlobal.CIM_CLASS_NAME;
    }
