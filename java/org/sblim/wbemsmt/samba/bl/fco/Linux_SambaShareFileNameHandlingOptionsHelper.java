...
public class Linux_SambaShareFileNameHandlingOptionsHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(
                Linux_SambaShareFileNameHandlingOptions.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    Linux_SambaShareFileNameHandlingOptions.CIM_CLASS_NAME)) {
                        resultArrayList
                                .add(new Linux_SambaShareFileNameHandlingOptions(cimInstance));
                        continue;
                    }
                    Class clazz = Linux_SambaShareFileNameHandlingOptionsHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaShareFileNameHandlingOptions.");
                        resultArrayList
                                .add(new Linux_SambaShareFileNameHandlingOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaShareFileNameHandlingOptions.");
                        resultArrayList
                                .add(new Linux_SambaShareFileNameHandlingOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaShareFileNameHandlingOptions.");
                        resultArrayList
                                .add(new Linux_SambaShareFileNameHandlingOptions(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaShareFileNameHandlingOptions getInstance(WBEMClient client,
    ...
    public final static Linux_SambaShareFileNameHandlingOptions getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaShareFileNameHandlingOptions.PROPERTY_INSTANCEID.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_SambaShareFileNameHandlingOptions.PROPERTY_NAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, Linux_SambaShareFileNameHandlingOptions.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_SambaShareFileNameHandlingOptions createInstance(WBEMClient client,
            Linux_SambaShareFileNameHandlingOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaShareFileNameHandlingOptions newDataInstance = Linux_SambaShareFileNameHandlingOptionsHelper
     ...
     */
    public final static Linux_SambaShareFileNameHandlingOptions modifyInstance(WBEMClient client,
            Linux_SambaShareFileNameHandlingOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaShareFileNameHandlingOptions dataInstance2 = Linux_SambaShareFileNameHandlingOptionsHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaShareFileNameHandlingOptions dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaShareFileNameHandlingOptions.getPackages());
    }
