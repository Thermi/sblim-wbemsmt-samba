...
public class Linux_SambaShareBrowseForShareHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaShareBrowseForShare.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaShareBrowseForShare.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaShareBrowseForShareHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaShareBrowseForShare.");
                        resultArrayList.add(new Linux_SambaShareBrowseForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaShareBrowseForShare.");
                        resultArrayList.add(new Linux_SambaShareBrowseForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaShareBrowseForShare.");
                        resultArrayList.add(new Linux_SambaShareBrowseForShare(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaShareBrowseForShare getInstance(WBEMClient client,
     ...
     */
    public final static Linux_SambaShareBrowseForShare getInstance(WBEMClient client,
            String namespace, Linux_SambaShareBrowseOptions SettingData,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaShareBrowseForShare.PROPERTY_SETTINGDATA_LINUX_SAMBASHAREBROWSEOPTIONS.NAME,
                new CIMDataType(Linux_SambaShareBrowseOptions.CIM_CLASS_NAME), setThis, false,
                false, Linux_SambaShareBrowseForShare.CIM_CLASS_NAME);

        setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                Linux_SambaShareBrowseForShare.PROPERTY_MANAGEDELEMENT_LINUX_SAMBASHAREOPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaShareBrowseForShare createInstance(WBEMClient client,
            Linux_SambaShareBrowseForShare dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaShareBrowseForShare newDataInstance = Linux_SambaShareBrowseForShareHelper
     ...
     */
    public final static Linux_SambaShareBrowseForShare modifyInstance(WBEMClient client,
            Linux_SambaShareBrowseForShare dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaShareBrowseForShare dataInstance2 = Linux_SambaShareBrowseForShareHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaShareBrowseForShare dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaShareBrowseForShare.getPackages());
    }
