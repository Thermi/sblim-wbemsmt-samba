		...
		this.container = new org.sblim.wbemsmt.samba.wizard.UserWizardContainer (new org.sblim.wbemsmt.samba.wizard.UserWizardContainerPanels()
 			{
					...
					DataContainer dc = new org.sblim.wbemsmt.cli.samba.container.wizard.UserWizardPage2Impl(adapter);
					return dc;
				}
            					public Object getPage3()  throws WbemSmtException {
					DataContainer dc = new org.sblim.wbemsmt.cli.samba.container.wizard.UserWizardPage3Impl(adapter);
					return dc;
				}
            	 			});
		super.initialize();
