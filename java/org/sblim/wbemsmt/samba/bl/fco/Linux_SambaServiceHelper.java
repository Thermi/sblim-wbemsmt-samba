...
public class Linux_SambaServiceHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaService.CIM_CLASS_NAME,
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(Linux_SambaService.CIM_CLASS_NAME)) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_SambaService.");
                        resultArrayList.add(new Linux_SambaService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaService.");
                        resultArrayList.add(new Linux_SambaService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaService.");
                        resultArrayList.add(new Linux_SambaService(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaService getInstance(WBEMClient client,
     ...
     */
    public final static Linux_SambaService getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static Linux_SambaService getInstance(WBEMClient client, String namespace,
            String CreationClassName, String Name, String SystemCreationClassName, String SystemName
        ...
        keyProperties[0] = new CIMProperty(Linux_SambaService.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_SambaService.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(Linux_SambaService.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_SambaService.CIM_CLASS_NAME);

        setThis = SystemCreationClassName;

        keyProperties[2] = new CIMProperty(
                Linux_SambaService.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, Linux_SambaService.CIM_CLASS_NAME);

        setThis = SystemName;

        keyProperties[3] = new CIMProperty(Linux_SambaService.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_SambaService.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_SambaService createInstance(WBEMClient client,
            Linux_SambaService dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        Linux_SambaService newDataInstance = Linux_SambaServiceHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static Linux_SambaService modifyInstance(WBEMClient client,
            Linux_SambaService dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaService dataInstance2 = Linux_SambaServiceHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, Linux_SambaService dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaService.getPackages());
    }
