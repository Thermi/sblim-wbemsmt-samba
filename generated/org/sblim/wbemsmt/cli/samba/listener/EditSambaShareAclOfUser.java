/**
 * EditSambaShareAclOfUser.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class EditSambaShareAclOfUser extends CimCommand {
    ...
    public static final OptionDefinition KEY_sambaUsername = new OptionDefinition(null,
            "sambaUsername", null, "EditSambaShareAclOfUser.sambaUsername.argValue", true, false,
            "EditSambaShareAclOfUser.sambaUsername.argDescription");
    /**
    ...
    public static final OptionDefinition KEY_shareName = new OptionDefinition(null, "shareName",
            null, "ShareACLItemDataContainer.shareName.argValue", true, false,
            "ShareACLItemDataContainer.shareName.argDescription");
    /**
     *  --access
     */
    public static final OptionDefinition KEY_access = new OptionDefinition(null, "access", null,
            "ShareACLItemDataContainer.accessTypeVI.argValue", false, false,
            "ShareACLItemDataContainer.accessTypeVI.argDescription");
    /**
     *  --accessTypeRW
     */
    public static final OptionDefinition KEY_accessTypeRW = new OptionDefinition(null,
            "accessTypeRW", null, "ShareACLItemDataContainer.accessTypeRW.argValue", false, false,
            "ShareACLItemDataContainer.accessTypeRW.argDescription");
    /**
     *  --admin
     */
    public static final OptionDefinition KEY_admin = new OptionDefinition(null, "admin", null,
            "ShareACLItemDataContainer.admin.argValue", false, false,
            "ShareACLItemDataContainer.admin.argDescription");
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] {
            KEY_sambaUsername, KEY_shareName, KEY_access, KEY_accessTypeRW, KEY_admin, };
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("ShareACLItemDataContainer.caption") }));

            CliDataLoader loader = new EditSambaShareAclOfUserLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.cli.samba.container.share.ShareACLItemDataContainerImpl dc = new org.sblim.wbemsmt.cli.samba.container.share.ShareACLItemDataContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.samba.bl.container.share.ShareACLItemDataContainer dc)
