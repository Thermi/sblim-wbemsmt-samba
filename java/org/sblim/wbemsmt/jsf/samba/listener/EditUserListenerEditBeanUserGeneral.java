/** 
  * EditUserListenerEditBeanUserGeneral.java
  *
...
public class EditUserListenerEditBeanUserGeneral extends EditBean {
		...
		public void edit(ITaskLauncherTreeNode treeNode) throws ObjectNotFoundException, UpdateControlsException, CountException, InitContainerException
		{
			...
			UIPanel panelToAdd= null;
				...
				bindingPrefix = "objectActionController.editBeans['userGeneral'].containers[0].";
				

				//create cotainner
    			currentEditContainer1 = new org.sblim.wbemsmt.jsf.samba.container.user.UserDataContainerImpl(adapter1,bindingPrefix);
