...
public class Linux_SambaWinbindOptionsHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaWinbindOptions.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaWinbindOptions.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_SambaWinbindOptions.");
                        resultArrayList.add(new Linux_SambaWinbindOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaWinbindOptions.");
                        resultArrayList.add(new Linux_SambaWinbindOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaWinbindOptions.");
                        resultArrayList.add(new Linux_SambaWinbindOptions(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaWinbindOptions getInstance(WBEMClient client,
    ...
    public final static Linux_SambaWinbindOptions getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(Linux_SambaWinbindOptions.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                Linux_SambaWinbindOptions.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(Linux_SambaWinbindOptions.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                Linux_SambaWinbindOptions.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_SambaWinbindOptions createInstance(WBEMClient client,
            Linux_SambaWinbindOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaWinbindOptions newDataInstance = Linux_SambaWinbindOptionsHelper.getInstance(
     ...
     */
    public final static Linux_SambaWinbindOptions modifyInstance(WBEMClient client,
            Linux_SambaWinbindOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaWinbindOptions dataInstance2 = Linux_SambaWinbindOptionsHelper.getInstance(
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaWinbindOptions dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaWinbindOptions.getPackages());
    }
