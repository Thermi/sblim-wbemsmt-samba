...
public class EditSambaShareFileAttributesLoader extends SambaLoader implements CliDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
		...
		String serviceName = CliUtil.getOption(commandValues,EditSambaShareFileAttributes.KEY_GLOBAL_serviceName);
		String shareName = CliUtil.getOption(commandValues,EditSambaShareFileAttributes.KEY_sambaSharename);
