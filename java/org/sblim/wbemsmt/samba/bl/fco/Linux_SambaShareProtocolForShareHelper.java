...
public class Linux_SambaShareProtocolForShareHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaShareProtocolForShare.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaShareProtocolForShare.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaShareProtocolForShareHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaShareProtocolForShare.");
                        resultArrayList.add(new Linux_SambaShareProtocolForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaShareProtocolForShare.");
                        resultArrayList.add(new Linux_SambaShareProtocolForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaShareProtocolForShare.");
                        resultArrayList.add(new Linux_SambaShareProtocolForShare(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaShareProtocolForShare getInstance(WBEMClient client,
     ...
     */
    public final static Linux_SambaShareProtocolForShare getInstance(WBEMClient client,
            String namespace, Linux_SambaShareOptions ManagedElement,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaShareProtocolForShare.PROPERTY_MANAGEDELEMENT_LINUX_SAMBASHAREOPTIONS.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_SambaShareProtocolForShare.PROPERTY_SETTINGDATA_LINUX_SAMBASHAREPROTOCOLOPTIONS.NAME,
                new CIMDataType(Linux_SambaShareProtocolOptions.CIM_CLASS_NAME), setThis, false,
                false, Linux_SambaShareProtocolForShare.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_SambaShareProtocolForShare createInstance(WBEMClient client,
            Linux_SambaShareProtocolForShare dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaShareProtocolForShare newDataInstance = Linux_SambaShareProtocolForShareHelper
     ...
     */
    public final static Linux_SambaShareProtocolForShare modifyInstance(WBEMClient client,
            Linux_SambaShareProtocolForShare dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaShareProtocolForShare dataInstance2 = Linux_SambaShareProtocolForShareHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaShareProtocolForShare dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaShareProtocolForShare.getPackages());
    }
