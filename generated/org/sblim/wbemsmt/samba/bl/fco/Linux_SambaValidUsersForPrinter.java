/**
 * Linux_SambaValidUsersForPrinter.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class Linux_SambaValidUsersForPrinter extends CIM_Component {
    ...
    public Linux_SambaValidUsersForPrinter(WBEMClient client, String namespace)
    ...
    public Linux_SambaValidUsersForPrinter(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaValidUsersForPrinter() {
    }
    ...
    public static CIMProperty create_PartComponent_Linux_SambaUser(WBEMClient client,
        ...
        Linux_SambaValidUsersForPrinter fco = new Linux_SambaValidUsersForPrinter(client, namespace);
    ...
    public String getObjectName() {
        return Linux_SambaValidUsersForPrinter.CIM_CLASS_NAME;
    }
