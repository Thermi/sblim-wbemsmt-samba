...
public class ShareDenyHostSecurityDataContainerImpl extends BaseDataContainer implements org.sblim.wbemsmt.samba.bl.container.share.ShareDenyHostSecurityDataContainer {
	...
	public ShareDenyHostSecurityDataContainerImpl(AbstractBaseCimAdapter adapter) throws InitContainerException {
		super();
		setAdapter(adapter);
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_DeniedHosts() {
    		...
    		{
				String label = getAdapter().getBundle().getString("ShareDenyHostSecurityDataContainer.deniedHosts");
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_HostsToDeny() {
    		...
    		{
				String label = getAdapter().getBundle().getString("ShareDenyHostSecurityDataContainer.hostsToDeny");
				org.sblim.wbemsmt.tools.converter.StringArrayConverter converter = new org.sblim.wbemsmt.tools.converter.UnsignedInt16StringArrayConverter();
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_AddHost() {
    		...
    		{
				String label = getAdapter().getBundle().getString("ShareDenyHostSecurityDataContainer.addHost");
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_RemoveHost() {
    		...
    		{
				String label = getAdapter().getBundle().getString("ShareDenyHostSecurityDataContainer.removeHost");
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
	...
	public void trace(java.io.PrintWriter 	printStream, String listOptions, boolean title)
	{
		if (title)
		{
			printStream.println(getAdapter().getBundle().getString("ShareDenyHostSecurityDataContainer.caption"));
		}
