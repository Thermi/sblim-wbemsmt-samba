...
public class PrinterInUserWizardACLItemDataContainerImpl extends BaseDataContainer implements
    ...
    public PrinterInUserWizardACLItemDataContainerImpl(AbstractBaseCimAdapter adapter)
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "PrinterInUserWizardACLItemDataContainer.caption"));
        }
