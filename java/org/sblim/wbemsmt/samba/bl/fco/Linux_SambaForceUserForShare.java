...
public class Linux_SambaForceUserForShare extends CIM_Component {
    ...
    public Linux_SambaForceUserForShare(WBEMClient client, String namespace)
    ...
    public Linux_SambaForceUserForShare(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaForceUserForShare() {
    }
    ...
    public static CIMProperty create_PartComponent_Linux_SambaUser(WBEMClient client,
        ...
        Linux_SambaForceUserForShare fco = new Linux_SambaForceUserForShare(client, namespace);
    ...
    public String getObjectName() {
        return Linux_SambaForceUserForShare.CIM_CLASS_NAME;
    }
