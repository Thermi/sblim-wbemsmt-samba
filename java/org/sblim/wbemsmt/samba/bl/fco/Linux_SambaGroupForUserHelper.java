...
public class Linux_SambaGroupForUserHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaGroupForUser.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaGroupForUser.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_SambaGroupForUser.");
                        resultArrayList.add(new Linux_SambaGroupForUser(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaGroupForUser.");
                        resultArrayList.add(new Linux_SambaGroupForUser(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaGroupForUser.");
                        resultArrayList.add(new Linux_SambaGroupForUser(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaGroupForUser getInstance(WBEMClient client,
    ...
    public final static Linux_SambaGroupForUser getInstance(WBEMClient client, String namespace,
            Linux_SambaGroup GroupComponent, Linux_SambaUser PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaGroupForUser.PROPERTY_GROUPCOMPONENT_LINUX_SAMBAGROUP.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_SambaGroupForUser.PROPERTY_PARTCOMPONENT_LINUX_SAMBAUSER.NAME,
     ...
     *
     */
    public final static Linux_SambaGroupForUser createInstance(WBEMClient client,
            Linux_SambaGroupForUser dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaGroupForUser newDataInstance = Linux_SambaGroupForUserHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static Linux_SambaGroupForUser modifyInstance(WBEMClient client,
            Linux_SambaGroupForUser dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaGroupForUser dataInstance2 = Linux_SambaGroupForUserHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, Linux_SambaGroupForUser dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaGroupForUser.getPackages());
    }
