/** 
  * Linux_SambaWriteListForPrinterHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_SambaWriteListForPrinter
  *    
  * 
  * generated Class
  * @see Linux_SambaWriteListForPrinter
  */
...
public class Linux_SambaWriteListForPrinterHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_SambaWriteListForPrinter or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaWriteListForPrinter.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaWriteListForPrinter.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_SambaWriteListForPrinter or the subclasses if deep == true
    */        
    public final static List<Linux_SambaWriteListForPrinter> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaWriteListForPrinter> resultArrayList = new ArrayList<Linux_SambaWriteListForPrinter>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaWriteListForPrinter.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaWriteListForPrinter(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_SambaWriteListForPrinterHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_SambaWriteListForPrinter.");
                        resultArrayList.add(new Linux_SambaWriteListForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_SambaWriteListForPrinter.");
                        resultArrayList.add(new Linux_SambaWriteListForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaWriteListForPrinter)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaWriteListForPrinter.");
                        resultArrayList.add(new Linux_SambaWriteListForPrinter(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaWriteListForPrinter getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaWriteListForPrinter getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_SambaWriteListForPrinter dataInstance = null;
        Class<?> clazz = Linux_SambaWriteListForPrinterHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_SambaWriteListForPrinter)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaWriteListForPrinter.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_SambaWriteListForPrinter(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_SambaWriteListForPrinter getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaWriteListForPrinter.PROPERTY_PARTCOMPONENT_LINUX_SAMBAUSER.NAME,new CIMDataType(Linux_SambaUser.CIM_CLASS_NAME),setThis,false,false,Linux_SambaWriteListForPrinter.CIM_CLASS_NAME); 
                   
                                 setThis = GroupComponent != null ? GroupComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_SambaWriteListForPrinter.PROPERTY_GROUPCOMPONENT_LINUX_SAMBAPRINTEROPTIONS.NAME,new CIMDataType(Linux_SambaPrinterOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaWriteListForPrinter.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaWriteListForPrinter.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_SambaWriteListForPrinter createInstance(WBEMClient client, Linux_SambaWriteListForPrinter dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_SambaWriteListForPrinter newDataInstance = Linux_SambaWriteListForPrinterHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_SambaWriteListForPrinter modifyInstance(WBEMClient client, Linux_SambaWriteListForPrinter dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_SambaWriteListForPrinter dataInstance2 = Linux_SambaWriteListForPrinterHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaWriteListForPrinter dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaWriteListForPrinter.getPackages());
    }
