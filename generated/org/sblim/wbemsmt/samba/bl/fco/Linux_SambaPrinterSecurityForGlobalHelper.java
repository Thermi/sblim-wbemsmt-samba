/** 
  * Linux_SambaPrinterSecurityForGlobalHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_SambaPrinterSecurityForGlobal
  *    
  * 
  * generated Class
  * @see Linux_SambaPrinterSecurityForGlobal
  */
...
public class Linux_SambaPrinterSecurityForGlobalHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_SambaPrinterSecurityForGlobal or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaPrinterSecurityForGlobal.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaPrinterSecurityForGlobal.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_SambaPrinterSecurityForGlobal or the subclasses if deep == true
    */        
    public final static List<Linux_SambaPrinterSecurityForGlobal> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaPrinterSecurityForGlobal> resultArrayList = new ArrayList<Linux_SambaPrinterSecurityForGlobal>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaPrinterSecurityForGlobal.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaPrinterSecurityForGlobal(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_SambaPrinterSecurityForGlobalHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_SambaPrinterSecurityForGlobal.");
                        resultArrayList.add(new Linux_SambaPrinterSecurityForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_SambaPrinterSecurityForGlobal.");
                        resultArrayList.add(new Linux_SambaPrinterSecurityForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaPrinterSecurityForGlobal)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaPrinterSecurityForGlobal.");
                        resultArrayList.add(new Linux_SambaPrinterSecurityForGlobal(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaPrinterSecurityForGlobal getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaPrinterSecurityForGlobal getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_SambaPrinterSecurityForGlobal dataInstance = null;
        Class<?> clazz = Linux_SambaPrinterSecurityForGlobalHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_SambaPrinterSecurityForGlobal)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaPrinterSecurityForGlobal.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_SambaPrinterSecurityForGlobal(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_SambaPrinterSecurityForGlobal getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaPrinterSecurityForGlobal.PROPERTY_SETTINGDATA_LINUX_SAMBAPRINTERSECURITYOPTIONS.NAME,new CIMDataType(Linux_SambaPrinterSecurityOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaPrinterSecurityForGlobal.CIM_CLASS_NAME); 
                   
                                 setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_SambaPrinterSecurityForGlobal.PROPERTY_MANAGEDELEMENT_LINUX_SAMBAGLOBALOPTIONS.NAME,new CIMDataType(Linux_SambaGlobalOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaPrinterSecurityForGlobal.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaPrinterSecurityForGlobal.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_SambaPrinterSecurityForGlobal createInstance(WBEMClient client, Linux_SambaPrinterSecurityForGlobal dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_SambaPrinterSecurityForGlobal newDataInstance = Linux_SambaPrinterSecurityForGlobalHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_SambaPrinterSecurityForGlobal modifyInstance(WBEMClient client, Linux_SambaPrinterSecurityForGlobal dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_SambaPrinterSecurityForGlobal dataInstance2 = Linux_SambaPrinterSecurityForGlobalHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaPrinterSecurityForGlobal dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaPrinterSecurityForGlobal.getPackages());
    }
