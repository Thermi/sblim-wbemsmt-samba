/**
 * Linux_SambaGuestAccountForGlobal.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED
...
public class Linux_SambaGuestAccountForGlobal extends CIM_Component {
    ...
    public Linux_SambaGuestAccountForGlobal(WBEMClient client, String namespace)
    ...
    public Linux_SambaGuestAccountForGlobal(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaGuestAccountForGlobal() {
    }
    ...
    public static CIMProperty create_PartComponent_Linux_SambaUser(WBEMClient client,
        ...
        Linux_SambaGuestAccountForGlobal fco = new Linux_SambaGuestAccountForGlobal(client,
                namespace);
    ...
    public String getObjectName() {
        return Linux_SambaGuestAccountForGlobal.CIM_CLASS_NAME;
    }
