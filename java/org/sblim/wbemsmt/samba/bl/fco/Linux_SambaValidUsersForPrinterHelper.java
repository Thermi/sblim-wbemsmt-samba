...
public class Linux_SambaValidUsersForPrinterHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaValidUsersForPrinter.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaValidUsersForPrinter.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaValidUsersForPrinterHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaValidUsersForPrinter.");
                        resultArrayList.add(new Linux_SambaValidUsersForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaValidUsersForPrinter.");
                        resultArrayList.add(new Linux_SambaValidUsersForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaValidUsersForPrinter.");
                        resultArrayList.add(new Linux_SambaValidUsersForPrinter(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaValidUsersForPrinter getInstance(WBEMClient client,
    ...
    public final static Linux_SambaValidUsersForPrinter getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaValidUsersForPrinter.PROPERTY_PARTCOMPONENT_LINUX_SAMBAUSER.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_SambaValidUsersForPrinter.PROPERTY_GROUPCOMPONENT_LINUX_SAMBAPRINTEROPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaValidUsersForPrinter createInstance(WBEMClient client,
            Linux_SambaValidUsersForPrinter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaValidUsersForPrinter newDataInstance = Linux_SambaValidUsersForPrinterHelper
     ...
     */
    public final static Linux_SambaValidUsersForPrinter modifyInstance(WBEMClient client,
            Linux_SambaValidUsersForPrinter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaValidUsersForPrinter dataInstance2 = Linux_SambaValidUsersForPrinterHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaValidUsersForPrinter dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaValidUsersForPrinter.getPackages());
    }
