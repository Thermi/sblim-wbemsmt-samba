...
public class Linux_SambaPrinterPrintingOptionsHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaPrinterPrintingOptions.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaPrinterPrintingOptions.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaPrinterPrintingOptionsHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaPrinterPrintingOptions.");
                        resultArrayList.add(new Linux_SambaPrinterPrintingOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaPrinterPrintingOptions.");
                        resultArrayList.add(new Linux_SambaPrinterPrintingOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaPrinterPrintingOptions.");
                        resultArrayList.add(new Linux_SambaPrinterPrintingOptions(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaPrinterPrintingOptions getInstance(WBEMClient client,
    ...
    public final static Linux_SambaPrinterPrintingOptions getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaPrinterPrintingOptions.PROPERTY_INSTANCEID.NAME, CIMDataType.STRING_T,
                setThis, true, false, Linux_SambaPrinterPrintingOptions.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(Linux_SambaPrinterPrintingOptions.PROPERTY_NAME.NAME,
     ...
     *
     */
    public final static Linux_SambaPrinterPrintingOptions createInstance(WBEMClient client,
            Linux_SambaPrinterPrintingOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaPrinterPrintingOptions newDataInstance = Linux_SambaPrinterPrintingOptionsHelper
     ...
     */
    public final static Linux_SambaPrinterPrintingOptions modifyInstance(WBEMClient client,
            Linux_SambaPrinterPrintingOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaPrinterPrintingOptions dataInstance2 = Linux_SambaPrinterPrintingOptionsHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaPrinterPrintingOptions dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaPrinterPrintingOptions.getPackages());
    }
