...
public final class Linux_SambaScriptingOptionsHelper {
	...
	*/	
	public final static Linux_SambaScriptingOptions getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_SambaScriptingOptionsHelper.getInstance(cimClient, new Linux_SambaScriptingOptions(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaScriptingOptions getInstance(CIMClient cimClient, Linux_SambaScriptingOptions dataInstance) {
		...
		return Linux_SambaScriptingOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaScriptingOptions getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			...
			{
				dataInstance = new Linux_SambaScriptingOptions(cimObjectPath, cimInstance);
			}
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = Linux_SambaScriptingOptions.getPackages();
	...
	*/	
	public final static Linux_SambaScriptingOptions createInstance(CIMClient cimClient, Linux_SambaScriptingOptions dataInstance, boolean notifyDifferencies){ 
		...
		Linux_SambaScriptingOptions newDataInstance = null;
		try {
			newDataInstance = Linux_SambaScriptingOptionsHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaScriptingOptions modifyInstance(CIMClient cimClient, Linux_SambaScriptingOptions dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_SambaScriptingOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_SambaScriptingOptions dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_SambaScriptingOptions dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_SambaScriptingOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_SambaScriptingOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_SambaScriptingOptions.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_SambaScriptingOptions.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_SambaScriptingOptions.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_AddGroupScript(String AddGroupScript) {
		return true;
	}

	public static boolean isValid_AddPrinterCommand(String AddPrinterCommand) {
		return true;
	}

	public static boolean isValid_AddShareCommand(String AddShareCommand) {
		return true;
	}

	public static boolean isValid_AddUserScript(String AddUserScript) {
		return true;
	}

	public static boolean isValid_AddUsertoGroupScript(String AddUsertoGroupScript) {
		return true;
	}

	public static boolean isValid_DeleteGrouprScript(String DeleteGrouprScript) {
		return true;
	}

	public static boolean isValid_DeleteUserScript(String DeleteUserScript) {
		return true;
	}

	public static boolean isValid_DeleteUserfromGroupScript(String DeleteUserfromGroupScript) {
		return true;
	}

	public static boolean isValid_SetPrimaryGroupScript(String SetPrimaryGroupScript) {
		return true;
	}
