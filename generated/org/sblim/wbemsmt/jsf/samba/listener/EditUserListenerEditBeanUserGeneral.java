/**
 * EditUserListenerEditBeanUserGeneral.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED
...
public class EditUserListenerEditBeanUserGeneral extends EditBean {

    private org.sblim.wbemsmt.jsf.samba.container.user.UserDataContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.samba.bl.adapter.SambaCimAdapter adapter1 = null;

    private HtmlPanelGrid panel;

    public EditUserListenerEditBeanUserGeneral() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container UserDataContainer
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        selector.select(treeNode, adapter1, "userGeneral");

        adapter1.setActiveModule(AbstractBaseCimAdapter.ACTIVE_EDIT);

        //ADD THE FIELDS FOR CONTAINER UserDataContainer in EditPanel ${editPanel.getId()}

        expressionPrefix = "objectActionController.editBeans['userGeneral'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.jsf.samba.container.user.UserDataContainerImpl(
