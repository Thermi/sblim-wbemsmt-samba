/**
 * Linux_SambaPrinterAdminForPrinter.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED
...
public class Linux_SambaPrinterAdminForPrinter extends CIM_Component {
    ...
    public Linux_SambaPrinterAdminForPrinter(WBEMClient client, String namespace)
    ...
    public Linux_SambaPrinterAdminForPrinter(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaPrinterAdminForPrinter() {
    }
    ...
    public static CIMProperty create_PartComponent_Linux_SambaUser(WBEMClient client,
        ...
        Linux_SambaPrinterAdminForPrinter fco = new Linux_SambaPrinterAdminForPrinter(client,
                namespace);
    ...
    public String getObjectName() {
        return Linux_SambaPrinterAdminForPrinter.CIM_CLASS_NAME;
    }
