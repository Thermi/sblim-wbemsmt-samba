/**
 * Linux_SambaWinbindForGlobal.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class Linux_SambaWinbindForGlobal extends CIM_ElementSettingData {
     ...
     * 
     */
    public static class PROPERTY_SETTINGDATA_LINUX_SAMBAWINBINDOPTIONS {
        /**
    ...
    public Linux_SambaWinbindForGlobal(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public Linux_SambaWinbindForGlobal(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaWinbindForGlobal() {
    }
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        propertiesToCheck.put("SettingData", new CIMProperty("SettingData", new CIMDataType(
                Linux_SambaWinbindOptions.CIM_CLASS_NAME), null));
    ...
    public Linux_SambaWinbindOptions get_SettingData_Linux_SambaWinbindOptions(
            javax.wbem.client.WBEMClient client) throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBAWINBINDOPTIONS.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_SETTINGDATA_LINUX_SAMBAWINBINDOPTIONS.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }

        return Linux_SambaWinbindOptionsHelper.getInstance(client, (CIMObjectPath) currentProperty
                .getValue());
    ...
    public static CIMProperty create_SettingData_Linux_SambaWinbindOptions(WBEMClient client,
            String namespace, Linux_SambaWinbindOptions newValue) throws WbemsmtException {
        Linux_SambaWinbindForGlobal fco = new Linux_SambaWinbindForGlobal(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBAWINBINDOPTIONS.NAME);
        if (property != null) {
            property = setPropertyValue_SettingData_Linux_SambaWinbindOptions(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_SETTINGDATA_LINUX_SAMBAWINBINDOPTIONS.NAME
    ...
    private static CIMProperty setPropertyValue_SettingData_Linux_SambaWinbindOptions(
            CIMProperty currentProperty, Linux_SambaWinbindOptions newValue) {
        Object setThis = null;
    ...
    public String getObjectName() {
        return Linux_SambaWinbindForGlobal.CIM_CLASS_NAME;
    }
