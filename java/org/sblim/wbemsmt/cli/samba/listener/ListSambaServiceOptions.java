...
public class ListSambaServiceOptions extends CimCommand {
	...
	//All Options that are local and defined for this command
		 ...
		 */
		public static final OptionDefinition KEY_list = new OptionDefinition(null,"list","INSTANCE_WITH_CHILDS","ListSambaServiceOptions.list.argValue",false,false,"ListSambaServiceOptions.list.argDescription");
