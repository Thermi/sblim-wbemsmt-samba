...
public class ServiceScriptingDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.samba.bl.container.service.ServiceScriptingDataContainer {
    ...
    public ServiceScriptingDataContainerImpl(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_AddGroupScript() {
        if (ic_AddGroupScript == null) {
            ...
            ic_AddGroupScript = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_AddPrinterCommand() {
        if (ic_AddPrinterCommand == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_AddPrinterCommand = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_AddShareCommand() {
        if (ic_AddShareCommand == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_AddShareCommand = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_AddUserScript() {
        if (ic_AddUserScript == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_AddUserScript = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_AddUsertoGroupScript() {
        if (ic_AddUsertoGroupScript == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_AddUsertoGroupScript = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_DeleteGroupScript() {
        if (ic_DeleteGroupScript == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_DeleteGroupScript = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_DeleteUserScript() {
        if (ic_DeleteUserScript == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_DeleteUserScript = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_DeleteUserfromGroupScript() {
        if (ic_DeleteUserfromGroupScript == null) {
            String label = bundle
                    .getString("ServiceScriptingDataContainer.DeleteUserfromGroupScript");
            String binding = bindingPrefix + "_DeleteUserfromGroupScript.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_DeleteUserfromGroupScript = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_SetPrimaryGroupScript() {
        if (ic_SetPrimaryGroupScript == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_SetPrimaryGroupScript = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public void reload() {
        super.reload();
        if (ic_AddGroupScript != null) {
            ic_AddGroupScript.setLabelText(bundle
                    .getString("ServiceScriptingDataContainer.AddGroupScript"));
        }
        if (ic_AddPrinterCommand != null) {
            ic_AddPrinterCommand.setLabelText(bundle
                    .getString("ServiceScriptingDataContainer.AddPrinterCommand"));
        }
        if (ic_AddShareCommand != null) {
            ic_AddShareCommand.setLabelText(bundle
                    .getString("ServiceScriptingDataContainer.AddShareCommand"));
        }
        if (ic_AddUserScript != null) {
            ic_AddUserScript.setLabelText(bundle
                    .getString("ServiceScriptingDataContainer.AddUserScript"));
        }
        if (ic_AddUsertoGroupScript != null) {
            ic_AddUsertoGroupScript.setLabelText(bundle
                    .getString("ServiceScriptingDataContainer.AddUsertoGroupScript"));
        }
        if (ic_DeleteGroupScript != null) {
            ic_DeleteGroupScript.setLabelText(bundle
                    .getString("ServiceScriptingDataContainer.DeleteGroupScript"));
        }
        if (ic_DeleteUserScript != null) {
            ic_DeleteUserScript.setLabelText(bundle
                    .getString("ServiceScriptingDataContainer.DeleteUserScript"));
        }
        if (ic_DeleteUserfromGroupScript != null) {
            ic_DeleteUserfromGroupScript.setLabelText(bundle
                    .getString("ServiceScriptingDataContainer.DeleteUserfromGroupScript"));
        }
        if (ic_SetPrimaryGroupScript != null) {
            ic_SetPrimaryGroupScript.setLabelText(bundle
                    .getString("ServiceScriptingDataContainer.SetPrimaryGroupScript"));
        }
    }
