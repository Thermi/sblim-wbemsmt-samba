/** 
  * PrinterInUserWizardACLItemDataContainer_AsPrinters_InUserWizardPage2Impl.java
  *
...
public class PrinterInUserWizardACLItemDataContainer_AsPrinters_InUserWizardPage2Impl extends org.sblim.wbemsmt.tools.jsf.MultiLineBasePanel implements org.sblim.wbemsmt.samba.bl.container.wizard.PrinterInUserWizardACLItemDataContainer {
...
//	public PrinterInUserWizardACLItemDataContainer_AsPrinters_InUserWizardPage2Impl(String bindingPrefix, org.sblim.wbemsmt.samba.bl.adapter.SambaCimAdapter adapter,int index) throws InitContainerException {
//		this(adapter,bindingPrefix,index, null);
//	}
	
	public PrinterInUserWizardACLItemDataContainer_AsPrinters_InUserWizardPage2Impl(org.sblim.wbemsmt.samba.bl.adapter.SambaCimAdapter adapter,String bindingPrefix,int index, HtmlPanelGrid grid) throws InitContainerException {
	    super(adapter,
		...
		if (first)
		{
			//setFooter(getInputFieldContainer(),"#{localeManager.bundle['SAMBA'].PrinterInUserWizardACLItemDataContainer_AsPrinters_InUserWizardPage2Impl_footerText}","PrinterInUserWizardACLItemDataContainer_AsPrinters_InUserWizardPage2Impl.footerText");
			//setFooter(getInputFieldContainer(),"PrinterInUserWizardACLItemDataContainer_AsPrinters_InUserWizardPage2Impl.footerText");
			String binding = "#{" +  bindingPrefix + "printers["+ index +"].footerText}";
			setFooter(getOuterPanel(),"PrinterInUserWizardACLItemDataContainer_AsPrinters_InUserWizardPage2.footerText",binding);
		}
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_PrinterName() {
    		if (ic_PrinterName == null)
    		{
				...
				;
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent)ic_PrinterName).setOrientation( LabeledBaseInputComponentIf.LEFT );
    		}
	...
	{
		PrinterInUserWizardACLItemDataContainer_AsPrinters_InUserWizardPage2Impl source = (PrinterInUserWizardACLItemDataContainer_AsPrinters_InUserWizardPage2Impl)sourceContainer;
