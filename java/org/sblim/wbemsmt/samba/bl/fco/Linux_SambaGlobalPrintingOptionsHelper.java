...
public class Linux_SambaGlobalPrintingOptionsHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaGlobalPrintingOptions.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaGlobalPrintingOptions.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaGlobalPrintingOptionsHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaGlobalPrintingOptions.");
                        resultArrayList.add(new Linux_SambaGlobalPrintingOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaGlobalPrintingOptions.");
                        resultArrayList.add(new Linux_SambaGlobalPrintingOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaGlobalPrintingOptions.");
                        resultArrayList.add(new Linux_SambaGlobalPrintingOptions(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaGlobalPrintingOptions getInstance(WBEMClient client,
    ...
    public final static Linux_SambaGlobalPrintingOptions getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaGlobalPrintingOptions.PROPERTY_INSTANCEID.NAME, CIMDataType.STRING_T,
                setThis, true, false, Linux_SambaGlobalPrintingOptions.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(Linux_SambaGlobalPrintingOptions.PROPERTY_NAME.NAME,
     ...
     *
     */
    public final static Linux_SambaGlobalPrintingOptions createInstance(WBEMClient client,
            Linux_SambaGlobalPrintingOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaGlobalPrintingOptions newDataInstance = Linux_SambaGlobalPrintingOptionsHelper
     ...
     */
    public final static Linux_SambaGlobalPrintingOptions modifyInstance(WBEMClient client,
            Linux_SambaGlobalPrintingOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaGlobalPrintingOptions dataInstance2 = Linux_SambaGlobalPrintingOptionsHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaGlobalPrintingOptions dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaGlobalPrintingOptions.getPackages());
    }
