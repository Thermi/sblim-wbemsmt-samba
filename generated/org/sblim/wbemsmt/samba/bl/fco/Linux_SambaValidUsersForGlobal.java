/**
 * Linux_SambaValidUsersForGlobal.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class Linux_SambaValidUsersForGlobal extends CIM_Component {
    ...
    public Linux_SambaValidUsersForGlobal(WBEMClient client, String namespace)
    ...
    public Linux_SambaValidUsersForGlobal(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaValidUsersForGlobal() {
    }
    ...
    public static CIMProperty create_PartComponent_Linux_SambaUser(WBEMClient client,
        ...
        Linux_SambaValidUsersForGlobal fco = new Linux_SambaValidUsersForGlobal(client, namespace);
    ...
    public String getObjectName() {
        return Linux_SambaValidUsersForGlobal.CIM_CLASS_NAME;
    }
