...
public final class Linux_SambaGlobalProtocolOptionsHelper {
	...
	*/	
	public final static Linux_SambaGlobalProtocolOptions getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_SambaGlobalProtocolOptionsHelper.getInstance(cimClient, new Linux_SambaGlobalProtocolOptions(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaGlobalProtocolOptions getInstance(CIMClient cimClient, Linux_SambaGlobalProtocolOptions dataInstance) {
		...
		return Linux_SambaGlobalProtocolOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaGlobalProtocolOptions getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			dataInstance = new Linux_SambaGlobalProtocolOptions(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaGlobalProtocolOptions createInstance(CIMClient cimClient, Linux_SambaGlobalProtocolOptions dataInstance, boolean notifyDifferencies){ 
		...
		Linux_SambaGlobalProtocolOptions newDataInstance = null;
		try {
			newDataInstance = Linux_SambaGlobalProtocolOptionsHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaGlobalProtocolOptions modifyInstance(CIMClient cimClient, Linux_SambaGlobalProtocolOptions dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_SambaGlobalProtocolOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_SambaGlobalProtocolOptions dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_SambaGlobalProtocolOptions dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_SambaGlobalProtocolOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_SambaGlobalProtocolOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_SambaGlobalProtocolOptions.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_SambaGlobalProtocolOptions.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_SambaGlobalProtocolOptions.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
