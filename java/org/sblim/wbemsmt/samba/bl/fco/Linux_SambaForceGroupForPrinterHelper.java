...
public class Linux_SambaForceGroupForPrinterHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaForceGroupForPrinter.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaForceGroupForPrinter.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaForceGroupForPrinterHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaForceGroupForPrinter.");
                        resultArrayList.add(new Linux_SambaForceGroupForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaForceGroupForPrinter.");
                        resultArrayList.add(new Linux_SambaForceGroupForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaForceGroupForPrinter.");
                        resultArrayList.add(new Linux_SambaForceGroupForPrinter(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaForceGroupForPrinter getInstance(WBEMClient client,
     ...
     */
    public final static Linux_SambaForceGroupForPrinter getInstance(WBEMClient client,
            String namespace, Linux_SambaPrinterOptions GroupComponent,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaForceGroupForPrinter.PROPERTY_GROUPCOMPONENT_LINUX_SAMBAPRINTEROPTIONS.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_SambaForceGroupForPrinter.PROPERTY_PARTCOMPONENT_LINUX_SAMBAGROUP.NAME,
                new CIMDataType(Linux_SambaGroup.CIM_CLASS_NAME), setThis, false, false,
                Linux_SambaForceGroupForPrinter.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_SambaForceGroupForPrinter createInstance(WBEMClient client,
            Linux_SambaForceGroupForPrinter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaForceGroupForPrinter newDataInstance = Linux_SambaForceGroupForPrinterHelper
     ...
     */
    public final static Linux_SambaForceGroupForPrinter modifyInstance(WBEMClient client,
            Linux_SambaForceGroupForPrinter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaForceGroupForPrinter dataInstance2 = Linux_SambaForceGroupForPrinterHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaForceGroupForPrinter dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaForceGroupForPrinter.getPackages());
    }
