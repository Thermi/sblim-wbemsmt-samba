/** 
  * Linux_SambaGlobalPrintingOptionsHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_SambaGlobalPrintingOptions
  *    
  * 
  * generated Class
  * @see Linux_SambaGlobalPrintingOptions
  */
...
public class Linux_SambaGlobalPrintingOptionsHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_SambaGlobalPrintingOptions or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaGlobalPrintingOptions.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaGlobalPrintingOptions.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_SambaGlobalPrintingOptions or the subclasses if deep == true
    */        
    public final static List<Linux_SambaGlobalPrintingOptions> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaGlobalPrintingOptions> resultArrayList = new ArrayList<Linux_SambaGlobalPrintingOptions>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaGlobalPrintingOptions.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaGlobalPrintingOptions(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_SambaGlobalPrintingOptionsHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_SambaGlobalPrintingOptions.");
                        resultArrayList.add(new Linux_SambaGlobalPrintingOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaGlobalPrintingOptions)dataObj);
                    } catch (Exception e) {
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaGlobalPrintingOptions getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaGlobalPrintingOptions getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        ...
        try {
            ...
            {
                dataInstance = new Linux_SambaGlobalPrintingOptions(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_SambaGlobalPrintingOptions getInstance(WBEMClient client, String namespace
                                                       ,String InstanceID
                                                       ,String Name
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaGlobalPrintingOptions.PROPERTY_INSTANCEID.NAME,CIMDataType.STRING_T,setThis,true,false,Linux_SambaGlobalPrintingOptions.CIM_CLASS_NAME); 
                   
                   setThis = Name;
                
           keyProperties[1]  = new CIMProperty(Linux_SambaGlobalPrintingOptions.PROPERTY_NAME.NAME,CIMDataType.STRING_T,setThis,true,false,Linux_SambaGlobalPrintingOptions.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaGlobalPrintingOptions.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_SambaGlobalPrintingOptions createInstance(WBEMClient client, Linux_SambaGlobalPrintingOptions dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_SambaGlobalPrintingOptions newDataInstance = Linux_SambaGlobalPrintingOptionsHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_SambaGlobalPrintingOptions modifyInstance(WBEMClient client, Linux_SambaGlobalPrintingOptions dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_SambaGlobalPrintingOptions dataInstance2 = Linux_SambaGlobalPrintingOptionsHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaGlobalPrintingOptions dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaGlobalPrintingOptions.getPackages());
    }
