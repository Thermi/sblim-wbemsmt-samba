...
public class UserInShareWizardACLItemDataContainer_AsUsers_InShareWizardPage4Impl extends org.sblim.wbemsmt.tools.jsf.MultiLineBasePanel implements org.sblim.wbemsmt.samba.bl.container.wizard.UserInShareWizardACLItemDataContainer {
...
//	public UserInShareWizardACLItemDataContainer_AsUsers_InShareWizardPage4Impl(String bindingPrefix, org.sblim.wbemsmt.samba.bl.adapter.SambaCimAdapter adapter,int index) throws InitContainerException {
//		this(adapter,bindingPrefix,index, null);
//	}
	
	public UserInShareWizardACLItemDataContainer_AsUsers_InShareWizardPage4Impl(org.sblim.wbemsmt.samba.bl.adapter.SambaCimAdapter adapter,String bindingPrefix,int index, HtmlPanelGrid grid) throws InitContainerException {
	    super(adapter,
		...
		if (first)
		{
			//setFooter(getInputFieldContainer(),"#{localeManager.bundle['SAMBA'].UserInShareWizardACLItemDataContainer_AsUsers_InShareWizardPage4Impl_footerText}","UserInShareWizardACLItemDataContainer_AsUsers_InShareWizardPage4Impl.footerText");
			//setFooter(getInputFieldContainer(),"UserInShareWizardACLItemDataContainer_AsUsers_InShareWizardPage4Impl.footerText");
			String binding = "#{" +  bindingPrefix + "users["+ index +"].footerText}";
			setFooter(getInputFieldContainer(),"UserInShareWizardACLItemDataContainer_AsUsers_InShareWizardPage4.footerText",binding);
		}
