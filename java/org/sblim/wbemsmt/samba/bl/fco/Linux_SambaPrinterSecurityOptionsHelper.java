...
public final class Linux_SambaPrinterSecurityOptionsHelper {
	...
	*/	
	public final static Linux_SambaPrinterSecurityOptions getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_SambaPrinterSecurityOptionsHelper.getInstance(cimClient, new Linux_SambaPrinterSecurityOptions(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaPrinterSecurityOptions getInstance(CIMClient cimClient, Linux_SambaPrinterSecurityOptions dataInstance) {
		...
		return Linux_SambaPrinterSecurityOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaPrinterSecurityOptions getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			dataInstance = new Linux_SambaPrinterSecurityOptions(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaPrinterSecurityOptions createInstance(CIMClient cimClient, Linux_SambaPrinterSecurityOptions dataInstance, boolean notifyDifferencies){ 
		...
		Linux_SambaPrinterSecurityOptions newDataInstance = null;
		try {
			newDataInstance = Linux_SambaPrinterSecurityOptionsHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaPrinterSecurityOptions modifyInstance(CIMClient cimClient, Linux_SambaPrinterSecurityOptions dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_SambaPrinterSecurityOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_SambaPrinterSecurityOptions dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_SambaPrinterSecurityOptions dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_SambaPrinterSecurityOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_SambaPrinterSecurityOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_SambaPrinterSecurityOptions.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_SambaPrinterSecurityOptions.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_SambaPrinterSecurityOptions.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
