...
public class Linux_SambaShareSecurityOptions extends CIM_SettingData {
    ...
    public Linux_SambaShareSecurityOptions(WBEMClient client, String namespace)
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        propertiesToCheck.put("CreateMask", new CIMProperty("CreateMask", CIMDataType.UINT16_T,
                null));
        propertiesToCheck.put("DirectoryMask", new CIMProperty("DirectoryMask",
                CIMDataType.UINT16_T, null));
        propertiesToCheck.put("DirectorySecurityMask", new CIMProperty("DirectorySecurityMask",
                CIMDataType.UINT16_T, null));
    ...
    public javax.cim.UnsignedInteger16 get_CreateMask() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_CREATEMASK.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_CreateMask(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_CreateMask(CIMProperty currentProperty,
    ...
    public javax.cim.UnsignedInteger16 get_DirectoryMask() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_DIRECTORYMASK.NAME
    ...
    public static CIMProperty create_DirectoryMask(WBEMClient client, String namespace,
            javax.cim.UnsignedInteger16 newValue) throws WbemsmtException {
        Linux_SambaShareSecurityOptions fco = new Linux_SambaShareSecurityOptions(client, namespace);
    ...
    private static CIMProperty setPropertyValue_DirectoryMask(CIMProperty currentProperty,
            javax.cim.UnsignedInteger16 newValue) {
        Object setThis = null;
    ...
    public javax.cim.UnsignedInteger16 get_DirectorySecurityMask() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_DIRECTORYSECURITYMASK.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_DirectorySecurityMask(WBEMClient client, String namespace,
            javax.cim.UnsignedInteger16 newValue) throws WbemsmtException {
        Linux_SambaShareSecurityOptions fco = new Linux_SambaShareSecurityOptions(client, namespace);
    ...
    private static CIMProperty setPropertyValue_DirectorySecurityMask(CIMProperty currentProperty,
            javax.cim.UnsignedInteger16 newValue) {
        Object setThis = null;
    ...
    public java.util.List getAssociated_Linux_SambaShareOptions_Linux_SambaShareSecurityForShares(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_Linux_SambaShareOptions_Linux_SambaShareSecurityForShares(cimClient,
    ...
    public java.util.List getAssociated_Linux_SambaShareOptions_Linux_SambaShareSecurityForShares(
        ...
        return getAssociated_Linux_SambaShareOptions_Linux_SambaShareSecurityForShares(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_LINUX_SAMBASHARESECURITYFORSHARE, resultClass, role,
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaShareSecurityOptionsHelper.findClass(cimClient,
                            cimInstance);
    ...
    public java.util.List getAssociated_Linux_SambaShareOptions_Linux_SambaShareSecurityForShareNames(
            WBEMClient cimClient) throws WbemsmtException {
    ...
    public java.util.List getAssociated_Linux_SambaGlobalOptions_Linux_SambaShareSecurityForGlobals(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_Linux_SambaGlobalOptions_Linux_SambaShareSecurityForGlobals(cimClient,
    ...
    public java.util.List getAssociated_Linux_SambaGlobalOptions_Linux_SambaShareSecurityForGlobals(
        ...
        return getAssociated_Linux_SambaGlobalOptions_Linux_SambaShareSecurityForGlobals(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_LINUX_SAMBASHARESECURITYFORGLOBAL, resultClass, role,
                resultRole, false, false, null);
    ...
    public java.util.List getAssociated_Linux_SambaGlobalOptions_Linux_SambaShareSecurityForGlobalNames(
            WBEMClient cimClient) throws WbemsmtException {
