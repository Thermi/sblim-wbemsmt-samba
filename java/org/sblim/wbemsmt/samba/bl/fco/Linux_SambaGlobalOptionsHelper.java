...
public final class Linux_SambaGlobalOptionsHelper {
	...
	*/	
	public final static Linux_SambaGlobalOptions getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_SambaGlobalOptionsHelper.getInstance(cimClient, new Linux_SambaGlobalOptions(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaGlobalOptions getInstance(CIMClient cimClient, Linux_SambaGlobalOptions dataInstance) {
		...
		return Linux_SambaGlobalOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaGlobalOptions getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			...
			{
				dataInstance = new Linux_SambaGlobalOptions(cimObjectPath, cimInstance);
			}
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = Linux_SambaGlobalOptions.getPackages();
	...
	*/	
	public final static Linux_SambaGlobalOptions createInstance(CIMClient cimClient, Linux_SambaGlobalOptions dataInstance, boolean notifyDifferencies){ 
		...
		Linux_SambaGlobalOptions newDataInstance = null;
		try {
			newDataInstance = Linux_SambaGlobalOptionsHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaGlobalOptions modifyInstance(CIMClient cimClient, Linux_SambaGlobalOptions dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_SambaGlobalOptionsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_SambaGlobalOptions dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_SambaGlobalOptions dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_SambaGlobalOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_SambaGlobalOptions.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_SambaGlobalOptions.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_SambaGlobalOptions.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_SambaGlobalOptions.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_BindInterfacesOnly(Boolean BindInterfacesOnly) {
		return true;
	}

	public static boolean isValid_Interfaces(String Interfaces) {
		return true;
	}
	...
	public static boolean isValid_NetbiosAlias(String NetbiosAlias) {
		return true;
	}

	public static boolean isValid_NetbiosName(String NetbiosName) {
		return true;
	}

	public static boolean isValid_Printable(Boolean Printable) {
		return true;
	}

	public static boolean isValid_ServerString(String ServerString) {
		return true;
	}

	public static boolean isValid_Workgroup(String Workgroup) {
		return true;
	}
