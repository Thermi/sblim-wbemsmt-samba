...
public class Linux_SambaGlobalPrintingOptions extends Linux_SambaPrintingOptions {
    ...
    public Linux_SambaGlobalPrintingOptions(WBEMClient client, String namespace)
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        ...
        propertiesToCheck.put("PrintcapCacheTime", new CIMProperty("PrintcapCacheTime",
    ...
    public static CIMProperty create_key_Name(WBEMClient client, String namespace, String newValue)
            throws WbemsmtException {
        Linux_SambaGlobalPrintingOptions fco = new Linux_SambaGlobalPrintingOptions(client,
                namespace);
    ...
    public javax.cim.UnsignedInteger64 get_PrintcapCacheTime() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_PRINTCAPCACHETIME.NAME
    ...
    public static CIMProperty create_PrintcapCacheTime(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_PrintcapCacheTime(CIMProperty currentProperty,
    ...
    public java.util.List getAssociated_Linux_SambaGlobalOptions_Linux_SambaGlobalPrintingForGlobals(
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaGlobalPrintingOptionsHelper.findClass(cimClient,
                            cimInstance);
    ...
    public java.util.List getAssociated_Linux_SambaGlobalOptions_Linux_SambaGlobalPrintingForGlobalNames(
            WBEMClient cimClient) throws WbemsmtException {
