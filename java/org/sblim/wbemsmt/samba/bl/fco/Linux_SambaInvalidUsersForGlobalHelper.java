...
public class Linux_SambaInvalidUsersForGlobalHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaInvalidUsersForGlobal.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaInvalidUsersForGlobal.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaInvalidUsersForGlobalHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaInvalidUsersForGlobal.");
                        resultArrayList.add(new Linux_SambaInvalidUsersForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaInvalidUsersForGlobal.");
                        resultArrayList.add(new Linux_SambaInvalidUsersForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaInvalidUsersForGlobal.");
                        resultArrayList.add(new Linux_SambaInvalidUsersForGlobal(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaInvalidUsersForGlobal getInstance(WBEMClient client,
    ...
    public final static Linux_SambaInvalidUsersForGlobal getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaInvalidUsersForGlobal.PROPERTY_PARTCOMPONENT_LINUX_SAMBAUSER.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_SambaInvalidUsersForGlobal.PROPERTY_GROUPCOMPONENT_LINUX_SAMBAGLOBALOPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaInvalidUsersForGlobal createInstance(WBEMClient client,
            Linux_SambaInvalidUsersForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaInvalidUsersForGlobal newDataInstance = Linux_SambaInvalidUsersForGlobalHelper
     ...
     */
    public final static Linux_SambaInvalidUsersForGlobal modifyInstance(WBEMClient client,
            Linux_SambaInvalidUsersForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaInvalidUsersForGlobal dataInstance2 = Linux_SambaInvalidUsersForGlobalHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaInvalidUsersForGlobal dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaInvalidUsersForGlobal.getPackages());
    }
