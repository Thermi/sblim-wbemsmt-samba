...
public class PrinterAllowHostSecurityDataContainerImpl extends
    ...
    public PrinterAllowHostSecurityDataContainerImpl(
    ...
    public void reload() {
        ...
        if (ic_usr_AllowedHosts != null) {
            ic_usr_AllowedHosts.setLabelText(bundle
                    .getString("PrinterAllowHostSecurityDataContainer.allowedHosts"));
        }
        if (ic_usr_HostsToAllow != null) {
            ic_usr_HostsToAllow.setLabelText(bundle
                    .getString("PrinterAllowHostSecurityDataContainer.hostsToAllow"));
        }
        if (ic_usr_AddHost != null) {
            ic_usr_AddHost.setLabelText(bundle
                    .getString("PrinterAllowHostSecurityDataContainer.addHost"));
        }
        if (ic_usr_RemoveHost != null) {
            ic_usr_RemoveHost.setLabelText(bundle
                    .getString("PrinterAllowHostSecurityDataContainer.removeHost"));
        }
    }
