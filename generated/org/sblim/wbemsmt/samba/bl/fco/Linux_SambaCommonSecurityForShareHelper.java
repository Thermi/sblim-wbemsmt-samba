/** 
  * Linux_SambaCommonSecurityForShareHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_SambaCommonSecurityForShare
  *    
  * 
  * generated Class
  * @see Linux_SambaCommonSecurityForShare
  */
...
public class Linux_SambaCommonSecurityForShareHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_SambaCommonSecurityForShare or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaCommonSecurityForShare.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaCommonSecurityForShare.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_SambaCommonSecurityForShare or the subclasses if deep == true
    */        
    public final static List<Linux_SambaCommonSecurityForShare> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaCommonSecurityForShare> resultArrayList = new ArrayList<Linux_SambaCommonSecurityForShare>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaCommonSecurityForShare.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaCommonSecurityForShare(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_SambaCommonSecurityForShareHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_SambaCommonSecurityForShare.");
                        resultArrayList.add(new Linux_SambaCommonSecurityForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_SambaCommonSecurityForShare.");
                        resultArrayList.add(new Linux_SambaCommonSecurityForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaCommonSecurityForShare)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaCommonSecurityForShare.");
                        resultArrayList.add(new Linux_SambaCommonSecurityForShare(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaCommonSecurityForShare getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaCommonSecurityForShare getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_SambaCommonSecurityForShare dataInstance = null;
        Class<?> clazz = Linux_SambaCommonSecurityForShareHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_SambaCommonSecurityForShare)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaCommonSecurityForShare.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_SambaCommonSecurityForShare(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_SambaCommonSecurityForShare getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaCommonSecurityForShare.PROPERTY_SETTINGDATA_LINUX_SAMBACOMMONSECURITYOPTIONS.NAME,new CIMDataType(Linux_SambaCommonSecurityOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaCommonSecurityForShare.CIM_CLASS_NAME); 
                   
                                 setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_SambaCommonSecurityForShare.PROPERTY_MANAGEDELEMENT_LINUX_SAMBASHAREOPTIONS.NAME,new CIMDataType(Linux_SambaShareOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaCommonSecurityForShare.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaCommonSecurityForShare.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_SambaCommonSecurityForShare createInstance(WBEMClient client, Linux_SambaCommonSecurityForShare dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_SambaCommonSecurityForShare newDataInstance = Linux_SambaCommonSecurityForShareHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_SambaCommonSecurityForShare modifyInstance(WBEMClient client, Linux_SambaCommonSecurityForShare dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_SambaCommonSecurityForShare dataInstance2 = Linux_SambaCommonSecurityForShareHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaCommonSecurityForShare dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaCommonSecurityForShare.getPackages());
    }
