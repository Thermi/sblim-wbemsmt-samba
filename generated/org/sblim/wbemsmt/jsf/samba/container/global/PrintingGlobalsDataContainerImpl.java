...
public class PrintingGlobalsDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel implements org.sblim.wbemsmt.samba.bl.container.global.PrintingGlobalsDataContainer
			, org.sblim.wbemsmt.samba.bl.container.global.AdminUsersInPrinterGlobalsHeader		
	{
    		...
    		private org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf ic_UseClientDriver;
				...
				private java.util.List<AdminUsersInPrinterGlobals> icUsers = new java.util.ArrayList<AdminUsersInPrinterGlobals>();
	...
	public PrintingGlobalsDataContainerImpl(org.sblim.wbemsmt.samba.bl.adapter.SambaCimAdapter adapter,String expressionPrefix) throws WbemsmtException  {

			
				super(adapter,expressionPrefix, "PrintingGlobalsDataContainer.caption",false);
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_PrintcapCacheTime() {
    		if (ic_PrintcapCacheTime == null)
    		{
				...
				String binding = expressionPrefix + "_PrintcapCacheTime.item";
		...
		*/
				public java.util.List<AdminUsersInPrinterGlobals> getUsers()
				{
						return icUsers;
		}
	...
	*/
	public java.util.List<AdminUsersInPrinterGlobals> getUsersForUI()
	{
				
		List<AdminUsersInPrinterGlobals> result = new ArrayList<AdminUsersInPrinterGlobals>();
	...
	public void countAndCreateChildren() throws WbemsmtException {
    			...
    			try
		{
			int count = adapter.count("users",org.sblim.wbemsmt.samba.bl.container.global.AdminUsersInPrinterGlobals.class, this);
	        if (count != usersCount)
	        {
	           usersCount = count;
	           clearUsers();
			   for (int i=0; i < count ; i++) {
	    			addUsers(new org.sblim.wbemsmt.jsf.samba.container.global.AdminUsersInPrinterGlobals_AsUsers_InPrintingGlobalsDataContainerImpl((org.sblim.wbemsmt.samba.bl.adapter.SambaCimAdapter)adapter,expressionPrefix, i));
			   }
	        }
	...
	public void copyFrom(DataContainer sourceContainer) throws WbemsmtException
	{
    	    		   ...
    	    		   List<AdminUsersInPrinterGlobals> targetListForUsers = getUsers();
    		   List<AdminUsersInPrinterGlobals> sourceListForUsers = source.getUsers();
