...
//**********************************************************************
    ...
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaServiceConfigurationForService.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaServiceConfigurationForService.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    */        
    public final static List<Linux_SambaServiceConfigurationForService> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaServiceConfigurationForService> resultArrayList = new ArrayList<Linux_SambaServiceConfigurationForService>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaServiceConfigurationForService.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaServiceConfigurationForService(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_SambaServiceConfigurationForServiceHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaServiceConfigurationForService)dataObj);
                    } catch (Exception e) {
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaServiceConfigurationForService getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaServiceConfigurationForService getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_SambaServiceConfigurationForService)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaServiceConfigurationForService.");
            }
        }
    ...
    */    
    public final static Linux_SambaServiceConfigurationForService getInstance(WBEMClient client, String namespace
                                                       ,Linux_SambaServiceConfiguration Configuration
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaServiceConfigurationForService.PROPERTY_CONFIGURATION_LINUX_SAMBASERVICECONFIGURATION.NAME,new CIMDataType(Linux_SambaServiceConfiguration.CIM_CLASS_NAME),setThis,false,false,Linux_SambaServiceConfigurationForService.CIM_CLASS_NAME); 
                   
                                 setThis = Element != null ? Element.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_SambaServiceConfigurationForService.PROPERTY_ELEMENT_LINUX_SAMBASERVICE.NAME,new CIMDataType(Linux_SambaService.CIM_CLASS_NAME),setThis,false,false,Linux_SambaServiceConfigurationForService.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaServiceConfigurationForService.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_SambaServiceConfigurationForService createInstance(WBEMClient client, Linux_SambaServiceConfigurationForService dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_SambaServiceConfigurationForService newDataInstance = Linux_SambaServiceConfigurationForServiceHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_SambaServiceConfigurationForService modifyInstance(WBEMClient client, Linux_SambaServiceConfigurationForService dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_SambaServiceConfigurationForService dataInstance2 = Linux_SambaServiceConfigurationForServiceHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaServiceConfigurationForService dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaServiceConfigurationForService.getPackages());
    }
