/**
 * EditSambaShareFileAttributes.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class EditSambaShareFileAttributes extends CimCommand {
     ...
     */
    public static final OptionDefinition KEY_sambaSharename = new OptionDefinition(null,
            "sambaSharename", null, "EditSambaShareFileAttributes.sambaSharename.argValue", true,
            false, "EditSambaShareFileAttributes.sambaSharename.argDescription");
    /**
     * the Default Create Mask required,  --createMask
     */
    public static final OptionDefinition KEY_createMask = new OptionDefinition(null, "createMask",
            null, "CMDShareFileAttributes.CreateMask.argValue", true, false,
            "CMDShareFileAttributes.CreateMask.argDescription");
    /**
     * The directory Mask required,  --directoryMask
     */
    public static final OptionDefinition KEY_directoryMask = new OptionDefinition(null,
            "directoryMask", null, "CMDShareFileAttributes.DirectoryMask.argValue", true, false,
            "CMDShareFileAttributes.DirectoryMask.argDescription");
    /**
     * required,  --directorySecurityMask
     */
    public static final OptionDefinition KEY_directorySecurityMask = new OptionDefinition(null,
            "directorySecurityMask", null, "CMDShareFileAttributes.DirectorySecurityMask.argValue",
            true, false, "CMDShareFileAttributes.DirectorySecurityMask.argDescription");
    /**
     *  --caseSensitive
     */
    public static final OptionDefinition KEY_caseSensitive = new OptionDefinition(null,
            "caseSensitive", null, "ShareFileAttributes.CaseSensitive.argValue", false, false,
            "ShareFileAttributes.CaseSensitive.argDescription");
    /**
     *  --hideDotFiles
     */
    public static final OptionDefinition KEY_hideDotFiles = new OptionDefinition(null,
            "hideDotFiles", null, "ShareFileAttributes.HideDotFiles.argValue", false, false,
            "ShareFileAttributes.HideDotFiles.argDescription");
    /**
     *  --dosFiletimes
     */
    public static final OptionDefinition KEY_dosFiletimes = new OptionDefinition(null,
            "dosFiletimes", null, "ShareFileAttributes.DosFiletimes.argValue", false, false,
            "ShareFileAttributes.DosFiletimes.argDescription");
    /**
     *  --eaSupport
     */
    public static final OptionDefinition KEY_eaSupport = new OptionDefinition(null, "eaSupport",
            null, "ShareFileAttributes.EASupport.argValue", false, false,
            "ShareFileAttributes.EASupport.argDescription");
    /**
     *  --aclCompatibility
     */
    public static final OptionDefinition KEY_aclCompatibility = new OptionDefinition(null,
            "aclCompatibility", null, "ShareFileAttributes.AclCompatibility.argValue", false,
            false, "ShareFileAttributes.AclCompatibility.argDescription");
    /**
     *  --ntaclSupport
     */
    public static final OptionDefinition KEY_ntaclSupport = new OptionDefinition(null,
            "ntaclSupport", null, "ShareFileAttributes.NTACLSupport.argValue", false, false,
            "ShareFileAttributes.NTACLSupport.argDescription");
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] {
            KEY_sambaSharename, KEY_createMask, KEY_directoryMask, KEY_directorySecurityMask,
            KEY_caseSensitive, KEY_hideDotFiles, KEY_dosFiletimes, KEY_eaSupport,
            KEY_aclCompatibility, KEY_ntaclSupport, };
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("CMDShareFileAttributes.caption") }));

            CliDataLoader loader = new EditSambaShareFileAttributesLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.cli.samba.container.share.CMDShareFileAttributesImpl dc = new org.sblim.wbemsmt.cli.samba.container.share.CMDShareFileAttributesImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.samba.bl.container.share.CMDShareFileAttributes dc)
