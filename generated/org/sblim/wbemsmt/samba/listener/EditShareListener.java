/**
 * EditShareListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS OF
...
public class EditShareListener extends TaskLauncherContextMenuEventListenerImpl implements
        org.sblim.wbemsmt.tasklauncher.event.EditListener {

    String jsfListener = "org.sblim.wbemsmt.jsf.samba.listener.EditShareListener";
    String swingListener = "org.sblim.wbemsmt.jswing.samba.listener.EditShareListener";

    //String cmdListener = "org.sblim.wbemsmt.cli.samba.listener.EditShareListener";
