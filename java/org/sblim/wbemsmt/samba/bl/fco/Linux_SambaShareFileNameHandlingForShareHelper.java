...
public class Linux_SambaShareFileNameHandlingForShareHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(
                Linux_SambaShareFileNameHandlingForShare.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    Linux_SambaShareFileNameHandlingForShare.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaShareFileNameHandlingForShare(
                                cimInstance));
                        continue;
                    }
                    Class clazz = Linux_SambaShareFileNameHandlingForShareHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaShareFileNameHandlingForShare.");
                        resultArrayList.add(new Linux_SambaShareFileNameHandlingForShare(
                                cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaShareFileNameHandlingForShare.");
                        resultArrayList.add(new Linux_SambaShareFileNameHandlingForShare(
                                cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaShareFileNameHandlingForShare.");
                        resultArrayList.add(new Linux_SambaShareFileNameHandlingForShare(
                                cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaShareFileNameHandlingForShare getInstance(WBEMClient client,
     ...
     */
    public final static Linux_SambaShareFileNameHandlingForShare getInstance(WBEMClient client,
            String namespace, Linux_SambaShareFileNameHandlingOptions SettingData,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaShareFileNameHandlingForShare.PROPERTY_SETTINGDATA_LINUX_SAMBASHAREFILENAMEHANDLINGOPTIONS.NAME,
                new CIMDataType(Linux_SambaShareFileNameHandlingOptions.CIM_CLASS_NAME), setThis,
                false, false, Linux_SambaShareFileNameHandlingForShare.CIM_CLASS_NAME);

        setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                Linux_SambaShareFileNameHandlingForShare.PROPERTY_MANAGEDELEMENT_LINUX_SAMBASHAREOPTIONS.NAME,
                new CIMDataType(Linux_SambaShareOptions.CIM_CLASS_NAME), setThis, false, false,
                Linux_SambaShareFileNameHandlingForShare.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_SambaShareFileNameHandlingForShare createInstance(WBEMClient client,
            Linux_SambaShareFileNameHandlingForShare dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaShareFileNameHandlingForShare newDataInstance = Linux_SambaShareFileNameHandlingForShareHelper
     ...
     */
    public final static Linux_SambaShareFileNameHandlingForShare modifyInstance(WBEMClient client,
            Linux_SambaShareFileNameHandlingForShare dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaShareFileNameHandlingForShare dataInstance2 = Linux_SambaShareFileNameHandlingForShareHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaShareFileNameHandlingForShare dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaShareFileNameHandlingForShare.getPackages());
    }
