/** 
  * Linux_SambaPrinterSecurityForPrinterHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_SambaPrinterSecurityForPrinter
  *    
  * 
  * generated Class
  * @see Linux_SambaPrinterSecurityForPrinter
  */
...
public class Linux_SambaPrinterSecurityForPrinterHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_SambaPrinterSecurityForPrinter or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaPrinterSecurityForPrinter.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaPrinterSecurityForPrinter.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_SambaPrinterSecurityForPrinter or the subclasses if deep == true
    */        
    public final static List<Linux_SambaPrinterSecurityForPrinter> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaPrinterSecurityForPrinter> resultArrayList = new ArrayList<Linux_SambaPrinterSecurityForPrinter>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaPrinterSecurityForPrinter.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaPrinterSecurityForPrinter(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_SambaPrinterSecurityForPrinterHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_SambaPrinterSecurityForPrinter.");
                        resultArrayList.add(new Linux_SambaPrinterSecurityForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_SambaPrinterSecurityForPrinter.");
                        resultArrayList.add(new Linux_SambaPrinterSecurityForPrinter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaPrinterSecurityForPrinter)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaPrinterSecurityForPrinter.");
                        resultArrayList.add(new Linux_SambaPrinterSecurityForPrinter(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaPrinterSecurityForPrinter getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaPrinterSecurityForPrinter getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_SambaPrinterSecurityForPrinter dataInstance = null;
        Class<?> clazz = Linux_SambaPrinterSecurityForPrinterHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_SambaPrinterSecurityForPrinter)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaPrinterSecurityForPrinter.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_SambaPrinterSecurityForPrinter(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_SambaPrinterSecurityForPrinter getInstance(WBEMClient client, String namespace
                                                       ,Linux_SambaPrinterSecurityOptions SettingData
                                                       ,Linux_SambaPrinterOptions ManagedElement
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaPrinterSecurityForPrinter.PROPERTY_SETTINGDATA_LINUX_SAMBAPRINTERSECURITYOPTIONS.NAME,new CIMDataType(Linux_SambaPrinterSecurityOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaPrinterSecurityForPrinter.CIM_CLASS_NAME); 
                   
                                 setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_SambaPrinterSecurityForPrinter.PROPERTY_MANAGEDELEMENT_LINUX_SAMBAPRINTEROPTIONS.NAME,new CIMDataType(Linux_SambaPrinterOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaPrinterSecurityForPrinter.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaPrinterSecurityForPrinter.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_SambaPrinterSecurityForPrinter createInstance(WBEMClient client, Linux_SambaPrinterSecurityForPrinter dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_SambaPrinterSecurityForPrinter newDataInstance = Linux_SambaPrinterSecurityForPrinterHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_SambaPrinterSecurityForPrinter modifyInstance(WBEMClient client, Linux_SambaPrinterSecurityForPrinter dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_SambaPrinterSecurityForPrinter dataInstance2 = Linux_SambaPrinterSecurityForPrinterHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaPrinterSecurityForPrinter dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaPrinterSecurityForPrinter.getPackages());
    }
