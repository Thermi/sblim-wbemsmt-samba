/**
 * Linux_SambaProtocolOptions.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class Linux_SambaProtocolOptions extends CIM_SettingData {
    ...
    public static class PROPERTY_ACLCOMPATIBILITY {
        ...
        public final static javax.cim.UnsignedInteger8 VALUE_MAP_ENTRY_Auto_FOR_VALUE_ENTRY_0 = new javax.cim.UnsignedInteger8(
                "0");

        /**
         * constant for value entry 0 (corresponds to mapEntry Auto )
         */
        public final static String VALUE_ENTRY_0 = "Auto";

        /**
         * constant for value map entry winnt
         */

        public final static javax.cim.UnsignedInteger8 VALUE_MAP_ENTRY_winnt_FOR_VALUE_ENTRY_1 = new javax.cim.UnsignedInteger8(
                "1");

        /**
         * constant for value entry 1 (corresponds to mapEntry winnt )
         */
        public final static String VALUE_ENTRY_1 = "winnt";

        /**
         * constant for value map entry win2k
         */

        public final static javax.cim.UnsignedInteger8 VALUE_MAP_ENTRY_win2k_FOR_VALUE_ENTRY_2 = new javax.cim.UnsignedInteger8(
                "2");

        /**
         * constant for value entry 2 (corresponds to mapEntry win2k )
         */
        public final static String VALUE_ENTRY_2 = "win2k";
        ...
        public static javax.cim.UnsignedInteger8 getValueMapEntry(String value) {
            ...
            if (VALUE_ENTRY_0.equals(value)) {
                return VALUE_MAP_ENTRY_Auto_FOR_VALUE_ENTRY_0;
            }

            if (VALUE_ENTRY_1.equals(value)) {
                return VALUE_MAP_ENTRY_winnt_FOR_VALUE_ENTRY_1;
            }

            if (VALUE_ENTRY_2.equals(value)) {
                return VALUE_MAP_ENTRY_win2k_FOR_VALUE_ENTRY_2;
            }
            return null;
        ...
        public static String getValueEntry(javax.cim.UnsignedInteger8 value) {
            ...
            if (iValue == VALUE_MAP_ENTRY_Auto_FOR_VALUE_ENTRY_0.intValue()) {
                return VALUE_ENTRY_0;
            }

            if (iValue == VALUE_MAP_ENTRY_winnt_FOR_VALUE_ENTRY_1.intValue()) {
                return VALUE_ENTRY_1;
            }

            if (iValue == VALUE_MAP_ENTRY_win2k_FOR_VALUE_ENTRY_2.intValue()) {
        ...
        public final static javax.cim.UnsignedInteger8[] VALUE_MAP_ENTRIES = {
                VALUE_MAP_ENTRY_Auto_FOR_VALUE_ENTRY_0, VALUE_MAP_ENTRY_winnt_FOR_VALUE_ENTRY_1,
                VALUE_MAP_ENTRY_win2k_FOR_VALUE_ENTRY_2 };
         ...
         * Value Map for the property AclCompatibility   
         */
        public final static String[] VALUE_ENTRIES = { VALUE_ENTRY_0, VALUE_ENTRY_1, VALUE_ENTRY_2 };
         ...
         * Value Map for the property AclCompatibility   
         */
        public final static String[] VALUE_ENTRIES_FOR_DISPLAY = { VALUE_ENTRY_0, VALUE_ENTRY_1,
                VALUE_ENTRY_2 };
