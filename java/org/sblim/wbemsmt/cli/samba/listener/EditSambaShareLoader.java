  ...
  * Contributors: 
  * 
  * Description: class for loading the objects if user edit a samba share
  * 
  */
...
public class EditSambaShareLoader extends SambaLoader implements
		CliDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
		...
		String serviceName = CliUtil.getOption(commandValues,EditSambaShare.KEY_GLOBAL_serviceName);
		String shareName = CliUtil.getOption(commandValues,EditSambaShare.KEY_sharename);
