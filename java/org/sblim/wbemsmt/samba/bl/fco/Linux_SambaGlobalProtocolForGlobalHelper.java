...
public class Linux_SambaGlobalProtocolForGlobalHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaGlobalProtocolForGlobal.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaGlobalProtocolForGlobal.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaGlobalProtocolForGlobalHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaGlobalProtocolForGlobal.");
                        resultArrayList.add(new Linux_SambaGlobalProtocolForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaGlobalProtocolForGlobal.");
                        resultArrayList.add(new Linux_SambaGlobalProtocolForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaGlobalProtocolForGlobal.");
                        resultArrayList.add(new Linux_SambaGlobalProtocolForGlobal(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaGlobalProtocolForGlobal getInstance(WBEMClient client,
     ...
     */
    public final static Linux_SambaGlobalProtocolForGlobal getInstance(WBEMClient client,
            String namespace, Linux_SambaGlobalProtocolOptions SettingData,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaGlobalProtocolForGlobal.PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALPROTOCOLOPTIONS.NAME,
                new CIMDataType(Linux_SambaGlobalProtocolOptions.CIM_CLASS_NAME), setThis, false,
                false, Linux_SambaGlobalProtocolForGlobal.CIM_CLASS_NAME);

        setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                Linux_SambaGlobalProtocolForGlobal.PROPERTY_MANAGEDELEMENT_LINUX_SAMBAGLOBALOPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaGlobalProtocolForGlobal createInstance(WBEMClient client,
            Linux_SambaGlobalProtocolForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaGlobalProtocolForGlobal newDataInstance = Linux_SambaGlobalProtocolForGlobalHelper
     ...
     */
    public final static Linux_SambaGlobalProtocolForGlobal modifyInstance(WBEMClient client,
            Linux_SambaGlobalProtocolForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaGlobalProtocolForGlobal dataInstance2 = Linux_SambaGlobalProtocolForGlobalHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaGlobalProtocolForGlobal dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaGlobalProtocolForGlobal.getPackages());
    }
