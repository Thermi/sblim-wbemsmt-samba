...
public class ListSambaGlobalPrinterAdmin extends CimCommand {
	...
	//All Options that are local and defined for this command
		 ...
		 */
		public static final OptionDefinition KEY_list = new OptionDefinition(null,"list","INSTANCE_WITH_CHILDS","ListSambaGlobalPrinterAdmin.list.argValue",false,false,"ListSambaGlobalPrinterAdmin.list.argDescription");
			/**
