...
public class ShareWizardPage3CMDImpl extends org.sblim.wbemsmt.tools.wizard.jsf.WizardBasePanel
        implements org.sblim.wbemsmt.samba.bl.container.wizard.ShareWizardPage3CMD {
    ...
    public ShareWizardPage3CMDImpl(org.sblim.wbemsmt.samba.bl.adapter.SambaCimAdapter adapter,
            String bindingPrefix) throws WbemsmtException {

        super(adapter, bindingPrefix, "ShareWizardPage3CMD.caption",
                "ShareWizardPage3CMD.subTitle", false);
    ...
    public void reload() {
        ...
        if (ic_DirectorySecurityMask != null) {
            ic_DirectorySecurityMask.setLabelText(bundle
                    .getString("ShareWizardPage3CMD.DirectorySecurityMask"));
        }
    }
