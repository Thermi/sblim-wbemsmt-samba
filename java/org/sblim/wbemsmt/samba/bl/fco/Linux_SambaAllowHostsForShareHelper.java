...
public class Linux_SambaAllowHostsForShareHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaAllowHostsForShare.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaAllowHostsForShare.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaAllowHostsForShareHelper
                            .findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaAllowHostsForShare.");
                        resultArrayList.add(new Linux_SambaAllowHostsForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaAllowHostsForShare.");
                        resultArrayList.add(new Linux_SambaAllowHostsForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaAllowHostsForShare.");
                        resultArrayList.add(new Linux_SambaAllowHostsForShare(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaAllowHostsForShare getInstance(WBEMClient client,
     ...
     */
    public final static Linux_SambaAllowHostsForShare getInstance(WBEMClient client,
            String namespace, Linux_SambaHost PartComponent, Linux_SambaShareOptions GroupComponent
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaAllowHostsForShare.PROPERTY_PARTCOMPONENT_LINUX_SAMBAHOST.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_SambaAllowHostsForShare.PROPERTY_GROUPCOMPONENT_LINUX_SAMBASHAREOPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaAllowHostsForShare createInstance(WBEMClient client,
            Linux_SambaAllowHostsForShare dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaAllowHostsForShare newDataInstance = Linux_SambaAllowHostsForShareHelper
     ...
     */
    public final static Linux_SambaAllowHostsForShare modifyInstance(WBEMClient client,
            Linux_SambaAllowHostsForShare dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaAllowHostsForShare dataInstance2 = Linux_SambaAllowHostsForShareHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaAllowHostsForShare dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaAllowHostsForShare.getPackages());
    }
