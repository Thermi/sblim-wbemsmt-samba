...
public class Linux_SambaPrinterSecurityForGlobalHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaPrinterSecurityForGlobal.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaPrinterSecurityForGlobal.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaPrinterSecurityForGlobalHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaPrinterSecurityForGlobal.");
                        resultArrayList.add(new Linux_SambaPrinterSecurityForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaPrinterSecurityForGlobal.");
                        resultArrayList.add(new Linux_SambaPrinterSecurityForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaPrinterSecurityForGlobal.");
                        resultArrayList.add(new Linux_SambaPrinterSecurityForGlobal(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaPrinterSecurityForGlobal getInstance(WBEMClient client,
    ...
    public final static Linux_SambaPrinterSecurityForGlobal getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaPrinterSecurityForGlobal.PROPERTY_SETTINGDATA_LINUX_SAMBAPRINTERSECURITYOPTIONS.NAME,
                new CIMDataType(Linux_SambaPrinterSecurityOptions.CIM_CLASS_NAME), setThis, false,
                false, Linux_SambaPrinterSecurityForGlobal.CIM_CLASS_NAME);

        setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                Linux_SambaPrinterSecurityForGlobal.PROPERTY_MANAGEDELEMENT_LINUX_SAMBAGLOBALOPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaPrinterSecurityForGlobal createInstance(WBEMClient client,
            Linux_SambaPrinterSecurityForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaPrinterSecurityForGlobal newDataInstance = Linux_SambaPrinterSecurityForGlobalHelper
     ...
     */
    public final static Linux_SambaPrinterSecurityForGlobal modifyInstance(WBEMClient client,
            Linux_SambaPrinterSecurityForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaPrinterSecurityForGlobal dataInstance2 = Linux_SambaPrinterSecurityForGlobalHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaPrinterSecurityForGlobal dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaPrinterSecurityForGlobal.getPackages());
    }
