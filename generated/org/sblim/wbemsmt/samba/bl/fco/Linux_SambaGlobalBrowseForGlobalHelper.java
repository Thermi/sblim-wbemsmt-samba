/** 
  * Linux_SambaGlobalBrowseForGlobalHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_SambaGlobalBrowseForGlobal
  *    
  * 
  * generated Class
  * @see Linux_SambaGlobalBrowseForGlobal
  */
...
public class Linux_SambaGlobalBrowseForGlobalHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_SambaGlobalBrowseForGlobal or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaGlobalBrowseForGlobal.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaGlobalBrowseForGlobal.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_SambaGlobalBrowseForGlobal or the subclasses if deep == true
    */        
    public final static List<Linux_SambaGlobalBrowseForGlobal> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaGlobalBrowseForGlobal> resultArrayList = new ArrayList<Linux_SambaGlobalBrowseForGlobal>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaGlobalBrowseForGlobal.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaGlobalBrowseForGlobal(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_SambaGlobalBrowseForGlobalHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_SambaGlobalBrowseForGlobal.");
                        resultArrayList.add(new Linux_SambaGlobalBrowseForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_SambaGlobalBrowseForGlobal.");
                        resultArrayList.add(new Linux_SambaGlobalBrowseForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaGlobalBrowseForGlobal)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaGlobalBrowseForGlobal.");
                        resultArrayList.add(new Linux_SambaGlobalBrowseForGlobal(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaGlobalBrowseForGlobal getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaGlobalBrowseForGlobal getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_SambaGlobalBrowseForGlobal dataInstance = null;
        Class<?> clazz = Linux_SambaGlobalBrowseForGlobalHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_SambaGlobalBrowseForGlobal)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaGlobalBrowseForGlobal.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_SambaGlobalBrowseForGlobal(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_SambaGlobalBrowseForGlobal getInstance(WBEMClient client, String namespace
                                                       ,Linux_SambaGlobalBrowseOptions SettingData
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaGlobalBrowseForGlobal.PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALBROWSEOPTIONS.NAME,new CIMDataType(Linux_SambaGlobalBrowseOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaGlobalBrowseForGlobal.CIM_CLASS_NAME); 
                   
                                 setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_SambaGlobalBrowseForGlobal.PROPERTY_MANAGEDELEMENT_LINUX_SAMBAGLOBALOPTIONS.NAME,new CIMDataType(Linux_SambaGlobalOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaGlobalBrowseForGlobal.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaGlobalBrowseForGlobal.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_SambaGlobalBrowseForGlobal createInstance(WBEMClient client, Linux_SambaGlobalBrowseForGlobal dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_SambaGlobalBrowseForGlobal newDataInstance = Linux_SambaGlobalBrowseForGlobalHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_SambaGlobalBrowseForGlobal modifyInstance(WBEMClient client, Linux_SambaGlobalBrowseForGlobal dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_SambaGlobalBrowseForGlobal dataInstance2 = Linux_SambaGlobalBrowseForGlobalHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaGlobalBrowseForGlobal dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaGlobalBrowseForGlobal.getPackages());
    }
