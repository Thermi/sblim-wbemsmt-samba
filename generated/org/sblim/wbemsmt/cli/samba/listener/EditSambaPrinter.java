/**
 * EditSambaPrinter.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS OF
...
public class EditSambaPrinter extends CimCommand {
    ...
    public static final OptionDefinition KEY_sambaPrintername = new OptionDefinition(null,
            "sambaPrintername", null, "PrinterOptionsDataContainer.Name.argValue", true, true,
            "PrinterOptionsDataContainer.Name.argDescription");
    /**
     *  --systemPrinterName
     */
    public static final OptionDefinition KEY_systemPrinterName = new OptionDefinition(null,
            "systemPrinterName", null, "PrinterOptionsDataContainer.SystemPrinterName.argValue",
            false, false, "PrinterOptionsDataContainer.SystemPrinterName.argDescription");
    /**
     *  --path
     */
    public static final OptionDefinition KEY_path = new OptionDefinition(null, "path", null,
            "PrinterOptionsDataContainer.Path.argValue", false, false,
            "PrinterOptionsDataContainer.Path.argDescription");
    /**
     *  --comment
     */
    public static final OptionDefinition KEY_comment = new OptionDefinition(null, "comment", null,
            "PrinterOptionsDataContainer.Comment.argValue", false, false,
            "PrinterOptionsDataContainer.Comment.argDescription");
    /**
     *  --available
     */
    public static final OptionDefinition KEY_available = new OptionDefinition(null, "available",
            null, "PrinterOptionsDataContainer.Available.argValue", false, false,
            "PrinterOptionsDataContainer.Available.argDescription");
    /**
     *  --guestOK
     */
    public static final OptionDefinition KEY_guestOK = new OptionDefinition(null, "guestOK", null,
            "PrinterOptionsDataContainer.GuestOK.argValue", false, false,
            "PrinterOptionsDataContainer.GuestOK.argDescription");
    /**
     *  --guestOnly
     */
    public static final OptionDefinition KEY_guestOnly = new OptionDefinition(null, "guestOnly",
            null, "PrinterOptionsDataContainer.GuestOnly.argValue", false, false,
            "PrinterOptionsDataContainer.GuestOnly.argDescription");
    /**
     *  --hostAllow
     */
    public static final OptionDefinition KEY_hostAllow = new OptionDefinition(null, "hostAllow",
            null, "PrinterOptionsDataContainer.HostsAllow.argValue", false, false,
            "PrinterOptionsDataContainer.HostsAllow.argDescription");
    /**
     *  --hostDeny
     */
    public static final OptionDefinition KEY_hostDeny = new OptionDefinition(null, "hostDeny",
            null, "PrinterOptionsDataContainer.HostsDeny.argValue", false, false,
            "PrinterOptionsDataContainer.HostsDeny.argDescription");
    /**
     *  --readOnly
     */
    public static final OptionDefinition KEY_readOnly = new OptionDefinition(null, "readOnly",
            null, "PrinterOptionsDataContainer.ReadOnly.argValue", false, false,
            "PrinterOptionsDataContainer.ReadOnly.argDescription");
    /**
     *  --browsable
     */
    public static final OptionDefinition KEY_browsable = new OptionDefinition(null, "browsable",
            null, "PrinterOptionsDataContainer.Browsable.argValue", false, false,
            "PrinterOptionsDataContainer.Browsable.argDescription");
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] {
            KEY_sambaPrintername, KEY_systemPrinterName, KEY_path, KEY_comment, KEY_available,
            KEY_guestOK, KEY_guestOnly, KEY_hostAllow, KEY_hostDeny, KEY_readOnly, KEY_browsable, };
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("PrinterOptionsDataContainer.caption") }));

            CliDataLoader loader = new EditSambaPrinterLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.cli.samba.container.printer.PrinterOptionsDataContainerImpl dc = new org.sblim.wbemsmt.cli.samba.container.printer.PrinterOptionsDataContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.samba.bl.container.printer.PrinterOptionsDataContainer dc)
