/** 
  * EditServiceListenerEditBeanTabServiceOptions.java
  *
...
public class EditServiceListenerEditBeanTabServiceOptions extends EditBean {
		...
		public void edit(ITaskLauncherTreeNode treeNode) throws ObjectNotFoundException, UpdateControlsException, CountException, InitContainerException
		{
			...
			UIPanel panelToAdd= null;
				...
				bindingPrefix = "objectActionController.editBeans['tabServiceOptions'].containers[0].";
				

				//create cotainner
    			currentEditContainer1 = new org.sblim.wbemsmt.jsf.samba.container.service.ServiceOptionsDataContainerImpl(adapter1,bindingPrefix);
