/** 
  * Linux_SambaShareFileNameHandlingOptionsHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_SambaShareFileNameHandlingOptions
  *    
  * 
  * generated Class
  * @see Linux_SambaShareFileNameHandlingOptions
  */
...
public class Linux_SambaShareFileNameHandlingOptionsHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_SambaShareFileNameHandlingOptions or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaShareFileNameHandlingOptions.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaShareFileNameHandlingOptions.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_SambaShareFileNameHandlingOptions or the subclasses if deep == true
    */        
    public final static List<Linux_SambaShareFileNameHandlingOptions> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaShareFileNameHandlingOptions> resultArrayList = new ArrayList<Linux_SambaShareFileNameHandlingOptions>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaShareFileNameHandlingOptions.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaShareFileNameHandlingOptions(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_SambaShareFileNameHandlingOptionsHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_SambaShareFileNameHandlingOptions.");
                        resultArrayList.add(new Linux_SambaShareFileNameHandlingOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_SambaShareFileNameHandlingOptions.");
                        resultArrayList.add(new Linux_SambaShareFileNameHandlingOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaShareFileNameHandlingOptions)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaShareFileNameHandlingOptions.");
                        resultArrayList.add(new Linux_SambaShareFileNameHandlingOptions(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaShareFileNameHandlingOptions getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaShareFileNameHandlingOptions getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_SambaShareFileNameHandlingOptions dataInstance = null;
        Class<?> clazz = Linux_SambaShareFileNameHandlingOptionsHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_SambaShareFileNameHandlingOptions)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaShareFileNameHandlingOptions.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_SambaShareFileNameHandlingOptions(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_SambaShareFileNameHandlingOptions getInstance(WBEMClient client, String namespace
                                                       ,String InstanceID
                                                       ,String Name
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaShareFileNameHandlingOptions.PROPERTY_INSTANCEID.NAME,CIMDataType.STRING_T,setThis,true,false,Linux_SambaShareFileNameHandlingOptions.CIM_CLASS_NAME); 
                   
                   setThis = Name;
                
           keyProperties[1]  = new CIMProperty(Linux_SambaShareFileNameHandlingOptions.PROPERTY_NAME.NAME,CIMDataType.STRING_T,setThis,true,false,Linux_SambaShareFileNameHandlingOptions.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaShareFileNameHandlingOptions.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_SambaShareFileNameHandlingOptions createInstance(WBEMClient client, Linux_SambaShareFileNameHandlingOptions dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_SambaShareFileNameHandlingOptions newDataInstance = Linux_SambaShareFileNameHandlingOptionsHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_SambaShareFileNameHandlingOptions modifyInstance(WBEMClient client, Linux_SambaShareFileNameHandlingOptions dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_SambaShareFileNameHandlingOptions dataInstance2 = Linux_SambaShareFileNameHandlingOptionsHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaShareFileNameHandlingOptions dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaShareFileNameHandlingOptions.getPackages());
    }
