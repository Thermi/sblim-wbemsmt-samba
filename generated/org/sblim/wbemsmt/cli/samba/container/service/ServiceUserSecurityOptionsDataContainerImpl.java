...
public class ServiceUserSecurityOptionsDataContainerImpl extends BaseDataContainer implements org.sblim.wbemsmt.samba.bl.container.service.ServiceUserSecurityOptionsDataContainer
	...
	public ServiceUserSecurityOptionsDataContainerImpl(AbstractBaseCimAdapter adapter) throws  WbemsmtException {
		super();
		setAdapter(adapter);
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_GuestUser() {
    		...
    		{
				String label = getAdapter().getBundle().getString("ServiceUserSecurityOptionsDataContainer.guestUser");
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
    			ic_usr_GuestUser = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(this,label,null,converter);
    		}
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_CurrentForceUser() {
    		...
    		{
				String label = getAdapter().getBundle().getString("ServiceUserSecurityOptionsDataContainer.currentForceUser");
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_NewForceUser() {
    		...
    		{
				String label = getAdapter().getBundle().getString("ServiceUserSecurityOptionsDataContainer.newForceUser");
	...
	public void trace(java.io.PrintWriter 	printStream, String listOptions, boolean title)
	{
		if (title)
		{
			printStream.println(getAdapter().getBundle().getString("ServiceUserSecurityOptionsDataContainer.caption"));
		}
	...
	{
    		        		List<UserACLItemDataContainerForService> listuserRights = getUserRights();
        		printStream.println();
        		...
        		for (int i = 0; i < listuserRights.size(); i++) {
        			...
        			printStream.println();
        			printStream.println(getAdapter().getBundle().getString("item") + ": " + (i+1) + " " + getAdapter().getBundle().getString("of") + " " + listuserRights.size());
