/**
 * Linux_SambaGlobalProtocolForGlobal.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED
...
public class Linux_SambaGlobalProtocolForGlobal extends CIM_ElementSettingData {
     ...
     * 
     */
    public static class PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALPROTOCOLOPTIONS {
        /**
    ...
    public Linux_SambaGlobalProtocolForGlobal(WBEMClient client, String namespace)
    ...
    public Linux_SambaGlobalProtocolForGlobal(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaGlobalProtocolForGlobal() {
    }
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        propertiesToCheck.put("SettingData", new CIMProperty("SettingData", new CIMDataType(
                Linux_SambaGlobalProtocolOptions.CIM_CLASS_NAME), null));
    ...
    public Linux_SambaGlobalProtocolOptions get_SettingData_Linux_SambaGlobalProtocolOptions(
            javax.wbem.client.WBEMClient client) throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALPROTOCOLOPTIONS.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALPROTOCOLOPTIONS.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }

        return Linux_SambaGlobalProtocolOptionsHelper.getInstance(client,
    ...
    public boolean set_SettingData_Linux_SambaGlobalProtocolOptions(
    ...
    public static CIMProperty create_SettingData_Linux_SambaGlobalProtocolOptions(
            WBEMClient client, String namespace, Linux_SambaGlobalProtocolOptions newValue)
            throws WbemsmtException {
        Linux_SambaGlobalProtocolForGlobal fco = new Linux_SambaGlobalProtocolForGlobal(client,
                namespace);
        CIMProperty property = fco
                .getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALPROTOCOLOPTIONS.NAME);
        if (property != null) {
            property = setPropertyValue_SettingData_Linux_SambaGlobalProtocolOptions(property,
                    newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALPROTOCOLOPTIONS.NAME
    ...
    private static CIMProperty setPropertyValue_SettingData_Linux_SambaGlobalProtocolOptions(
            CIMProperty currentProperty, Linux_SambaGlobalProtocolOptions newValue) {
        Object setThis = null;
    ...
    public String getObjectName() {
        return Linux_SambaGlobalProtocolForGlobal.CIM_CLASS_NAME;
    }
