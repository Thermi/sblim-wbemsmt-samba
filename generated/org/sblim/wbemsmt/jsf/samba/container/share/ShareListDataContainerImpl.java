...
public class ShareListDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel implements org.sblim.wbemsmt.samba.bl.container.share.ShareListDataContainer
			, org.sblim.wbemsmt.samba.bl.container.share.ShareListItemDataContainerHeader		
	{
				...
				private java.util.List<ShareListItemDataContainer> icShares = new java.util.ArrayList<ShareListItemDataContainer>();
	...
	public ShareListDataContainerImpl(org.sblim.wbemsmt.samba.bl.adapter.SambaCimAdapter adapter,String expressionPrefix) throws WbemsmtException  {

			
				super(adapter,expressionPrefix, "ShareListDataContainer.caption",false);
	...
	*/
	public java.util.List<ShareListItemDataContainer> getSharesForUI()
	{
				
		List<ShareListItemDataContainer> result = new ArrayList<ShareListItemDataContainer>();
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getSharesHeader_Name() {
    		if (icSharesHeader_Name == null)
    		{
				...
				String binding = expressionPrefix + "sharesHeader_Name.item";
				...
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent)icSharesHeader_Name).setOrientation( org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT );    		}
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getSharesHeader_Available() {
    		if (icSharesHeader_Available == null)
    		{
				...
				String binding = expressionPrefix + "sharesHeader_Available.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				...
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFCheckboxComponent)icSharesHeader_Available).setOrientation( org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT );    		}
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getSharesHeader_Comment() {
    		if (icSharesHeader_Comment == null)
    		{
				...
				String binding = expressionPrefix + "sharesHeader_Comment.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;
				...
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent)icSharesHeader_Comment).setOrientation( org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT );    		}
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getSharesHeader_Path() {
    		if (icSharesHeader_Path == null)
    		{
				...
				String binding = expressionPrefix + "sharesHeader_Path.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;
				...
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent)icSharesHeader_Path).setOrientation( org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT );    		}
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getSharesHeader_Browsable() {
    		if (icSharesHeader_Browsable == null)
    		{
				...
				String binding = expressionPrefix + "sharesHeader_Browsable.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;
				...
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFCheckboxComponent)icSharesHeader_Browsable).setOrientation( org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT );    		}
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getSharesHeader_GuestOK() {
    		if (icSharesHeader_GuestOK == null)
    		{
				...
				String binding = expressionPrefix + "sharesHeader_GuestOK.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;
				...
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFCheckboxComponent)icSharesHeader_GuestOK).setOrientation( org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT );    		}
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getSharesHeader_GuestOnly() {
    		if (icSharesHeader_GuestOnly == null)
    		{
				...
				String binding = expressionPrefix + "sharesHeader_GuestOnly.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;
				...
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFCheckboxComponent)icSharesHeader_GuestOnly).setOrientation( org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT );    		}
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getSharesHeader_HostsAllow() {
    		if (icSharesHeader_HostsAllow == null)
    		{
				...
				String binding = expressionPrefix + "sharesHeader_HostsAllow.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;
				...
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent)icSharesHeader_HostsAllow).setOrientation( org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT );    		}
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getSharesHeader_HostsDeny() {
    		if (icSharesHeader_HostsDeny == null)
    		{
				...
				String binding = expressionPrefix + "sharesHeader_HostsDeny.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;
				...
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent)icSharesHeader_HostsDeny).setOrientation( org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT );    		}
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getSharesHeader_ReadOnly() {
    		if (icSharesHeader_ReadOnly == null)
    		{
				...
				String binding = expressionPrefix + "sharesHeader_ReadOnly.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;
				...
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFCheckboxComponent)icSharesHeader_ReadOnly).setOrientation( org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT );    		}
	...
	public void countAndCreateChildren() throws WbemsmtException {
    			...
    			try
		{
			int count = adapter.count("shares",org.sblim.wbemsmt.samba.bl.container.share.ShareListItemDataContainer.class, this);
	        if (count != sharesCount)
	        {
	           sharesCount = count;
	           clearShares();
			   for (int i=0; i < count ; i++) {
	    			addShares(new org.sblim.wbemsmt.jsf.samba.container.share.ShareListItemDataContainer_AsShares_InShareListDataContainerImpl((org.sblim.wbemsmt.samba.bl.adapter.SambaCimAdapter)adapter,expressionPrefix, i));
			   }
	        }
	...
	public void copyFrom(DataContainer sourceContainer) throws WbemsmtException
	{
    	    		   ...
    	    		   List<ShareListItemDataContainer> targetListForShares = getShares();
    		   List<ShareListItemDataContainer> sourceListForShares = source.getShares();
