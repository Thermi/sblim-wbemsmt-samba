/** 
  * Linux_SambaShareFileNameHandlingForShareHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_SambaShareFileNameHandlingForShare
  *    
  * 
  * generated Class
  * @see Linux_SambaShareFileNameHandlingForShare
  */
...
public class Linux_SambaShareFileNameHandlingForShareHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_SambaShareFileNameHandlingForShare or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaShareFileNameHandlingForShare.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaShareFileNameHandlingForShare.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_SambaShareFileNameHandlingForShare or the subclasses if deep == true
    */        
    public final static List<Linux_SambaShareFileNameHandlingForShare> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaShareFileNameHandlingForShare> resultArrayList = new ArrayList<Linux_SambaShareFileNameHandlingForShare>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaShareFileNameHandlingForShare.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaShareFileNameHandlingForShare(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_SambaShareFileNameHandlingForShareHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_SambaShareFileNameHandlingForShare.");
                        resultArrayList.add(new Linux_SambaShareFileNameHandlingForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_SambaShareFileNameHandlingForShare.");
                        resultArrayList.add(new Linux_SambaShareFileNameHandlingForShare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaShareFileNameHandlingForShare)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaShareFileNameHandlingForShare.");
                        resultArrayList.add(new Linux_SambaShareFileNameHandlingForShare(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaShareFileNameHandlingForShare getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaShareFileNameHandlingForShare getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_SambaShareFileNameHandlingForShare dataInstance = null;
        Class<?> clazz = Linux_SambaShareFileNameHandlingForShareHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_SambaShareFileNameHandlingForShare)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaShareFileNameHandlingForShare.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_SambaShareFileNameHandlingForShare(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_SambaShareFileNameHandlingForShare getInstance(WBEMClient client, String namespace
                                                       ,Linux_SambaShareFileNameHandlingOptions SettingData
                                                       ,Linux_SambaShareOptions ManagedElement
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaShareFileNameHandlingForShare.PROPERTY_SETTINGDATA_LINUX_SAMBASHAREFILENAMEHANDLINGOPTIONS.NAME,new CIMDataType(Linux_SambaShareFileNameHandlingOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaShareFileNameHandlingForShare.CIM_CLASS_NAME); 
                   
                                 setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_SambaShareFileNameHandlingForShare.PROPERTY_MANAGEDELEMENT_LINUX_SAMBASHAREOPTIONS.NAME,new CIMDataType(Linux_SambaShareOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaShareFileNameHandlingForShare.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaShareFileNameHandlingForShare.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_SambaShareFileNameHandlingForShare createInstance(WBEMClient client, Linux_SambaShareFileNameHandlingForShare dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_SambaShareFileNameHandlingForShare newDataInstance = Linux_SambaShareFileNameHandlingForShareHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_SambaShareFileNameHandlingForShare modifyInstance(WBEMClient client, Linux_SambaShareFileNameHandlingForShare dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_SambaShareFileNameHandlingForShare dataInstance2 = Linux_SambaShareFileNameHandlingForShareHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaShareFileNameHandlingForShare dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaShareFileNameHandlingForShare.getPackages());
    }
