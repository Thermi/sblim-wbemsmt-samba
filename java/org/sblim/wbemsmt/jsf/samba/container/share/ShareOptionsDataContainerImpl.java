...
public class ShareOptionsDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.samba.bl.container.share.ShareOptionsDataContainer {
    ...
    public ShareOptionsDataContainerImpl(
            org.sblim.wbemsmt.samba.bl.adapter.SambaCimAdapter adapter, String bindingPrefix)
            throws WbemsmtException {

        super(adapter, bindingPrefix, "ShareOptionsDataContainer.caption", false);
        ...
        setFooter(getPanelForCustomLayout(), "ShareOptionsDataContainer.footerText");
    ...
    public void reload() {
        super.reload();
        if (ic_Name != null) {
            ic_Name.setLabelText(bundle.getString("ShareOptionsDataContainer.Name"));
        }
        if (ic_Available != null) {
            ic_Available.setLabelText(bundle.getString("ShareOptionsDataContainer.Available"));
        }
        if (ic_Comment != null) {
            ic_Comment.setLabelText(bundle.getString("ShareOptionsDataContainer.Comment"));
        }
        if (ic_Path != null) {
            ic_Path.setLabelText(bundle.getString("ShareOptionsDataContainer.Path"));
        }
        if (ic_Browsable != null) {
            ic_Browsable.setLabelText(bundle.getString("ShareOptionsDataContainer.Browsable"));
        }
        if (ic_GuestOK != null) {
            ic_GuestOK.setLabelText(bundle.getString("ShareOptionsDataContainer.GuestOK"));
        }
        if (ic_GuestOnly != null) {
            ic_GuestOnly.setLabelText(bundle.getString("ShareOptionsDataContainer.GuestOnly"));
        }
        if (ic_HostsAllow != null) {
            ic_HostsAllow.setLabelText(bundle.getString("ShareOptionsDataContainer.HostsAllow"));
        }
        if (ic_HostsDeny != null) {
            ic_HostsDeny.setLabelText(bundle.getString("ShareOptionsDataContainer.HostsDeny"));
        }
        if (ic_ReadOnly != null) {
            ic_ReadOnly.setLabelText(bundle.getString("ShareOptionsDataContainer.ReadOnly"));
        }
    }
