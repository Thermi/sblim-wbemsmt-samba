...
public class Linux_SambaScriptingForGlobalHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaScriptingForGlobal.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaScriptingForGlobal.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaScriptingForGlobalHelper
                            .findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaScriptingForGlobal.");
                        resultArrayList.add(new Linux_SambaScriptingForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaScriptingForGlobal.");
                        resultArrayList.add(new Linux_SambaScriptingForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaScriptingForGlobal.");
                        resultArrayList.add(new Linux_SambaScriptingForGlobal(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaScriptingForGlobal getInstance(WBEMClient client,
    ...
    public final static Linux_SambaScriptingForGlobal getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaScriptingForGlobal.PROPERTY_MANAGEDELEMENT_LINUX_SAMBAGLOBALOPTIONS.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_SambaScriptingForGlobal.PROPERTY_SETTINGDATA_LINUX_SAMBASCRIPTINGOPTIONS.NAME,
                new CIMDataType(Linux_SambaScriptingOptions.CIM_CLASS_NAME), setThis, false, false,
                Linux_SambaScriptingForGlobal.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_SambaScriptingForGlobal createInstance(WBEMClient client,
            Linux_SambaScriptingForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaScriptingForGlobal newDataInstance = Linux_SambaScriptingForGlobalHelper
     ...
     */
    public final static Linux_SambaScriptingForGlobal modifyInstance(WBEMClient client,
            Linux_SambaScriptingForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaScriptingForGlobal dataInstance2 = Linux_SambaScriptingForGlobalHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaScriptingForGlobal dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaScriptingForGlobal.getPackages());
    }
