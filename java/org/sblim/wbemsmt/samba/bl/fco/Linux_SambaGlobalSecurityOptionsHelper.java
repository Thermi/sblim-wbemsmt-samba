...
public class Linux_SambaGlobalSecurityOptionsHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaGlobalSecurityOptions.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaGlobalSecurityOptions.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaGlobalSecurityOptionsHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaGlobalSecurityOptions.");
                        resultArrayList.add(new Linux_SambaGlobalSecurityOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaGlobalSecurityOptions.");
                        resultArrayList.add(new Linux_SambaGlobalSecurityOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaGlobalSecurityOptions.");
                        resultArrayList.add(new Linux_SambaGlobalSecurityOptions(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaGlobalSecurityOptions getInstance(WBEMClient client,
    ...
    public final static Linux_SambaGlobalSecurityOptions getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaGlobalSecurityOptions.PROPERTY_INSTANCEID.NAME, CIMDataType.STRING_T,
                setThis, true, false, Linux_SambaGlobalSecurityOptions.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(Linux_SambaGlobalSecurityOptions.PROPERTY_NAME.NAME,
     ...
     *
     */
    public final static Linux_SambaGlobalSecurityOptions createInstance(WBEMClient client,
            Linux_SambaGlobalSecurityOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaGlobalSecurityOptions newDataInstance = Linux_SambaGlobalSecurityOptionsHelper
     ...
     */
    public final static Linux_SambaGlobalSecurityOptions modifyInstance(WBEMClient client,
            Linux_SambaGlobalSecurityOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaGlobalSecurityOptions dataInstance2 = Linux_SambaGlobalSecurityOptionsHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaGlobalSecurityOptions dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaGlobalSecurityOptions.getPackages());
    }
