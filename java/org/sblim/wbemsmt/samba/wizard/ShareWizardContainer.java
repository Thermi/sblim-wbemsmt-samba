...
import org.sblim.wbemsmt.bl.adapter.AbstractBaseCimAdapter;
	...
	public class ShareWizardContainer extends AbstractWizardContainerBase implements IWizardContainer {

	org.sblim.wbemsmt.tools.wizard.WizardContainerUtil util = new ShareWizardContainerUtil();
	static Logger logger = Logger.getLogger(ShareWizardContainer.class.getName());
	...
	private final ShareWizardContainerPanels panels;
	
	public ShareWizardContainer(AbstractBaseCimAdapter adapter, ShareWizardContainerPanels panels) {
		super(adapter);
		this.panels = panels;
		hmPages = new HashMap();
	...
	public boolean isLast(String pageName) {
    			if (pageName.equals(WIZARD_PANEL_PAGE4)) {
			return true;
		}
        		else return false;
	}
