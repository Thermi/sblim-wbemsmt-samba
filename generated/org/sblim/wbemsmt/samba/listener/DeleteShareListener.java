/**
 * DeleteShareListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS
...
public class DeleteShareListener extends TaskLauncherContextMenuEventListenerImpl implements
        org.sblim.wbemsmt.tasklauncher.event.DeleteListener {

    String jsfListener = "org.sblim.wbemsmt.jsf.samba.listener.DeleteShareListener";
    String swingListener = "org.sblim.wbemsmt.jswing.samba.listener.DeleteShareListener";

    //String cmdListener = "org.sblim.wbemsmt.cli.samba.listener.DeleteShareListener";
