/** 
  * ShareInUserWizardACLItemDataContainer_AsShares_InUserWizardPage2Impl.java
  *
...
public class ShareInUserWizardACLItemDataContainer_AsShares_InUserWizardPage2Impl extends org.sblim.wbemsmt.tools.jsf.MultiLineBasePanel implements org.sblim.wbemsmt.samba.bl.container.wizard.ShareInUserWizardACLItemDataContainer {
...
//	public ShareInUserWizardACLItemDataContainer_AsShares_InUserWizardPage2Impl(String bindingPrefix, org.sblim.wbemsmt.samba.bl.adapter.SambaCimAdapter adapter,int index) throws InitContainerException {
//		this(adapter,bindingPrefix,index, null);
//	}
	
	public ShareInUserWizardACLItemDataContainer_AsShares_InUserWizardPage2Impl(org.sblim.wbemsmt.samba.bl.adapter.SambaCimAdapter adapter,String bindingPrefix,int index, HtmlPanelGrid grid) throws InitContainerException {
	    super(adapter,
		...
		if (first)
		{
			//setFooter(getInputFieldContainer(),"#{localeManager.bundle['SAMBA'].ShareInUserWizardACLItemDataContainer_AsShares_InUserWizardPage2Impl_footerText}","ShareInUserWizardACLItemDataContainer_AsShares_InUserWizardPage2Impl.footerText");
			//setFooter(getInputFieldContainer(),"ShareInUserWizardACLItemDataContainer_AsShares_InUserWizardPage2Impl.footerText");
			String binding = "#{" +  bindingPrefix + "shares["+ index +"].footerText}";
			setFooter(getOuterPanel(),"ShareInUserWizardACLItemDataContainer_AsShares_InUserWizardPage2.footerText",binding);
		}
	...
	{
		ShareInUserWizardACLItemDataContainer_AsShares_InUserWizardPage2Impl source = (ShareInUserWizardACLItemDataContainer_AsShares_InUserWizardPage2Impl)sourceContainer;
