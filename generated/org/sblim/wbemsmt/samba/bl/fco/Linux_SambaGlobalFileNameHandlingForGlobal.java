/**
 * Linux_SambaGlobalFileNameHandlingForGlobal.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS
...
public class Linux_SambaGlobalFileNameHandlingForGlobal extends CIM_ElementSettingData {
     ...
     * 
     */
    public static class PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALFILENAMEHANDLINGOPTIONS {
        /**
    ...
    public Linux_SambaGlobalFileNameHandlingForGlobal(WBEMClient client, String namespace)
    ...
    public Linux_SambaGlobalFileNameHandlingForGlobal(CIMInstance cimInstance)
            throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaGlobalFileNameHandlingForGlobal() {
    }
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        ...
        propertiesToCheck.put("SettingData", new CIMProperty("SettingData", new CIMDataType(
                Linux_SambaGlobalFileNameHandlingOptions.CIM_CLASS_NAME), null));
    ...
    public static CIMProperty create_ManagedElement_Linux_SambaGlobalOptions(WBEMClient client,
        ...
        Linux_SambaGlobalFileNameHandlingForGlobal fco = new Linux_SambaGlobalFileNameHandlingForGlobal(
                client, namespace);
    ...
    public Linux_SambaGlobalFileNameHandlingOptions get_SettingData_Linux_SambaGlobalFileNameHandlingOptions(
            javax.wbem.client.WBEMClient client) throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALFILENAMEHANDLINGOPTIONS.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property "
                    + PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALFILENAMEHANDLINGOPTIONS.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }

        return Linux_SambaGlobalFileNameHandlingOptionsHelper.getInstance(client,
    ...
    public boolean set_SettingData_Linux_SambaGlobalFileNameHandlingOptions(
            Linux_SambaGlobalFileNameHandlingOptions newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALFILENAMEHANDLINGOPTIONS.NAME);
        if (currentProperty != null) {
            setProperty(setPropertyValue_SettingData_Linux_SambaGlobalFileNameHandlingOptions(
    ...
    public static CIMProperty create_SettingData_Linux_SambaGlobalFileNameHandlingOptions(
            WBEMClient client, String namespace, Linux_SambaGlobalFileNameHandlingOptions newValue)
            throws WbemsmtException {
        Linux_SambaGlobalFileNameHandlingForGlobal fco = new Linux_SambaGlobalFileNameHandlingForGlobal(
                client, namespace);
        CIMProperty property = fco
                .getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALFILENAMEHANDLINGOPTIONS.NAME);
        if (property != null) {
            property = setPropertyValue_SettingData_Linux_SambaGlobalFileNameHandlingOptions(
                    property, newValue);
        }
        else {
            logger.warning("Property "
    ...
    private static CIMProperty setPropertyValue_SettingData_Linux_SambaGlobalFileNameHandlingOptions(
            CIMProperty currentProperty, Linux_SambaGlobalFileNameHandlingOptions newValue) {
        Object setThis = null;
    ...
    public String getObjectName() {
        return Linux_SambaGlobalFileNameHandlingForGlobal.CIM_CLASS_NAME;
    }
