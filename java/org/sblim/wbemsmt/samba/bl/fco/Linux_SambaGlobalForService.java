/** 
 * Linux_SambaGlobalForService.java
 *
...
public class Linux_SambaGlobalForService extends CIM_ElementSettingData  {
	...
	public final static String CIM_PROPERTY_LINUX_SAMBAGLOBALOPTIONS = "SettingData"; //$NON-NLS-1$
	...
	*	Class constructor
	*/	
	public Linux_SambaGlobalForService() {
	...
	*	Class constructor
	*/	
	public Linux_SambaGlobalForService(Vector keyProperties){ 
		this();
	...
	*	Class constructor
	*/	
	public Linux_SambaGlobalForService(CIMObjectPath cimObjectPath, CIMInstance cimInstance){ 
	...
	*/	
	public boolean equals(Object object) {
	    ...
	    if (!(object instanceof Linux_SambaGlobalForService)) {
	        return false;
	    }
	    
	    if (this.cimInstance == null && ((Linux_SambaGlobalForService)object).cimInstance != null) {
	    	return false;
	    	
	    } else if (this.cimInstance != null && ((Linux_SambaGlobalForService)object).cimInstance == null) {
	    	return false;
	    	
	    } else if (this.cimInstance != null && !this.cimInstance.equals(((Linux_SambaGlobalForService)object).cimInstance)) {
	    	return false;
	    	
	    } else if (this.original_cimInstance == null && ((Linux_SambaGlobalForService)object).original_cimInstance != null) {
	    	return false;
	    	
	    } else if (this.original_cimInstance != null && ((Linux_SambaGlobalForService)object).original_cimInstance == null) {
	    	return false;
	    	
	    } else if (this.original_cimInstance != null && !this.original_cimInstance.equals(((Linux_SambaGlobalForService)object).original_cimInstance)) {
	        return false;
	        
	    } else if (this.cimObjectPath == null && ((Linux_SambaGlobalForService)object).cimObjectPath != null) {
	    	return false;
	    	
	    } else if (this.cimObjectPath != null && ((Linux_SambaGlobalForService)object).cimObjectPath == null) {
	    	return false;
		    	
	    } else if (this.cimObjectPath != null && !this.cimObjectPath.equals(((Linux_SambaGlobalForService)object).cimObjectPath)) {
	        return false;
	...
	*/	
	...
	public CIMObjectPath get_Linux_SambaGlobalOptions() {
		...
		CIMProperty currentProperty = this.cimInstance.getProperty(Linux_SambaGlobalForService.CIM_PROPERTY_LINUX_SAMBAGLOBALOPTIONS);
	...
	public CIMObjectPath get_Linux_SambaService() {
		...
		CIMProperty currentProperty = this.cimInstance.getProperty(Linux_SambaGlobalForService.CIM_PROPERTY_LINUX_SAMBASERVICE);
