...
public class Linux_SambaGroupHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaGroup.CIM_CLASS_NAME,
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_SambaGroup.");
                        resultArrayList.add(new Linux_SambaGroup(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaGroup.");
                        resultArrayList.add(new Linux_SambaGroup(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaGroup.");
                        resultArrayList.add(new Linux_SambaGroup(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaGroup getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static Linux_SambaGroup getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static Linux_SambaGroup getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(Linux_SambaGroup.PROPERTY_SAMBAGROUPNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_SambaGroup.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_SambaGroup createInstance(WBEMClient client,
            Linux_SambaGroup dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        Linux_SambaGroup newDataInstance = Linux_SambaGroupHelper
     ...
     */
    public final static Linux_SambaGroup modifyInstance(WBEMClient client,
            Linux_SambaGroup dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaGroup dataInstance2 = Linux_SambaGroupHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, Linux_SambaGroup dataInstance)
            throws WbemsmtException {
