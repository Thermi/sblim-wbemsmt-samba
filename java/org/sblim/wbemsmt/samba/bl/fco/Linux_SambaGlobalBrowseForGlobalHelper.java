...
public class Linux_SambaGlobalBrowseForGlobalHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaGlobalBrowseForGlobal.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaGlobalBrowseForGlobal.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaGlobalBrowseForGlobalHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaGlobalBrowseForGlobal.");
                        resultArrayList.add(new Linux_SambaGlobalBrowseForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaGlobalBrowseForGlobal.");
                        resultArrayList.add(new Linux_SambaGlobalBrowseForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaGlobalBrowseForGlobal.");
                        resultArrayList.add(new Linux_SambaGlobalBrowseForGlobal(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaGlobalBrowseForGlobal getInstance(WBEMClient client,
     ...
     */
    public final static Linux_SambaGlobalBrowseForGlobal getInstance(WBEMClient client,
            String namespace, Linux_SambaGlobalBrowseOptions SettingData,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaGlobalBrowseForGlobal.PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALBROWSEOPTIONS.NAME,
                new CIMDataType(Linux_SambaGlobalBrowseOptions.CIM_CLASS_NAME), setThis, false,
                false, Linux_SambaGlobalBrowseForGlobal.CIM_CLASS_NAME);

        setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                Linux_SambaGlobalBrowseForGlobal.PROPERTY_MANAGEDELEMENT_LINUX_SAMBAGLOBALOPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaGlobalBrowseForGlobal createInstance(WBEMClient client,
            Linux_SambaGlobalBrowseForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaGlobalBrowseForGlobal newDataInstance = Linux_SambaGlobalBrowseForGlobalHelper
     ...
     */
    public final static Linux_SambaGlobalBrowseForGlobal modifyInstance(WBEMClient client,
            Linux_SambaGlobalBrowseForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaGlobalBrowseForGlobal dataInstance2 = Linux_SambaGlobalBrowseForGlobalHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaGlobalBrowseForGlobal dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaGlobalBrowseForGlobal.getPackages());
    }
