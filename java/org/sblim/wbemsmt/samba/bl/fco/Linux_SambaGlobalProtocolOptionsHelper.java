...
public class Linux_SambaGlobalProtocolOptionsHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaGlobalProtocolOptions.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaGlobalProtocolOptions.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaGlobalProtocolOptionsHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaGlobalProtocolOptions.");
                        resultArrayList.add(new Linux_SambaGlobalProtocolOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaGlobalProtocolOptions.");
                        resultArrayList.add(new Linux_SambaGlobalProtocolOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaGlobalProtocolOptions.");
                        resultArrayList.add(new Linux_SambaGlobalProtocolOptions(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaGlobalProtocolOptions getInstance(WBEMClient client,
    ...
    public final static Linux_SambaGlobalProtocolOptions getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaGlobalProtocolOptions.PROPERTY_INSTANCEID.NAME, CIMDataType.STRING_T,
                setThis, true, false, Linux_SambaGlobalProtocolOptions.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(Linux_SambaGlobalProtocolOptions.PROPERTY_NAME.NAME,
     ...
     *
     */
    public final static Linux_SambaGlobalProtocolOptions createInstance(WBEMClient client,
            Linux_SambaGlobalProtocolOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaGlobalProtocolOptions newDataInstance = Linux_SambaGlobalProtocolOptionsHelper
     ...
     */
    public final static Linux_SambaGlobalProtocolOptions modifyInstance(WBEMClient client,
            Linux_SambaGlobalProtocolOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaGlobalProtocolOptions dataInstance2 = Linux_SambaGlobalProtocolOptionsHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaGlobalProtocolOptions dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaGlobalProtocolOptions.getPackages());
    }
