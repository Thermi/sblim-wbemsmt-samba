/** 
  ...
  * 
  * Description: Helper class for Linux_SambaWinbindForGlobal
  *    
  * 
  * generated Class
  * @see Linux_SambaWinbindForGlobal
  */
...
public class Linux_SambaWinbindForGlobalHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_SambaWinbindForGlobal or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaWinbindForGlobal.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaWinbindForGlobal.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_SambaWinbindForGlobal or the subclasses if deep == true
    */        
    public final static List<Linux_SambaWinbindForGlobal> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaWinbindForGlobal> resultArrayList = new ArrayList<Linux_SambaWinbindForGlobal>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaWinbindForGlobal.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaWinbindForGlobal(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_SambaWinbindForGlobalHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaWinbindForGlobal)dataObj);
                    } catch (Exception e) {
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaWinbindForGlobal getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaWinbindForGlobal getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        ...
        try {
            ...
            {
                dataInstance = new Linux_SambaWinbindForGlobal(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_SambaWinbindForGlobal getInstance(WBEMClient client, String namespace
                                                       ,Linux_SambaWinbindOptions SettingData
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaWinbindForGlobal.PROPERTY_SETTINGDATA_LINUX_SAMBAWINBINDOPTIONS.NAME,new CIMDataType(Linux_SambaWinbindOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaWinbindForGlobal.CIM_CLASS_NAME); 
                   
                                 setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_SambaWinbindForGlobal.PROPERTY_MANAGEDELEMENT_LINUX_SAMBAGLOBALOPTIONS.NAME,new CIMDataType(Linux_SambaGlobalOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaWinbindForGlobal.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaWinbindForGlobal.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_SambaWinbindForGlobal createInstance(WBEMClient client, Linux_SambaWinbindForGlobal dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_SambaWinbindForGlobal newDataInstance = Linux_SambaWinbindForGlobalHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_SambaWinbindForGlobal modifyInstance(WBEMClient client, Linux_SambaWinbindForGlobal dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_SambaWinbindForGlobal dataInstance2 = Linux_SambaWinbindForGlobalHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaWinbindForGlobal dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaWinbindForGlobal.getPackages());
    }
