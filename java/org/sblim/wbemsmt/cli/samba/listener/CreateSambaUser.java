...
public class CreateSambaUser extends CimCommand implements ContainerUpdater {
    ...
    private void updateContainerChilds(CommandLine cmd, AbstractBaseCimAdapter adapter,
        ...
        try {
            ...
            count = adapter
                    .count(org.sblim.wbemsmt.samba.bl.container.wizard.ShareInUserWizardACLItemDataContainer.class);
            dc.getShares().clear();
            ...
            count = adapter
                    .count(org.sblim.wbemsmt.samba.bl.container.wizard.PrinterInUserWizardACLItemDataContainer.class);
