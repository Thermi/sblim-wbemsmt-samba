/**
 * Linux_SambaShareFileNameHandlingForShare.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS
...
public class Linux_SambaShareFileNameHandlingForShare extends CIM_ElementSettingData {
     ...
     * 
     */
    public static class PROPERTY_SETTINGDATA_LINUX_SAMBASHAREFILENAMEHANDLINGOPTIONS {
        /**
    ...
    public Linux_SambaShareFileNameHandlingForShare(WBEMClient client, String namespace)
    ...
    public Linux_SambaShareFileNameHandlingForShare(CIMInstance cimInstance)
            throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaShareFileNameHandlingForShare() {
    }
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        propertiesToCheck.put("SettingData", new CIMProperty("SettingData", new CIMDataType(
                Linux_SambaShareFileNameHandlingOptions.CIM_CLASS_NAME), null));
    ...
    public Linux_SambaShareFileNameHandlingOptions get_SettingData_Linux_SambaShareFileNameHandlingOptions(
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property "
                    + PROPERTY_SETTINGDATA_LINUX_SAMBASHAREFILENAMEHANDLINGOPTIONS.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }

        return Linux_SambaShareFileNameHandlingOptionsHelper.getInstance(client,
    ...
    public boolean set_SettingData_Linux_SambaShareFileNameHandlingOptions(
    ...
    public static CIMProperty create_SettingData_Linux_SambaShareFileNameHandlingOptions(
            WBEMClient client, String namespace, Linux_SambaShareFileNameHandlingOptions newValue)
            throws WbemsmtException {
        Linux_SambaShareFileNameHandlingForShare fco = new Linux_SambaShareFileNameHandlingForShare(
                client, namespace);
        CIMProperty property = fco
                .getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBASHAREFILENAMEHANDLINGOPTIONS.NAME);
        if (property != null) {
            property = setPropertyValue_SettingData_Linux_SambaShareFileNameHandlingOptions(
                    property, newValue);
        }
        else {
            logger.warning("Property "
    ...
    private static CIMProperty setPropertyValue_SettingData_Linux_SambaShareFileNameHandlingOptions(
            CIMProperty currentProperty, Linux_SambaShareFileNameHandlingOptions newValue) {
        Object setThis = null;
    ...
    public String getObjectName() {
        return Linux_SambaShareFileNameHandlingForShare.CIM_CLASS_NAME;
    }
