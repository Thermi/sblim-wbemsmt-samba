...
public class EditShareGlobalsListenerEditBeanFieldTab extends EditBean {
        				...
        				if (!result.hasErrors())
        				{
    						...
    						try {
                    			...
                    			for (int i=0; i < count; i++) {
	                    			currentEditContainer1.addUsers(new org.sblim.wbemsmt.jsf.samba.container.global.AdminUsersInShareGlobals_AsUsers_InGUIShareGlobalsDataContainerImpl(adapter1,bindingPrefix, i));
                    			}
		...
		public void edit(ITaskLauncherTreeNode treeNode) throws ObjectNotFoundException, UpdateControlsException, CountException, InitContainerException
		{
			...
			UIPanel panelToAdd= null;
				...
				//create cotainner
    			currentEditContainer1 = new org.sblim.wbemsmt.jsf.samba.container.global.GUIShareGlobalsDataContainerImpl(adapter1,bindingPrefix);
