...
public final class Linux_SambaServiceConfigurationHelper {
	...
	*/	
	public final static Linux_SambaServiceConfiguration getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_SambaServiceConfigurationHelper.getInstance(cimClient, new Linux_SambaServiceConfiguration(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaServiceConfiguration getInstance(CIMClient cimClient, Linux_SambaServiceConfiguration dataInstance) {
		...
		return Linux_SambaServiceConfigurationHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_SambaServiceConfiguration getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			dataInstance = new Linux_SambaServiceConfiguration(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaServiceConfiguration createInstance(CIMClient cimClient, Linux_SambaServiceConfiguration dataInstance, boolean notifyDifferencies){ 
		...
		Linux_SambaServiceConfiguration newDataInstance = null;
		try {
			newDataInstance = Linux_SambaServiceConfigurationHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_SambaServiceConfiguration modifyInstance(CIMClient cimClient, Linux_SambaServiceConfiguration dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_SambaServiceConfigurationHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_SambaServiceConfiguration dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_SambaServiceConfiguration dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_SambaServiceConfiguration.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_SambaServiceConfiguration.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_SambaServiceConfiguration.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_SambaServiceConfiguration.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_SambaServiceConfiguration.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_ConfigurationFile(String ConfigurationFile) {
		return true;
	}
