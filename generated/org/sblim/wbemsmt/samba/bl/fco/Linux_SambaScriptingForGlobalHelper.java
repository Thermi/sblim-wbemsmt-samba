/** 
  * Linux_SambaScriptingForGlobalHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_SambaScriptingForGlobal
  *    
  * 
  * generated Class
  * @see Linux_SambaScriptingForGlobal
  */
...
public class Linux_SambaScriptingForGlobalHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_SambaScriptingForGlobal or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaScriptingForGlobal.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaScriptingForGlobal.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_SambaScriptingForGlobal or the subclasses if deep == true
    */        
    public final static List<Linux_SambaScriptingForGlobal> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaScriptingForGlobal> resultArrayList = new ArrayList<Linux_SambaScriptingForGlobal>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaScriptingForGlobal.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaScriptingForGlobal(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_SambaScriptingForGlobalHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_SambaScriptingForGlobal.");
                        resultArrayList.add(new Linux_SambaScriptingForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_SambaScriptingForGlobal.");
                        resultArrayList.add(new Linux_SambaScriptingForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaScriptingForGlobal)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaScriptingForGlobal.");
                        resultArrayList.add(new Linux_SambaScriptingForGlobal(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaScriptingForGlobal getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaScriptingForGlobal getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_SambaScriptingForGlobal dataInstance = null;
        Class<?> clazz = Linux_SambaScriptingForGlobalHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_SambaScriptingForGlobal)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaScriptingForGlobal.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_SambaScriptingForGlobal(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_SambaScriptingForGlobal getInstance(WBEMClient client, String namespace
                                                       ,Linux_SambaGlobalOptions ManagedElement
                                                       ,Linux_SambaScriptingOptions SettingData
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaScriptingForGlobal.PROPERTY_MANAGEDELEMENT_LINUX_SAMBAGLOBALOPTIONS.NAME,new CIMDataType(Linux_SambaGlobalOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaScriptingForGlobal.CIM_CLASS_NAME); 
                   
                                 setThis = SettingData != null ? SettingData.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_SambaScriptingForGlobal.PROPERTY_SETTINGDATA_LINUX_SAMBASCRIPTINGOPTIONS.NAME,new CIMDataType(Linux_SambaScriptingOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaScriptingForGlobal.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaScriptingForGlobal.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_SambaScriptingForGlobal createInstance(WBEMClient client, Linux_SambaScriptingForGlobal dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_SambaScriptingForGlobal newDataInstance = Linux_SambaScriptingForGlobalHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_SambaScriptingForGlobal modifyInstance(WBEMClient client, Linux_SambaScriptingForGlobal dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_SambaScriptingForGlobal dataInstance2 = Linux_SambaScriptingForGlobalHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaScriptingForGlobal dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaScriptingForGlobal.getPackages());
    }
