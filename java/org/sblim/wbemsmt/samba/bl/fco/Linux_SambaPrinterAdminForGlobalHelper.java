...
public class Linux_SambaPrinterAdminForGlobalHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaPrinterAdminForGlobal.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaPrinterAdminForGlobal.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaPrinterAdminForGlobalHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaPrinterAdminForGlobal.");
                        resultArrayList.add(new Linux_SambaPrinterAdminForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaPrinterAdminForGlobal.");
                        resultArrayList.add(new Linux_SambaPrinterAdminForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaPrinterAdminForGlobal.");
                        resultArrayList.add(new Linux_SambaPrinterAdminForGlobal(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaPrinterAdminForGlobal getInstance(WBEMClient client,
     ...
     */
    public final static Linux_SambaPrinterAdminForGlobal getInstance(WBEMClient client,
            String namespace, Linux_SambaUser PartComponent, Linux_SambaGlobalOptions GroupComponent
        ...
        keyProperties[0] = new CIMProperty(
                Linux_SambaPrinterAdminForGlobal.PROPERTY_PARTCOMPONENT_LINUX_SAMBAUSER.NAME,
                new CIMDataType(Linux_SambaUser.CIM_CLASS_NAME), setThis, false, false,
                Linux_SambaPrinterAdminForGlobal.CIM_CLASS_NAME);

        setThis = GroupComponent != null ? GroupComponent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                Linux_SambaPrinterAdminForGlobal.PROPERTY_GROUPCOMPONENT_LINUX_SAMBAGLOBALOPTIONS.NAME,
     ...
     *
     */
    public final static Linux_SambaPrinterAdminForGlobal createInstance(WBEMClient client,
            Linux_SambaPrinterAdminForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaPrinterAdminForGlobal newDataInstance = Linux_SambaPrinterAdminForGlobalHelper
     ...
     */
    public final static Linux_SambaPrinterAdminForGlobal modifyInstance(WBEMClient client,
            Linux_SambaPrinterAdminForGlobal dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaPrinterAdminForGlobal dataInstance2 = Linux_SambaPrinterAdminForGlobalHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaPrinterAdminForGlobal dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaPrinterAdminForGlobal.getPackages());
    }
