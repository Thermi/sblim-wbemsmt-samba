...
public class Linux_SambaPrinterOptionsHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaPrinterOptions.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaPrinterOptions.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_SambaPrinterOptions.");
                        resultArrayList.add(new Linux_SambaPrinterOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaPrinterOptions.");
                        resultArrayList.add(new Linux_SambaPrinterOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaPrinterOptions.");
                        resultArrayList.add(new Linux_SambaPrinterOptions(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaPrinterOptions getInstance(WBEMClient client,
    ...
    public final static Linux_SambaPrinterOptions getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(Linux_SambaPrinterOptions.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                Linux_SambaPrinterOptions.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(Linux_SambaPrinterOptions.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                Linux_SambaPrinterOptions.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_SambaPrinterOptions createInstance(WBEMClient client,
            Linux_SambaPrinterOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaPrinterOptions newDataInstance = Linux_SambaPrinterOptionsHelper.getInstance(
     ...
     */
    public final static Linux_SambaPrinterOptions modifyInstance(WBEMClient client,
            Linux_SambaPrinterOptions dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaPrinterOptions dataInstance2 = Linux_SambaPrinterOptionsHelper.getInstance(
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaPrinterOptions dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaPrinterOptions.getPackages());
    }
