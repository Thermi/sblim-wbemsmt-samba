...
public class UserWizardPage1Impl extends org.sblim.wbemsmt.tools.wizard.jsf.WizardBasePanel
        implements org.sblim.wbemsmt.samba.bl.container.wizard.UserWizardPage1 {
    ...
    public UserWizardPage1Impl(org.sblim.wbemsmt.samba.bl.adapter.SambaCimAdapter adapter,
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_SambaUserName() {
        if (ic_SambaUserName == null) {
            ...
            ic_SambaUserName = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_SystemUserName() {
        if (ic_SystemUserName == null) {
            ...
            boolean readOnly = false;
            ic_SystemUserName = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFListComponent(
                    parent, label, binding, converter, readOnly);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_SambaUserPassword() {
        if (ic_SambaUserPassword == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_SambaUserPassword = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFPasswordFieldComponent(
                    parent, label, binding, converter, readOnly);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_SambaUserPassword2() {
        if (ic_SambaUserPassword2 == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_SambaUserPassword2 = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFPasswordFieldComponent(
                    parent, label, binding, converter, readOnly);
    ...
    public void reload() {
        ...
        if (ic_SambaUserPassword != null) {
            ic_SambaUserPassword
                    .setLabelText(bundle.getString("UserWizardPage1.SambaUserPassword"));
        }
        if (ic_SambaUserPassword2 != null) {
            ic_SambaUserPassword2.setLabelText(bundle
                    .getString("UserWizardPage1.SambaUserPassword2"));
        }
        if (ic_usr_IsGuest != null) {
