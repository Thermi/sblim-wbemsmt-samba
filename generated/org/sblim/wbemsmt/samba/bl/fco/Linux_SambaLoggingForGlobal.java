/**
 * Linux_SambaLoggingForGlobal.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class Linux_SambaLoggingForGlobal extends CIM_ElementSettingData {
     ...
     * 
     */
    public static class PROPERTY_SETTINGDATA_LINUX_SAMBALOGGINGOPTIONS {
        /**
    ...
    public Linux_SambaLoggingForGlobal(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public Linux_SambaLoggingForGlobal(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaLoggingForGlobal() {
    }
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        propertiesToCheck.put("SettingData", new CIMProperty("SettingData", new CIMDataType(
                Linux_SambaLoggingOptions.CIM_CLASS_NAME), null));
    ...
    public Linux_SambaLoggingOptions get_SettingData_Linux_SambaLoggingOptions(
            javax.wbem.client.WBEMClient client) throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBALOGGINGOPTIONS.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_SETTINGDATA_LINUX_SAMBALOGGINGOPTIONS.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }

        return Linux_SambaLoggingOptionsHelper.getInstance(client, (CIMObjectPath) currentProperty
                .getValue());
    ...
    public boolean set_SettingData_Linux_SambaLoggingOptions(Linux_SambaLoggingOptions newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBALOGGINGOPTIONS.NAME);
        if (currentProperty != null) {
            setProperty(setPropertyValue_SettingData_Linux_SambaLoggingOptions(currentProperty,
                    newValue));
            return true;
        }
        else {
    ...
    public static CIMProperty create_SettingData_Linux_SambaLoggingOptions(WBEMClient client,
            String namespace, Linux_SambaLoggingOptions newValue) throws WbemsmtException {
        Linux_SambaLoggingForGlobal fco = new Linux_SambaLoggingForGlobal(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_SETTINGDATA_LINUX_SAMBALOGGINGOPTIONS.NAME);
        if (property != null) {
            property = setPropertyValue_SettingData_Linux_SambaLoggingOptions(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_SETTINGDATA_LINUX_SAMBALOGGINGOPTIONS.NAME
    ...
    private static CIMProperty setPropertyValue_SettingData_Linux_SambaLoggingOptions(
            CIMProperty currentProperty, Linux_SambaLoggingOptions newValue) {
        Object setThis = null;
    ...
    public String getObjectName() {
        return Linux_SambaLoggingForGlobal.CIM_CLASS_NAME;
    }
