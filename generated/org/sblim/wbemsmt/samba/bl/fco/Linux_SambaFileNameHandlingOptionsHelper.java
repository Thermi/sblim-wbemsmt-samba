...
//**********************************************************************
    ...
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaFileNameHandlingOptions.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaFileNameHandlingOptions.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    */        
    public final static List<Linux_SambaFileNameHandlingOptions> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaFileNameHandlingOptions> resultArrayList = new ArrayList<Linux_SambaFileNameHandlingOptions>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaFileNameHandlingOptions.CIM_CLASS_NAME)) {
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaFileNameHandlingOptions)dataObj);
                    } catch (Exception e) {
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaFileNameHandlingOptions getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaFileNameHandlingOptions getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaFileNameHandlingOptions getInstance(WBEMClient client, String namespace
                                                       ,String InstanceID
                                                       ,String Name
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaFileNameHandlingOptions.PROPERTY_INSTANCEID.NAME,CIMDataType.STRING_T,setThis,true,false,Linux_SambaFileNameHandlingOptions.CIM_CLASS_NAME); 
                   
                   setThis = Name;
                
           keyProperties[1]  = new CIMProperty(Linux_SambaFileNameHandlingOptions.PROPERTY_NAME.NAME,CIMDataType.STRING_T,setThis,true,false,Linux_SambaFileNameHandlingOptions.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaFileNameHandlingOptions.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaFileNameHandlingOptions dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaFileNameHandlingOptions.getPackages());
    }
