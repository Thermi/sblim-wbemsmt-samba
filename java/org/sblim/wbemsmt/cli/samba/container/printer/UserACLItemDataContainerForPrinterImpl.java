...
public class UserACLItemDataContainerForPrinterImpl extends BaseDataContainer implements org.sblim.wbemsmt.samba.bl.container.printer.UserACLItemDataContainerForPrinter {
	...
	public UserACLItemDataContainerForPrinterImpl(AbstractBaseCimAdapter adapter) throws InitContainerException {
		super();
		setAdapter(adapter);
	...
	public void trace(java.io.PrintWriter 	printStream, String listOptions, boolean title)
	{
		if (title)
		{
			printStream.println(getAdapter().getBundle().getString("UserACLItemDataContainerForPrinter.caption"));
		}
