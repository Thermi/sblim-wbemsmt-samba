/** 
  * Linux_SambaGroupForUserHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_SambaGroupForUser
  *    
  * 
  * generated Class
  * @see Linux_SambaGroupForUser
  */
...
public class Linux_SambaGroupForUserHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_SambaGroupForUser or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaGroupForUser.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaGroupForUser.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_SambaGroupForUser or the subclasses if deep == true
    */        
    public final static List<Linux_SambaGroupForUser> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaGroupForUser> resultArrayList = new ArrayList<Linux_SambaGroupForUser>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaGroupForUser.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaGroupForUser(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_SambaGroupForUserHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_SambaGroupForUser.");
                        resultArrayList.add(new Linux_SambaGroupForUser(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_SambaGroupForUser.");
                        resultArrayList.add(new Linux_SambaGroupForUser(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaGroupForUser)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaGroupForUser.");
                        resultArrayList.add(new Linux_SambaGroupForUser(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaGroupForUser getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaGroupForUser getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_SambaGroupForUser dataInstance = null;
        Class<?> clazz = Linux_SambaGroupForUserHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_SambaGroupForUser)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaGroupForUser.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_SambaGroupForUser(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_SambaGroupForUser getInstance(WBEMClient client, String namespace
                                                       ,Linux_SambaGroup GroupComponent
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaGroupForUser.PROPERTY_GROUPCOMPONENT_LINUX_SAMBAGROUP.NAME,new CIMDataType(Linux_SambaGroup.CIM_CLASS_NAME),setThis,false,false,Linux_SambaGroupForUser.CIM_CLASS_NAME); 
                   
                                 setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_SambaGroupForUser.PROPERTY_PARTCOMPONENT_LINUX_SAMBAUSER.NAME,new CIMDataType(Linux_SambaUser.CIM_CLASS_NAME),setThis,false,false,Linux_SambaGroupForUser.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaGroupForUser.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_SambaGroupForUser createInstance(WBEMClient client, Linux_SambaGroupForUser dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_SambaGroupForUser newDataInstance = Linux_SambaGroupForUserHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_SambaGroupForUser modifyInstance(WBEMClient client, Linux_SambaGroupForUser dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_SambaGroupForUser dataInstance2 = Linux_SambaGroupForUserHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaGroupForUser dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaGroupForUser.getPackages());
    }
