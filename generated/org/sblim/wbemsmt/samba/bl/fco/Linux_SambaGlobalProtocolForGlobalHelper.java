/** 
  * Linux_SambaGlobalProtocolForGlobalHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_SambaGlobalProtocolForGlobal
  *    
  * 
  * generated Class
  * @see Linux_SambaGlobalProtocolForGlobal
  */
...
public class Linux_SambaGlobalProtocolForGlobalHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_SambaGlobalProtocolForGlobal or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_SambaGlobalProtocolForGlobal.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_SambaGlobalProtocolForGlobal.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_SambaGlobalProtocolForGlobal or the subclasses if deep == true
    */        
    public final static List<Linux_SambaGlobalProtocolForGlobal> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_SambaGlobalProtocolForGlobal> resultArrayList = new ArrayList<Linux_SambaGlobalProtocolForGlobal>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_SambaGlobalProtocolForGlobal.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_SambaGlobalProtocolForGlobal(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_SambaGlobalProtocolForGlobalHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_SambaGlobalProtocolForGlobal.");
                        resultArrayList.add(new Linux_SambaGlobalProtocolForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_SambaGlobalProtocolForGlobal.");
                        resultArrayList.add(new Linux_SambaGlobalProtocolForGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_SambaGlobalProtocolForGlobal)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaGlobalProtocolForGlobal.");
                        resultArrayList.add(new Linux_SambaGlobalProtocolForGlobal(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_SambaGlobalProtocolForGlobal getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_SambaGlobalProtocolForGlobal getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_SambaGlobalProtocolForGlobal dataInstance = null;
        Class<?> clazz = Linux_SambaGlobalProtocolForGlobalHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_SambaGlobalProtocolForGlobal)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_SambaGlobalProtocolForGlobal.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_SambaGlobalProtocolForGlobal(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_SambaGlobalProtocolForGlobal getInstance(WBEMClient client, String namespace
                                                       ,Linux_SambaGlobalProtocolOptions SettingData
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_SambaGlobalProtocolForGlobal.PROPERTY_SETTINGDATA_LINUX_SAMBAGLOBALPROTOCOLOPTIONS.NAME,new CIMDataType(Linux_SambaGlobalProtocolOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaGlobalProtocolForGlobal.CIM_CLASS_NAME); 
                   
                                 setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_SambaGlobalProtocolForGlobal.PROPERTY_MANAGEDELEMENT_LINUX_SAMBAGLOBALOPTIONS.NAME,new CIMDataType(Linux_SambaGlobalOptions.CIM_CLASS_NAME),setThis,false,false,Linux_SambaGlobalProtocolForGlobal.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_SambaGlobalProtocolForGlobal.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_SambaGlobalProtocolForGlobal createInstance(WBEMClient client, Linux_SambaGlobalProtocolForGlobal dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_SambaGlobalProtocolForGlobal newDataInstance = Linux_SambaGlobalProtocolForGlobalHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_SambaGlobalProtocolForGlobal modifyInstance(WBEMClient client, Linux_SambaGlobalProtocolForGlobal dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_SambaGlobalProtocolForGlobal dataInstance2 = Linux_SambaGlobalProtocolForGlobalHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_SambaGlobalProtocolForGlobal dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_SambaGlobalProtocolForGlobal.getPackages());
    }
