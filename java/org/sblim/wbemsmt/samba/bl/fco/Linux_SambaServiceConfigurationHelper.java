...
public class Linux_SambaServiceConfigurationHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_SambaServiceConfiguration.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_SambaServiceConfiguration.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_SambaServiceConfigurationHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_SambaServiceConfiguration.");
                        resultArrayList.add(new Linux_SambaServiceConfiguration(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_SambaServiceConfiguration.");
                        resultArrayList.add(new Linux_SambaServiceConfiguration(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_SambaServiceConfiguration.");
                        resultArrayList.add(new Linux_SambaServiceConfiguration(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_SambaServiceConfiguration getInstance(WBEMClient client,
    ...
    public final static Linux_SambaServiceConfiguration getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(Linux_SambaServiceConfiguration.PROPERTY_NAME.NAME,
     ...
     *
     */
    public final static Linux_SambaServiceConfiguration createInstance(WBEMClient client,
            Linux_SambaServiceConfiguration dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_SambaServiceConfiguration newDataInstance = Linux_SambaServiceConfigurationHelper
     ...
     */
    public final static Linux_SambaServiceConfiguration modifyInstance(WBEMClient client,
            Linux_SambaServiceConfiguration dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_SambaServiceConfiguration dataInstance2 = Linux_SambaServiceConfigurationHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_SambaServiceConfiguration dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_SambaServiceConfiguration.getPackages());
    }
