/**
 * Linux_SambaForceUserForPrinter.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class Linux_SambaForceUserForPrinter extends CIM_Component {
    ...
    public Linux_SambaForceUserForPrinter(WBEMClient client, String namespace)
    ...
    public Linux_SambaForceUserForPrinter(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_SambaForceUserForPrinter() {
    }
    ...
    public static CIMProperty create_PartComponent_Linux_SambaUser(WBEMClient client,
        ...
        Linux_SambaForceUserForPrinter fco = new Linux_SambaForceUserForPrinter(client, namespace);
    ...
    public String getObjectName() {
        return Linux_SambaForceUserForPrinter.CIM_CLASS_NAME;
    }
